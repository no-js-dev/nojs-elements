...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-tooltip",""),e.textContent=t,document.head.appendChild(e)}function yo(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}var We=8;function Xt(t,e,r){let o=e.getBoundingClientRect(),n=t.getBoundingClientRect(),i=window.innerWidth,c=window.innerHeight,a,s;switch(r){case"bottom":a=o.bottom+We,s=o.left+(o.width-n.width)/2;break;case"left":a=o.top+(o.height-n.height)/2,s=o.left-n.width-We;break;case"right":a=o.top+(o.height-n.height)/2,s=o.right+We;break;default:a=o.top-n.height-We,s=o.left+(o.width-n.width)/2;break}s<4&&(s=4),s+n.width>i-4&&(s=i-n.width-4),a<4&&(a=4),a+n.height>c-4&&(a=c-n.height-4),t.style.top=`${a}px`,t.style.left=`${s}px`}var xo=0;function Eo(t,e,r){document.body.appendChild(e),Xt(e,t,r),e.setAttribute("aria-hidden","false")}function Kt(t,e){e.setAttribute("aria-hidden","true"),e.remove()}function _o(t,e){t&&typeof t._warn=="function"?t._warn(e):console.warn(e)}function Zt(t){t.directive("tooltip",{priority:20,init(e,r,o){Yt();let n=o;if(!n){_o(t,"[tooltip] attribute value (tooltip text) is required.");return}let i=e.getAttribute("tooltip-position")||"top",c=parseInt(e.getAttribute("tooltip-delay"),10),a=Number.isNaN(c)?300:c,s=e.getAttribute("tooltip-disabled"),l=s?t.findContext(e):null,m=()=>{if(!s||!l)return!1;try{return!!t.evaluate(s,l)}catch{return!1}},d=`nojs-tooltip-${++xo}`,g=document.createElement("div");g.className="nojs-tooltip",g.setAttribute("role","tooltip"),g.setAttribute("id",d),g.setAttribute("aria-hidden","true"),g.textContent=n,e.setAttribute("aria-describedby",d),xe.set(e,g);let u=!1,f=0,h=()=>{!u||!e.isConnected||f||(f=requestAnimationFrame(()=>{f=0,!(!u||!e.isConnected)&&Xt(g,e,i)}))},v=()=>{window.addEventListener("scroll",h,!0),window.addEventListener("resize",h)},p=()=>{window.removeEventListener("scroll",h,!0),window.removeEventListener("resize",h),f&&(cancelAnimationFrame(f),f=0)},b=()=>{u||(Eo(e,g,i),u=!0,v())},w=()=>{if(!u){Kt(e,g);return}p(),Kt(e,g),u=!1},y=()=>{if(m())return;te.has(e)&&clearTimeout(te.get(e));let B=setTimeout(()=>{te.delete(e),!m()&&e.isConnected&&b()},a);te.set(e,B)},x=()=>{te.has(e)&&(clearTimeout(te.get(e)),te.delete(e)),w()},A=()=>y(),L=()=>x(),k=()=>y(),j=()=>x(),S=B=>{B.key==="Escape"&&g.getAttribute("aria-hidden")==="false"&&x()};e.addEventListener("mouseenter",A),e.addEventListener("mouseleave",L),e.addEventListener("focusin",k),e.addEventListener("focusout",j),e.addEventListener("keydown",S);let _=null;if(s&&l&&typeof l.$watch=="function"){let B=()=>{u&&m()&&w()};_=l.$watch(B)}yo(e,()=>{e.removeEventListener("mouseenter",A),e.removeEventListener("mouseleave",L),e.removeEventListener("focusin",k),e.removeEventListener("focusout",j),e.removeEventListener("keydown",S),_&&(_(),_=null),p(),te.has(e)&&(clearTimeout(te.get(e)),te.delete(e)),u=!1,g.remove(),xe.delete(e)})}})}function Qt(t,e={}){Zt(t)}function Jt(){Ut()}var Y=new Map;function er(){Y.clear()}function Ge(){if(typeof document>"u"||document.querySelector("style[data-nojs-popover]"))return;let t=`
.nojs-popover {
  position: fixed;
  z-index: 9998;
  margin: 0;
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-modal",""),e.textContent=t,document.head.appendChild(e)}function Ao(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}var ar='a[href], button:not([disabled]), input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])',pt=new WeakMap;function Lo(t){let e=r=>{if(r.key!=="Tab")return;let o=[...t.querySelectorAll(ar)].filter(c=>c.offsetParent!==null);if(o.length===0){r.preventDefault();return}let n=o[0],i=o[o.length-1];r.shiftKey?document.activeElement===n&&(r.preventDefault(),i.focus()):document.activeElement===i&&(r.preventDefault(),n.focus())};t.addEventListener("keydown",e),pt.set(t,e)}function sr(t){let e=pt.get(t);e&&(t.removeEventListener("keydown",e),pt.delete(t))}var De=new WeakMap;function cr(t){t.directive("modal",{priority:10,init(r,o,n){_e();let i=n||`nojs-modal-${Date.now()}-${Math.random().toString(36).slice(2,7)}`;r.setAttribute("popover","manual"),r.classList.add("nojs-modal"),r.id=r.id||`nojs-modal-${i}`,r.setAttribute("data-modal-id",i),r.setAttribute("role","dialog"),r.setAttribute("aria-modal","true");let c=r.querySelector("h1, h2, h3, h4, h5, h6");c&&(c.id||(c.id=`nojs-modal-heading-${i}`),r.setAttribute("aria-labelledby",c.id));let a=r.getAttribute("modal-backdrop");a==="false"&&r.setAttribute("data-nojs-no-backdrop","");let s=r.getAttribute("modal-class"),l=r.getAttribute("modal-escape"),m=g=>{g.target===r&&a!=="false"&&l!=="false"&&we(r,i)};r.addEventListener("click",m),oe.set(i,r);let d=g=>{if(g.newState==="open"){if(r.style.zIndex=String(or()),s&&s.split(/\s+/).filter(Boolean).forEach(u=>r.classList.add(u)),requestAnimationFrame(()=>{if(!r.isConnected||!N.some(f=>f.el===r))return;let u=r.querySelector(ar);u?u.focus():r.focus()}),Lo(r),l!=="false"){let u=f=>{f.key==="Escape"&&(f.stopPropagation(),we(r,i))};r.addEventListener("keydown",u),De.set(r,u)}}else if(g.newState==="closed"){s&&s.split(/\s+/).filter(Boolean).forEach(h=>r.classList.remove(h)),sr(r);let u=De.get(r);u&&(r.removeEventListener("keydown",u),De.delete(r));let f=N.findIndex(h=>h.el===r);if(f===-1&&(f=N.findIndex(h=>h.id===i)),f!==-1){let h=N[f];N.splice(f,1),h.triggerEl&&requestAnimationFrame(()=>{h.triggerEl.focus()})}}};r.addEventListener("toggle",d),Ao(r,()=>{r.removeEventListener("click",m),r.removeEventListener("toggle",d),sr(r);let g=De.get(r);g&&(r.removeEventListener("keydown",g),De.delete(r)),oe.delete(i);let u=N.findIndex(f=>f.el===r);u===-1&&(u=N.findIndex(f=>f.id===i)),u!==-1&&N.splice(u,1)})}});let e=r=>e.open(r);e.open=r=>{let o=oe.get(r);if(!o)return!1;try{o.showPopover()}catch{return!1}return N.some(n=>n.id===r)||N.push({id:r,el:o,triggerEl:null}),!0},e.close=r=>{let o=oe.get(r);return o?(we(o,r),!0):!1},e.closeAll=()=>{for(let r=N.length-1;r>=0;r--)we(N[r].el,N[r].id)},t.modal=e}function we(t,e){try{t.hidePopover()}catch{}}function dr(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function jo(t){let e=document.querySelectorAll("[data-modal-id]");for(let r of e)if(r.getAttribute("data-modal-id")===t)return r;return null}function lr(t){t.directive("modal-open",{priority:10,init(e,r,o){_e();let n=o;if(!n){let d=(e.closest("[use]")||e.parentElement)?.querySelector("[data-modal-id]");if(d&&(n=d.getAttribute("data-modal-id")),!n){console.warn('[modal-open] requires a target modal ID, e.g. modal-open="my-dialog"');return}}e.setAttribute("aria-haspopup","dialog"),e.setAttribute("aria-expanded","false");let i=()=>{let m=oe.get(n)||jo(n);if(!m){console.warn(`[modal-open] modal "${n}" not found`);return}let d=N.some(g=>g.id===n);m.id&&e.setAttribute("aria-controls",m.id);try{m.showPopover()}catch{console.warn(`[modal-open] failed to open modal "${n}"`);return}d||N.push({id:n,el:m,triggerEl:e}),e.setAttribute("aria-expanded","true")},c=()=>{e.setAttribute("aria-expanded","false")},a=null,s=null,l=()=>{let m=oe.get(n);return m?(s=m,a=d=>{d.newState==="closed"&&e.setAttribute("aria-expanded","false")},m.addEventListener("toggle",a),!0):!1};if(!l()){let m=requestAnimationFrame(l);dr(e,()=>cancelAnimationFrame(m))}e.addEventListener("click",i),dr(e,()=>{e.removeEventListener("click",i),s&&a&&s.removeEventListener("toggle",a)})}})}function ko(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function ur(t){t.directive("modal-close",{priority:10,init(e,r,o){_e();let n=()=>{let i,c;if(o){if(c=o,i=oe.get(c),!i){console.warn(`[modal-close] modal "${c}" not found`);return}}else{if(i=e.closest("[modal]"),!i){console.warn("[modal-close] no parent modal found");return}c=i.getAttribute("modal")}we(i,c)};e.addEventListener("click",n),ko(e,()=>{e.removeEventListener("click",n)})}})}function pr(t,e={}){cr(t),lr(t),ur(t)}function fr(){ir()}var de={openMenus:new Map};function mr(){de.openMenus.clear()}function Ae(){if(typeof document>"u"||document.querySelector("style[data-nojs-dropdown]"))return;let t=`
.nojs-dropdown-menu {
  position: fixed;
  z-index: 9999;
  margin: 0;
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-breadcrumb",""),e.textContent=t,document.head.appendChild(e)}function Bn(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function si(t){let e=t.getAttribute("breadcrumb");if(e&&e.trim()!=="")return e.trim();let r=t.getAttribute("title");return r&&r.trim()!==""?r.trim():(t.textContent||"").trim()}function ai(t){return t&&t.charAt(0).toUpperCase()+t.slice(1)}function Hn(t,e){let r=t.querySelector("ol.nojs-breadcrumb");r&&r.remove();let o=document.createElement("ol");o.classList.add("nojs-breadcrumb");for(let i=0;i<e.length;i++){let c=e[i],a=document.createElement("li");if(i===e.length-1){let l=document.createElement("span");l.setAttribute("aria-current","page"),l.textContent=c.label,a.appendChild(l)}else{let l=document.createElement("a");l.href=c.href,l.textContent=c.label,a.appendChild(l)}o.appendChild(a)}t.appendChild(o);let n=ue.containers.get(t);n&&(n.crumbs=e)}function ci(t){let e=[],r=Array.from(t.children);for(let o of r){if(o.tagName==="OL"&&o.classList.contains("nojs-breadcrumb"))continue;let n=si(o);if(!n)continue;let i=o.getAttribute("href")||"#";e.push({label:n,href:i})}return e}function di(t){if(!t||t==="/")return[{label:"Home",href:"/",isLast:!0}];let r=(t.replace(/\/+$/,"")||"/").split("/").filter(Boolean),o=[{label:"Home",href:"/"}],n="";for(let i=0;i<r.length;i++){n+="/"+r[i];let c=ai(r[i].replace(/[-_]/g," "));o.push({label:c,href:n})}return o}function Mn(t){t.directive("breadcrumb",{priority:15,init(e,r,o){In(),e.tagName==="NAV"&&!e.getAttribute("aria-label")&&e.setAttribute("aria-label","Breadcrumb");let n=Array.from(e.children).some(a=>!(a.tagName==="OL"&&a.classList.contains("nojs-breadcrumb"))),i=t.router,c=!n&&i;if(ue.containers.set(e,{unsub:null,crumbs:[]}),c){let a=()=>{let s=i.current,l=s?s.path:"/",m=di(l);Hn(e,m)};if(a(),typeof i.on=="function"){let s=i.on(a),l=ue.containers.get(e);l&&(l.unsub=s),Bn(e,()=>{typeof s=="function"&&s();let m=ue.containers.get(e);m&&(m.unsub=null)})}}else{let a=ci(e);for(let s of Array.from(e.children))s.tagName==="OL"&&s.classList.contains("nojs-breadcrumb")||(s.style.display="none");Hn(e,a)}Bn(e,()=>{ue.containers.delete(e)})}})}function qn(t,e={}){Mn(t)}function Pn(){Dn()}var Je={containers:new Map};function Rn(){Je.containers.clear()}function zn(){if(typeof document>"u"||document.querySelector("style[data-nojs-accordion]"))return;let t=`
[accordion] {
  display: flex;
  flex-direction: column;

 ...
 */
(()=>{var E={dragging:null,selected:new Map,placeholder:null},Pe=new Map;function wt(){E.dragging=null,E.selected.clear(),E.placeholder&&(E.placeholder.remove(),E.placeholder=null),Pe.clear()}function Re(){if(typeof document>"u"||document.querySelector("style[data-nojs-dnd]"))return;let t=`
.nojs-dragging {
  opacity: 0.5;
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-tooltip",""),e.textContent=t,document.head.appendChild(e)}function Nn(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}var Ve=8;function Vt(t,e,r){let o=e.getBoundingClientRect(),n=t.getBoundingClientRect(),i=window.innerWidth,c=window.innerHeight,s,a;switch(r){case"bottom":s=o.bottom+Ve,a=o.left+(o.width-n.width)/2;break;case"left":s=o.top+(o.height-n.height)/2,a=o.left-n.width-Ve;break;case"right":s=o.top+(o.height-n.height)/2,a=o.right+Ve;break;default:s=o.top-n.height-Ve,a=o.left+(o.width-n.width)/2;break}a<4&&(a=4),a+n.width>i-4&&(a=i-n.width-4),s<4&&(s=4),s+n.height>c-4&&(s=c-n.height-4),t.style.top=`${s}px`,t.style.left=`${a}px`}var Zn=0;function Qn(t,e,r){document.body.appendChild(e),Vt(e,t,r),e.setAttribute("aria-hidden","false")}function Ot(t,e){e.setAttribute("aria-hidden","true"),e.remove()}function Jn(t,e){t&&typeof t._warn=="function"?t._warn(e):console.warn(e)}function Wt(t){t.directive("tooltip",{priority:20,init(e,r,o){Mt();let n=o;if(!n){Jn(t,"[tooltip] attribute value (tooltip text) is required.");return}let i=e.getAttribute("tooltip-position")||"top",c=parseInt(e.getAttribute("tooltip-delay"),10),s=Number.isNaN(c)?300:c,a=e.getAttribute("tooltip-disabled"),l=a?t.findContext(e):null,f=()=>{if(!a||!l)return!1;try{return!!t.evaluate(a,l)}catch{return!1}},d=`nojs-tooltip-${++Zn}`,m=document.createElement("div");m.className="nojs-tooltip",m.setAttribute("role","tooltip"),m.setAttribute("id",d),m.setAttribute("aria-hidden","true"),m.textContent=n,e.setAttribute("aria-describedby",d),ye.set(e,m);let p=!1,g=0,v=()=>{!p||!e.isConnected||g||(g=requestAnimationFrame(()=>{g=0,!(!p||!e.isConnected)&&Vt(m,e,i)}))},y=()=>{window.addEventListener("scroll",v,!0),window.addEventListener("resize",v)},u=()=>{window.removeEventListener("scroll",v,!0),window.removeEventListener("resize",v),g&&(cancelAnimationFrame(g),g=0)},b=()=>{p||(Qn(e,m,i),p=!0,y())},A=()=>{if(!p){Ot(e,m);return}u(),Ot(e,m),p=!1},h=()=>{if(f())return;te.has(e)&&clearTimeout(te.get(e));let B=setTimeout(()=>{te.delete(e),!f()&&e.isConnected&&b()},s);te.set(e,B)},x=()=>{te.has(e)&&(clearTimeout(te.get(e)),te.delete(e)),A()},_=()=>h(),L=()=>x(),j=()=>h(),k=()=>x(),S=B=>{B.key==="Escape"&&m.getAttribute("aria-hidden")==="false"&&x()};e.addEventListener("mouseenter",_),e.addEventListener("mouseleave",L),e.addEventListener("focusin",j),e.addEventListener("focusout",k),e.addEventListener("keydown",S);let w=null;if(a&&l&&typeof l.$watch=="function"){let B=()=>{p&&f()&&A()};w=l.$watch(B)}Nn(e,()=>{e.removeEventListener("mouseenter",_),e.removeEventListener("mouseleave",L),e.removeEventListener("focusin",j),e.removeEventListener("focusout",k),e.removeEventListener("keydown",S),w&&(w(),w=null),u(),te.has(e)&&(clearTimeout(te.get(e)),te.delete(e)),p=!1,m.remove(),ye.delete(e)})}})}function Ut(t,e={}){Wt(t)}function Gt(){Ht()}var K=new Map;function Yt(){K.clear()}function We(){if(typeof document>"u"||document.querySelector("style[data-nojs-popover]"))return;let t=`
.nojs-popover {
  position: fixed;
  z-index: 9998;
  margin: 0;
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-dropdown",""),e.textContent=t,document.head.appendChild(e)}var io=0;function so(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function cr(t,e,r){let o=r.getAttribute("dropdown-position")||"bottom",n=r.getAttribute("dropdown-align")||"start";t.style.top="",t.style.left="";let i=e.getBoundingClientRect(),c=t.getBoundingClientRect(),s=window.innerHeight,a=window.innerWidth,l,f;switch(o){case"top":l=i.top-c.height,f=i.left;break;case"left":l=i.top,f=i.left-c.width;break;case"right":l=i.top,f=i.right;break;default:l=i.bottom,f=i.left}o==="bottom"||o==="top"?n==="end"&&(f=i.right-c.width):n==="end"&&(l=i.bottom-c.height),o==="bottom"&&l+c.height>s&&i.top-c.height>0?l=i.top-c.height:o==="top"&&l<0&&i.bottom+c.height<=s&&(l=i.bottom),f<4&&(f=4),f+c.width>a-4&&(f=a-c.width-4),t.style.top=`${l}px`,t.style.left=`${f}px`}function dt(t){return[...t.querySelectorAll("[dropdown-item]")].filter(e=>!e.hasAttribute("disabled")&&e.getAttribute("aria-disabled")!=="true")}function ct(t){let e=dt(t);e.length&&e[0].focus()}function dr(t){let e=dt(t);e.length&&e[e.length-1].focus()}function lr(t){t.directive("dropdown",{priority:15,init(r){Ae()}}),t.directive("dropdown-toggle",{priority:15,init(r){Ae();let o=r.closest("[dropdown]");if(!o)return;let n=o.querySelector("[dropdown-menu]");if(!n)return;r.setAttribute("aria-haspopup","menu"),r.setAttribute("aria-expanded","false"),n.classList.add("nojs-dropdown-menu"),n.setAttribute("role","menu"),n.setAttribute("popover","auto"),n.id||(n.id=`nojs-dd-menu-${Date.now()}-${io++}`),r.setAttribute("aria-controls",n.id);let i=!1,c=typeof n.showPopover=="function"&&typeof n.hidePopover=="function";function s(){if(n.setAttribute("data-open",""),c&&!i)try{n.showPopover(),i=!0}catch{i=!1}r.setAttribute("aria-expanded","true"),cr(n,r,o),de.openMenus.set(n,{toggle:r,wrapper:o})}function a(){if(c&&i){i=!1;try{n.hidePopover()}catch{}}n.removeAttribute("data-open"),r.setAttribute("aria-expanded","false"),de.openMenus.delete(n)}function l(){return r.getAttribute("aria-expanded")==="true"}let f=u=>{u.newState==="closed"&&l()&&a()};n.addEventListener("toggle",f);let d=u=>{u.preventDefault(),u.stopPropagation(),l()?a():s()};r.addEventListener("click",d);let m=u=>{l()&&!o.contains(u.target)&&a()};document.addEventListener("click",m,!0);let p=u=>{u.key==="Escape"&&l()&&(a(),r.focus())};document.addEventListener("keydown",p);let g=u=>{switch(u.key){case"Enter":case" ":u.preventDefault(),s(),ct(n);break;case"ArrowDown":u.preventDefault(),s(),ct(n);break;case"ArrowUp":u.preventDefault(),s(),dr(n);break}};r.addEventListener("keydown",g);let v=u=>{if(!(!l()||dt(n).find(h=>h===document.activeElement)))switch(u.key){case"ArrowDown":u.preventDefault(),ct(n);break;case"ArrowUp":u.preventDefault(),dr(n);break}};n.addEventListener("keydown",v);let y=()=>{l()&&cr(n,r,o)};window.addEventListener("scroll",y,!0),window.addEventListener("resize",y),so(r,()=>{r.removeEventListener("click",d),r.removeEventListener("keydown",g),n.removeEventListener("keydown",v),n.removeEventListener("toggle",f),document.removeEventListener("click",m,!0),document.removeEventListener("keydown",p),window.removeEventListener("scroll",y,!0),window.removeEventListener("resize",y),de.openMenus.delete(n)})}}),t.directive("dropdown-menu",{priority:15,init(r){Ae(),r.hasAttribute("role")||r.setAttribute("role","menu")}});let e=r=>e.open(r);e.open=r=>{let o=document.getElementById(r);if(!o)return!1;let i=o.closest("[dropdown]")?.querySelector("[dropdown-toggle]");return!i||i.getAttribute("aria-expanded")==="true"?!1:(i.click(),!0)},e.close=r=>{let o=document.getElementById(r);if(!o)return!1;let i=o.closest("[dropdown]")?.querySelector("[dropdown-toggle]");return!i||i.getAttribute("aria-expanded")!=="true"?!1:(i.click(),!0)},t.dropdown=e}function ur(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function ao(t){return[...t.querySelectorAll("[dropdown-item]")].filter(e=>!e.hasAttribute("disabled")&&e.getAttribute("aria-disabled")!=="true")}function lt(t,e){if(!t)return;if(typeof t.hidePopover=="function")try{t.hidePopover()}catch{}t.removeAttribute("data-open");let r=e&&e.querySelector("[dropdown-toggle]");r&&r.setAttribute("aria-expanded","false"),de.openMenus.has(t)&&de.openMenus.delete(t)}function pr(t){t.directive("dropdown-item",{priority:15,init(e){Ae();let r=e.closest("[dropdown-menu]"),o=e.closest("[dropdown]");e.setAttribute("role","menuitem"),e.setAttribute("tabindex","-1"),e.classList.add("nojs-dropdown-item"),e.hasAttribute("disabled")&&e.setAttribute("aria-disabled","true");let n=c=>{if(!r)return;let s=ao(r),a=s.indexOf(e);switch(c.key){case"ArrowDown":{c.preventDefault(),(a+1<s.length?s[a+1]:s[0]).focus();break}case"ArrowUp":{c.preventDefault(),(a-1>=0?s[a-1]:s[s.length-1]).focus();break}case"Home":{c.preventDefault(),s.length&&s[0].focus();break}case"End":{c.preventDefault(),s.length&&s[s.length-1].focus();break}case"Enter":{c.preventDefault(),e.click();break}case"Escape":{if(c.preventDefault(),lt(r,o),o){let l=o.querySelector("[dropdown-toggle]");l&&l.focus()}break}case"Tab":{lt(r,o);break}}};e.addEventListener("keydown",n),ur(e,()=>e.removeEventListener("keydown",n));let i=()=>{if(lt(r,o),o){let c=o.querySelector("[dropdown-toggle]");c&&c.focus()}};e.addEventListener("click",i),ur(e,()=>e.removeEventListener("click",i))}})}function fr(t,e={}){lr(t),pr(t)}function gr(){ar()}var ie=new Map,_e=new Set,mr=0;function br(){return++mr}function hr(){for(let t of _e)clearTimeout(t);_e.clear();for(let t of ie.values())t.remove();ie.clear(),mr=0}function vr(){if(typeof document>"u"||document.querySelector("style[data-nojs-toast]"))return;let t=`
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-toast",""),e.textContent=t,document.head.appendChild(e)}function ut(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}var co=new Set(["top-right","top-left","bottom-right","bottom-left","top-center","bottom-center"]);function pt(){return ie.size>0?ie.values().next().value:lo("top-right")}function lo(t){if(ie.has(t))return ie.get(t);let e=document.createElement("div");return e.classList.add("nojs-toast-container"),e.setAttribute("data-position",t),e.setAttribute("role","log"),e.setAttribute("aria-live","polite"),e.setAttribute("aria-relevant","additions"),document.body.appendChild(e),ie.set(t,e),e}function uo(t){return t.startsWith("top")}function ft(t,e,r,o,n){let i=br(),c=t.getAttribute("data-position")||"top-right",s=document.createElement("div");s.classList.add("nojs-toast"),s.setAttribute("data-toast-id",i),s.setAttribute("data-type",r),r==="error"&&s.setAttribute("aria-live","assertive");let a=document.createElement("span");if(a.textContent=e,s.appendChild(a),n){let l=document.createElement("button");l.type="button",l.classList.add("nojs-toast-dismiss"),l.setAttribute("aria-label","Dismiss"),l.textContent="\xD7",l.addEventListener("click",()=>Ge(s)),s.appendChild(l)}if(uo(c)&&t.firstChild?t.insertBefore(s,t.firstChild):t.appendChild(s),o>0){let l=setTimeout(()=>{_e.delete(l),s.isConnected&&Ge(s)},o);_e.add(l),s._toastTimerId=l}return s}function Ge(t){!t||!t.isConnected||(t._toastTimerId!=null&&(clearTimeout(t._toastTimerId),_e.delete(t._toastTimerId)),t.remove())}function yr(t){vr(),t.directive("toast-container",{priority:10,init(r,o,n){let i=n&&co.has(n)?n:"top-right";r.classList.add("nojs-toast-container"),r.setAttribute("data-position",i),r.setAttribute("role","log"),r.setAttribute("aria-live","polite"),r.setAttribute("aria-relevant","additions"),ie.set(i,r),ut(r,()=>{ie.get(i)===r&&ie.delete(i)})}}),t.directive("toast",{priority:10,init(r,o,n){if(!n)return;let i=r.getAttribute("toast-type")||"info",c=parseInt(r.getAttribute("toast-duration"),10),s=Number.isNaN(c)?3e3:c,a=r.getAttribute("toast-dismiss")!=="false";if(r.tagName==="BUTTON"||r.tagName==="A"||r.hasAttribute("on:click")){let g=()=>{let v=pt();ft(v,n,i,s,a)};r.addEventListener("click",g),ut(r,()=>r.removeEventListener("click",g));return}let f=t.findContext(r);if(!f||typeof f.$watch!="function"){console.warn("[toast] reactive toast requires a parent [state] or [use] context \u2014 element will be inert");return}let d;function m(){let g=t.evaluate(n,f);if(g&&g!==d){let v=typeof g=="string"?g:String(g),y=pt();ft(y,v,i,s,a),d=g}else d=g}let p=f.$watch(m);ut(r,p)}});let e=(r,o="info",n=3e3)=>{if(typeof document>"u")return;let i=!0,c=pt();return ft(c,String(r),o,n,i)};e.dismiss=r=>{let o=typeof CSS<"u"&&CSS.escape?CSS.escape(String(r)):String(r).replace(/["\\\]]/g,"\\$&"),n=document.querySelector(`[data-toast-id="${o}"]`);n&&Ge(n)},e.dismissAll=()=>{document.querySelectorAll(".nojs-toast").forEach(r=>Ge(r))},t.toast=e}function xr(t,e={}){yr(t)}function Er(){hr()}var me={containers:new Map};function wr(){me.containers.clear()}function Ar(){if(typeof document>"u"||document.querySelector("style[data-nojs-tabs]"))return;let t=`
.nojs-tabs {
  display: flex;
  flex-direction: column;
  border: 1px solid #E2E8F0;
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-tree",""),e.textContent=t,document.head.appendChild(e)}function ke(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function Dr(t){let e=[],r=document.createTreeWalker(t,NodeFilter.SHOW_ELEMENT,{acceptNode(n){return n.matches&&n.matches('.nojs-subtree[aria-hidden="true"]')?NodeFilter.FILTER_REJECT:n.getAttribute("role")==="treeitem"?NodeFilter.FILTER_ACCEPT:NodeFilter.FILTER_SKIP}}),o;for(;o=r.nextNode();)e.push(o);return e}function Ir(t){return t.closest('[role="tree"]')}function go(t){let e=t.parentElement?.closest('[role="group"], .nojs-subtree');if(e){let r=e.parentElement?.closest('[role="treeitem"]');if(r)return r;let o=e.previousElementSibling;if(o?.matches?.('[role="treeitem"]'))return o}return t.parentElement?.closest('[role="treeitem"]')||null}function mo(t){let e=t.cloneNode(!0);return e.querySelectorAll('[role="group"]').forEach(o=>o.remove()),(e.textContent||"").trim().toLowerCase()}function gt(t){let e=I.selectedItem;e&&e!==t&&(e.classList.remove("nojs-branch-selected"),e.setAttribute("aria-selected","false")),t.classList.add("nojs-branch-selected"),t.setAttribute("aria-selected","true"),I.selectedItem=t}function Br(t){let e=I.branches.get(t);!e||!e.subtreeEl||(e.expanded=!e.expanded,t.setAttribute("aria-expanded",String(e.expanded)),e.subtreeEl.setAttribute("aria-hidden",String(!e.expanded)))}function bo(t){let e=I.branches.get(t);!e||!e.subtreeEl||e.expanded||(e.expanded=!0,t.setAttribute("aria-expanded","true"),e.subtreeEl.setAttribute("aria-hidden","false"))}function ho(t){let e=I.branches.get(t);!e||!e.subtreeEl||!e.expanded||(e.expanded=!1,t.setAttribute("aria-expanded","false"),e.subtreeEl.setAttribute("aria-hidden","true"))}function Fr(t,e){let r=Ir(e);if(!r)return;let o=Dr(r),n=o.indexOf(e);if(n<0)return;let i=I.branches.get(e),c=i&&i.subtreeEl;switch(t.key){case"ArrowRight":if(t.preventDefault(),c&&!i.expanded)bo(e);else if(c&&i.expanded){let s=i.subtreeEl.querySelector('[role="treeitem"]');s&&be(s,o)}break;case"ArrowLeft":if(t.preventDefault(),c&&i.expanded)ho(e);else{let s=go(e);s&&be(s,Dr(r))}break;case"ArrowDown":t.preventDefault(),n<o.length-1&&be(o[n+1],o);break;case"ArrowUp":t.preventDefault(),n>0&&be(o[n-1],o);break;case"Enter":case" ":t.preventDefault(),gt(e),c&&Br(e);break;case"Home":t.preventDefault(),o.length>0&&be(o[0],o);break;case"End":t.preventDefault(),o.length>0&&be(o[o.length-1],o);break;default:if(t.key.length===1&&!t.ctrlKey&&!t.altKey&&!t.metaKey){t.preventDefault(),I.typeahead+=t.key.toLowerCase(),I.typeaheadTimer&&clearTimeout(I.typeaheadTimer),I.typeaheadTimer=setTimeout(()=>{I.typeahead="",I.typeaheadTimer=null},500);let s=n+1;for(let a=0;a<o.length;a++){let l=(s+a)%o.length;if(mo(o[l]).startsWith(I.typeahead)){be(o[l],o);break}}}break}}function qr(t){t.directive("tree",{priority:15,init(e){Le(),e.classList.add("nojs-tree"),e.setAttribute("role","tree"),e.getAttribute("tree-icon")==="false"&&e.setAttribute("data-tree-icon","false")}})}function Pr(t){t.directive("branch",{priority:16,init(e,r,o){Le();let n=o==="expanded";e.classList.add("nojs-branch"),e.setAttribute("role","treeitem"),e.setAttribute("aria-expanded",String(n));let i=Ir(e);if(i){let l=i.querySelector('[role="treeitem"][tabindex="0"]');e.setAttribute("tabindex",l?"-1":"0")}else e.setAttribute("tabindex","0");let c=!1;queueMicrotask(()=>{if(c)return;let l=e.querySelector(":scope > [subtree], :scope > .nojs-subtree")||(e.nextElementSibling?.matches?.("[subtree], .nojs-subtree")?e.nextElementSibling:null);l?(I.branches.set(e,{expanded:n,subtreeEl:l}),l.setAttribute("aria-hidden",String(!n))):I.branches.set(e,{expanded:n,subtreeEl:null})});let s=l=>{l.target.closest?.('[role="treeitem"]')===e&&(l.stopPropagation(),gt(e),Br(e))};e.addEventListener("click",s),ke(e,()=>e.removeEventListener("click",s));let a=l=>{Fr(l,e)};e.addEventListener("keydown",a),ke(e,()=>e.removeEventListener("keydown",a)),ke(e,()=>{c=!0,I.branches.delete(e),I.selectedItem===e&&(I.selectedItem=null),I.typeaheadTimer&&(clearTimeout(I.typeaheadTimer),I.typeaheadTimer=null,I.typeahead="")})}})}function be(t,e){for(let r of e)r.setAttribute("tabindex",r===t?"0":"-1");t.focus()}function Rr(t){t.directive("subtree",{priority:16,init(e){Le(),e.classList.add("nojs-subtree"),e.classList.add("nojs-tree"),e.setAttribute("role","group");for(let o of e.children)if(o.tagName==="LI"&&!o.querySelector("[branch], .nojs-branch")){o.setAttribute("role","treeitem"),o.setAttribute("tabindex","-1"),o.classList.add("nojs-tree-leaf");let n=c=>{c.stopPropagation(),gt(o)};o.addEventListener("click",n),ke(o,()=>o.removeEventListener("click",n));let i=c=>{Fr(c,o)};o.addEventListener("keydown",i),ke(o,()=>o.removeEventListener("keydown",i)),ke(o,()=>{I.selectedItem===o&&(I.selectedItem=null)})}let r=e.parentElement?.matches?.('[role="treeitem"]')?e.parentElement:e.previousElementSibling?.matches?.('[role="treeitem"]')?e.previousElementSibling:null;if(r){let o=I.branches.get(r);o?(e.setAttribute("aria-hidden",String(!o.expanded)),o.subtreeEl=e):e.setAttribute("aria-hidden","true")}else e.setAttribute("aria-hidden","true")}})}function $r(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function mt(t){return t.closest('[role="treeitem"]')}function vo(t){return t.closest('[role="tree"]')}function yo(t){let e=t.parentElement;return e?[...e.children].filter(r=>r.getAttribute("role")==="treeitem"):[]}function xo(t){return yo(t).indexOf(t)}function Eo(t,e,r){let o=t.getBoundingClientRect(),n=e-o.top,i=o.height;return r==="reparent"?"on":r==="reorder"?n<i/2?"before":"after":n<i*.25?"before":n>i*.75?"after":"on"}function zr(t,e){let r=t.parentElement;for(;r;){if(r===e)return!0;r=r.parentElement}return!1}var D={dragging:null,indicator:null,currentTarget:null,currentPosition:null};function je(){D.indicator&&(D.indicator.remove(),D.indicator=null)}function Ie(t){if(!t)return;let e=t.querySelectorAll(".nojs-tree-drag-over");for(let r of e)r.classList.remove("nojs-tree-drag-over")}function wo(){let t=document.createElement("div");return t.className="nojs-tree-drag-indicator",t.setAttribute("aria-hidden","true"),t}function Ao(t,e){je();let r=wo(),o=t.getBoundingClientRect(),n=vo(t);if(!n)return;let i=n.getBoundingClientRect();r.style.position="absolute",r.style.left=o.left-i.left+"px",r.style.width=o.width+"px",e==="before"?r.style.top=o.top-i.top-1+"px":r.style.top=o.bottom-i.top-1+"px",getComputedStyle(n).position==="static"&&(n.style.position="relative"),n.appendChild(r),D.indicator=r}function Hr(t){t.directive("tree-drag-mode",{priority:15,init(e,r,o){if(Le(),o!=="reparent"&&o!=="reorder"&&o!=="both")return;let n=0,i=m=>{let p=mt(m.target);if(p&&e.contains(p)){if(p.hasAttribute("tree-drag-disabled")){m.preventDefault();return}D.dragging={el:p,treeRoot:e},m.dataTransfer&&(m.dataTransfer.effectAllowed="move",m.dataTransfer.setData("text/plain","")),p.classList.add("nojs-dragging"),p.dispatchEvent(new CustomEvent("tree:drag-start",{bubbles:!0,detail:{node:p}}))}},c=m=>{if(!D.dragging||D.dragging.treeRoot!==e)return;let p=mt(m.target);if(!p||!e.contains(p)||p===D.dragging.el||zr(p,D.dragging.el))return;m.preventDefault(),m.dataTransfer&&(m.dataTransfer.dropEffect="move");let g=Eo(p,m.clientY,o);(D.currentTarget!==p||D.currentPosition!==g)&&(Ie(e),je(),D.currentTarget=p,D.currentPosition=g,g==="on"?p.classList.add("nojs-tree-drag-over"):Ao(p,g))},s=m=>{D.dragging&&D.dragging.treeRoot===e&&n++},a=m=>{D.dragging&&(n--,n<=0&&(n=0,Ie(e),je(),D.currentTarget=null,D.currentPosition=null))},l=m=>{if(m.preventDefault(),m.stopPropagation(),n=0,!D.dragging||D.dragging.treeRoot!==e)return;let p=D.dragging.el,g=D.currentTarget,v=D.currentPosition;if(Ie(e),je(),!g||!v){D.dragging=null,D.currentTarget=null,D.currentPosition=null;return}if(g===p||zr(g,p)){D.dragging=null,D.currentTarget=null,D.currentPosition=null;return}if(v==="on"){let y=g.querySelector(':scope > [role="group"]');y||(y=g.nextElementSibling?.matches?.('[role="group"]')?g.nextElementSibling:null),y?y.setAttribute("aria-hidden","false"):(y=document.createElement("ul"),y.setAttribute("role","group"),y.setAttribute("subtree",""),y.classList.add("nojs-subtree","nojs-tree"),y.setAttribute("aria-hidden","false"),g.appendChild(y));let u=I.branches.get(g);u&&(u.expanded=!0,u.subtreeEl=y,g.setAttribute("aria-expanded","true")),y.appendChild(p),e.dispatchEvent(new CustomEvent("tree:reparent",{bubbles:!0,detail:{node:p,newParent:g}}))}else{let y=g.parentElement;if(!y){D.dragging=null,D.currentTarget=null,D.currentPosition=null;return}if(v==="before")y.insertBefore(p,g);else{let b=g.nextElementSibling,A=b?.matches?.('[role="group"]')?b.nextElementSibling:b;A?y.insertBefore(p,A):y.appendChild(p)}let u=xo(p);e.dispatchEvent(new CustomEvent("tree:reorder",{bubbles:!0,detail:{node:p,newIndex:u}}))}D.dragging=null,D.currentTarget=null,D.currentPosition=null},f=m=>{let p=mt(m.target);p&&p.classList.remove("nojs-dragging"),Ie(e),je(),n=0,D.dragging&&D.dragging.el.dispatchEvent(new CustomEvent("tree:drag-end",{bubbles:!0,detail:{node:D.dragging.el}})),D.dragging=null,D.currentTarget=null,D.currentPosition=null};e.addEventListener("dragstart",i),e.addEventListener("dragover",c),e.addEventListener("dragenter",s),e.addEventListener("dragleave",a),e.addEventListener("drop",l),e.addEventListener("dragend",f),$r(e,()=>{e.removeEventListener("dragstart",i),e.removeEventListener("dragover",c),e.removeEventListener("dragenter",s),e.removeEventListener("dragleave",a),e.removeEventListener("drop",l),e.removeEventListener("dragend",f),Ie(e),je()}),_o(e);let d=new MutationObserver(m=>{for(let p of m)for(let g of p.addedNodes){if(g.nodeType!==1)continue;g.getAttribute("role")==="treeitem"&&bt(g);let v=g.querySelectorAll?.('[role="treeitem"]');if(v)for(let y of v)bt(y)}});d.observe(e,{childList:!0,subtree:!0}),$r(e,()=>d.disconnect())}})}function bt(t){if(t.hasAttribute("tree-drag-disabled")){t.draggable=!1;return}t.draggable=!0}function _o(t){let e=t.querySelectorAll('[role="treeitem"]');for(let r of e)bt(r)}function Mr(t,e={}){qr(t),Pr(t),Rr(t),Hr(t)}function Or(){Tr()}var Ye=new Map;function Vr(){Ye.clear()}function Ke(){if(typeof document>"u"||document.querySelector("style[data-nojs-stepper]"))return;let t=`
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-stepper",""),e.textContent=t,document.head.appendChild(e)}function Wr(t,e){if(!t.hasAttribute("stepper-validate"))return!0;let r=t.querySelector("form[validate]");if(!r)return!0;let n=e(r)?.$form;return n?!!n.valid:!0}function Ur(t){let e=t.querySelectorAll("input, textarea, select");for(let r of e)r.dispatchEvent(new Event("focusout",{bubbles:!0}))}function Gr(t,e,r){t.dispatchEvent(new CustomEvent("stepper:validation-blocked",{bubbles:!0,detail:{step:e,form:r}}))}function Be(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function Yr(t){t.directive("stepper",{priority:14,init(e,r,o){Ke();let n=t.findContext(e),i=Array.from(e.querySelectorAll("[step]"));if(!i.length){console.warn("[stepper] No [step] children found.");return}let c=o&&parseInt(o,10)||0,s=e.getAttribute("stepper-mode")||"linear",a=e.getAttribute("stepper-indicator")!=="false",l=e.getAttribute("stepper-nav")!=="false",f=e.getAttribute("aria-label")||"Stepper",d=Math.max(0,Math.min(c,i.length-1));e.setAttribute("role","group"),e.setAttribute("aria-label",f),e.classList.add("nojs-stepper");let m=null,p=[];if(a){m=document.createElement("div"),m.className="nojs-stepper-indicator",m.setAttribute("role","tablist"),m.setAttribute("aria-label","Progress"),i.forEach((k,S)=>{if(S>0){let z=document.createElement("div");z.className="nojs-stepper-separator",z.setAttribute("aria-hidden","true"),m.appendChild(z)}let w=document.createElement("button");w.type="button",w.className="nojs-stepper-indicator-item",w.setAttribute("role","tab"),w.setAttribute("aria-selected",S===d?"true":"false");let B=k.getAttribute("step-label")||`Step ${S+1}`,M=document.createElement("span");M.textContent=B,w.appendChild(M),w.setAttribute("aria-label",B);let N=`nojs-stepper-tab-${Lo++}`;if(w.id=N,s==="free"){w.setAttribute("data-clickable","");let z=()=>x(S);w.addEventListener("click",z),Be(e,()=>w.removeEventListener("click",z))}else w.setAttribute("tabindex","-1");m.appendChild(w),p.push(w)});let j=k=>{if(!["ArrowLeft","ArrowRight","Home","End"].includes(k.key))return;k.preventDefault();let S=d;k.key==="ArrowRight"?S=Math.min(d+1,i.length-1):k.key==="ArrowLeft"?S=Math.max(d-1,0):k.key==="Home"?S=0:k.key==="End"&&(S=i.length-1),s==="free"?(x(S),p[S]?.focus()):p[d]?.focus()};m.addEventListener("keydown",j),Be(e,()=>m.removeEventListener("keydown",j)),e.insertBefore(m,e.firstChild)}let g=null,v=null,y=null;if(l){g=document.createElement("div"),g.className="nojs-stepper-nav",g.setAttribute("aria-hidden","true"),v=document.createElement("button"),v.type="button",v.className="nojs-stepper-prev",v.textContent="Previous";let j=()=>h();v.addEventListener("click",j),Be(e,()=>v.removeEventListener("click",j)),y=document.createElement("button"),y.type="button",y.className="nojs-stepper-next",y.textContent="Next";let k=()=>A();y.addEventListener("click",k),Be(e,()=>y.removeEventListener("click",k)),g.appendChild(v),g.appendChild(y),e.appendChild(g)}function u(j){let k=i[j];if(!k)return!0;if(!Wr(k,t.findContext)){let B=k.querySelector("form[validate]");return B&&(Ur(B),p[j]&&p[j].classList.add("nojs-step-invalid"),Gr(e,k,B)),!1}p[j]&&p[j].classList.remove("nojs-step-invalid");let S=k.querySelectorAll("[required]");for(let B of S)if(typeof B.checkValidity=="function"&&!B.checkValidity())return B.reportValidity(),!1;let w=k.getAttribute("step-validate");if(w)try{if(!t.evaluate(w,n))return!1}catch(B){return console.warn(`[stepper] step-validate error: ${B.message}`),!1}return!0}function b(j){i.forEach((k,S)=>{let w=S===d;k.setAttribute("aria-hidden",w?"false":"true"),w?(k.removeAttribute("inert"),k.setAttribute("aria-current","step")):(k.setAttribute("inert",""),k.removeAttribute("aria-current"))}),p.length&&p.forEach((k,S)=>{k.setAttribute("aria-selected",S===d?"true":"false"),S<d?k.setAttribute("data-completed",""):k.removeAttribute("data-completed"),k.setAttribute("tabindex",S===d?"0":"-1");let w=i[S];w.id&&(k.setAttribute("aria-controls",w.id),w.setAttribute("aria-labelledby",k.id))}),v&&(v.disabled=d===0),y&&(y.textContent=d===i.length-1?"Finish":"Next"),e.dispatchEvent(new CustomEvent("step-change",{bubbles:!j,detail:{current:d,total:i.length}}))}function A(){return d>=i.length-1?(s==="linear"&&!u(d)||e.dispatchEvent(new CustomEvent("step-complete",{bubbles:!0,detail:{current:d,total:i.length}})),!1):s==="linear"&&!u(d)?!1:(d++,b(),L(),!0)}function h(){return d<=0?!1:(d--,b(),L(),!0)}function x(j){if(j<0||j>=i.length||j===d)return!1;if(s==="linear"&&j>d){for(let k=d;k<j;k++)if(d=k,b(),!u(k))return L(),!1}return d=j,b(),L(),!0}let _={get current(){return d},get total(){return i.length},next:A,prev:h,goTo:x,get isFirst(){return d===0},get isLast(){return d===i.length-1}};function L(){n.$stepper=_}L(),Ye.set(e,{get current(){return d},steps:i,mode:s,indicatorEl:m,navEl:g}),b(!0),Be(e,()=>{Ye.delete(e),m&&m.parentNode&&m.remove(),g&&g.parentNode&&g.remove(),delete n.$stepper})}})}var Lo=0;var ko=0;function Kr(t){t.directive("step",{priority:13,init(e,r,o){Ke(),e.classList.add("nojs-step"),e.setAttribute("role","tabpanel"),e.id||(e.id=`nojs-stepper-panel-${ko++}`),e.setAttribute("tabindex","0")}})}function Xr(t,e={}){Kr(t),Yr(t)}function Nr(){Vr()}function Zr(){if(typeof document>"u"||document.querySelector("style[data-nojs-skeleton]"))return;let t=`
.nojs-skeleton {
  position: relative;
  overflow: hidden;
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-table",""),e.textContent=t,document.head.appendChild(e)}function Bo(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function Fo(t,e){let r=t.querySelector("tbody");if(!r)return null;let o=null;if(r.hasAttribute("each")||r.hasAttribute("foreach")?o=r:o=r.querySelector("[each]")||r.querySelector("[foreach]"),!o)return null;let n=o.getAttribute("each")||o.getAttribute("foreach");if(!n)return null;let i=n.match(/^\s*(\w+)\s+(?:in|of)\s+(.+)\s*$/);return i?{iteratorVar:i[1],arrayPath:i[2].trim()}:null}function qo(t,e){let r=e.split("."),o=t;for(let n of r){if(o==null)return;o=o[n]}return o}function ln(t,e,r){let o=e.split("."),n=t;for(let i=0;i<o.length-1;i++){if(n[o[i]]==null)return;n=n[o[i]]}n[o[o.length-1]]=r}function un(t,e){let r=Number.isNaN(t),o=Number.isNaN(e);return r&&o?0:r?1:o||t<e?-1:t>e?1:0}function fn(t,e,r){if(t==null&&e==null)return 0;if(t==null)return-1;if(e==null)return 1;switch(r){case"number":return un(Number(t),Number(e));case"date":return un(new Date(t).getTime(),new Date(e).getTime());default:return String(t).localeCompare(String(e))}}function Po(t){let e=t.querySelectorAll("th[data-sortable]");for(let r of e)r.removeAttribute("data-sort-dir"),r.setAttribute("aria-sort","none")}function gn(t){t.directive("sortable",{priority:10,init(e){ve(),e.classList.add("nojs-sortable")}})}function mn(t){t.directive("sort",{priority:11,init(e,r,o){ve();let n=o;if(!n)return;let i=e.getAttribute("sort-type")||"string",c=e.getAttribute("sort-default");e.setAttribute("data-sortable",""),e.setAttribute("aria-sort","none");let s=e.closest("table");if(!s)return;le.sorts.has(s)||le.sorts.set(s,{column:null,direction:null}),(c==="asc"||c==="desc")&&(le.sorts.get(s).column||pn(e,s,n,i,c,t));let a=()=>{let l=le.sorts.get(s),f;l.column!==n?f="asc":l.direction==="asc"?f="desc":l.direction==="desc"?f=null:f="asc",pn(e,s,n,i,f,t)};e.addEventListener("click",a),Bo(e,()=>{e.removeEventListener("click",a),s&&!s.isConnected&&(le.sorts.delete(s),delete s._nojsOriginalOrder,delete s._nojsOriginalRows)})}})}function pn(t,e,r,o,n,i){let c=le.sorts.get(e);Po(e),n?(t.setAttribute("data-sort-dir",n),t.setAttribute("aria-sort",n==="asc"?"ascending":"descending"),c.column=r,c.direction=n):(c.column=null,c.direction=null);let s=Fo(e,i);if(s){let a=i.findContext(e),l=a?qo(a,s.arrayPath):null;if(Array.isArray(l)){if(!n){let d=e._nojsOriginalOrder;if(d){let m=new Set(l),p=d.filter(g=>m.has(g));for(let g of l)d.includes(g)||p.push(g);ln(a,s.arrayPath,p)}return}e._nojsOriginalOrder||(e._nojsOriginalOrder=[...l]);let f=[...l].sort((d,m)=>{let p=d!=null?d[r]:null,g=m!=null?m[r]:null,v=fn(p,g,o);return n==="desc"?-v:v});ln(a,s.arrayPath,f);return}}Ro(e,t,r,o,n)}function Ro(t,e,r,o,n){let i=t.querySelector("tbody");if(!i)return;let a=[...e.closest("tr").children].indexOf(e);if(a<0)return;let l=[...i.querySelectorAll(":scope > tr")];if(t._nojsOriginalRows||(t._nojsOriginalRows=[...l]),!n){let m=document.createDocumentFragment();for(let p of t._nojsOriginalRows)m.appendChild(p);i.appendChild(m);return}let f=m=>{let p=m.replace(/[^0-9.\-]/g,"");return p===""||p==="-"?NaN:parseFloat(p)};l.sort((m,p)=>{let g=m.children[a]?.textContent?.trim()||"",v=p.children[a]?.textContent?.trim()||"",y=fn(o==="number"?f(g):g,o==="number"?f(v):v,o);return n==="desc"?-y:y});let d=document.createDocumentFragment();for(let m of l)d.appendChild(m);i.appendChild(d)}function bn(t){t.directive("fixed-header",{priority:10,init(e){ve(),e.classList.add("nojs-fixed-header")}})}function hn(t){t.directive("fixed-col",{priority:10,init(e){ve(),e.classList.add("nojs-fixed-col")}})}function vt(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function vn(t){let e=t.querySelector("tbody");if(!e)return null;let r=null;if(e.hasAttribute("each")||e.hasAttribute("foreach")?r=e:r=e.querySelector("[each]")||e.querySelector("[foreach]"),!r)return null;let o=r.getAttribute("each")||r.getAttribute("foreach");if(!o)return null;let n=o.match(/^\s*(\w+)\s+(?:in|of)\s+(.+)\s*$/);return n?{iteratorVar:n[1],arrayPath:n[2].trim(),eachEl:r}:null}function yn(t,e){let r=e.split("."),o=t;for(let n of r){if(o==null)return;o=o[n]}return o}function xn(t,e,r){let o=e.split("."),n=t;for(let i=0;i<o.length-1;i++){if(n[o[i]]==null)return;n=n[o[i]]}n[o[o.length-1]]=r}function En(t){t.directive("table-reorder",{priority:15,init(e){if(ve(),e.tagName!=="TABLE")return;let r=e.querySelector("tbody");if(!r)return;let o=t.findContext(e),n=e.getAttribute("table-reorder-handle"),i=e.getAttribute("table-reorder-drag-class")||"nojs-row-dragging",c=e.getAttribute("table-reorder-over-class")||"nojs-row-drag-over",s=null,a=null,l=null;function f(){let y=r.querySelectorAll(":scope > tr");for(let u=0;u<y.length;u++){let b=y[u];if(b._nojsReorderSetup)continue;b._nojsReorderSetup=!0,b.draggable=!0,b.setAttribute("aria-grabbed","false");let A=!0;if(n){let k=S=>{A=!!S.target.closest(n)};b.addEventListener("mousedown",k),vt(b,()=>b.removeEventListener("mousedown",k))}let h=k=>{if(n&&!A){k.preventDefault();return}s=[...r.querySelectorAll(":scope > tr")].indexOf(b),a=b,k.dataTransfer&&(k.dataTransfer.effectAllowed="move",k.dataTransfer.setData("text/plain","")),i.split(/\s+/).filter(Boolean).forEach(w=>b.classList.add(w)),b.setAttribute("aria-grabbed","true")},x=k=>{if(a==null)return;k.preventDefault(),k.dataTransfer&&(k.dataTransfer.dropEffect="move");let S=b.getBoundingClientRect(),w=S.top+S.height/2,M=[...r.querySelectorAll(":scope > tr")].indexOf(b);d(),M!==s&&(k.clientY<w?b.classList.add("nojs-reorder-insert-before"):b.classList.add("nojs-reorder-insert-after"),l=b)},_=()=>{b.classList.remove("nojs-reorder-insert-before"),b.classList.remove("nojs-reorder-insert-after"),l===b&&(l=null)},L=k=>{if(k.preventDefault(),k.stopPropagation(),a==null||s==null)return;let S=[...r.querySelectorAll(":scope > tr")],w=b.getBoundingClientRect(),B=w.top+w.height/2,M=S.indexOf(b);k.clientY>=B&&M++;let N=s;if(N===M||N+1===M){m();return}let z=N<M?M-1:M,se=vn(e);if(se&&o){let T=yn(o,se.arrayPath);if(Array.isArray(T)){let q=[...T],[$]=q.splice(N,1);q.splice(z,0,$),xn(o,se.arrayPath,q),e._nojsOriginalOrder&&(e._nojsOriginalOrder=[...q]),e.dispatchEvent(new CustomEvent("table:reorder",{bubbles:!0,detail:{from:N,to:z,item:$}}))}}else{let T=a,q=S[z];T&&q&&(N<z?r.insertBefore(T,q.nextSibling):r.insertBefore(T,q),e.dispatchEvent(new CustomEvent("table:reorder",{bubbles:!0,detail:{from:N,to:z,item:null}})))}m()},j=()=>{m()};b.addEventListener("dragstart",h),b.addEventListener("dragover",x),b.addEventListener("dragleave",_),b.addEventListener("drop",L),b.addEventListener("dragend",j),vt(b,()=>{b.removeEventListener("dragstart",h),b.removeEventListener("dragover",x),b.removeEventListener("dragleave",_),b.removeEventListener("drop",L),b.removeEventListener("dragend",j),b._nojsReorderSetup=!1})}}function d(){l&&(l.classList.remove("nojs-reorder-insert-before"),l.classList.remove("nojs-reorder-insert-after"),l=null)}function m(){a&&(i.split(/\s+/).filter(Boolean).forEach(u=>a.classList.remove(u)),a.setAttribute("aria-grabbed","false")),d(),s=null,a=null;let y=r.querySelectorAll(":scope > tr");for(let u of y)u.classList.remove("nojs-reorder-insert-before"),u.classList.remove("nojs-reorder-insert-after"),c.split(/\s+/).filter(Boolean).forEach(b=>u.classList.remove(b))}let p=y=>{a!=null&&(y.preventDefault(),y.dataTransfer&&(y.dataTransfer.dropEffect="move"))},g=y=>{if(a==null||y.target!==r)return;y.preventDefault(),y.stopPropagation();let u=s,A=[...r.querySelectorAll(":scope > tr")].length-1;if(u===A){m();return}let h=vn(e);if(h&&o){let x=yn(o,h.arrayPath);if(Array.isArray(x)){let _=[...x],[L]=_.splice(u,1);_.push(L),xn(o,h.arrayPath,_),e._nojsOriginalOrder&&(e._nojsOriginalOrder=[..._]),e.dispatchEvent(new CustomEvent("table:reorder",{bubbles:!0,detail:{from:u,to:_.length-1,item:L}}))}}m()};r.addEventListener("dragover",p),r.addEventListener("drop",g);let v=new MutationObserver(()=>{f()});v.observe(r,{childList:!0}),f(),vt(e,()=>{v.disconnect(),r.removeEventListener("dragover",p),r.removeEventListener("drop",g),m()})}})}function wn(t,e={}){gn(t),mn(t),bn(t),hn(t),En(t)}function An(){dn()}var ue={containers:new Map};function _n(){for(let[,t]of ue.containers)typeof t.unsub=="function"&&t.unsub();ue.containers.clear()}function Ln(){if(typeof document>"u"||document.querySelector("style[data-nojs-breadcrumb]"))return;let t=`
.nojs-breadcrumb {
  display: flex;
  align-items: center;
  flex-wrap: wrap;
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-breadcrumb",""),e.textContent=t,document.head.appendChild(e)}function kn(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function $o(t){let e=t.getAttribute("breadcrumb");if(e&&e.trim()!=="")return e.trim();let r=t.getAttribute("title");return r&&r.trim()!==""?r.trim():(t.textContent||"").trim()}function zo(t){return t&&t.charAt(0).toUpperCase()+t.slice(1)}function jn(t,e){let r=t.querySelector("ol.nojs-breadcrumb");r&&r.remove();let o=document.createElement("ol");o.classList.add("nojs-breadcrumb");for(let i=0;i<e.length;i++){let c=e[i],s=document.createElement("li");if(i===e.length-1){let l=document.createElement("span");l.setAttribute("aria-current","page"),l.textContent=c.label,s.appendChild(l)}else{let l=document.createElement("a");l.href=c.href,l.textContent=c.label,s.appendChild(l)}o.appendChild(s)}t.appendChild(o);let n=ue.containers.get(t);n&&(n.crumbs=e)}function Ho(t){let e=[],r=Array.from(t.children);for(let o of r){if(o.tagName==="OL"&&o.classList.contains("nojs-breadcrumb"))continue;let n=$o(o);if(!n)continue;let i=o.getAttribute("href")||"#";e.push({label:n,href:i})}return e}function Mo(t){if(!t||t==="/")return[{label:"Home",href:"/",isLast:!0}];let r=(t.replace(/\/+$/,"")||"/").split("/").filter(Boolean),o=[{label:"Home",href:"/"}],n="";for(let i=0;i<r.length;i++){n+="/"+r[i];let c=zo(r[i].replace(/[-_]/g," "));o.push({label:c,href:n})}return o}function Cn(t){t.directive("breadcrumb",{priority:15,init(e,r,o){Ln(),e.tagName==="NAV"&&!e.getAttribute("aria-label")&&e.setAttribute("aria-label","Breadcrumb");let n=Array.from(e.children).some(s=>!(s.tagName==="OL"&&s.classList.contains("nojs-breadcrumb"))),i=t.router,c=!n&&i;if(ue.containers.set(e,{unsub:null,crumbs:[]}),c){let s=()=>{let a=i.current,l=a?a.path:"/",f=Mo(l);jn(e,f)};if(s(),typeof i.on=="function"){let a=i.on(s),l=ue.containers.get(e);l&&(l.unsub=a),kn(e,()=>{typeof a=="function"&&a();let f=ue.containers.get(e);f&&(f.unsub=null)})}}else{let s=Ho(e);for(let a of Array.from(e.children))a.tagName==="OL"&&a.classList.contains("nojs-breadcrumb")||(a.style.display="none");jn(e,s)}kn(e,()=>{ue.containers.delete(e)})}})}function Sn(t,e={}){Cn(t)}function Tn(){_n()}var Ze={containers:new Map};function Dn(){Ze.containers.clear()}function In(){if(typeof document>"u"||document.querySelector("style[data-nojs-accordion]"))return;let t=`
[accordion] {
  display: flex;
  flex-direction: column;
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-accordion",""),e.textContent=t,document.head.appendChild(e)}function Oo(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}var Qe=null;function Vo(){return Qe!==null||(Qe=typeof CSS<"u"&&typeof CSS.supports=="function"&&CSS.supports("interpolate-size","allow-keywords")),Qe}function Bn(t){let e=t.querySelector(":scope > summary");if(!e)return null;let r=t.querySelector(":scope > .nojs-accordion-content");if(r)return r;r=document.createElement("div"),r.classList.add("nojs-accordion-content");let o=Array.from(t.children),n=!1;for(let i of o){if(i===e){n=!0;continue}n&&r.appendChild(i)}return t.appendChild(r),r}function Wo(t,e){if(!e)return;let r=e.scrollHeight;e.style.height="0px",t.open=!0,requestAnimationFrame(()=>{e.style.height=r+"px";let o=()=>{e.style.height="",e.removeEventListener("transitionend",o)};e.addEventListener("transitionend",o)})}function qn(t,e){if(!e){t.open=!1;return}let r=e.scrollHeight;e.style.height=r+"px",requestAnimationFrame(()=>{e.style.height="0px";let o=()=>{t.open=!1,e.style.height="",e.removeEventListener("transitionend",o)};e.addEventListener("transitionend",o)})}function Fn(t,e){if(t.open)if(e){let r=t.querySelector(":scope > .nojs-accordion-content");qn(t,r)}else t.open=!1}function Je(t,e,r,o){let n=new CustomEvent("accordion-change",{bubbles:!0,detail:{element:e,open:r,index:o}});t.dispatchEvent(n)}function Ce(t){let e=[];for(let r of t.children)r.tagName==="DETAILS"&&e.push(r);return e}function Pn(t){t.directive("accordion",{priority:10,init(e,r,o){In();let n=(o||"").trim().toLowerCase()==="multi"?"multi":"single",i=!Vo();e.setAttribute("role","group");let c=Ce(e);if(c.length===0)return;if(i)for(let d of c)Bn(d);let s=[],a=new MutationObserver(d=>{for(let m of d)for(let p of m.addedNodes)p.nodeType!==1||p.tagName!=="DETAILS"||p.parentElement===e&&l(p)});a.observe(e,{childList:!0});let l=d=>{i&&Bn(d);let m=g=>{let v=Ce(e),y=v.indexOf(d);if(d.open){if(n==="single")for(let u of v)u!==d&&u.open&&Fn(u,i);Je(e,d,!0,y)}else Je(e,d,!1,y)},p=null;if(i){let g=d.querySelector(":scope > summary");g&&(p=v=>{v.preventDefault();let y=d.querySelector(":scope > .nojs-accordion-content");if(d.open)qn(d,y),Je(e,d,!1,Ce(e).indexOf(d));else{if(n==="single"){let u=Ce(e);for(let b of u)b!==d&&b.open&&Fn(b,!0)}Wo(d,y),Je(e,d,!0,Ce(e).indexOf(d))}},g.addEventListener("click",p))}d.addEventListener("toggle",m),s.push({details:d,toggleHandler:m,clickHandler:p})};for(let d of c)l(d);let f=d=>{let m=d.target;if(m.tagName!=="SUMMARY")return;let p=m.parentElement;if(!p||p.parentElement!==e)return;let v=Ce(e).map(b=>b.querySelector(":scope > summary")).filter(Boolean),y=v.indexOf(m);if(y===-1)return;let u=-1;switch(d.key){case"ArrowDown":case"ArrowRight":u=(y+1)%v.length;break;case"ArrowUp":case"ArrowLeft":u=(y-1+v.length)%v.length;break;case"Home":u=0;break;case"End":u=v.length-1;break;default:return}u!==-1&&u!==y&&(d.preventDefault(),v[u].focus())};e.addEventListener("keydown",f),Ze.containers.set(e,{mode:n,listeners:s,observer:a}),Oo(e,()=>{e.removeEventListener("keydown",f),a.disconnect();for(let d of s)if(d.details.removeEventListener("toggle",d.toggleHandler),d.clickHandler){let m=d.details.querySelector(":scope > summary");m&&m.removeEventListener("click",d.clickHandler)}s.length=0,Ze.containers.delete(e)})}})}function Rn(t,e={}){Pn(t)}function $n(){Dn()}var Uo="[validate],[drag],[drop],[drag-list],[drag-multiple]";function zn(t){if(typeof document>"u")return;let e=document.querySelectorAll(Uo);for(let r of e){if(!r.__declared)continue;let o=X(t,"disposeTree");typeof o=="function"?o(r):(r.__disposers&&(r.__disposers.forEach(i=>i()),r.__disposers=null),r.__declared=!1);let n=t.findContext?t.findContext(r):null;n&&delete n.$form,t.processTree(r)}}var Go=["tooltip","popover","popover-trigger","popover-dismiss","modal","modal-open","modal-close","dropdown","dropdown-toggle","dropdown-menu","dropdown-item","toast","toast-container","tabs","tab","tab-disabled","tab-position","tree","branch","subtree","stepper","step","skeleton","split","pane","panel","sortable","sort","fixed-header","fixed-col","breadcrumb","accordion"],Yo={name:"nojs-elements",install(t,e={}){Ct(t,e),$t(t,e),Ut(t,e),Xt(t,e),ir(t,e),fr(t,e),xr(t,e),Cr(t,e),Mr(t,e),Xr(t,e),en(t,e),an(t,e),wn(t,e),Sn(t,e),Rn(t,e),zn(t)},init(t){if(zn(t),typeof document>"u"||!document.body)return;let e=Go.map(o=>`[${o}]`).join(","),r;try{r=document.body.querySelectorAll(e)}catch{return}for(let o of r)o.__declared&&!o.__disposers&&!o.__ctx&&(o.__declared=!1);try{t.processTree(document.body)}catch(o){t.internals?.warn?.("nojs-elements init re-process error:",o.message)}},dispose(t){St(),zt(),Gt(),Nt(),sr(),gr(),Er(),Sr(),Or(),Nr(),cn(),An(),Tn(),$n()}},yt=Yo;if(typeof window<"u"){let e=function(){return t?!0:window.NoJS&&typeof window.NoJS.use=="function"?(window.NoJS.use(yt),t=!0,!0):!1};window.NoJSElements=yt;let t=!1;if(!e()){let r=0,o=100,n=setInterval(()=>{(e()||++r>=o)&&clearInterval(n)},50);typeof document<"u"&&document.addEventListener("DOMContentLoaded",()=>{e()&&clearInterval(n)},{once:!0})}}})();

 ...
 * @license MIT
 */
(()=>{var N=new Map,C=new Map;function Et(){for(let e of C.values())clearTimeout(e);C.clear();for(let e of N.values())e.remove();N.clear()}function kt(){if(typeof document>"u"||document.querySelector("style[data-nojs-tooltip]"))return;let e=`
.nojs-tooltip {
  position: fixed;
  z-index: 9999;
  pointer-events: none;
...
`.trim(),t=document.createElement("style");t.setAttribute("data-nojs-tooltip",""),t.textContent=e,document.head.appendChild(t)}function We(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}var J=8;function Ve(e,t,r){let i=t.getBoundingClientRect(),o=e.getBoundingClientRect(),n=window.innerWidth,l=window.innerHeight,s,a;switch(r){case"bottom":s=i.bottom+J,a=i.left+(i.width-o.width)/2;break;case"left":s=i.top+(i.height-o.height)/2,a=i.left-o.width-J;break;case"right":s=i.top+(i.height-o.height)/2,a=i.right+J;break;default:s=i.top-o.height-J,a=i.left+(i.width-o.width)/2;break}a<4&&(a=4),a+o.width>n-4&&(a=n-o.width-4),s<4&&(s=4),s+o.height>l-4&&(s=l-o.height-4),e.style.top=`${s}px`,e.style.left=`${a}px`}var Ue=0;function Ke(e,t,r){document.body.appendChild(t),Ve(t,e,r),t.setAttribute("aria-hidden","false")}function Ne(e,t){t.setAttribute("aria-hidden","true"),t.remove()}function _t(e){e.directive("tooltip",{priority:20,init(t,r,i){kt();let o=i;if(!o){console.warn("[tooltip] attribute value (tooltip text) is required.");return}let n=t.getAttribute("tooltip-position")||"top",l=parseInt(t.getAttribute("tooltip-delay"),10)||300,s=t.getAttribute("tooltip-disabled"),a=s?e.findContext(t):null,f=`nojs-tooltip-${++Ue}`,u=document.createElement("div");u.className="nojs-tooltip",u.setAttribute("role","tooltip"),u.setAttribute("id",f),u.setAttribute("aria-hidden","true"),u.textContent=o,t.setAttribute("aria-describedby",f),N.set(t,u);let m=()=>{if(s&&a&&e.evaluate(s,a))return;C.has(t)&&clearTimeout(C.get(t));let y=setTimeout(()=>{C.delete(t),!(s&&a&&e.evaluate(s,a))&&Ke(t,u,n)},l);C.set(t,y)},g=()=>{C.has(t)&&(clearTimeout(C.get(t)),C.delete(t)),Ne(t,u)},p=()=>m(),c=()=>g(),d=()=>m(),b=()=>g(),h=y=>{y.key==="Escape"&&u.getAttribute("aria-hidden")==="false"&&g()};t.addEventListener("mouseenter",p),t.addEventListener("mouseleave",c),t.addEventListener("focusin",d),t.addEventListener("focusout",b),t.addEventListener("keydown",h),We(t,()=>{t.removeEventListener("mouseenter",p),t.removeEventListener("mouseleave",c),t.removeEventListener("focusin",d),t.removeEventListener("focusout",b),t.removeEventListener("keydown",h),C.has(t)&&(clearTimeout(C.get(t)),C.delete(t)),u.remove(),N.delete(t)})}})}function jt(e,t={}){_t(e)}function St(){Et()}var j=new Map;function Lt(){j.clear()}function tt(){if(typeof document>"u"||document.querySelector("style[data-nojs-popover]"))return;let e=`
.nojs-popover {
  position: fixed;
  z-index: 9998;
  margin: 0;
...
`.trim(),t=document.createElement("style");t.setAttribute("data-nojs-modal",""),t.textContent=e,document.head.appendChild(t)}function Xe(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}var Pt='a[href], button:not([disabled]), input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])',ft=new WeakMap;function Ze(e){let t=r=>{if(r.key!=="Tab")return;let i=[...e.querySelectorAll(Pt)].filter(l=>l.offsetParent!==null);if(i.length===0){r.preventDefault();return}let o=i[0],n=i[i.length-1];r.shiftKey?document.activeElement===o&&(r.preventDefault(),n.focus()):document.activeElement===n&&(r.preventDefault(),o.focus())};e.addEventListener("keydown",t),ft.set(e,t)}function Ft(e){let t=ft.get(e);t&&(e.removeEventListener("keydown",t),ft.delete(e))}var Y=new WeakMap;function Mt(e){e.directive("modal",{priority:10,init(r,i,o){R();let n=o||`nojs-modal-${Date.now()}-${Math.random().toString(36).slice(2,7)}`;r.setAttribute("popover","manual"),r.classList.add("nojs-modal"),r.id=r.id||`nojs-modal-${n}`,r.setAttribute("data-modal-id",n),r.setAttribute("role","dialog"),r.setAttribute("aria-modal","true");let l=r.querySelector("h1, h2, h3, h4, h5, h6");l&&(l.id||(l.id=`nojs-modal-heading-${n}`),r.setAttribute("aria-labelledby",l.id));let s=r.getAttribute("modal-backdrop");s==="false"&&r.setAttribute("data-nojs-no-backdrop","");let a=r.getAttribute("modal-class"),f=r.getAttribute("modal-escape"),u=g=>{g.target===r&&s!=="false"&&f!=="false"&&O(r,n)};r.addEventListener("click",u),T.set(n,r);let m=g=>{if(g.newState==="open"){if(r.style.zIndex=String(It()),a&&a.split(/\s+/).filter(Boolean).forEach(p=>r.classList.add(p)),requestAnimationFrame(()=>{let p=r.querySelector(Pt);p?p.focus():r.focus()}),Ze(r),f!=="false"){let p=c=>{c.key==="Escape"&&(c.stopPropagation(),O(r,n))};r.addEventListener("keydown",p),Y.set(r,p)}}else if(g.newState==="closed"){a&&a.split(/\s+/).filter(Boolean).forEach(d=>r.classList.remove(d)),Ft(r);let p=Y.get(r);p&&(r.removeEventListener("keydown",p),Y.delete(r));let c=L.findIndex(d=>d.id===n);if(c!==-1){let d=L[c];L.splice(c,1),d.triggerEl&&requestAnimationFrame(()=>{d.triggerEl.focus()})}}};r.addEventListener("toggle",m),Xe(r,()=>{r.removeEventListener("click",u),r.removeEventListener("toggle",m),Ft(r);let g=Y.get(r);g&&(r.removeEventListener("keydown",g),Y.delete(r)),T.delete(n);let p=L.findIndex(c=>c.id===n);p!==-1&&L.splice(p,1)})}});let t=r=>t.open(r);t.open=r=>{let i=T.get(r);if(!i)return!1;L.push({id:r,el:i,triggerEl:null});try{i.showPopover()}catch{return!1}return!0},t.close=r=>{let i=T.get(r);return i?(O(i,r),!0):!1},t.closeAll=()=>{for(let r=L.length-1;r>=0;r--)O(L[r].el,L[r].id)},e.modal=t}function O(e,t){try{e.hidePopover()}catch{}}function Qe(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}function qt(e){e.directive("modal-open",{priority:10,init(t,r,i){R();let o=i;if(!o){let m=(t.closest("[use]")||t.parentElement)?.querySelector("[data-modal-id]");if(m&&(o=m.getAttribute("data-modal-id")),!o){console.warn('[modal-open] requires a target modal ID, e.g. modal-open="my-dialog"');return}}t.setAttribute("aria-haspopup","dialog"),t.setAttribute("aria-expanded","false");let n=()=>{let u=T.get(o)||document.querySelector(`[data-modal-id="${o}"]`);if(!u){console.warn(`[modal-open] modal "${o}" not found`);return}L.push({id:o,el:u,triggerEl:t}),t.setAttribute("aria-expanded","true"),u.id&&t.setAttribute("aria-controls",u.id);try{u.showPopover()}catch{console.warn(`[modal-open] failed to open modal "${o}"`)}},l=()=>{t.setAttribute("aria-expanded","false")},s=null,a=null;requestAnimationFrame(()=>{let u=T.get(o);u&&(a=u,s=m=>{m.newState==="closed"&&t.setAttribute("aria-expanded","false")},u.addEventListener("toggle",s))}),t.addEventListener("click",n),Qe(t,()=>{t.removeEventListener("click",n),a&&s&&a.removeEventListener("toggle",s)})}})}function Je(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}function Bt(e){e.directive("modal-close",{priority:10,init(t,r,i){R();let o=()=>{let n,l;if(i){if(l=i,n=T.get(l),!n){console.warn(`[modal-close] modal "${l}" not found`);return}}else{if(n=t.closest("[modal]"),!n){console.warn("[modal-close] no parent modal found");return}l=n.getAttribute("modal")}O(n,l)};t.addEventListener("click",o),Je(t,()=>{t.removeEventListener("click",o)})}})}function Ht(e,t={}){Mt(e),qt(e),Bt(e)}function $t(){zt()}var X={openMenus:new Map};function Rt(){X.openMenus.clear()}function G(){if(typeof document>"u"||document.querySelector("style[data-nojs-dropdown]"))return;let e=`
.nojs-dropdown-menu {
  position: fixed;
  z-index: 9999;
  margin: 0;
...
`.trim(),t=document.createElement("style");t.setAttribute("data-nojs-dropdown",""),t.textContent=e,document.head.appendChild(t)}function tr(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}function Ot(e,t,r){let i=r.getAttribute("dropdown-position")||"bottom",o=r.getAttribute("dropdown-align")||"start";e.style.top="",e.style.left="";let n=t.getBoundingClientRect(),l=e.getBoundingClientRect(),s=window.innerHeight,a=window.innerWidth,f,u;switch(i){case"top":f=n.top-l.height,u=n.left;break;case"left":f=n.top,u=n.left-l.width;break;case"right":f=n.top,u=n.right;break;default:f=n.bottom,u=n.left}i==="bottom"||i==="top"?o==="end"&&(u=n.right-l.width):o==="end"&&(f=n.bottom-l.height),i==="bottom"&&f+l.height>s&&n.top-l.height>0?f=n.top-l.height:i==="top"&&f<0&&n.bottom+l.height<=s&&(f=n.bottom),u<4&&(u=4),u+l.width>a-4&&(u=a-l.width-4),e.style.top=`${f}px`,e.style.left=`${u}px`}function bt(e){return[...e.querySelectorAll("[dropdown-item]")].filter(t=>!t.hasAttribute("disabled")&&t.getAttribute("aria-disabled")!=="true")}function mt(e){let t=bt(e);t.length&&t[0].focus()}function Gt(e){let t=bt(e);t.length&&t[t.length-1].focus()}function Wt(e){e.directive("dropdown",{priority:15,init(r){G()}}),e.directive("dropdown-toggle",{priority:15,init(r){G();let i=r.closest("[dropdown]");if(!i)return;let o=i.querySelector("[dropdown-menu]");if(!o)return;r.setAttribute("aria-haspopup","menu"),r.setAttribute("aria-expanded","false"),o.classList.add("nojs-dropdown-menu"),o.setAttribute("role","menu"),o.setAttribute("popover","auto"),o.id||(o.id=`nojs-dd-menu-${Date.now()}-${Math.random().toString(36).slice(2,7)}`),r.setAttribute("aria-controls",o.id);function n(){o.setAttribute("data-open",""),o.showPopover&&o.showPopover(),r.setAttribute("aria-expanded","true"),Ot(o,r,i),X.openMenus.set(o,{toggle:r,wrapper:i})}function l(){o.removeAttribute("data-open"),r.setAttribute("aria-expanded","false"),X.openMenus.delete(o)}function s(){return r.getAttribute("aria-expanded")==="true"}let a=d=>{d.newState==="closed"&&s()&&l()};o.addEventListener("toggle",a);let f=d=>{d.preventDefault(),d.stopPropagation(),s()?l():n()};r.addEventListener("click",f);let u=d=>{s()&&!i.contains(d.target)&&l()};document.addEventListener("click",u,!0);let m=d=>{d.key==="Escape"&&s()&&(l(),r.focus())};document.addEventListener("keydown",m);let g=d=>{switch(d.key){case"Enter":case" ":d.preventDefault(),n(),mt(o);break;case"ArrowDown":d.preventDefault(),n(),mt(o);break;case"ArrowUp":d.preventDefault(),n(),Gt(o);break}};r.addEventListener("keydown",g);let p=d=>{if(!(!s()||bt(o).find(y=>y===document.activeElement)))switch(d.key){case"ArrowDown":d.preventDefault(),mt(o);break;case"ArrowUp":d.preventDefault(),Gt(o);break}};o.addEventListener("keydown",p);let c=()=>{s()&&Ot(o,r,i)};window.addEventListener("scroll",c,!0),window.addEventListener("resize",c),tr(r,()=>{r.removeEventListener("click",f),r.removeEventListener("keydown",g),o.removeEventListener("keydown",p),o.removeEventListener("toggle",a),document.removeEventListener("click",u,!0),document.removeEventListener("keydown",m),window.removeEventListener("scroll",c,!0),window.removeEventListener("resize",c),X.openMenus.delete(o)})}}),e.directive("dropdown-menu",{priority:15,init(r){G(),r.hasAttribute("role")||r.setAttribute("role","menu")}});let t=r=>t.open(r);t.open=r=>{let i=document.getElementById(r);if(!i)return!1;let n=i.closest("[dropdown]")?.querySelector("[dropdown-toggle]");return!n||n.getAttribute("aria-expanded")==="true"?!1:(n.click(),!0)},t.close=r=>{let i=document.getElementById(r);if(!i)return!1;let n=i.closest("[dropdown]")?.querySelector("[dropdown-toggle]");return!n||n.getAttribute("aria-expanded")!=="true"?!1:(n.click(),!0)},e.dropdown=t}function Vt(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}function er(e){return[...e.querySelectorAll("[dropdown-item]")].filter(t=>!t.hasAttribute("disabled")&&t.getAttribute("aria-disabled")!=="true")}function Ut(e){e.directive("dropdown-item",{priority:15,init(t){G();let r=t.closest("[dropdown-menu]"),i=t.closest("[dropdown]");t.setAttribute("role","menuitem"),t.setAttribute("tabindex","-1"),t.classList.add("nojs-dropdown-item"),t.hasAttribute("disabled")&&t.setAttribute("aria-disabled","true");let o=l=>{if(!r)return;let s=er(r),a=s.indexOf(t);switch(l.key){case"ArrowDown":{l.preventDefault(),(a+1<s.length?s[a+1]:s[0]).focus();break}case"ArrowUp":{l.preventDefault(),(a-1>=0?s[a-1]:s[s.length-1]).focus();break}case"Home":{l.preventDefault(),s.length&&s[0].focus();break}case"End":{l.preventDefault(),s.length&&s[s.length-1].focus();break}case"Enter":{l.preventDefault(),t.click();break}case"Escape":{if(l.preventDefault(),r)try{r.hidePopover()}catch{}if(i){let f=i.querySelector("[dropdown-toggle]");f&&f.focus()}break}case"Tab":{if(r)try{r.hidePopover()}catch{}break}}};t.addEventListener("keydown",o),Vt(t,()=>t.removeEventListener("keydown",o));let n=()=>{if(r)try{r.hidePopover()}catch{}if(i){let l=i.querySelector("[dropdown-toggle]");l&&l.focus()}};t.addEventListener("click",n),Vt(t,()=>t.removeEventListener("click",n))}})}function Kt(e,t={}){Wt(e),Ut(e)}function Nt(){Rt()}var D=new Map,W=new Set,Yt=0;function Xt(){return++Yt}function Zt(){for(let e of W)clearTimeout(e);W.clear();for(let e of D.values())e.remove();D.clear(),Yt=0}function Qt(){if(typeof document>"u"||document.querySelector("style[data-nojs-toast]"))return;let e=`
...
`.trim(),t=document.createElement("style");t.setAttribute("data-nojs-toast",""),t.textContent=e,document.head.appendChild(t)}function gt(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}var rr=new Set(["top-right","top-left","bottom-right","bottom-left","top-center","bottom-center"]);function ht(){return D.size>0?D.values().next().value:or("top-right")}function or(e){if(D.has(e))return D.get(e);let t=document.createElement("div");return t.classList.add("nojs-toast-container"),t.setAttribute("data-position",e),t.setAttribute("role","log"),t.setAttribute("aria-live","polite"),t.setAttribute("aria-relevant","additions"),document.body.appendChild(t),D.set(e,t),t}function nr(e){return e.startsWith("top")}function vt(e,t,r,i,o){let n=Xt(),l=e.getAttribute("data-position")||"top-right",s=document.createElement("div");s.classList.add("nojs-toast"),s.setAttribute("data-toast-id",n),s.setAttribute("data-type",r),r==="error"&&s.setAttribute("aria-live","assertive");let a=document.createElement("span");if(a.textContent=t,s.appendChild(a),o){let f=document.createElement("button");f.type="button",f.classList.add("nojs-toast-dismiss"),f.setAttribute("aria-label","Dismiss"),f.textContent="\xD7",f.addEventListener("click",()=>rt(s)),s.appendChild(f)}if(nr(l)&&e.firstChild?e.insertBefore(s,e.firstChild):e.appendChild(s),i>0){let f=setTimeout(()=>{W.delete(f),rt(s)},i);W.add(f),s._toastTimerId=f}return s}function rt(e){!e||!e.isConnected||(e._toastTimerId!=null&&(clearTimeout(e._toastTimerId),W.delete(e._toastTimerId)),e.remove())}function Jt(e){Qt(),e.directive("toast-container",{priority:10,init(r,i,o){let n=o&&rr.has(o)?o:"top-right";r.classList.add("nojs-toast-container"),r.setAttribute("data-position",n),r.setAttribute("role","log"),r.setAttribute("aria-live","polite"),r.setAttribute("aria-relevant","additions"),D.set(n,r),gt(r,()=>{D.get(n)===r&&D.delete(n)})}}),e.directive("toast",{priority:10,init(r,i,o){if(!o)return;let n=r.getAttribute("toast-type")||"info",l=parseInt(r.getAttribute("toast-duration"),10)||3e3,s=r.getAttribute("toast-dismiss")!=="false";if(r.tagName==="BUTTON"||r.tagName==="A"||r.hasAttribute("on:click")){let p=()=>{let c=ht();vt(c,o,n,l,s)};r.addEventListener("click",p),gt(r,()=>r.removeEventListener("click",p));return}let f=e.findContext(r),u;function m(){let p=e.evaluate(o,f);if(p&&p!==u){let c=typeof p=="string"?p:String(p),d=ht();vt(d,c,n,l,s)}u=p}let g=f.$watch(m);gt(r,g)}});let t=(r,i="info",o=3e3)=>{if(typeof document>"u")return;let n=!0,l=ht();return vt(l,String(r),i,o,n)};t.dismiss=r=>{let i=document.querySelector(`[data-toast-id="${r}"]`);i&&rt(i)},t.dismissAll=()=>{document.querySelectorAll(".nojs-toast").forEach(r=>rt(r))},e.toast=t}function te(e,t={}){Jt(e)}function ee(){Zt()}var q={containers:new Map};function re(){q.containers.clear()}function oe(){if(typeof document>"u"||document.querySelector("style[data-nojs-tabs]"))return;let e=`
.nojs-tabs {
  display: flex;
  flex-direction: column;
  border: 1px solid #E2E8F0;
...
`.trim(),t=document.createElement("style");t.setAttribute("data-nojs-tabs",""),t.textContent=e,document.head.appendChild(t)}function ir(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}var sr=0;function ne(e){return`${e}-${++sr}`}function yt(e,t){let r=q.containers.get(e);if(!r)return;let{tabs:i,panels:o}=r;if(!(t<0||t>=i.length)&&i[t].getAttribute("aria-disabled")!=="true"){for(let n=0;n<i.length;n++)i[n].setAttribute("aria-selected","false"),i[n].setAttribute("tabindex","-1"),o[n].setAttribute("aria-hidden","true"),o[n].inert=!0;i[t].setAttribute("aria-selected","true"),i[t].setAttribute("tabindex","0"),o[t].setAttribute("aria-hidden","false"),o[t].inert=!1,r.activeIndex=t}}function Z(e,t,r){let i=e.length,o=t;for(let n=0;n<i;n++)if(o=(o+r+i)%i,e[o].getAttribute("aria-disabled")!=="true")return o;return t}function ie(e){e.directive("tabs",{priority:10,init(t,r,i){oe();let o=[],n=[];for(let c of Array.from(t.children))c.hasAttribute("tab")?o.push(c):c.hasAttribute("panel")&&n.push(c);if(o.length===0){console.warn("[tabs] No child [tab] elements found.");return}o.length!==n.length&&console.warn("[tabs] Mismatch: "+o.length+" tabs but "+n.length+" panels.");let l=t.getAttribute("tab-position")||"top";t.setAttribute("data-position",l),t.classList.add("nojs-tabs");let s=document.createElement("div");s.setAttribute("role","tablist"),s.classList.add("nojs-tablist");let a=Math.min(o.length,n.length);for(let c=0;c<a;c++){let d=o[c],b=n[c],h=d.id||ne("nojs-tab"),y=b.id||ne("nojs-panel");d.id=h,b.id=y,d.setAttribute("role","tab"),d.setAttribute("aria-selected","false"),d.setAttribute("aria-controls",y),d.setAttribute("tabindex","-1"),d.classList.add("nojs-tab"),b.setAttribute("role","tabpanel"),b.setAttribute("aria-labelledby",h),b.setAttribute("tabindex","0"),b.setAttribute("aria-hidden","true"),b.inert=!0,b.classList.add("nojs-panel"),s.appendChild(d)}let f=n[0];f?t.insertBefore(s,f):t.appendChild(s),q.containers.set(t,{tabs:o.slice(0,a),panels:n.slice(0,a),activeIndex:-1});let u=e.findContext(t);for(let c=0;c<a;c++){let d=o[c].getAttribute("tab-disabled");d&&e.evaluate(d,u)&&o[c].setAttribute("aria-disabled","true")}let m=0;if(i&&i.trim()!==""){let c=parseInt(i,10);!isNaN(c)&&c>=0&&c<a&&(m=c)}o[m]?.getAttribute("aria-disabled")==="true"&&(m=Z(o.slice(0,a),m,1)),yt(t,m);let g=c=>{let d=q.containers.get(t);if(!d)return;let b=c.target;if(b.getAttribute("role")!=="tab")return;let{tabs:h}=d,y=h.indexOf(b);if(y===-1)return;let w=-1;switch(c.key){case"ArrowRight":case"ArrowDown":w=Z(h,y,1);break;case"ArrowLeft":case"ArrowUp":w=Z(h,y,-1);break;case"Home":w=Z(h,h.length-1,1);break;case"End":w=Z(h,0,-1);break;case"Tab":return;default:return}w!==-1&&w!==y&&(c.preventDefault(),yt(t,w),h[w].focus())};s.addEventListener("keydown",g);let p=c=>{let d=c.target.closest("[role='tab']");if(!d)return;let b=q.containers.get(t);if(!b)return;let h=b.tabs.indexOf(d);h!==-1&&(yt(t,h),d.focus())};s.addEventListener("click",p),ir(t,()=>{s.removeEventListener("keydown",g),s.removeEventListener("click",p),q.containers.delete(t)})}})}function se(e){e.directive("tab",{priority:11,init(){}}),e.directive("tab-disabled",{priority:11,init(){}}),e.directive("tab-position",{priority:11,init(){}})}function ae(e){e.directive("panel",{priority:11,init(){}})}function ce(e,t={}){ie(e),se(e),ae(e)}function de(){re()}var E={branches:new Map,selectedItem:null,typeahead:"",typeaheadTimer:null};function le(){E.branches.clear(),E.selectedItem=null,E.typeahead="",E.typeaheadTimer&&(clearTimeout(E.typeaheadTimer),E.typeaheadTimer=null)}function ot(){if(typeof document>"u"||document.querySelector("style[data-nojs-tree]"))return;let e=`
.nojs-tree {
  list-style: none;
  padding-left: 0;
  margin: 0;

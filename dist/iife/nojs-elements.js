...
`.trim(),t=document.createElement("style");t.setAttribute("data-nojs-table",""),t.textContent=e,document.head.appendChild(t)}function fr(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}function mr(e,t){let r=e.querySelector("tbody");if(!r)return null;let i=null;if(r.hasAttribute("each")||r.hasAttribute("foreach")?i=r:i=r.querySelector("[each]")||r.querySelector("[foreach]"),!i)return null;let o=i.getAttribute("each")||i.getAttribute("foreach");if(!o)return null;let n=o.match(/^\s*(\w+)\s+(?:in|of)\s+(.+)\s*$/);return n?{iteratorVar:n[1],arrayPath:n[2].trim()}:null}function br(e,t){let r=t.split("."),i=e;for(let o of r){if(i==null)return;i=i[o]}return i}function De(e,t,r){let i=t.split("."),o=e;for(let n=0;n<i.length-1;n++){if(o[i[n]]==null)return;o=o[i[n]]}o[i[i.length-1]]=r}function ze(e,t,r){if(e==null&&t==null)return 0;if(e==null)return-1;if(t==null)return 1;switch(r){case"number":return Number(e)-Number(t);case"date":return new Date(e).getTime()-new Date(t).getTime();default:return String(e).localeCompare(String(t))}}function gr(e){let t=e.querySelectorAll("th[data-sortable]");for(let r of t)r.removeAttribute("data-sort-dir"),r.setAttribute("aria-sort","none")}function Fe(e){e.directive("sortable",{priority:10,init(t){X(),t.classList.add("nojs-sortable")}})}function Pe(e){e.directive("sort",{priority:11,init(t,r,i){X();let o=i;if(!o)return;let n=t.getAttribute("sort-type")||"string",l=t.getAttribute("sort-default");t.setAttribute("data-sortable",""),t.setAttribute("aria-sort","none");let s=t.closest("table");if(!s)return;G.sorts.has(s)||G.sorts.set(s,{column:null,direction:null}),(l==="asc"||l==="desc")&&Ie(t,s,o,n,l,e);let u=()=>{let f=G.sorts.get(s),p;f.column!==o?p="asc":f.direction==="asc"?p="desc":f.direction==="desc"?p=null:p="asc",Ie(t,s,o,n,p,e)};t.addEventListener("click",u),fr(t,()=>{t.removeEventListener("click",u),s&&s._nojsOriginalOrder&&delete s._nojsOriginalOrder})}})}function Ie(e,t,r,i,o,n){let l=G.sorts.get(t);gr(t),o?(e.setAttribute("data-sort-dir",o),e.setAttribute("aria-sort",o==="asc"?"ascending":"descending"),l.column=r,l.direction=o):(l.column=null,l.direction=null);let s=mr(t,n);if(s){let u=n.findContext(t),f=u?br(u,s.arrayPath):null;if(Array.isArray(f)){if(!o){let m=t._nojsOriginalOrder;if(m){let g=new Set(f),d=m.filter(a=>g.has(a));for(let a of f)m.includes(a)||d.push(a);De(u,s.arrayPath,d)}return}t._nojsOriginalOrder||(t._nojsOriginalOrder=[...f]);let p=[...f].sort((m,g)=>{let d=m!=null?m[r]:null,a=g!=null?g[r]:null,c=ze(d,a,i);return o==="desc"?-c:c});De(u,s.arrayPath,p);return}}hr(t,e,r,i,o)}function hr(e,t,r,i,o){let n=e.querySelector("tbody");if(!n)return;let u=[...t.closest("tr").children].indexOf(t);if(u<0)return;let f=[...n.querySelectorAll(":scope > tr")];if(e._nojsOriginalRows||(e._nojsOriginalRows=[...f]),!o){let m=document.createDocumentFragment();for(let g of e._nojsOriginalRows)m.appendChild(g);n.appendChild(m);return}f.sort((m,g)=>{let d=m.children[u]?.textContent?.trim()||"",a=g.children[u]?.textContent?.trim()||"",c=ze(i==="number"?parseFloat(d.replace(/[^0-9.\-]/g,""))||0:d,i==="number"?parseFloat(a.replace(/[^0-9.\-]/g,""))||0:a,i);return o==="desc"?-c:c});let p=document.createDocumentFragment();for(let m of f)p.appendChild(m);n.appendChild(p)}function Me(e){e.directive("fixed-header",{priority:10,init(t){X(),t.classList.add("nojs-fixed-header")}})}function qe(e){e.directive("fixed-col",{priority:10,init(t){X(),t.classList.add("nojs-fixed-col")}})}function Be(e,t={}){Fe(e),Pe(e),Me(e),qe(e)}function He(){Te()}var vr={name:"nojs-elements",install(e,t={}){Et(e,t),St(e,t),Mt(e,t),Wt(e,t),Zt(e,t),ie(e,t),fe(e,t),ve(e,t),Ee(e,t),Le(e,t),Be(e,t)},dispose(e){jt(),Lt(),qt(),Vt(),Qt(),se(),me(),ye(),Ce(),He()}},yt=vr;typeof window<"u"&&(window.NoJSElements=yt,window.NoJS&&typeof window.NoJS.use=="function"&&window.NoJS.use(yt));})();

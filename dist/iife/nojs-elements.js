 ...
 * @license MIT
 */
(()=>{var K=new Map,D=new Map;function wt(){for(let e of D.values())clearTimeout(e);D.clear();for(let e of K.values())e.remove();K.clear()}function At(){if(typeof document>"u"||document.querySelector("style[data-nojs-tooltip]"))return;let e=`
.nojs-tooltip {
  position: fixed;
  z-index: 9999;
  pointer-events: none;
...
`.trim(),t=document.createElement("style");t.setAttribute("data-nojs-tooltip",""),t.textContent=e,document.head.appendChild(t)}function Ge(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}var J=8;function We(e,t,r){let i=t.getBoundingClientRect(),o=e.getBoundingClientRect(),n=window.innerWidth,d=window.innerHeight,s,l;switch(r){case"bottom":s=i.bottom+J,l=i.left+(i.width-o.width)/2;break;case"left":s=i.top+(i.height-o.height)/2,l=i.left-o.width-J;break;case"right":s=i.top+(i.height-o.height)/2,l=i.right+J;break;default:s=i.top-o.height-J,l=i.left+(i.width-o.width)/2;break}l<4&&(l=4),l+o.width>n-4&&(l=n-o.width-4),s<4&&(s=4),s+o.height>d-4&&(s=d-o.height-4),e.style.top=`${s}px`,e.style.left=`${l}px`}var Ne=0;function Ve(e,t,r){document.body.appendChild(t),We(t,e,r),t.setAttribute("aria-hidden","false")}function Ue(e,t){t.setAttribute("aria-hidden","true"),t.remove()}function Et(e){e.directive("tooltip",{priority:20,init(t,r,i){At();let o=i;if(!o){console.warn("[tooltip] attribute value (tooltip text) is required.");return}let n=t.getAttribute("tooltip-position")||"top",d=parseInt(t.getAttribute("tooltip-delay"),10)||300,s=t.getAttribute("tooltip-disabled"),l=s?e.findContext(t):null,f=`nojs-tooltip-${++Ne}`,p=document.createElement("div");p.className="nojs-tooltip",p.setAttribute("role","tooltip"),p.setAttribute("id",f),p.setAttribute("aria-hidden","true"),p.textContent=o,t.setAttribute("aria-describedby",f),K.set(t,p);let m=()=>{if(s&&l&&e.evaluate(s,l))return;D.has(t)&&clearTimeout(D.get(t));let y=setTimeout(()=>{D.delete(t),!(s&&l&&e.evaluate(s,l))&&Ve(t,p,n)},d);D.set(t,y)},h=()=>{D.has(t)&&(clearTimeout(D.get(t)),D.delete(t)),Ue(t,p)},c=()=>m(),a=()=>h(),u=()=>m(),b=()=>h(),g=y=>{y.key==="Escape"&&p.getAttribute("aria-hidden")==="false"&&h()};t.addEventListener("mouseenter",c),t.addEventListener("mouseleave",a),t.addEventListener("focusin",u),t.addEventListener("focusout",b),t.addEventListener("keydown",g),Ge(t,()=>{t.removeEventListener("mouseenter",c),t.removeEventListener("mouseleave",a),t.removeEventListener("focusin",u),t.removeEventListener("focusout",b),t.removeEventListener("keydown",g),D.has(t)&&(clearTimeout(D.get(t)),D.delete(t)),p.remove(),K.delete(t)})}})}function jt(e,t={}){Et(e)}function _t(){wt()}var S=new Map;function kt(){S.clear()}function tt(){if(typeof document>"u"||document.querySelector("style[data-nojs-popover]"))return;let e=`
.nojs-popover {
  position: fixed;
  z-index: 9998;
  margin: 0;
...
`.trim(),t=document.createElement("style");t.setAttribute("data-nojs-split",""),t.textContent=e,document.head.appendChild(t)}function pr(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}function ke(e){return e==="horizontal"?"clientX":"clientY"}function L(e,t){let r=e.getBoundingClientRect?e.getBoundingClientRect():null,i=r&&(t==="horizontal"?r.width:r.height);return i||(t==="horizontal"?e.offsetWidth:e.offsetHeight)}function Se(e,t){if(t!=="horizontal")return 1;try{return(e.closest&&e.closest("[dir]")?.getAttribute("dir")||(typeof getComputedStyle=="function"?getComputedStyle(e).direction:""))==="rtl"?-1:1}catch{return 1}}function ur(e,t){let i=(B.get(e)?.gutters||[]).reduce((o,n)=>o+L(n,t),0);return L(e,t)-i}function fr(e,t){if(!e)return null;let r=parseFloat(e);return Number.isNaN(r)?null:typeof e=="string"&&e.trim().endsWith("%")?r/100*t:r}function Z(e,t){let r=_.get(t);return r?r.min!=null&&e<r.min?r.min:r.max!=null&&e>r.max?r.max:e:e}function st(e,t,r,i){let o=L(t,i),n=L(r,i),d=_.get(t),s=_.get(r);e.setAttribute("aria-valuenow",Math.round(o)),e.setAttribute("aria-valuemin",d?.min||0),e.setAttribute("aria-valuemax",Math.round(o+n-(s?.min||0)))}function yt(e){let t=e.getAttribute("split-persist");if(!t)return;let r=B.get(e);if(!r)return;let i=r.panes.map(o=>o.style.flexBasis||"");try{localStorage.setItem(`nojs-split:${t}`,JSON.stringify(i))}catch{}}function mr(e){let t=e.getAttribute("split-persist");if(!t)return!1;try{let r=localStorage.getItem(`nojs-split:${t}`);if(!r)return!1;let i=JSON.parse(r),o=B.get(e);return!o||i.length!==o.panes.length?!1:(i.forEach((n,d)=>{n&&(o.panes[d].style.flexBasis=n,o.panes[d].style.flexGrow="0")}),!0)}catch{return!1}}function br(e,t,r,i,o){let n=document.createElement("div");n.className="nojs-gutter",n.setAttribute("role","separator"),n.setAttribute("tabindex","0"),n.setAttribute("aria-orientation",t==="horizontal"?"vertical":"horizontal"),n.setAttribute("aria-label","Resize"),o!==6&&n.style.setProperty("--nojs-gutter-size",`${o}px`);let d=c=>{if(c.button!==0)return;c.preventDefault();let a=ur(e,t);v.active=!0,v.splitEl=e,v.gutterEl=n,v.prevPane=r,v.nextPane=i,v.direction=t,v.startPos=c[ke(t)],v.startPrevSize=L(r,t),v.startNextSize=L(i,t),v.containerSize=a,v.sign=Se(e,t),document.body.style.cursor=t==="horizontal"?"col-resize":"row-resize",document.body.style.userSelect="none",n.setPointerCapture(c.pointerId)},s=c=>{if(!v.active||v.gutterEl!==n)return;let a=(c[ke(v.direction)]-v.startPos)*(v.sign||1),u=Z(v.startPrevSize+a,v.prevPane),b=Z(v.startNextSize-a,v.nextPane),g=v.startPrevSize+v.startNextSize;u+b!==g&&(u!==v.startPrevSize+a?b=g-u:u=g-b),v.prevPane.style.flexBasis=`${u}px`,v.prevPane.style.flexGrow="0",v.nextPane.style.flexBasis=`${b}px`,v.nextPane.style.flexGrow="0",st(n,v.prevPane,v.nextPane,v.direction)},l=()=>{!v.active||v.gutterEl!==n||(v.active=!1,document.body.style.cursor="",document.body.style.userSelect="",yt(e),e.dispatchEvent(new CustomEvent("split-resize",{bubbles:!0,detail:{prevPane:r,nextPane:i}})))};n.addEventListener("pointerdown",d),n.addEventListener("pointermove",s),n.addEventListener("pointerup",l),n.addEventListener("pointercancel",l);let f=10,p=c=>{let a=t==="horizontal",u=Se(e,t),b=0;if(a&&c.key==="ArrowRight"||!a&&c.key==="ArrowDown")b=f*u;else if(a&&c.key==="ArrowLeft"||!a&&c.key==="ArrowUp")b=-f*u;else if(c.key==="Home")b=(_.get(r)?.min||0)-L(r,t);else if(c.key==="End"){let N=_.get(i);b=L(r,t)+L(i,t)-(N?.min||0)-L(r,t)}else return;c.preventDefault();let g=L(r,t),y=L(i,t),w=g+y,k=Z(g+b,r),T=Z(w-k,i);k=w-T,k=Z(k,r),T=w-k,r.style.flexBasis=`${k}px`,r.style.flexGrow="0",i.style.flexBasis=`${T}px`,i.style.flexGrow="0",st(n,r,i,t),yt(e)};n.addEventListener("keydown",p);let m=()=>{let c=_.get(r),a=_.get(i),u=c?.collapsible?r:a?.collapsible?i:null;if(!u)return;let b=_.get(u);if(!b)return;let g=u===r?i:r,y=L(r,t)+L(i,t);if(b.collapsed){b.collapsed=!1,u.removeAttribute("data-collapsed");let w=b.preCollapseSize||`${Math.round(y/2)}px`,k=fr(w,y)??y/2,T=Math.min(k,y);u.style.flexBasis=`${T}px`,u.style.flexGrow="0",g.style.flexBasis=`${y-T}px`,g.style.flexGrow="0"}else b.preCollapseSize=u.style.flexBasis||`${L(u,t)}px`,b.collapsed=!0,u.setAttribute("data-collapsed","true"),u.style.flexBasis="0px",u.style.flexGrow="0",g.style.flexBasis=`${y}px`,g.style.flexGrow="0";st(n,r,i,t),yt(e),e.dispatchEvent(new CustomEvent("split-collapse",{bubbles:!0,detail:{pane:u,collapsed:b.collapsed}}))};return n.addEventListener("dblclick",m),{gutter:n,cleanup:()=>{n.removeEventListener("pointerdown",d),n.removeEventListener("pointermove",s),n.removeEventListener("pointerup",l),n.removeEventListener("pointercancel",l),n.removeEventListener("keydown",p),n.removeEventListener("dblclick",m)}}}function Le(e){e.directive("split",{priority:14,init(t,r,i){it();let o=(i||"horizontal").trim()==="vertical"?"vertical":"horizontal",n=parseInt(t.getAttribute("split-gutter"),10)||6;t.classList.add("nojs-split"),t.setAttribute("data-direction",o);let d=Array.from(t.children).filter(p=>p.hasAttribute("pane"));if(d.length<2){console.warn(`[split] Container requires at least 2 [pane] children, found ${d.length}.`);return}d.forEach(p=>{_.get(p)||_.set(p,{size:p.getAttribute("pane")||null,min:parseInt(p.getAttribute("pane-min"),10)||0,max:parseInt(p.getAttribute("pane-max"),10)||1/0,collapsible:p.getAttribute("pane-collapsible")==="true",collapsed:!1,preCollapseSize:null})});let s=[],l=[];for(let p=0;p<d.length-1;p++){let{gutter:m,cleanup:h}=br(t,o,d[p],d[p+1],n);d[p].after(m),s.push(m),l.push(h)}B.set(t,{direction:o,gutterSize:n,panes:d,gutters:s}),mr(t)||d.forEach(p=>{let h=_.get(p)?.size;h?(p.style.flexBasis=h,p.style.flexGrow="0"):(p.style.flexGrow="1",p.style.flexBasis="0")}),requestAnimationFrame(()=>{s.forEach((p,m)=>{st(p,d[m],d[m+1],o)})}),pr(t,()=>{l.forEach(p=>p()),s.forEach(p=>p.remove()),B.delete(t),d.forEach(p=>_.delete(p)),t.classList.remove("nojs-split"),t.removeAttribute("data-direction")})}})}function gr(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}function Ce(e){e.directive("pane",{priority:15,init(t,r,i){it(),t.classList.add("nojs-pane"),_.has(t)||_.set(t,{size:i||null,min:parseInt(t.getAttribute("pane-min"),10)||0,max:parseInt(t.getAttribute("pane-max"),10)||1/0,collapsible:t.getAttribute("pane-collapsible")==="true",collapsed:!1,preCollapseSize:null});let o=_.get(t),n=t.closest("[data-direction='vertical']")?"height":"width";o.min&&(t.style[`min${n==="width"?"Width":"Height"}`]=`${o.min}px`),o.max&&o.max!==1/0&&(t.style[`max${n==="width"?"Width":"Height"}`]=`${o.max}px`),gr(t,()=>{t.classList.remove("nojs-pane"),_.delete(t),t.style.removeProperty("min-width"),t.style.removeProperty("min-height"),t.style.removeProperty("max-width"),t.style.removeProperty("max-height"),t.style.removeProperty("flex-basis"),t.style.removeProperty("flex-grow")})}})}function Te(e,t={}){Le(e),Ce(e)}function De(){_e()}var W={sorts:new Map};function Ie(){W.sorts.clear()}function Q(){if(typeof document>"u"||document.querySelector("style[data-nojs-table]"))return;let e=`
...
`.trim(),t=document.createElement("style");t.setAttribute("data-nojs-table",""),t.textContent=e,document.head.appendChild(t)}function hr(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}function vr(e,t){let r=e.querySelector("tbody");if(!r)return null;let i=null;if(r.hasAttribute("each")||r.hasAttribute("foreach")?i=r:i=r.querySelector("[each]")||r.querySelector("[foreach]"),!i)return null;let o=i.getAttribute("each")||i.getAttribute("foreach");if(!o)return null;let n=o.match(/^\s*(\w+)\s+(?:in|of)\s+(.+)\s*$/);return n?{iteratorVar:n[1],arrayPath:n[2].trim()}:null}function yr(e,t){let r=t.split("."),i=e;for(let o of r){if(i==null)return;i=i[o]}return i}function ze(e,t,r){let i=t.split("."),o=e;for(let n=0;n<i.length-1;n++){if(o[i[n]]==null)return;o=o[i[n]]}o[i[i.length-1]]=r}function Pe(e,t,r){if(e==null&&t==null)return 0;if(e==null)return-1;if(t==null)return 1;switch(r){case"number":return Number(e)-Number(t);case"date":return new Date(e).getTime()-new Date(t).getTime();default:return String(e).localeCompare(String(t))}}function xr(e){let t=e.querySelectorAll("th[data-sortable]");for(let r of t)r.removeAttribute("data-sort-dir"),r.setAttribute("aria-sort","none")}function Me(e){e.directive("sortable",{priority:10,init(t){Q(),t.classList.add("nojs-sortable")}})}function qe(e){e.directive("sort",{priority:11,init(t,r,i){Q();let o=i;if(!o)return;let n=t.getAttribute("sort-type")||"string",d=t.getAttribute("sort-default");t.setAttribute("data-sortable",""),t.setAttribute("aria-sort","none");let s=t.closest("table");if(!s)return;W.sorts.has(s)||W.sorts.set(s,{column:null,direction:null}),(d==="asc"||d==="desc")&&Fe(t,s,o,n,d,e);let l=()=>{let f=W.sorts.get(s),p;f.column!==o?p="asc":f.direction==="asc"?p="desc":f.direction==="desc"?p=null:p="asc",Fe(t,s,o,n,p,e)};t.addEventListener("click",l),hr(t,()=>{t.removeEventListener("click",l),s&&s._nojsOriginalOrder&&delete s._nojsOriginalOrder})}})}function Fe(e,t,r,i,o,n){let d=W.sorts.get(t);xr(t),o?(e.setAttribute("data-sort-dir",o),e.setAttribute("aria-sort",o==="asc"?"ascending":"descending"),d.column=r,d.direction=o):(d.column=null,d.direction=null);let s=vr(t,n);if(s){let l=n.findContext(t),f=l?yr(l,s.arrayPath):null;if(Array.isArray(f)){if(!o){let m=t._nojsOriginalOrder;if(m){let h=new Set(f),c=m.filter(a=>h.has(a));for(let a of f)m.includes(a)||c.push(a);ze(l,s.arrayPath,c)}return}t._nojsOriginalOrder||(t._nojsOriginalOrder=[...f]);let p=[...f].sort((m,h)=>{let c=m!=null?m[r]:null,a=h!=null?h[r]:null,u=Pe(c,a,i);return o==="desc"?-u:u});ze(l,s.arrayPath,p);return}}wr(t,e,r,i,o)}function wr(e,t,r,i,o){let n=e.querySelector("tbody");if(!n)return;let l=[...t.closest("tr").children].indexOf(t);if(l<0)return;let f=[...n.querySelectorAll(":scope > tr")];if(e._nojsOriginalRows||(e._nojsOriginalRows=[...f]),!o){let m=document.createDocumentFragment();for(let h of e._nojsOriginalRows)m.appendChild(h);n.appendChild(m);return}f.sort((m,h)=>{let c=m.children[l]?.textContent?.trim()||"",a=h.children[l]?.textContent?.trim()||"",u=Pe(i==="number"?parseFloat(c.replace(/[^0-9.\-]/g,""))||0:c,i==="number"?parseFloat(a.replace(/[^0-9.\-]/g,""))||0:a,i);return o==="desc"?-u:u});let p=document.createDocumentFragment();for(let m of f)p.appendChild(m);n.appendChild(p)}function Be(e){e.directive("fixed-header",{priority:10,init(t){Q(),t.classList.add("nojs-fixed-header")}})}function He(e){e.directive("fixed-col",{priority:10,init(t){Q(),t.classList.add("nojs-fixed-col")}})}function $e(e,t={}){Me(e),qe(e),Be(e),He(e)}function Re(){Ie()}var Ar={name:"nojs-elements",install(e,t={}){jt(e,t),Lt(e,t),qt(e,t),Nt(e,t),Qt(e,t),se(e,t),me(e,t),ye(e,t),je(e,t),Te(e,t),$e(e,t)},dispose(e){_t(),Ct(),Bt(),Vt(),Jt(),ae(),be(),xe(),De(),Re()}},xt=Ar;typeof window<"u"&&(window.NoJSElements=xt,window.NoJS&&typeof window.NoJS.use=="function"&&window.NoJS.use(xt));})();

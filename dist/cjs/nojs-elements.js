 ...
 */
var st=Object.defineProperty;var co=Object.getOwnPropertyDescriptor;var lo=Object.getOwnPropertyNames;var uo=Object.prototype.hasOwnProperty;var po=(t,e)=>{for(var r in e)st(t,r,{get:e[r],enumerable:!0})},fo=(t,e,r,o)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of lo(e))!uo.call(t,n)&&n!==r&&st(t,n,{get:()=>e[n],enumerable:!(o=co(e,n))||o.enumerable});return t};var mo=t=>fo(st({},"__esModule",{value:!0}),t);var Pi={};po(Pi,{default:()=>Mi});module.exports=mo(Pi);var E={dragging:null,selected:new Map,placeholder:null},Fe=new Map;function St(){E.dragging=null,E.selected.clear(),E.placeholder&&(E.placeholder.remove(),E.placeholder=null),Fe.clear()}function Me(){if(typeof document>"u"||document.querySelector("style[data-nojs-dnd]"))return;let t=`
.nojs-dragging {
  opacity: 0.5;
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-tooltip",""),e.textContent=t,document.head.appendChild(e)}function Lo(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}var We=8;function Xt(t,e,r){let o=e.getBoundingClientRect(),n=t.getBoundingClientRect(),i=window.innerWidth,c=window.innerHeight,a,s;switch(r){case"bottom":a=o.bottom+We,s=o.left+(o.width-n.width)/2;break;case"left":a=o.top+(o.height-n.height)/2,s=o.left-n.width-We;break;case"right":a=o.top+(o.height-n.height)/2,s=o.right+We;break;default:a=o.top-n.height-We,s=o.left+(o.width-n.width)/2;break}s<4&&(s=4),s+n.width>i-4&&(s=i-n.width-4),a<4&&(a=4),a+n.height>c-4&&(a=c-n.height-4),t.style.top=`${a}px`,t.style.left=`${s}px`}var jo=0;function ko(t,e,r){document.body.appendChild(e),Xt(e,t,r),e.setAttribute("aria-hidden","false")}function Kt(t,e){e.setAttribute("aria-hidden","true"),e.remove()}function Co(t,e){t&&typeof t._warn=="function"?t._warn(e):console.warn(e)}function Zt(t){t.directive("tooltip",{priority:20,init(e,r,o){Yt();let n=o;if(!n){Co(t,"[tooltip] attribute value (tooltip text) is required.");return}let i=e.getAttribute("tooltip-position")||"top",c=parseInt(e.getAttribute("tooltip-delay"),10),a=Number.isNaN(c)?300:c,s=e.getAttribute("tooltip-disabled"),l=s?t.findContext(e):null,m=()=>{if(!s||!l)return!1;try{return!!t.evaluate(s,l)}catch{return!1}},d=`nojs-tooltip-${++jo}`,g=document.createElement("div");g.className="nojs-tooltip",g.setAttribute("role","tooltip"),g.setAttribute("id",d),g.setAttribute("aria-hidden","true"),g.textContent=n,e.setAttribute("aria-describedby",d),xe.set(e,g);let u=!1,f=0,h=()=>{!u||!e.isConnected||f||(f=requestAnimationFrame(()=>{f=0,!(!u||!e.isConnected)&&Xt(g,e,i)}))},v=()=>{window.addEventListener("scroll",h,!0),window.addEventListener("resize",h)},p=()=>{window.removeEventListener("scroll",h,!0),window.removeEventListener("resize",h),f&&(cancelAnimationFrame(f),f=0)},b=()=>{u||(ko(e,g,i),u=!0,v())},w=()=>{if(!u){Kt(e,g);return}p(),Kt(e,g),u=!1},y=()=>{if(m())return;te.has(e)&&clearTimeout(te.get(e));let B=setTimeout(()=>{te.delete(e),!m()&&e.isConnected&&b()},a);te.set(e,B)},x=()=>{te.has(e)&&(clearTimeout(te.get(e)),te.delete(e)),w()},A=()=>y(),L=()=>x(),k=()=>y(),j=()=>x(),S=B=>{B.key==="Escape"&&g.getAttribute("aria-hidden")==="false"&&x()};e.addEventListener("mouseenter",A),e.addEventListener("mouseleave",L),e.addEventListener("focusin",k),e.addEventListener("focusout",j),e.addEventListener("keydown",S);let _=null;if(s&&l&&typeof l.$watch=="function"){let B=()=>{u&&m()&&w()};_=l.$watch(B)}Lo(e,()=>{e.removeEventListener("mouseenter",A),e.removeEventListener("mouseleave",L),e.removeEventListener("focusin",k),e.removeEventListener("focusout",j),e.removeEventListener("keydown",S),_&&(_(),_=null),p(),te.has(e)&&(clearTimeout(te.get(e)),te.delete(e)),u=!1,g.remove(),xe.delete(e)})}})}function Qt(t,e={}){Zt(t)}function Jt(){Ut()}var Y=new Map;function er(){Y.clear()}function Ge(){if(typeof document>"u"||document.querySelector("style[data-nojs-popover]"))return;let t=`
.nojs-popover {
  position: fixed;
  z-index: 9998;
  margin: 0;
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-toast",""),e.textContent=t,document.head.appendChild(e)}function ht(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}var zo=new Set(["top-right","top-left","bottom-right","bottom-left","top-center","bottom-center"]);function vt(){return ie.size>0?ie.values().next().value:Fo("top-right")}function Fo(t){if(ie.has(t))return ie.get(t);let e=document.createElement("div");return e.classList.add("nojs-toast-container"),e.setAttribute("data-position",t),e.setAttribute("role","log"),e.setAttribute("aria-live","polite"),e.setAttribute("aria-relevant","additions"),document.body.appendChild(e),ie.set(t,e),e}function Mo(t){return t.startsWith("top")}function yt(t,e,r,o,n){let i=wr(),c=t.getAttribute("data-position")||"top-right",a=document.createElement("div");a.classList.add("nojs-toast"),a.setAttribute("data-toast-id",i),a.setAttribute("data-type",r),r==="error"&&a.setAttribute("aria-live","assertive");let s=document.createElement("span");if(s.textContent=e,a.appendChild(s),n){let l=document.createElement("button");l.type="button",l.classList.add("nojs-toast-dismiss"),l.setAttribute("aria-label","Dismiss"),l.textContent="\xD7",l.addEventListener("click",()=>Ye(a)),a.appendChild(l)}if(Mo(c)&&t.firstChild?t.insertBefore(a,t.firstChild):t.appendChild(a),o>0){let l=setTimeout(()=>{Le.delete(l),a.isConnected&&Ye(a)},o);Le.add(l),a._toastTimerId=l}return a}function Ye(t){!t||!t.isConnected||(t._toastTimerId!=null&&(clearTimeout(t._toastTimerId),Le.delete(t._toastTimerId)),t.remove())}function jr(t){Lr(),t.directive("toast-container",{priority:10,init(r,o,n){let i=n&&zo.has(n)?n:"top-right";r.classList.add("nojs-toast-container"),r.setAttribute("data-position",i),r.setAttribute("role","log"),r.setAttribute("aria-live","polite"),r.setAttribute("aria-relevant","additions"),ie.set(i,r),ht(r,()=>{ie.get(i)===r&&ie.delete(i)})}}),t.directive("toast",{priority:10,init(r,o,n){if(!n)return;let i=r.getAttribute("toast-type")||"info",c=parseInt(r.getAttribute("toast-duration"),10),a=Number.isNaN(c)?3e3:c,s=r.getAttribute("toast-dismiss")!=="false";if(r.tagName==="BUTTON"||r.tagName==="A"||r.hasAttribute("on:click")){let f=()=>{let h=vt();yt(h,n,i,a,s)};r.addEventListener("click",f),ht(r,()=>r.removeEventListener("click",f));return}let m=t.findContext(r);if(!m||typeof m.$watch!="function"){console.warn("[toast] reactive toast requires a parent [state] or [use] context \u2014 element will be inert");return}let d;function g(){let f=t.evaluate(n,m);if(f&&f!==d){let h=typeof f=="string"?f:String(f),v=vt();yt(v,h,i,a,s),d=f}else d=f}let u=m.$watch(g);ht(r,u)}});let e=(r,o="info",n=3e3)=>{if(typeof document>"u")return;let i=!0,c=vt();return yt(c,String(r),o,n,i)};e.dismiss=r=>{let o=typeof CSS<"u"&&CSS.escape?CSS.escape(String(r)):String(r).replace(/["\\\]]/g,"\\$&"),n=document.querySelector(`[data-toast-id="${o}"]`);n&&Ye(n)},e.dismissAll=()=>{document.querySelectorAll(".nojs-toast").forEach(r=>Ye(r))},t.toast=e,t.global("toast",e)}function kr(t,e={}){jr(t)}function Cr(){Ar()}var be={containers:new Map};function Sr(){be.containers.clear()}function Tr(){if(typeof document>"u"||document.querySelector("style[data-nojs-tabs]"))return;let t=`
.nojs-tabs {
  display: flex;
  flex-direction: column;
  border: 1px solid #E2E8F0;
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-tree",""),e.textContent=t,document.head.appendChild(e)}function ke(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function Fr(t){let e=[],r=document.createTreeWalker(t,NodeFilter.SHOW_ELEMENT,{acceptNode(n){return n.matches&&n.matches('.nojs-subtree[aria-hidden="true"]')?NodeFilter.FILTER_REJECT:n.getAttribute("role")==="treeitem"?NodeFilter.FILTER_ACCEPT:NodeFilter.FILTER_SKIP}}),o;for(;o=r.nextNode();)e.push(o);return e}function Mr(t){return t.closest('[role="tree"]')}function Oo(t){let e=t.parentElement?.closest('[role="group"], .nojs-subtree');if(e){let r=e.parentElement?.closest('[role="treeitem"]');if(r)return r;let o=e.previousElementSibling;if(o?.matches?.('[role="treeitem"]'))return o}return t.parentElement?.closest('[role="treeitem"]')||null}function Vo(t){let e=t.cloneNode(!0);return e.querySelectorAll('[role="group"]').forEach(o=>o.remove()),(e.textContent||"").trim().toLowerCase()}function xt(t){let e=I.selectedItem;e&&e!==t&&(e.classList.remove("nojs-branch-selected"),e.setAttribute("aria-selected","false")),t.classList.add("nojs-branch-selected"),t.setAttribute("aria-selected","true"),I.selectedItem=t}function Pr(t){let e=I.branches.get(t);!e||!e.subtreeEl||(e.expanded=!e.expanded,t.setAttribute("aria-expanded",String(e.expanded)),e.subtreeEl.setAttribute("aria-hidden",String(!e.expanded)))}function No(t){let e=I.branches.get(t);!e||!e.subtreeEl||e.expanded||(e.expanded=!0,t.setAttribute("aria-expanded","true"),e.subtreeEl.setAttribute("aria-hidden","false"))}function Wo(t){let e=I.branches.get(t);!e||!e.subtreeEl||!e.expanded||(e.expanded=!1,t.setAttribute("aria-expanded","false"),e.subtreeEl.setAttribute("aria-hidden","true"))}function $r(t,e){let r=Mr(e);if(!r)return;let o=Fr(r),n=o.indexOf(e);if(n<0)return;let i=I.branches.get(e),c=i&&i.subtreeEl;switch(t.key){case"ArrowRight":if(t.preventDefault(),c&&!i.expanded)No(e);else if(c&&i.expanded){let a=i.subtreeEl.querySelector('[role="treeitem"]');a&&he(a,o)}break;case"ArrowLeft":if(t.preventDefault(),c&&i.expanded)Wo(e);else{let a=Oo(e);a&&he(a,Fr(r))}break;case"ArrowDown":t.preventDefault(),n<o.length-1&&he(o[n+1],o);break;case"ArrowUp":t.preventDefault(),n>0&&he(o[n-1],o);break;case"Enter":case" ":t.preventDefault(),xt(e),c&&Pr(e);break;case"Home":t.preventDefault(),o.length>0&&he(o[0],o);break;case"End":t.preventDefault(),o.length>0&&he(o[o.length-1],o);break;default:if(t.key.length===1&&!t.ctrlKey&&!t.altKey&&!t.metaKey){t.preventDefault(),I.typeahead+=t.key.toLowerCase(),I.typeaheadTimer&&clearTimeout(I.typeaheadTimer),I.typeaheadTimer=setTimeout(()=>{I.typeahead="",I.typeaheadTimer=null},500);let a=n+1;for(let s=0;s<o.length;s++){let l=(a+s)%o.length;if(Vo(o[l]).startsWith(I.typeahead)){he(o[l],o);break}}}break}}function Or(t){t.directive("tree",{priority:15,init(e){je(),e.classList.add("nojs-tree"),e.setAttribute("role","tree"),e.getAttribute("tree-icon")==="false"&&e.setAttribute("data-tree-icon","false")}})}function Vr(t){t.directive("branch",{priority:16,init(e,r,o){je();let n=o==="expanded";e.classList.add("nojs-branch"),e.setAttribute("role","treeitem"),e.setAttribute("aria-expanded",String(n));let i=Mr(e);if(i){let l=i.querySelector('[role="treeitem"][tabindex="0"]');e.setAttribute("tabindex",l?"-1":"0")}else e.setAttribute("tabindex","0");let c=!1;queueMicrotask(()=>{if(c)return;let l=e.querySelector(":scope > [subtree], :scope > .nojs-subtree")||(e.nextElementSibling?.matches?.("[subtree], .nojs-subtree")?e.nextElementSibling:null);l?(I.branches.set(e,{expanded:n,subtreeEl:l}),l.setAttribute("aria-hidden",String(!n))):I.branches.set(e,{expanded:n,subtreeEl:null})});let a=l=>{l.target.closest?.('[role="treeitem"]')===e&&(l.stopPropagation(),xt(e),Pr(e))};e.addEventListener("click",a),ke(e,()=>e.removeEventListener("click",a));let s=l=>{$r(l,e)};e.addEventListener("keydown",s),ke(e,()=>e.removeEventListener("keydown",s)),ke(e,()=>{c=!0,I.branches.delete(e),I.selectedItem===e&&(I.selectedItem=null),I.typeaheadTimer&&(clearTimeout(I.typeaheadTimer),I.typeaheadTimer=null,I.typeahead="")})}})}function he(t,e){for(let r of e)r.setAttribute("tabindex",r===t?"0":"-1");t.focus()}function Nr(t){t.directive("subtree",{priority:16,init(e){je(),e.classList.add("nojs-subtree"),e.classList.add("nojs-tree"),e.setAttribute("role","group");for(let o of e.children)if(o.tagName==="LI"&&!o.querySelector("[branch], .nojs-branch")){o.setAttribute("role","treeitem"),o.setAttribute("tabindex","-1"),o.classList.add("nojs-tree-leaf");let n=c=>{c.stopPropagation(),xt(o)};o.addEventListener("click",n),ke(o,()=>o.removeEventListener("click",n));let i=c=>{$r(c,o)};o.addEventListener("keydown",i),ke(o,()=>o.removeEventListener("keydown",i)),ke(o,()=>{I.selectedItem===o&&(I.selectedItem=null)})}let r=e.parentElement?.matches?.('[role="treeitem"]')?e.parentElement:e.previousElementSibling?.matches?.('[role="treeitem"]')?e.previousElementSibling:null;if(r){let o=I.branches.get(r);o?(e.setAttribute("aria-hidden",String(!o.expanded)),o.subtreeEl=e):e.setAttribute("aria-hidden","true")}else e.setAttribute("aria-hidden","true")}})}function Wr(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function Et(t){return t.closest('[role="treeitem"]')}function Go(t){return t.closest('[role="tree"]')}function Uo(t){let e=t.parentElement;return e?[...e.children].filter(r=>r.getAttribute("role")==="treeitem"):[]}function Yo(t){return Uo(t).indexOf(t)}function Ko(t,e,r){let o=t.getBoundingClientRect(),n=e-o.top,i=o.height;return r==="reparent"?"on":r==="reorder"?n<i/2?"before":"after":n<i*.25?"before":n>i*.75?"after":"on"}function Gr(t,e){let r=t.parentElement;for(;r;){if(r===e)return!0;r=r.parentElement}return!1}var D={dragging:null,indicator:null,currentTarget:null,currentPosition:null};function Ce(){D.indicator&&(D.indicator.remove(),D.indicator=null)}function He(t){if(!t)return;let e=t.querySelectorAll(".nojs-tree-drag-over");for(let r of e)r.classList.remove("nojs-tree-drag-over")}function Xo(){let t=document.createElement("div");return t.className="nojs-tree-drag-indicator",t.setAttribute("aria-hidden","true"),t}function Zo(t,e){Ce();let r=Xo(),o=t.getBoundingClientRect(),n=Go(t);if(!n)return;let i=n.getBoundingClientRect();r.style.position="absolute",r.style.left=o.left-i.left+"px",r.style.width=o.width+"px",e==="before"?r.style.top=o.top-i.top-1+"px":r.style.top=o.bottom-i.top-1+"px",getComputedStyle(n).position==="static"&&(n.style.position="relative"),n.appendChild(r),D.indicator=r}function Ur(t){t.directive("tree-drag-mode",{priority:15,init(e,r,o){if(je(),o!=="reparent"&&o!=="reorder"&&o!=="both")return;let n=0,i=g=>{let u=Et(g.target);if(u&&e.contains(u)){if(u.hasAttribute("tree-drag-disabled")){g.preventDefault();return}D.dragging={el:u,treeRoot:e},g.dataTransfer&&(g.dataTransfer.effectAllowed="move",g.dataTransfer.setData("text/plain","")),u.classList.add("nojs-dragging"),u.dispatchEvent(new CustomEvent("tree:drag-start",{bubbles:!0,detail:{node:u}}))}},c=g=>{if(!D.dragging||D.dragging.treeRoot!==e)return;let u=Et(g.target);if(!u||!e.contains(u)||u===D.dragging.el||Gr(u,D.dragging.el))return;g.preventDefault(),g.dataTransfer&&(g.dataTransfer.dropEffect="move");let f=Ko(u,g.clientY,o);(D.currentTarget!==u||D.currentPosition!==f)&&(He(e),Ce(),D.currentTarget=u,D.currentPosition=f,f==="on"?u.classList.add("nojs-tree-drag-over"):Zo(u,f))},a=g=>{D.dragging&&D.dragging.treeRoot===e&&n++},s=g=>{D.dragging&&(n--,n<=0&&(n=0,He(e),Ce(),D.currentTarget=null,D.currentPosition=null))},l=g=>{if(g.preventDefault(),g.stopPropagation(),n=0,!D.dragging||D.dragging.treeRoot!==e)return;let u=D.dragging.el,f=D.currentTarget,h=D.currentPosition;if(He(e),Ce(),!f||!h){D.dragging=null,D.currentTarget=null,D.currentPosition=null;return}if(f===u||Gr(f,u)){D.dragging=null,D.currentTarget=null,D.currentPosition=null;return}if(h==="on"){let v=f.querySelector(':scope > [role="group"]');v||(v=f.nextElementSibling?.matches?.('[role="group"]')?f.nextElementSibling:null),v?v.setAttribute("aria-hidden","false"):(v=document.createElement("ul"),v.setAttribute("role","group"),v.setAttribute("subtree",""),v.classList.add("nojs-subtree","nojs-tree"),v.setAttribute("aria-hidden","false"),f.appendChild(v));let p=I.branches.get(f);p&&(p.expanded=!0,p.subtreeEl=v,f.setAttribute("aria-expanded","true")),v.appendChild(u),e.dispatchEvent(new CustomEvent("tree:reparent",{bubbles:!0,detail:{node:u,newParent:f}}))}else{let v=f.parentElement;if(!v){D.dragging=null,D.currentTarget=null,D.currentPosition=null;return}if(h==="before")v.insertBefore(u,f);else{let b=f.nextElementSibling,w=b?.matches?.('[role="group"]')?b.nextElementSibling:b;w?v.insertBefore(u,w):v.appendChild(u)}let p=Yo(u);e.dispatchEvent(new CustomEvent("tree:reorder",{bubbles:!0,detail:{node:u,newIndex:p}}))}D.dragging=null,D.currentTarget=null,D.currentPosition=null},m=g=>{let u=Et(g.target);u&&u.classList.remove("nojs-dragging"),He(e),Ce(),n=0,D.dragging&&D.dragging.el.dispatchEvent(new CustomEvent("tree:drag-end",{bubbles:!0,detail:{node:D.dragging.el}})),D.dragging=null,D.currentTarget=null,D.currentPosition=null};e.addEventListener("dragstart",i),e.addEventListener("dragover",c),e.addEventListener("dragenter",a),e.addEventListener("dragleave",s),e.addEventListener("drop",l),e.addEventListener("dragend",m),Wr(e,()=>{e.removeEventListener("dragstart",i),e.removeEventListener("dragover",c),e.removeEventListener("dragenter",a),e.removeEventListener("dragleave",s),e.removeEventListener("drop",l),e.removeEventListener("dragend",m),He(e),Ce()}),Qo(e);let d=new MutationObserver(g=>{for(let u of g)for(let f of u.addedNodes){if(f.nodeType!==1)continue;f.getAttribute("role")==="treeitem"&&_t(f);let h=f.querySelectorAll?.('[role="treeitem"]');if(h)for(let v of h)_t(v)}});d.observe(e,{childList:!0,subtree:!0}),Wr(e,()=>d.disconnect())}})}function _t(t){if(t.hasAttribute("tree-drag-disabled")){t.draggable=!1;return}t.draggable=!0}function Qo(t){let e=t.querySelectorAll('[role="treeitem"]');for(let r of e)_t(r)}function Yr(t,e={}){Or(t),Vr(t),Nr(t),Ur(t)}function Kr(){zr()}var Ke=new Map;function Xr(){Ke.clear()}function Xe(){if(typeof document>"u"||document.querySelector("style[data-nojs-stepper]"))return;let t=`
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-breadcrumb",""),e.textContent=t,document.head.appendChild(e)}function Bn(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function pi(t){let e=t.getAttribute("breadcrumb");if(e&&e.trim()!=="")return e.trim();let r=t.getAttribute("title");return r&&r.trim()!==""?r.trim():(t.textContent||"").trim()}function fi(t){return t&&t.charAt(0).toUpperCase()+t.slice(1)}function Hn(t,e){let r=t.querySelector("ol.nojs-breadcrumb");r&&r.remove();let o=document.createElement("ol");o.classList.add("nojs-breadcrumb");for(let i=0;i<e.length;i++){let c=e[i],a=document.createElement("li");if(i===e.length-1){let l=document.createElement("span");l.setAttribute("aria-current","page"),l.textContent=c.label,a.appendChild(l)}else{let l=document.createElement("a");l.href=c.href,l.textContent=c.label,a.appendChild(l)}o.appendChild(a)}t.appendChild(o);let n=ue.containers.get(t);n&&(n.crumbs=e)}function mi(t){let e=[],r=Array.from(t.children);for(let o of r){if(o.tagName==="OL"&&o.classList.contains("nojs-breadcrumb"))continue;let n=pi(o);if(!n)continue;let i=o.getAttribute("href")||"#";e.push({label:n,href:i})}return e}function gi(t){if(!t||t==="/")return[{label:"Home",href:"/",isLast:!0}];let r=(t.replace(/\/+$/,"")||"/").split("/").filter(Boolean),o=[{label:"Home",href:"/"}],n="";for(let i=0;i<r.length;i++){n+="/"+r[i];let c=fi(r[i].replace(/[-_]/g," "));o.push({label:c,href:n})}return o}function qn(t){t.directive("breadcrumb",{priority:15,init(e,r,o){In(),e.tagName==="NAV"&&!e.getAttribute("aria-label")&&e.setAttribute("aria-label","Breadcrumb");let n=Array.from(e.children).some(a=>!(a.tagName==="OL"&&a.classList.contains("nojs-breadcrumb"))),i=t.router,c=!n&&i;if(ue.containers.set(e,{unsub:null,crumbs:[]}),c){let a=()=>{let s=i.current,l=s?s.path:"/",m=gi(l);Hn(e,m)};if(a(),typeof i.on=="function"){let s=i.on(a),l=ue.containers.get(e);l&&(l.unsub=s),Bn(e,()=>{typeof s=="function"&&s();let m=ue.containers.get(e);m&&(m.unsub=null)})}}else{let a=mi(e);for(let s of Array.from(e.children))s.tagName==="OL"&&s.classList.contains("nojs-breadcrumb")||(s.style.display="none");Hn(e,a)}Bn(e,()=>{ue.containers.delete(e)})}})}function Rn(t,e={}){qn(t)}function zn(){Dn()}var Je={containers:new Map};function Fn(){Je.containers.clear()}function Mn(){if(typeof document>"u"||document.querySelector("style[data-nojs-accordion]"))return;let t=`
[accordion] {
  display: flex;
  flex-direction: column;

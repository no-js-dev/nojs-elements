 ...
 * @license MIT
 */
var Ve=Object.defineProperty;var on=Object.getOwnPropertyDescriptor;var sn=Object.getOwnPropertyNames;var an=Object.prototype.hasOwnProperty;var dn=(t,e)=>{for(var r in e)Ve(t,r,{get:e[r],enumerable:!0})},cn=(t,e,r,i)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of sn(e))!an.call(t,n)&&n!==r&&Ve(t,n,{get:()=>e[n],enumerable:!(i=on(e,n))||i.enumerable});return t};var ln=t=>cn(Ve({},"__esModule",{value:!0}),t);var so={};dn(so,{default:()=>io});module.exports=ln(so);var x={dragging:null,selected:new Map,placeholder:null},Ce=new Map;function lt(){x.dragging=null,x.selected.clear(),x.placeholder&&(x.placeholder.remove(),x.placeholder=null),Ce.clear()}function Se(){if(typeof document>"u"||document.querySelector("style[data-nojs-dnd]"))return;let t=`
.nojs-dragging {
  opacity: 0.5;
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-tooltip",""),e.textContent=t,document.head.appendChild(e)}function yn(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}var Fe=8;function xn(t,e,r){let i=e.getBoundingClientRect(),n=t.getBoundingClientRect(),o=window.innerWidth,l=window.innerHeight,s,c;switch(r){case"bottom":s=i.bottom+Fe,c=i.left+(i.width-n.width)/2;break;case"left":s=i.top+(i.height-n.height)/2,c=i.left-n.width-Fe;break;case"right":s=i.top+(i.height-n.height)/2,c=i.right+Fe;break;default:s=i.top-n.height-Fe,c=i.left+(i.width-n.width)/2;break}c<4&&(c=4),c+n.width>o-4&&(c=o-n.width-4),s<4&&(s=4),s+n.height>l-4&&(s=l-n.height-4),t.style.top=`${s}px`,t.style.left=`${c}px`}var En=0;function An(t,e,r){document.body.appendChild(e),xn(e,t,r),e.setAttribute("aria-hidden","false")}function wn(t,e){e.setAttribute("aria-hidden","true"),e.remove()}function St(t){t.directive("tooltip",{priority:20,init(e,r,i){Ct();let n=i;if(!n){console.warn("[tooltip] attribute value (tooltip text) is required.");return}let o=e.getAttribute("tooltip-position")||"top",l=parseInt(e.getAttribute("tooltip-delay"),10)||300,s=e.getAttribute("tooltip-disabled"),c=s?t.findContext(e):null,p=`nojs-tooltip-${++En}`,f=document.createElement("div");f.className="nojs-tooltip",f.setAttribute("role","tooltip"),f.setAttribute("id",p),f.setAttribute("aria-hidden","true"),f.textContent=n,e.setAttribute("aria-describedby",p),Ae.set(e,f);let u=()=>{if(s&&c&&t.evaluate(s,c))return;te.has(e)&&clearTimeout(te.get(e));let h=setTimeout(()=>{te.delete(e),!(s&&c&&t.evaluate(s,c))&&An(e,f,o)},l);te.set(e,h)},m=()=>{te.has(e)&&(clearTimeout(te.get(e)),te.delete(e)),wn(e,f)},d=()=>u(),a=()=>m(),g=()=>u(),b=()=>m(),v=h=>{h.key==="Escape"&&f.getAttribute("aria-hidden")==="false"&&m()};e.addEventListener("mouseenter",d),e.addEventListener("mouseleave",a),e.addEventListener("focusin",g),e.addEventListener("focusout",b),e.addEventListener("keydown",v),yn(e,()=>{e.removeEventListener("mouseenter",d),e.removeEventListener("mouseleave",a),e.removeEventListener("focusin",g),e.removeEventListener("focusout",b),e.removeEventListener("keydown",v),te.has(e)&&(clearTimeout(te.get(e)),te.delete(e)),f.remove(),Ae.delete(e)})}})}function Tt(t,e={}){St(t)}function Dt(){kt()}var K=new Map;function It(){K.clear()}function $e(){if(typeof document>"u"||document.querySelector("style[data-nojs-popover]"))return;let t=`
.nojs-popover {
  position: fixed;
  z-index: 9998;
  margin: 0;
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-modal",""),e.textContent=t,document.head.appendChild(e)}function Ln(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}var qt='a[href], button:not([disabled]), input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])',Ze=new WeakMap;function jn(t){let e=r=>{if(r.key!=="Tab")return;let i=[...t.querySelectorAll(qt)].filter(l=>l.offsetParent!==null);if(i.length===0){r.preventDefault();return}let n=i[0],o=i[i.length-1];r.shiftKey?document.activeElement===n&&(r.preventDefault(),o.focus()):document.activeElement===o&&(r.preventDefault(),n.focus())};t.addEventListener("keydown",e),Ze.set(t,e)}function Pt(t){let e=Ze.get(t);e&&(t.removeEventListener("keydown",e),Ze.delete(t))}var we=new WeakMap;function Mt(t){t.directive("modal",{priority:10,init(r,i,n){me();let o=n||`nojs-modal-${Date.now()}-${Math.random().toString(36).slice(2,7)}`;r.setAttribute("popover","manual"),r.classList.add("nojs-modal"),r.id=r.id||`nojs-modal-${o}`,r.setAttribute("data-modal-id",o),r.setAttribute("role","dialog"),r.setAttribute("aria-modal","true");let l=r.querySelector("h1, h2, h3, h4, h5, h6");l&&(l.id||(l.id=`nojs-modal-heading-${o}`),r.setAttribute("aria-labelledby",l.id));let s=r.getAttribute("modal-backdrop");s==="false"&&r.setAttribute("data-nojs-no-backdrop","");let c=r.getAttribute("modal-class"),p=r.getAttribute("modal-escape"),f=m=>{m.target===r&&s!=="false"&&p!=="false"&&be(r,o)};r.addEventListener("click",f),ne.set(o,r);let u=m=>{if(m.newState==="open"){if(r.style.zIndex=String(Rt()),c&&c.split(/\s+/).filter(Boolean).forEach(d=>r.classList.add(d)),requestAnimationFrame(()=>{let d=r.querySelector(qt);d?d.focus():r.focus()}),jn(r),p!=="false"){let d=a=>{a.key==="Escape"&&(a.stopPropagation(),be(r,o))};r.addEventListener("keydown",d),we.set(r,d)}}else if(m.newState==="closed"){c&&c.split(/\s+/).filter(Boolean).forEach(g=>r.classList.remove(g)),Pt(r);let d=we.get(r);d&&(r.removeEventListener("keydown",d),we.delete(r));let a=J.findIndex(g=>g.id===o);if(a!==-1){let g=J[a];J.splice(a,1),g.triggerEl&&requestAnimationFrame(()=>{g.triggerEl.focus()})}}};r.addEventListener("toggle",u),Ln(r,()=>{r.removeEventListener("click",f),r.removeEventListener("toggle",u),Pt(r);let m=we.get(r);m&&(r.removeEventListener("keydown",m),we.delete(r)),ne.delete(o);let d=J.findIndex(a=>a.id===o);d!==-1&&J.splice(d,1)})}});let e=r=>e.open(r);e.open=r=>{let i=ne.get(r);if(!i)return!1;J.push({id:r,el:i,triggerEl:null});try{i.showPopover()}catch{return!1}return!0},e.close=r=>{let i=ne.get(r);return i?(be(i,r),!0):!1},e.closeAll=()=>{for(let r=J.length-1;r>=0;r--)be(J[r].el,J[r].id)},t.modal=e}function be(t,e){try{t.hidePopover()}catch{}}function kn(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function zt(t){t.directive("modal-open",{priority:10,init(e,r,i){me();let n=i;if(!n){let u=(e.closest("[use]")||e.parentElement)?.querySelector("[data-modal-id]");if(u&&(n=u.getAttribute("data-modal-id")),!n){console.warn('[modal-open] requires a target modal ID, e.g. modal-open="my-dialog"');return}}e.setAttribute("aria-haspopup","dialog"),e.setAttribute("aria-expanded","false");let o=()=>{let f=ne.get(n)||document.querySelector(`[data-modal-id="${n}"]`);if(!f){console.warn(`[modal-open] modal "${n}" not found`);return}J.push({id:n,el:f,triggerEl:e}),e.setAttribute("aria-expanded","true"),f.id&&e.setAttribute("aria-controls",f.id);try{f.showPopover()}catch{console.warn(`[modal-open] failed to open modal "${n}"`)}},l=()=>{e.setAttribute("aria-expanded","false")},s=null,c=null;requestAnimationFrame(()=>{let f=ne.get(n);f&&(c=f,s=u=>{u.newState==="closed"&&e.setAttribute("aria-expanded","false")},f.addEventListener("toggle",s))}),e.addEventListener("click",o),kn(e,()=>{e.removeEventListener("click",o),c&&s&&c.removeEventListener("toggle",s)})}})}function Cn(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function Ot(t){t.directive("modal-close",{priority:10,init(e,r,i){me();let n=()=>{let o,l;if(i){if(l=i,o=ne.get(l),!o){console.warn(`[modal-close] modal "${l}" not found`);return}}else{if(o=e.closest("[modal]"),!o){console.warn("[modal-close] no parent modal found");return}l=o.getAttribute("modal")}be(o,l)};e.addEventListener("click",n),Cn(e,()=>{e.removeEventListener("click",n)})}})}function Vt(t,e={}){Mt(t),zt(t),Ot(t)}function Wt(){Ht()}var _e={openMenus:new Map};function Gt(){_e.openMenus.clear()}function he(){if(typeof document>"u"||document.querySelector("style[data-nojs-dropdown]"))return;let t=`
.nojs-dropdown-menu {
  position: fixed;
  z-index: 9999;
  margin: 0;
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-dropdown",""),e.textContent=t,document.head.appendChild(e)}function Sn(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function Yt(t,e,r){let i=r.getAttribute("dropdown-position")||"bottom",n=r.getAttribute("dropdown-align")||"start";t.style.top="",t.style.left="";let o=e.getBoundingClientRect(),l=t.getBoundingClientRect(),s=window.innerHeight,c=window.innerWidth,p,f;switch(i){case"top":p=o.top-l.height,f=o.left;break;case"left":p=o.top,f=o.left-l.width;break;case"right":p=o.top,f=o.right;break;default:p=o.bottom,f=o.left}i==="bottom"||i==="top"?n==="end"&&(f=o.right-l.width):n==="end"&&(p=o.bottom-l.height),i==="bottom"&&p+l.height>s&&o.top-l.height>0?p=o.top-l.height:i==="top"&&p<0&&o.bottom+l.height<=s&&(p=o.bottom),f<4&&(f=4),f+l.width>c-4&&(f=c-l.width-4),t.style.top=`${p}px`,t.style.left=`${f}px`}function Ne(t){return[...t.querySelectorAll("[dropdown-item]")].filter(e=>!e.hasAttribute("disabled")&&e.getAttribute("aria-disabled")!=="true")}function Qe(t){let e=Ne(t);e.length&&e[0].focus()}function Ut(t){let e=Ne(t);e.length&&e[e.length-1].focus()}function Kt(t){t.directive("dropdown",{priority:15,init(r){he()}}),t.directive("dropdown-toggle",{priority:15,init(r){he();let i=r.closest("[dropdown]");if(!i)return;let n=i.querySelector("[dropdown-menu]");if(!n)return;r.setAttribute("aria-haspopup","menu"),r.setAttribute("aria-expanded","false"),n.classList.add("nojs-dropdown-menu"),n.setAttribute("role","menu"),n.setAttribute("popover","auto"),n.id||(n.id=`nojs-dd-menu-${Date.now()}-${Math.random().toString(36).slice(2,7)}`),r.setAttribute("aria-controls",n.id);function o(){n.setAttribute("data-open",""),n.showPopover&&n.showPopover(),r.setAttribute("aria-expanded","true"),Yt(n,r,i),_e.openMenus.set(n,{toggle:r,wrapper:i})}function l(){n.removeAttribute("data-open"),r.setAttribute("aria-expanded","false"),_e.openMenus.delete(n)}function s(){return r.getAttribute("aria-expanded")==="true"}let c=g=>{g.newState==="closed"&&s()&&l()};n.addEventListener("toggle",c);let p=g=>{g.preventDefault(),g.stopPropagation(),s()?l():o()};r.addEventListener("click",p);let f=g=>{s()&&!i.contains(g.target)&&l()};document.addEventListener("click",f,!0);let u=g=>{g.key==="Escape"&&s()&&(l(),r.focus())};document.addEventListener("keydown",u);let m=g=>{switch(g.key){case"Enter":case" ":g.preventDefault(),o(),Qe(n);break;case"ArrowDown":g.preventDefault(),o(),Qe(n);break;case"ArrowUp":g.preventDefault(),o(),Ut(n);break}};r.addEventListener("keydown",m);let d=g=>{if(!(!s()||Ne(n).find(h=>h===document.activeElement)))switch(g.key){case"ArrowDown":g.preventDefault(),Qe(n);break;case"ArrowUp":g.preventDefault(),Ut(n);break}};n.addEventListener("keydown",d);let a=()=>{s()&&Yt(n,r,i)};window.addEventListener("scroll",a,!0),window.addEventListener("resize",a),Sn(r,()=>{r.removeEventListener("click",p),r.removeEventListener("keydown",m),n.removeEventListener("keydown",d),n.removeEventListener("toggle",c),document.removeEventListener("click",f,!0),document.removeEventListener("keydown",u),window.removeEventListener("scroll",a,!0),window.removeEventListener("resize",a),_e.openMenus.delete(n)})}}),t.directive("dropdown-menu",{priority:15,init(r){he(),r.hasAttribute("role")||r.setAttribute("role","menu")}});let e=r=>e.open(r);e.open=r=>{let i=document.getElementById(r);if(!i)return!1;let o=i.closest("[dropdown]")?.querySelector("[dropdown-toggle]");return!o||o.getAttribute("aria-expanded")==="true"?!1:(o.click(),!0)},e.close=r=>{let i=document.getElementById(r);if(!i)return!1;let o=i.closest("[dropdown]")?.querySelector("[dropdown-toggle]");return!o||o.getAttribute("aria-expanded")!=="true"?!1:(o.click(),!0)},t.dropdown=e}function Xt(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function Tn(t){return[...t.querySelectorAll("[dropdown-item]")].filter(e=>!e.hasAttribute("disabled")&&e.getAttribute("aria-disabled")!=="true")}function Zt(t){t.directive("dropdown-item",{priority:15,init(e){he();let r=e.closest("[dropdown-menu]"),i=e.closest("[dropdown]");e.setAttribute("role","menuitem"),e.setAttribute("tabindex","-1"),e.classList.add("nojs-dropdown-item"),e.hasAttribute("disabled")&&e.setAttribute("aria-disabled","true");let n=l=>{if(!r)return;let s=Tn(r),c=s.indexOf(e);switch(l.key){case"ArrowDown":{l.preventDefault(),(c+1<s.length?s[c+1]:s[0]).focus();break}case"ArrowUp":{l.preventDefault(),(c-1>=0?s[c-1]:s[s.length-1]).focus();break}case"Home":{l.preventDefault(),s.length&&s[0].focus();break}case"End":{l.preventDefault(),s.length&&s[s.length-1].focus();break}case"Enter":{l.preventDefault(),e.click();break}case"Escape":{if(l.preventDefault(),r)try{r.hidePopover()}catch{}if(i){let p=i.querySelector("[dropdown-toggle]");p&&p.focus()}break}case"Tab":{if(r)try{r.hidePopover()}catch{}break}}};e.addEventListener("keydown",n),Xt(e,()=>e.removeEventListener("keydown",n));let o=()=>{if(r)try{r.hidePopover()}catch{}if(i){let l=i.querySelector("[dropdown-toggle]");l&&l.focus()}};e.addEventListener("click",o),Xt(e,()=>e.removeEventListener("click",o))}})}function Qt(t,e={}){Kt(t),Zt(t)}function Nt(){Gt()}var oe=new Map,ve=new Set,Jt=0;function er(){return++Jt}function tr(){for(let t of ve)clearTimeout(t);ve.clear();for(let t of oe.values())t.remove();oe.clear(),Jt=0}function rr(){if(typeof document>"u"||document.querySelector("style[data-nojs-toast]"))return;let t=`
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-toast",""),e.textContent=t,document.head.appendChild(e)}function Je(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}var Dn=new Set(["top-right","top-left","bottom-right","bottom-left","top-center","bottom-center"]);function et(){return oe.size>0?oe.values().next().value:In("top-right")}function In(t){if(oe.has(t))return oe.get(t);let e=document.createElement("div");return e.classList.add("nojs-toast-container"),e.setAttribute("data-position",t),e.setAttribute("role","log"),e.setAttribute("aria-live","polite"),e.setAttribute("aria-relevant","additions"),document.body.appendChild(e),oe.set(t,e),e}function Bn(t){return t.startsWith("top")}function tt(t,e,r,i,n){let o=er(),l=t.getAttribute("data-position")||"top-right",s=document.createElement("div");s.classList.add("nojs-toast"),s.setAttribute("data-toast-id",o),s.setAttribute("data-type",r),r==="error"&&s.setAttribute("aria-live","assertive");let c=document.createElement("span");if(c.textContent=e,s.appendChild(c),n){let p=document.createElement("button");p.type="button",p.classList.add("nojs-toast-dismiss"),p.setAttribute("aria-label","Dismiss"),p.textContent="\xD7",p.addEventListener("click",()=>Re(s)),s.appendChild(p)}if(Bn(l)&&t.firstChild?t.insertBefore(s,t.firstChild):t.appendChild(s),i>0){let p=setTimeout(()=>{ve.delete(p),Re(s)},i);ve.add(p),s._toastTimerId=p}return s}function Re(t){!t||!t.isConnected||(t._toastTimerId!=null&&(clearTimeout(t._toastTimerId),ve.delete(t._toastTimerId)),t.remove())}function nr(t){rr(),t.directive("toast-container",{priority:10,init(r,i,n){let o=n&&Dn.has(n)?n:"top-right";r.classList.add("nojs-toast-container"),r.setAttribute("data-position",o),r.setAttribute("role","log"),r.setAttribute("aria-live","polite"),r.setAttribute("aria-relevant","additions"),oe.set(o,r),Je(r,()=>{oe.get(o)===r&&oe.delete(o)})}}),t.directive("toast",{priority:10,init(r,i,n){if(!n)return;let o=r.getAttribute("toast-type")||"info",l=parseInt(r.getAttribute("toast-duration"),10)||3e3,s=r.getAttribute("toast-dismiss")!=="false";if(r.tagName==="BUTTON"||r.tagName==="A"||r.hasAttribute("on:click")){let d=()=>{let a=et();tt(a,n,o,l,s)};r.addEventListener("click",d),Je(r,()=>r.removeEventListener("click",d));return}let p=t.findContext(r),f;function u(){let d=t.evaluate(n,p);if(d&&d!==f){let a=typeof d=="string"?d:String(d),g=et();tt(g,a,o,l,s)}f=d}let m=p.$watch(u);Je(r,m)}});let e=(r,i="info",n=3e3)=>{if(typeof document>"u")return;let o=!0,l=et();return tt(l,String(r),i,n,o)};e.dismiss=r=>{let i=document.querySelector(`[data-toast-id="${r}"]`);i&&Re(i)},e.dismissAll=()=>{document.querySelectorAll(".nojs-toast").forEach(r=>Re(r))},t.toast=e}function or(t,e={}){nr(t)}function ir(){tr()}var le={containers:new Map};function sr(){le.containers.clear()}function ar(){if(typeof document>"u"||document.querySelector("style[data-nojs-tabs]"))return;let t=`
.nojs-tabs {
  display: flex;
  flex-direction: column;
  border: 1px solid #E2E8F0;

...
`.trim(),t=document.createElement("style");t.setAttribute("data-nojs-tooltip",""),t.textContent=e,document.head.appendChild(t)}function Ye(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}var N=8;function Xe(e,t,r){let n=t.getBoundingClientRect(),o=e.getBoundingClientRect(),i=window.innerWidth,d=window.innerHeight,s,l;switch(r){case"bottom":s=n.bottom+N,l=n.left+(n.width-o.width)/2;break;case"left":s=n.top+(n.height-o.height)/2,l=n.left-o.width-N;break;case"right":s=n.top+(n.height-o.height)/2,l=n.right+N;break;default:s=n.top-o.height-N,l=n.left+(n.width-o.width)/2;break}l<4&&(l=4),l+o.width>i-4&&(l=i-o.width-4),s<4&&(s=4),s+o.height>d-4&&(s=d-o.height-4),e.style.top=`${s}px`,e.style.left=`${l}px`}var Ze=0;function Ne(e,t,r){document.body.appendChild(t),Xe(t,e,r),t.setAttribute("aria-hidden","false")}function Qe(e,t){t.setAttribute("aria-hidden","true"),t.remove()}function Et(e){e.directive("tooltip",{priority:20,init(t,r,n){At();let o=n;if(!o){console.warn("[tooltip] attribute value (tooltip text) is required.");return}let i=t.getAttribute("tooltip-position")||"top",d=parseInt(t.getAttribute("tooltip-delay"),10)||300,s=t.getAttribute("tooltip-disabled"),l=s?e.findContext(t):null,f=`nojs-tooltip-${++Ze}`,p=document.createElement("div");p.className="nojs-tooltip",p.setAttribute("role","tooltip"),p.setAttribute("id",f),p.setAttribute("aria-hidden","true"),p.textContent=o,t.setAttribute("aria-describedby",f),K.set(t,p);let m=()=>{if(s&&l&&e.evaluate(s,l))return;C.has(t)&&clearTimeout(C.get(t));let y=setTimeout(()=>{C.delete(t),!(s&&l&&e.evaluate(s,l))&&Ne(t,p,i)},d);C.set(t,y)},g=()=>{C.has(t)&&(clearTimeout(C.get(t)),C.delete(t)),Qe(t,p)},c=()=>m(),a=()=>g(),u=()=>m(),h=()=>g(),b=y=>{y.key==="Escape"&&p.getAttribute("aria-hidden")==="false"&&g()};t.addEventListener("mouseenter",c),t.addEventListener("mouseleave",a),t.addEventListener("focusin",u),t.addEventListener("focusout",h),t.addEventListener("keydown",b),Ye(t,()=>{t.removeEventListener("mouseenter",c),t.removeEventListener("mouseleave",a),t.removeEventListener("focusin",u),t.removeEventListener("focusout",h),t.removeEventListener("keydown",b),C.has(t)&&(clearTimeout(C.get(t)),C.delete(t)),p.remove(),K.delete(t)})}})}function _t(e,t={}){Et(e)}function jt(){wt()}var k=new Map;function kt(){k.clear()}function Q(){if(typeof document>"u"||document.querySelector("style[data-nojs-popover]"))return;let e=`
.nojs-popover {
  position: fixed;
  z-index: 9998;
  margin: 0;
...
`.trim(),t=document.createElement("style");t.setAttribute("data-nojs-modal",""),t.textContent=e,document.head.appendChild(t)}function tr(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}var zt='a[href], button:not([disabled]), input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])',pt=new WeakMap;function er(e){let t=r=>{if(r.key!=="Tab")return;let n=[...e.querySelectorAll(zt)].filter(d=>d.offsetParent!==null);if(n.length===0){r.preventDefault();return}let o=n[0],i=n[n.length-1];r.shiftKey?document.activeElement===o&&(r.preventDefault(),i.focus()):document.activeElement===i&&(r.preventDefault(),o.focus())};e.addEventListener("keydown",t),pt.set(e,t)}function It(e){let t=pt.get(e);t&&(e.removeEventListener("keydown",t),pt.delete(e))}var Y=new WeakMap;function Ft(e){e.directive("modal",{priority:10,init(r,n,o){$();let i=o||`nojs-modal-${Date.now()}-${Math.random().toString(36).slice(2,7)}`;r.setAttribute("popover","manual"),r.classList.add("nojs-modal"),r.id=r.id||`nojs-modal-${i}`,r.setAttribute("data-modal-id",i),r.setAttribute("role","dialog"),r.setAttribute("aria-modal","true");let d=r.querySelector("h1, h2, h3, h4, h5, h6");d&&(d.id||(d.id=`nojs-modal-heading-${i}`),r.setAttribute("aria-labelledby",d.id));let s=r.getAttribute("modal-backdrop");s==="false"&&r.setAttribute("data-nojs-no-backdrop","");let l=r.getAttribute("modal-class"),f=r.getAttribute("modal-escape"),p=g=>{g.target===r&&s!=="false"&&f!=="false"&&R(r,i)};r.addEventListener("click",p),D.set(i,r);let m=g=>{if(g.newState==="open"){if(r.style.zIndex=String(Tt()),l&&l.split(/\s+/).filter(Boolean).forEach(c=>r.classList.add(c)),requestAnimationFrame(()=>{let c=r.querySelector(zt);c?c.focus():r.focus()}),er(r),f!=="false"){let c=a=>{a.key==="Escape"&&(a.stopPropagation(),R(r,i))};r.addEventListener("keydown",c),Y.set(r,c)}}else if(g.newState==="closed"){l&&l.split(/\s+/).filter(Boolean).forEach(u=>r.classList.remove(u)),It(r);let c=Y.get(r);c&&(r.removeEventListener("keydown",c),Y.delete(r));let a=L.findIndex(u=>u.id===i);if(a!==-1){let u=L[a];L.splice(a,1),u.triggerEl&&requestAnimationFrame(()=>{u.triggerEl.focus()})}}};r.addEventListener("toggle",m),tr(r,()=>{r.removeEventListener("click",p),r.removeEventListener("toggle",m),It(r);let g=Y.get(r);g&&(r.removeEventListener("keydown",g),Y.delete(r)),D.delete(i);let c=L.findIndex(a=>a.id===i);c!==-1&&L.splice(c,1)})}});let t=r=>t.open(r);t.open=r=>{let n=D.get(r);if(!n)return!1;L.push({id:r,el:n,triggerEl:null});try{n.showPopover()}catch{return!1}return!0},t.close=r=>{let n=D.get(r);return n?(R(n,r),!0):!1},t.closeAll=()=>{for(let r=L.length-1;r>=0;r--)R(L[r].el,L[r].id)},e.modal=t}function R(e,t){try{e.hidePopover()}catch{}}function rr(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}function Pt(e){e.directive("modal-open",{priority:10,init(t,r,n){$();let o=n;if(!o){let m=(t.closest("[use]")||t.parentElement)?.querySelector("[data-modal-id]");if(m&&(o=m.getAttribute("data-modal-id")),!o){console.warn('[modal-open] requires a target modal ID, e.g. modal-open="my-dialog"');return}}t.setAttribute("aria-haspopup","dialog"),t.setAttribute("aria-expanded","false");let i=()=>{let p=D.get(o)||document.querySelector(`[data-modal-id="${o}"]`);if(!p){console.warn(`[modal-open] modal "${o}" not found`);return}L.push({id:o,el:p,triggerEl:t}),t.setAttribute("aria-expanded","true"),p.id&&t.setAttribute("aria-controls",p.id);try{p.showPopover()}catch{console.warn(`[modal-open] failed to open modal "${o}"`)}},d=()=>{t.setAttribute("aria-expanded","false")},s=null,l=null;requestAnimationFrame(()=>{let p=D.get(o);p&&(l=p,s=m=>{m.newState==="closed"&&t.setAttribute("aria-expanded","false")},p.addEventListener("toggle",s))}),t.addEventListener("click",i),rr(t,()=>{t.removeEventListener("click",i),l&&s&&l.removeEventListener("toggle",s)})}})}function or(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}function Mt(e){e.directive("modal-close",{priority:10,init(t,r,n){$();let o=()=>{let i,d;if(n){if(d=n,i=D.get(d),!i){console.warn(`[modal-close] modal "${d}" not found`);return}}else{if(i=t.closest("[modal]"),!i){console.warn("[modal-close] no parent modal found");return}d=i.getAttribute("modal")}R(i,d)};t.addEventListener("click",o),or(t,()=>{t.removeEventListener("click",o)})}})}function qt(e,t={}){Ft(e),Pt(e),Mt(e)}function Bt(){Dt()}var P={openMenus:new Map};function Ht(){P.openMenus.clear()}function O(){if(typeof document>"u"||document.querySelector("style[data-nojs-dropdown]"))return;let e=`
.nojs-dropdown-menu {
  position: fixed;
  z-index: 9999;
  margin: 0;
...
`.trim(),t=document.createElement("style");t.setAttribute("data-nojs-dropdown",""),t.textContent=e,document.head.appendChild(t)}var nr=0;function ir(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}function $t(e,t,r){let n=r.getAttribute("dropdown-position")||"bottom",o=r.getAttribute("dropdown-align")||"start";e.style.top="",e.style.left="";let i=t.getBoundingClientRect(),d=e.getBoundingClientRect(),s=window.innerHeight,l=window.innerWidth,f,p;switch(n){case"top":f=i.top-d.height,p=i.left;break;case"left":f=i.top,p=i.left-d.width;break;case"right":f=i.top,p=i.right;break;default:f=i.bottom,p=i.left}n==="bottom"||n==="top"?o==="end"&&(p=i.right-d.width):o==="end"&&(f=i.bottom-d.height),n==="bottom"&&f+d.height>s&&i.top-d.height>0?f=i.top-d.height:n==="top"&&f<0&&i.bottom+d.height<=s&&(f=i.bottom),p<4&&(p=4),p+d.width>l-4&&(p=l-d.width-4),e.style.top=`${f}px`,e.style.left=`${p}px`}function ft(e){return[...e.querySelectorAll("[dropdown-item]")].filter(t=>!t.hasAttribute("disabled")&&t.getAttribute("aria-disabled")!=="true")}function ut(e){let t=ft(e);t.length&&t[0].focus()}function Rt(e){let t=ft(e);t.length&&t[t.length-1].focus()}function Ot(e){e.directive("dropdown",{priority:15,init(r){O()}}),e.directive("dropdown-toggle",{priority:15,init(r){O();let n=r.closest("[dropdown]");if(!n)return;let o=n.querySelector("[dropdown-menu]");if(!o)return;r.setAttribute("aria-haspopup","menu"),r.setAttribute("aria-expanded","false"),o.classList.add("nojs-dropdown-menu"),o.setAttribute("role","menu"),o.setAttribute("popover","auto"),o.id||(o.id=`nojs-dd-menu-${Date.now()}-${nr++}`),r.setAttribute("aria-controls",o.id);let i=!1,d=typeof o.showPopover=="function"&&typeof o.hidePopover=="function";function s(){if(o.setAttribute("data-open",""),d&&!i)try{o.showPopover(),i=!0}catch{i=!1}r.setAttribute("aria-expanded","true"),$t(o,r,n),P.openMenus.set(o,{toggle:r,wrapper:n})}function l(){if(d&&i){i=!1;try{o.hidePopover()}catch{}}o.removeAttribute("data-open"),r.setAttribute("aria-expanded","false"),P.openMenus.delete(o)}function f(){return r.getAttribute("aria-expanded")==="true"}let p=b=>{b.newState==="closed"&&f()&&l()};o.addEventListener("toggle",p);let m=b=>{b.preventDefault(),b.stopPropagation(),f()?l():s()};r.addEventListener("click",m);let g=b=>{f()&&!n.contains(b.target)&&l()};document.addEventListener("click",g,!0);let c=b=>{b.key==="Escape"&&f()&&(l(),r.focus())};document.addEventListener("keydown",c);let a=b=>{switch(b.key){case"Enter":case" ":b.preventDefault(),s(),ut(o);break;case"ArrowDown":b.preventDefault(),s(),ut(o);break;case"ArrowUp":b.preventDefault(),s(),Rt(o);break}};r.addEventListener("keydown",a);let u=b=>{if(!(!f()||ft(o).find(T=>T===document.activeElement)))switch(b.key){case"ArrowDown":b.preventDefault(),ut(o);break;case"ArrowUp":b.preventDefault(),Rt(o);break}};o.addEventListener("keydown",u);let h=()=>{f()&&$t(o,r,n)};window.addEventListener("scroll",h,!0),window.addEventListener("resize",h),ir(r,()=>{r.removeEventListener("click",m),r.removeEventListener("keydown",a),o.removeEventListener("keydown",u),o.removeEventListener("toggle",p),document.removeEventListener("click",g,!0),document.removeEventListener("keydown",c),window.removeEventListener("scroll",h,!0),window.removeEventListener("resize",h),P.openMenus.delete(o)})}}),e.directive("dropdown-menu",{priority:15,init(r){O(),r.hasAttribute("role")||r.setAttribute("role","menu")}});let t=r=>t.open(r);t.open=r=>{let n=document.getElementById(r);if(!n)return!1;let i=n.closest("[dropdown]")?.querySelector("[dropdown-toggle]");return!i||i.getAttribute("aria-expanded")==="true"?!1:(i.click(),!0)},t.close=r=>{let n=document.getElementById(r);if(!n)return!1;let i=n.closest("[dropdown]")?.querySelector("[dropdown-toggle]");return!i||i.getAttribute("aria-expanded")!=="true"?!1:(i.click(),!0)},e.dropdown=t}function Gt(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}function sr(e){return[...e.querySelectorAll("[dropdown-item]")].filter(t=>!t.hasAttribute("disabled")&&t.getAttribute("aria-disabled")!=="true")}function mt(e,t){if(!e)return;if(typeof e.hidePopover=="function")try{e.hidePopover()}catch{}e.removeAttribute("data-open");let r=t&&t.querySelector("[dropdown-toggle]");r&&r.setAttribute("aria-expanded","false"),P.openMenus.has(e)&&P.openMenus.delete(e)}function Wt(e){e.directive("dropdown-item",{priority:15,init(t){O();let r=t.closest("[dropdown-menu]"),n=t.closest("[dropdown]");t.setAttribute("role","menuitem"),t.setAttribute("tabindex","-1"),t.classList.add("nojs-dropdown-item"),t.hasAttribute("disabled")&&t.setAttribute("aria-disabled","true");let o=d=>{if(!r)return;let s=sr(r),l=s.indexOf(t);switch(d.key){case"ArrowDown":{d.preventDefault(),(l+1<s.length?s[l+1]:s[0]).focus();break}case"ArrowUp":{d.preventDefault(),(l-1>=0?s[l-1]:s[s.length-1]).focus();break}case"Home":{d.preventDefault(),s.length&&s[0].focus();break}case"End":{d.preventDefault(),s.length&&s[s.length-1].focus();break}case"Enter":{d.preventDefault(),t.click();break}case"Escape":{if(d.preventDefault(),mt(r,n),n){let f=n.querySelector("[dropdown-toggle]");f&&f.focus()}break}case"Tab":{mt(r,n);break}}};t.addEventListener("keydown",o),Gt(t,()=>t.removeEventListener("keydown",o));let i=()=>{if(mt(r,n),n){let d=n.querySelector("[dropdown-toggle]");d&&d.focus()}};t.addEventListener("click",i),Gt(t,()=>t.removeEventListener("click",i))}})}function Vt(e,t={}){Ot(e),Wt(e)}function Ut(){Ht()}var I=new Map,G=new Set,Kt=0;function Yt(){return++Kt}function Xt(){for(let e of G)clearTimeout(e);G.clear();for(let e of I.values())e.remove();I.clear(),Kt=0}function Zt(){if(typeof document>"u"||document.querySelector("style[data-nojs-toast]"))return;let e=`
...
`.trim(),t=document.createElement("style");t.setAttribute("data-nojs-toast",""),t.textContent=e,document.head.appendChild(t)}function bt(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}var ar=new Set(["top-right","top-left","bottom-right","bottom-left","top-center","bottom-center"]);function gt(){return I.size>0?I.values().next().value:cr("top-right")}function cr(e){if(I.has(e))return I.get(e);let t=document.createElement("div");return t.classList.add("nojs-toast-container"),t.setAttribute("data-position",e),t.setAttribute("role","log"),t.setAttribute("aria-live","polite"),t.setAttribute("aria-relevant","additions"),document.body.appendChild(t),I.set(e,t),t}function dr(e){return e.startsWith("top")}function ht(e,t,r,n,o){let i=Yt(),d=e.getAttribute("data-position")||"top-right",s=document.createElement("div");s.classList.add("nojs-toast"),s.setAttribute("data-toast-id",i),s.setAttribute("data-type",r),r==="error"&&s.setAttribute("aria-live","assertive");let l=document.createElement("span");if(l.textContent=t,s.appendChild(l),o){let f=document.createElement("button");f.type="button",f.classList.add("nojs-toast-dismiss"),f.setAttribute("aria-label","Dismiss"),f.textContent="\xD7",f.addEventListener("click",()=>J(s)),s.appendChild(f)}if(dr(d)&&e.firstChild?e.insertBefore(s,e.firstChild):e.appendChild(s),n>0){let f=setTimeout(()=>{G.delete(f),J(s)},n);G.add(f),s._toastTimerId=f}return s}function J(e){!e||!e.isConnected||(e._toastTimerId!=null&&(clearTimeout(e._toastTimerId),G.delete(e._toastTimerId)),e.remove())}function Nt(e){Zt(),e.directive("toast-container",{priority:10,init(r,n,o){let i=o&&ar.has(o)?o:"top-right";r.classList.add("nojs-toast-container"),r.setAttribute("data-position",i),r.setAttribute("role","log"),r.setAttribute("aria-live","polite"),r.setAttribute("aria-relevant","additions"),I.set(i,r),bt(r,()=>{I.get(i)===r&&I.delete(i)})}}),e.directive("toast",{priority:10,init(r,n,o){if(!o)return;let i=r.getAttribute("toast-type")||"info",d=parseInt(r.getAttribute("toast-duration"),10)||3e3,s=r.getAttribute("toast-dismiss")!=="false";if(r.tagName==="BUTTON"||r.tagName==="A"||r.hasAttribute("on:click")){let c=()=>{let a=gt();ht(a,o,i,d,s)};r.addEventListener("click",c),bt(r,()=>r.removeEventListener("click",c));return}let f=e.findContext(r),p;function m(){let c=e.evaluate(o,f);if(c&&c!==p){let a=typeof c=="string"?c:String(c),u=gt();ht(u,a,i,d,s)}p=c}let g=f.$watch(m);bt(r,g)}});let t=(r,n="info",o=3e3)=>{if(typeof document>"u")return;let i=!0,d=gt();return ht(d,String(r),n,o,i)};t.dismiss=r=>{let n=document.querySelector(`[data-toast-id="${r}"]`);n&&J(n)},t.dismissAll=()=>{document.querySelectorAll(".nojs-toast").forEach(r=>J(r))},e.toast=t}function Qt(e,t={}){Nt(e)}function Jt(){Xt()}var M={containers:new Map};function te(){M.containers.clear()}function ee(){if(typeof document>"u"||document.querySelector("style[data-nojs-tabs]"))return;let e=`
.nojs-tabs {
  display: flex;
  flex-direction: column;
  border: 1px solid #E2E8F0;
...
`.trim(),t=document.createElement("style");t.setAttribute("data-nojs-table",""),t.textContent=e,document.head.appendChild(t)}function wr(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}function Ar(e,t){let r=e.querySelector("tbody");if(!r)return null;let n=null;if(r.hasAttribute("each")||r.hasAttribute("foreach")?n=r:n=r.querySelector("[each]")||r.querySelector("[foreach]"),!n)return null;let o=n.getAttribute("each")||n.getAttribute("foreach");if(!o)return null;let i=o.match(/^\s*(\w+)\s+(?:in|of)\s+(.+)\s*$/);return i?{iteratorVar:i[1],arrayPath:i[2].trim()}:null}function Er(e,t){let r=t.split("."),n=e;for(let o of r){if(n==null)return;n=n[o]}return n}function Ie(e,t,r){let n=t.split("."),o=e;for(let i=0;i<n.length-1;i++){if(o[n[i]]==null)return;o=o[n[i]]}o[n[n.length-1]]=r}function Fe(e,t,r){if(e==null&&t==null)return 0;if(e==null)return-1;if(t==null)return 1;switch(r){case"number":return Number(e)-Number(t);case"date":return new Date(e).getTime()-new Date(t).getTime();default:return String(e).localeCompare(String(t))}}function _r(e){let t=e.querySelectorAll("th[data-sortable]");for(let r of t)r.removeAttribute("data-sort-dir"),r.setAttribute("aria-sort","none")}function Pe(e){e.directive("sortable",{priority:10,init(t){Z(),t.classList.add("nojs-sortable")}})}function Me(e){e.directive("sort",{priority:11,init(t,r,n){Z();let o=n;if(!o)return;let i=t.getAttribute("sort-type")||"string",d=t.getAttribute("sort-default");t.setAttribute("data-sortable",""),t.setAttribute("aria-sort","none");let s=t.closest("table");if(!s)return;W.sorts.has(s)||W.sorts.set(s,{column:null,direction:null}),(d==="asc"||d==="desc")&&ze(t,s,o,i,d,e);let l=()=>{let f=W.sorts.get(s),p;f.column!==o?p="asc":f.direction==="asc"?p="desc":f.direction==="desc"?p=null:p="asc",ze(t,s,o,i,p,e)};t.addEventListener("click",l),wr(t,()=>{t.removeEventListener("click",l),s&&s._nojsOriginalOrder&&delete s._nojsOriginalOrder})}})}function ze(e,t,r,n,o,i){let d=W.sorts.get(t);_r(t),o?(e.setAttribute("data-sort-dir",o),e.setAttribute("aria-sort",o==="asc"?"ascending":"descending"),d.column=r,d.direction=o):(d.column=null,d.direction=null);let s=Ar(t,i);if(s){let l=i.findContext(t),f=l?Er(l,s.arrayPath):null;if(Array.isArray(f)){if(!o){let m=t._nojsOriginalOrder;if(m){let g=new Set(f),c=m.filter(a=>g.has(a));for(let a of f)m.includes(a)||c.push(a);Ie(l,s.arrayPath,c)}return}t._nojsOriginalOrder||(t._nojsOriginalOrder=[...f]);let p=[...f].sort((m,g)=>{let c=m!=null?m[r]:null,a=g!=null?g[r]:null,u=Fe(c,a,n);return o==="desc"?-u:u});Ie(l,s.arrayPath,p);return}}jr(t,e,r,n,o)}function jr(e,t,r,n,o){let i=e.querySelector("tbody");if(!i)return;let l=[...t.closest("tr").children].indexOf(t);if(l<0)return;let f=[...i.querySelectorAll(":scope > tr")];if(e._nojsOriginalRows||(e._nojsOriginalRows=[...f]),!o){let m=document.createDocumentFragment();for(let g of e._nojsOriginalRows)m.appendChild(g);i.appendChild(m);return}f.sort((m,g)=>{let c=m.children[l]?.textContent?.trim()||"",a=g.children[l]?.textContent?.trim()||"",u=Fe(n==="number"?parseFloat(c.replace(/[^0-9.\-]/g,""))||0:c,n==="number"?parseFloat(a.replace(/[^0-9.\-]/g,""))||0:a,n);return o==="desc"?-u:u});let p=document.createDocumentFragment();for(let m of f)p.appendChild(m);i.appendChild(p)}function qe(e){e.directive("fixed-header",{priority:10,init(t){Z(),t.classList.add("nojs-fixed-header")}})}function Be(e){e.directive("fixed-col",{priority:10,init(t){Z(),t.classList.add("nojs-fixed-col")}})}function He(e,t={}){Pe(e),Me(e),qe(e),Be(e)}function $e(){De()}var kr=["tooltip","popover","popover-trigger","popover-dismiss","modal","modal-open","modal-close","dropdown","dropdown-toggle","dropdown-menu","dropdown-item","toast","toast-container","tabs","tab","tab-disabled","tab-position","tree","branch","subtree","stepper","step","skeleton","split","pane","panel","sortable","sort","fixed-header","fixed-col"],Sr={name:"nojs-elements",install(e,t={}){_t(e,t),Lt(e,t),qt(e,t),Vt(e,t),Qt(e,t),se(e,t),me(e,t),ye(e,t),_e(e,t),Ce(e,t),He(e,t)},init(e){if(typeof document>"u"||!document.body)return;let t=kr.map(n=>`[${n}]`).join(","),r;try{r=document.body.querySelectorAll(t)}catch{return}for(let n of r)n.__declared&&!n.__disposers&&!n.__ctx&&(n.__declared=!1);try{e.processTree(document.body)}catch(n){e.internals?.warn?.("nojs-elements init re-process error:",n.message)}},dispose(e){jt(),Ct(),Bt(),Ut(),Jt(),ae(),be(),xe(),Te(),$e()}},Lr=Sr;

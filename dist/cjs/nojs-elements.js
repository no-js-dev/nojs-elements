 ...
 */
var mt=Object.defineProperty;var bo=Object.getOwnPropertyDescriptor;var ho=Object.getOwnPropertyNames;var vo=Object.prototype.hasOwnProperty;var yo=(t,e)=>{for(var r in e)mt(t,r,{get:e[r],enumerable:!0})},xo=(t,e,r,o)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of ho(e))!vo.call(t,n)&&n!==r&&mt(t,n,{get:()=>e[n],enumerable:!(o=bo(e,n))||o.enumerable});return t};var Eo=t=>xo(mt({},"__esModule",{value:!0}),t);var Ki={};yo(Ki,{default:()=>Yi});module.exports=Eo(Ki);var x={dragging:null,selected:new Map,placeholder:null},Ne=new Map;function qt(){x.dragging=null,x.selected.clear(),x.placeholder&&(x.placeholder.remove(),x.placeholder=null),Ne.clear()}function We(){if(typeof document>"u"||document.querySelector("style[data-nojs-dnd]"))return;let t=`
.nojs-dragging {
  opacity: 0.5;
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-tooltip",""),e.textContent=t,document.head.appendChild(e)}function Bo(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}var Ze=8;function nr(t,e,r){let o=e.getBoundingClientRect(),n=t.getBoundingClientRect(),i=window.innerWidth,c=window.innerHeight,s,a;switch(r){case"bottom":s=o.bottom+Ze,a=o.left+(o.width-n.width)/2;break;case"left":s=o.top+(o.height-n.height)/2,a=o.left-n.width-Ze;break;case"right":s=o.top+(o.height-n.height)/2,a=o.right+Ze;break;default:s=o.top-n.height-Ze,a=o.left+(o.width-n.width)/2;break}a<4&&(a=4),a+n.width>i-4&&(a=i-n.width-4),s<4&&(s=4),s+n.height>c-4&&(s=c-n.height-4),t.style.top=`${s}px`,t.style.left=`${a}px`}var Ho=0;function $o(t,e,r){document.body.appendChild(e),nr(e,t,r),e.setAttribute("aria-hidden","false")}function rr(t,e){e.setAttribute("aria-hidden","true"),e.remove()}function qo(t,e){t&&typeof t._warn=="function"?t._warn(e):console.warn(e)}function or(t){t.directive("tooltip",{priority:20,init(e,r,o){tr();let n=o;if(!n){qo(t,"[tooltip] attribute value (tooltip text) is required.");return}let i=e.getAttribute("tooltip-position")||"top",c=parseInt(e.getAttribute("tooltip-delay"),10),s=Number.isNaN(c)?300:c,a=e.getAttribute("tooltip-disabled"),d=a?t.findContext(e):null,m=()=>{if(!a||!d)return!1;try{return!!t.evaluate(a,d)}catch{return!1}},p=`nojs-tooltip-${++Ho}`,f=document.createElement("div");f.className="nojs-tooltip",f.setAttribute("role","tooltip"),f.setAttribute("id",p),f.setAttribute("aria-hidden","true"),f.textContent=n,e.setAttribute("aria-describedby",p),je.set(e,f);let l=!1,u=0,v=()=>{!l||!e.isConnected||u||(u=requestAnimationFrame(()=>{u=0,!(!l||!e.isConnected)&&nr(f,e,i)}))},y=()=>{window.addEventListener("scroll",v,!0),window.addEventListener("resize",v)},g=()=>{window.removeEventListener("scroll",v,!0),window.removeEventListener("resize",v),u&&(cancelAnimationFrame(u),u=0)},b=()=>{l||($o(e,f,i),l=!0,y())},E=()=>{if(!l){rr(e,f);return}g(),rr(e,f),l=!1},h=()=>{if(m())return;ee.has(e)&&clearTimeout(ee.get(e));let $=setTimeout(()=>{ee.delete(e),!m()&&e.isConnected&&b()},s);ee.set(e,$)},_=()=>{ee.has(e)&&(clearTimeout(ee.get(e)),ee.delete(e)),E()},A=()=>h(),j=()=>_(),k=()=>h(),L=()=>_(),S=$=>{$.key==="Escape"&&f.getAttribute("aria-hidden")==="false"&&_()};e.addEventListener("mouseenter",A),e.addEventListener("mouseleave",j),e.addEventListener("focusin",k),e.addEventListener("focusout",L),e.addEventListener("keydown",S);let w=null;if(a&&d&&typeof d.$watch=="function"){let $=()=>{l&&m()&&E()};w=d.$watch($)}Bo(e,()=>{e.removeEventListener("mouseenter",A),e.removeEventListener("mouseleave",j),e.removeEventListener("focusin",k),e.removeEventListener("focusout",L),e.removeEventListener("keydown",S),w&&(w(),w=null),g(),ee.has(e)&&(clearTimeout(ee.get(e)),ee.delete(e)),l=!1,f.remove(),je.delete(e)})}})}function ir(t,e={}){or(t)}function sr(){er()}var Y=new Map;function ar(){Y.clear()}function Qe(){if(typeof document>"u"||document.querySelector("style[data-nojs-popover]"))return;let t=`
.nojs-popover {
  position: fixed;
  z-index: 9998;
  margin: 0;
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-dropdown",""),e.textContent=t,document.head.appendChild(e)}var Oo=0;function Vo(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function No(){O.installed||(O.outsideClickHandler=t=>{let e=[...te.openMenus.entries()];for(let[r,{toggle:o,wrapper:n}]of e)if(!n.contains(t.target)){if(r.removeAttribute("data-open"),o.setAttribute("aria-expanded","false"),typeof r.hidePopover=="function")try{r.hidePopover()}catch{}te.openMenus.delete(r)}},O.escHandler=t=>{if(t.key!=="Escape")return;let e=[...te.openMenus.entries()];for(let[r,{toggle:o}]of e){if(r.removeAttribute("data-open"),o.setAttribute("aria-expanded","false"),typeof r.hidePopover=="function")try{r.hidePopover()}catch{}o.focus()}te.openMenus.clear()},document.addEventListener("click",O.outsideClickHandler,!0),document.addEventListener("keydown",O.escHandler),O.installed=!0)}function wt(){O.installed&&(document.removeEventListener("click",O.outsideClickHandler,!0),document.removeEventListener("keydown",O.escHandler),O.outsideClickHandler=null,O.escHandler=null,O.installed=!1)}function _r(t,e,r){let o=r.getAttribute("dropdown-position")||"bottom",n=r.getAttribute("dropdown-align")||"start";t.style.top="",t.style.left="";let i=e.getBoundingClientRect(),c=t.getBoundingClientRect(),s=window.innerHeight,a=window.innerWidth,d,m;switch(o){case"top":d=i.top-c.height,m=i.left;break;case"left":d=i.top,m=i.left-c.width;break;case"right":d=i.top,m=i.right;break;default:d=i.bottom,m=i.left}o==="bottom"||o==="top"?n==="end"&&(m=i.right-c.width):n==="end"&&(d=i.bottom-c.height),o==="bottom"&&d+c.height>s&&i.top-c.height>0?d=i.top-c.height:o==="top"&&d<0&&i.bottom+c.height<=s&&(d=i.bottom),m<4&&(m=4),m+c.width>a-4&&(m=a-c.width-4),t.style.top=`${d}px`,t.style.left=`${m}px`}function At(t){return[...t.querySelectorAll("[dropdown-item]")].filter(e=>!e.hasAttribute("disabled")&&e.getAttribute("aria-disabled")!=="true")}function _t(t){let e=At(t);e.length&&e[0].focus()}function wr(t){let e=At(t);e.length&&e[e.length-1].focus()}function Ar(t){t.directive("dropdown",{priority:15,init(r){Se()}}),t.directive("dropdown-toggle",{priority:15,init(r){Se();let o=r.closest("[dropdown]");if(!o)return;let n=o.querySelector("[dropdown-menu]");if(!n)return;r.setAttribute("aria-haspopup","menu"),r.setAttribute("aria-expanded","false"),n.classList.add("nojs-dropdown-menu"),n.setAttribute("role","menu"),n.setAttribute("popover","auto"),n.id||(n.id=`nojs-dd-menu-${Date.now()}-${Oo++}`),r.setAttribute("aria-controls",n.id);let i=!1,c=typeof n.showPopover=="function"&&typeof n.hidePopover=="function";function s(){if(n.setAttribute("data-open",""),c&&!i)try{n.showPopover(),i=!0}catch{i=!1}r.setAttribute("aria-expanded","true"),_r(n,r,o),te.openMenus.set(n,{toggle:r,wrapper:o})}function a(){if(c&&i){i=!1;try{n.hidePopover()}catch{}}n.removeAttribute("data-open"),r.setAttribute("aria-expanded","false"),te.openMenus.delete(n)}function d(){return r.getAttribute("aria-expanded")==="true"}let m=v=>{v.newState==="closed"&&d()&&a()};n.addEventListener("toggle",m);let p=v=>{v.preventDefault(),v.stopPropagation(),d()?a():s()};r.addEventListener("click",p),O.instanceCount++,No();let f=v=>{switch(v.key){case"Enter":case" ":v.preventDefault(),s(),_t(n);break;case"ArrowDown":v.preventDefault(),s(),_t(n);break;case"ArrowUp":v.preventDefault(),s(),wr(n);break}};r.addEventListener("keydown",f);let l=v=>{if(!(!d()||At(n).find(b=>b===document.activeElement)))switch(v.key){case"ArrowDown":v.preventDefault(),_t(n);break;case"ArrowUp":v.preventDefault(),wr(n);break}};n.addEventListener("keydown",l);let u=()=>{d()&&_r(n,r,o)};window.addEventListener("scroll",u,!0),window.addEventListener("resize",u),Vo(r,()=>{r.removeEventListener("click",p),r.removeEventListener("keydown",f),n.removeEventListener("keydown",l),n.removeEventListener("toggle",m),window.removeEventListener("scroll",u,!0),window.removeEventListener("resize",u),te.openMenus.delete(n),O.instanceCount--,O.instanceCount<=0&&(O.instanceCount=0,wt())})}}),t.directive("dropdown-menu",{priority:15,init(r){Se(),r.hasAttribute("role")||r.setAttribute("role","menu")}});let e=r=>e.open(r);e.open=r=>{let o=document.getElementById(r);if(!o)return!1;let i=o.closest("[dropdown]")?.querySelector("[dropdown-toggle]");return!i||i.getAttribute("aria-expanded")==="true"?!1:(i.click(),!0)},e.close=r=>{let o=document.getElementById(r);if(!o)return!1;let i=o.closest("[dropdown]")?.querySelector("[dropdown-toggle]");return!i||i.getAttribute("aria-expanded")!=="true"?!1:(i.click(),!0)},t.dropdown=e}function jr(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function Wo(t){return[...t.querySelectorAll("[dropdown-item]")].filter(e=>!e.hasAttribute("disabled")&&e.getAttribute("aria-disabled")!=="true")}function jt(t,e){if(!t)return;if(typeof t.hidePopover=="function")try{t.hidePopover()}catch{}t.removeAttribute("data-open");let r=e&&e.querySelector("[dropdown-toggle]");r&&r.setAttribute("aria-expanded","false"),te.openMenus.has(t)&&te.openMenus.delete(t)}function Lr(t){t.directive("dropdown-item",{priority:15,init(e){Se();let r=e.closest("[dropdown-menu]"),o=e.closest("[dropdown]");e.setAttribute("role","menuitem"),e.setAttribute("tabindex","-1"),e.classList.add("nojs-dropdown-item"),e.hasAttribute("disabled")&&e.setAttribute("aria-disabled","true");let n=c=>{if(!r)return;let s=Wo(r),a=s.indexOf(e);switch(c.key){case"ArrowDown":{c.preventDefault(),(a+1<s.length?s[a+1]:s[0]).focus();break}case"ArrowUp":{c.preventDefault(),(a-1>=0?s[a-1]:s[s.length-1]).focus();break}case"Home":{c.preventDefault(),s.length&&s[0].focus();break}case"End":{c.preventDefault(),s.length&&s[s.length-1].focus();break}case"Enter":{c.preventDefault(),e.click();break}case"Escape":{if(c.preventDefault(),jt(r,o),o){let d=o.querySelector("[dropdown-toggle]");d&&d.focus()}break}case"Tab":{jt(r,o);break}}};e.addEventListener("keydown",n),jr(e,()=>e.removeEventListener("keydown",n));let i=()=>{if(jt(r,o),o){let c=o.querySelector("[dropdown-toggle]");c&&c.focus()}};e.addEventListener("click",i),jr(e,()=>e.removeEventListener("click",i))}})}function kr(t,e={}){Ar(t),Lr(t)}function Cr(){wt(),Er()}var se=new Map,Te=new Set,Sr=0;function Tr(){return++Sr}function Dr(){for(let t of Te)clearTimeout(t);Te.clear();for(let t of se.values())t.remove();se.clear(),Sr=0}function Ir(){if(typeof document>"u"||document.querySelector("style[data-nojs-toast]"))return;let t=`
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-toast",""),e.textContent=t,document.head.appendChild(e)}function Lt(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}var Go=new Set(["top-right","top-left","bottom-right","bottom-left","top-center","bottom-center"]);function kt(){return se.size>0?se.values().next().value:Uo("top-right")}function Uo(t){if(se.has(t))return se.get(t);let e=document.createElement("div");return e.classList.add("nojs-toast-container"),e.setAttribute("data-position",t),e.setAttribute("role","log"),e.setAttribute("aria-live","polite"),e.setAttribute("aria-relevant","additions"),document.body.appendChild(e),se.set(t,e),e}function Yo(t){return t.startsWith("top")}function Ct(t,e,r,o,n){let i=Tr(),c=t.getAttribute("data-position")||"top-right",s=document.createElement("div");s.classList.add("nojs-toast"),s.setAttribute("data-toast-id",i),s.setAttribute("data-type",r),r==="error"&&s.setAttribute("aria-live","assertive");let a=document.createElement("span");if(a.textContent=e,s.appendChild(a),n){let d=document.createElement("button");d.type="button",d.classList.add("nojs-toast-dismiss"),d.setAttribute("aria-label","Dismiss"),d.textContent="\xD7",d.addEventListener("click",()=>et(s)),s.appendChild(d)}if(Yo(c)&&t.firstChild?t.insertBefore(s,t.firstChild):t.appendChild(s),o>0){let d=setTimeout(()=>{Te.delete(d),s.isConnected&&et(s)},o);Te.add(d),s._toastTimerId=d}return s}function et(t){!t||!t.isConnected||(t._toastTimerId!=null&&(clearTimeout(t._toastTimerId),Te.delete(t._toastTimerId)),t.remove())}function Br(t){Ir(),t.directive("toast-container",{priority:10,init(r,o,n){let i=n&&Go.has(n)?n:"top-right";r.classList.add("nojs-toast-container"),r.setAttribute("data-position",i),r.setAttribute("role","log"),r.setAttribute("aria-live","polite"),r.setAttribute("aria-relevant","additions"),se.set(i,r),Lt(r,()=>{se.get(i)===r&&se.delete(i)})}}),t.directive("toast",{priority:10,init(r,o,n){if(!n)return;let i=r.getAttribute("toast-type")||"info",c=parseInt(r.getAttribute("toast-duration"),10),s=Number.isNaN(c)?3e3:c,a=r.getAttribute("toast-dismiss")!=="false";if(r.tagName==="BUTTON"||r.tagName==="A"||r.hasAttribute("on:click")){let u=()=>{let v=kt();Ct(v,n,i,s,a)};r.addEventListener("click",u),Lt(r,()=>r.removeEventListener("click",u));return}let m=t.findContext(r);if(!m||typeof m.$watch!="function"){console.warn("[toast] reactive toast requires a parent [state] or [use] context \u2014 element will be inert");return}let p;function f(){let u=t.evaluate(n,m);if(u&&u!==p){let v=typeof u=="string"?u:String(u),y=kt();Ct(y,v,i,s,a),p=u}else p=u}let l=m.$watch(f);Lt(r,l)}});let e=(r,o="info",n=3e3)=>{if(typeof document>"u")return;let i=!0,c=kt();return Ct(c,String(r),o,n,i)};e.dismiss=r=>{let o=typeof CSS<"u"&&CSS.escape?CSS.escape(String(r)):String(r).replace(/["\\\]]/g,"\\$&"),n=document.querySelector(`[data-toast-id="${o}"]`);n&&et(n)},e.dismissAll=()=>{document.querySelectorAll(".nojs-toast").forEach(r=>et(r))},t.toast=e,t.global("toast",e)}function Hr(t,e={}){Br(t)}function $r(){Dr()}var Ee={containers:new Map};function qr(){Ee.containers.clear()}function Mr(){if(typeof document>"u"||document.querySelector("style[data-nojs-tabs]"))return;let t=`
.nojs-tabs {
  display: flex;
  flex-direction: column;
  border: 1px solid #E2E8F0;
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-breadcrumb",""),e.textContent=t,document.head.appendChild(e)}function Fn(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function Ei(t){let e=t.getAttribute("breadcrumb");if(e&&e.trim()!=="")return e.trim();let r=t.getAttribute("title");return r&&r.trim()!==""?r.trim():(t.textContent||"").trim()}function _i(t){return t&&t.charAt(0).toUpperCase()+t.slice(1)}function zn(t,e){let r=t.querySelector("ol.nojs-breadcrumb");r&&r.remove();let o=document.createElement("ol");o.classList.add("nojs-breadcrumb");for(let i=0;i<e.length;i++){let c=e[i],s=document.createElement("li");if(i===e.length-1){let d=document.createElement("span");d.setAttribute("aria-current","page"),d.textContent=c.label,s.appendChild(d)}else{let d=document.createElement("a");d.href=c.href,d.textContent=c.label,s.appendChild(d)}o.appendChild(s)}t.appendChild(o);let n=me.containers.get(t);n&&(n.crumbs=e)}function wi(t){let e=[],r=Array.from(t.children);for(let o of r){if(o.tagName==="OL"&&o.classList.contains("nojs-breadcrumb"))continue;let n=Ei(o);if(!n)continue;let i=o.getAttribute("href")||"#";e.push({label:n,href:i})}return e}function Ai(t){if(!t||t==="/")return[{label:"Home",href:"/",isLast:!0}];let r=(t.replace(/\/+$/,"")||"/").split("/").filter(Boolean),o=[{label:"Home",href:"/"}],n="";for(let i=0;i<r.length;i++){n+="/"+r[i];let c=_i(r[i].replace(/[-_]/g," "));o.push({label:c,href:n})}return o}function On(t){t.directive("breadcrumb",{priority:15,init(e,r,o){Rn(),e.tagName==="NAV"&&!e.getAttribute("aria-label")&&e.setAttribute("aria-label","Breadcrumb");let n=Array.from(e.children).some(s=>!(s.tagName==="OL"&&s.classList.contains("nojs-breadcrumb"))),i=t.router,c=!n&&i;if(me.containers.set(e,{unsub:null,crumbs:[]}),c){let s=()=>{let a=i.current,d=a?a.path:"/",m=Ai(d);zn(e,m)};if(s(),typeof i.on=="function"){let a=i.on(s),d=me.containers.get(e);d&&(d.unsub=a),Fn(e,()=>{typeof a=="function"&&a();let m=me.containers.get(e);m&&(m.unsub=null)})}}else{let s=wi(e);for(let a of Array.from(e.children))a.tagName==="OL"&&a.classList.contains("nojs-breadcrumb")||(a.style.display="none");zn(e,s)}Fn(e,()=>{me.containers.delete(e)})}})}function Vn(t,e={}){On(t)}function Nn(){Pn()}var it={containers:new Map};function Wn(){it.containers.clear()}function Gn(){if(typeof document>"u"||document.querySelector("style[data-nojs-accordion]"))return;let t=`
[accordion] {
  display: flex;
  flex-direction: column;
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-accordion",""),e.textContent=t,document.head.appendChild(e)}function ji(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}var st=null;function Li(){return st!==null||(st=typeof CSS<"u"&&typeof CSS.supports=="function"&&CSS.supports("interpolate-size","allow-keywords")),st}function Un(t){let e=t.querySelector(":scope > summary");if(!e)return null;let r=t.querySelector(":scope > .nojs-accordion-content");if(r)return r;r=document.createElement("div"),r.classList.add("nojs-accordion-content");let o=Array.from(t.children),n=!1;for(let i of o){if(i===e){n=!0;continue}n&&r.appendChild(i)}return t.appendChild(r),r}function ki(t,e){if(!e)return;let r=e.scrollHeight;e.style.height="0px",t.open=!0,requestAnimationFrame(()=>{e.style.height=r+"px";let o=()=>{e.style.height="",e.removeEventListener("transitionend",o)};e.addEventListener("transitionend",o)})}function Kn(t,e){if(!e){t.open=!1;return}let r=e.scrollHeight;e.style.height=r+"px",requestAnimationFrame(()=>{e.style.height="0px";let o=()=>{t.open=!1,e.style.height="",e.removeEventListener("transitionend",o)};e.addEventListener("transitionend",o)})}function Yn(t,e){if(t.open)if(e){let r=t.querySelector(":scope > .nojs-accordion-content");Kn(t,r)}else t.open=!1}function at(t,e,r,o){let n=new CustomEvent("nojs:accordion-change",{bubbles:!0,detail:{element:e,open:r,index:o}});t.dispatchEvent(n)}function He(t){let e=[];for(let r of t.children)r.tagName==="DETAILS"&&e.push(r);return e}function Xn(t){t.directive("accordion",{priority:10,init(e,r,o){Gn();let n=(o||"").trim().toLowerCase()==="multi"?"multi":"single",i=!Li();e.setAttribute("role","group");let c=He(e);if(c.length===0)return;if(i)for(let f of c)Un(f);let s=[],a=new MutationObserver(f=>{for(let l of f)for(let u of l.addedNodes)u.nodeType!==1||u.tagName!=="DETAILS"||u.parentElement===e&&m(u)});a.observe(e,{childList:!0});let d=0,m=f=>{i&&Un(f);let l=f.querySelector(":scope > summary");if(l){let y=`nojs-accordion-panel-${Date.now()}-${d++}`,g=f.querySelector(":scope > .nojs-accordion-content");g?(g.id=g.id||y,g.setAttribute("role","region"),y=g.id):(f.id||(f.id=y),y=f.id),l.setAttribute("aria-expanded",f.open?"true":"false"),l.setAttribute("aria-controls",y)}let u=y=>{let g=He(e),b=g.indexOf(f),E=f.querySelector(":scope > summary");if(E&&E.setAttribute("aria-expanded",f.open?"true":"false"),f.open){if(n==="single")for(let h of g)h!==f&&h.open&&Yn(h,i);at(e,f,!0,b)}else at(e,f,!1,b)},v=null;if(i){let y=f.querySelector(":scope > summary");y&&(v=g=>{g.preventDefault();let b=f.querySelector(":scope > .nojs-accordion-content");if(f.open)Kn(f,b),y.setAttribute("aria-expanded","false"),at(e,f,!1,He(e).indexOf(f));else{if(n==="single"){let E=He(e);for(let h of E)if(h!==f&&h.open){Yn(h,!0);let _=h.querySelector(":scope > summary");_&&_.setAttribute("aria-expanded","false")}}ki(f,b),y.setAttribute("aria-expanded","true"),at(e,f,!0,He(e).indexOf(f))}},y.addEventListener("click",v))}f.addEventListener("toggle",u),s.push({details:f,toggleHandler:u,clickHandler:v})};for(let f of c)m(f);let p=f=>{let l=f.target;if(l.tagName!=="SUMMARY")return;let u=l.parentElement;if(!u||u.parentElement!==e)return;let y=He(e).map(E=>E.querySelector(":scope > summary")).filter(Boolean),g=y.indexOf(l);if(g===-1)return;let b=-1;switch(f.key){case"ArrowDown":case"ArrowRight":b=(g+1)%y.length;break;case"ArrowUp":case"ArrowLeft":b=(g-1+y.length)%y.length;break;case"Home":b=0;break;case"End":b=y.length-1;break;default:return}b!==-1&&b!==g&&(f.preventDefault(),y[b].focus())};e.addEventListener("keydown",p),it.containers.set(e,{mode:n,listeners:s,observer:a}),ji(e,()=>{e.removeEventListener("keydown",p),a.disconnect();for(let f of s)if(f.details.removeEventListener("toggle",f.toggleHandler),f.clickHandler){let l=f.details.querySelector(":scope > summary");l&&l.removeEventListener("click",f.clickHandler)}s.length=0,it.containers.delete(e)})}})}function Zn(t,e={}){Xn(t)}function Qn(){Wn()}var $e=new Map;function Jn(){let t=Array.from($e.keys());for(let e of t){let r=$e.get(e);if(r){if(r.resizeObserver){try{r.resizeObserver.disconnect()}catch{}r.resizeObserver=null}if(r.scrollHandler){try{e.removeEventListener("scroll",r.scrollHandler)}catch{}r.scrollHandler=null}if(r.spacerTop&&r.spacerTop.parentNode&&r.spacerTop.remove(),r.spacerBottom&&r.spacerBottom.parentNode&&r.spacerBottom.remove(),r.renderedNodes){for(let[o,n]of r.renderedNodes){if(n.__disposers){for(let i of n.__disposers)try{i()}catch{}n.__disposers=null}n.parentNode&&n.remove()}r.renderedNodes.clear()}r.disposed=!0}}$e.clear()}function eo(){if(typeof document>"u"||document.querySelector("style[data-nojs-virtual-list]"))return;let t=`
[data-nojs-virtual] {
  overflow-y: auto;
  position: relative;

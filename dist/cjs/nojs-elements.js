 ...
 */
var Ne=Object.defineProperty;var Cn=Object.getOwnPropertyDescriptor;var Sn=Object.getOwnPropertyNames;var Tn=Object.prototype.hasOwnProperty;var Dn=(t,e)=>{for(var r in e)Ne(t,r,{get:e[r],enumerable:!0})},In=(t,e,r,o)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of Sn(e))!Tn.call(t,n)&&n!==r&&Ne(t,n,{get:()=>e[n],enumerable:!(o=Cn(e,n))||o.enumerable});return t};var Bn=t=>In(Ne({},"__esModule",{value:!0}),t);var Mo={};Dn(Mo,{default:()=>zo});module.exports=Bn(Mo);var E={dragging:null,selected:new Map,placeholder:null},Pe=new Map;function vt(){E.dragging=null,E.selected.clear(),E.placeholder&&(E.placeholder.remove(),E.placeholder=null),Pe.clear()}function $e(){if(typeof document>"u"||document.querySelector("style[data-nojs-dnd]"))return;let t=`
.nojs-dragging {
  opacity: 0.5;
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-tooltip",""),e.textContent=t,document.head.appendChild(e)}function Wn(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}var Oe=8;function zt(t,e,r){let o=e.getBoundingClientRect(),n=t.getBoundingClientRect(),i=window.innerWidth,c=window.innerHeight,s,a;switch(r){case"bottom":s=o.bottom+Oe,a=o.left+(o.width-n.width)/2;break;case"left":s=o.top+(o.height-n.height)/2,a=o.left-n.width-Oe;break;case"right":s=o.top+(o.height-n.height)/2,a=o.right+Oe;break;default:s=o.top-n.height-Oe,a=o.left+(o.width-n.width)/2;break}a<4&&(a=4),a+n.width>i-4&&(a=i-n.width-4),s<4&&(s=4),s+n.height>c-4&&(s=c-n.height-4),t.style.top=`${s}px`,t.style.left=`${a}px`}var Gn=0;function Un(t,e,r){document.body.appendChild(e),zt(e,t,r),e.setAttribute("aria-hidden","false")}function qt(t,e){e.setAttribute("aria-hidden","true"),e.remove()}function Yn(t,e){t&&typeof t._warn=="function"?t._warn(e):console.warn(e)}function Mt(t){t.directive("tooltip",{priority:20,init(e,r,o){Rt();let n=o;if(!n){Yn(t,"[tooltip] attribute value (tooltip text) is required.");return}let i=e.getAttribute("tooltip-position")||"top",c=parseInt(e.getAttribute("tooltip-delay"),10),s=Number.isNaN(c)?300:c,a=e.getAttribute("tooltip-disabled"),d=a?t.findContext(e):null,u=()=>{if(!a||!d)return!1;try{return!!t.evaluate(a,d)}catch{return!1}},l=`nojs-tooltip-${++Gn}`,m=document.createElement("div");m.className="nojs-tooltip",m.setAttribute("role","tooltip"),m.setAttribute("id",l),m.setAttribute("aria-hidden","true"),m.textContent=n,e.setAttribute("aria-describedby",l),ye.set(e,m);let f=!1,g=0,v=()=>{!f||!e.isConnected||g||(g=requestAnimationFrame(()=>{g=0,!(!f||!e.isConnected)&&zt(m,e,i)}))},y=()=>{window.addEventListener("scroll",v,!0),window.addEventListener("resize",v)},p=()=>{window.removeEventListener("scroll",v,!0),window.removeEventListener("resize",v),g&&(cancelAnimationFrame(g),g=0)},b=()=>{f||(Un(e,m,i),f=!0,y())},A=()=>{if(!f){qt(e,m);return}p(),qt(e,m),f=!1},h=()=>{if(u())return;te.has(e)&&clearTimeout(te.get(e));let B=setTimeout(()=>{te.delete(e),!u()&&e.isConnected&&b()},s);te.set(e,B)},x=()=>{te.has(e)&&(clearTimeout(te.get(e)),te.delete(e)),A()},_=()=>h(),L=()=>x(),k=()=>h(),j=()=>x(),S=B=>{B.key==="Escape"&&m.getAttribute("aria-hidden")==="false"&&x()};e.addEventListener("mouseenter",_),e.addEventListener("mouseleave",L),e.addEventListener("focusin",k),e.addEventListener("focusout",j),e.addEventListener("keydown",S);let w=null;if(a&&d&&typeof d.$watch=="function"){let B=()=>{f&&u()&&A()};w=d.$watch(B)}Wn(e,()=>{e.removeEventListener("mouseenter",_),e.removeEventListener("mouseleave",L),e.removeEventListener("focusin",k),e.removeEventListener("focusout",j),e.removeEventListener("keydown",S),w&&(w(),w=null),p(),te.has(e)&&(clearTimeout(te.get(e)),te.delete(e)),f=!1,m.remove(),ye.delete(e)})}})}function Ht(t,e={}){Mt(t)}function Ot(){$t()}var K=new Map;function Vt(){K.clear()}function Ve(){if(typeof document>"u"||document.querySelector("style[data-nojs-popover]"))return;let t=`
.nojs-popover {
  position: fixed;
  z-index: 9998;
  margin: 0;
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-dropdown",""),e.textContent=t,document.head.appendChild(e)}var Jn=0;function eo(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function or(t,e,r){let o=r.getAttribute("dropdown-position")||"bottom",n=r.getAttribute("dropdown-align")||"start";t.style.top="",t.style.left="";let i=e.getBoundingClientRect(),c=t.getBoundingClientRect(),s=window.innerHeight,a=window.innerWidth,d,u;switch(o){case"top":d=i.top-c.height,u=i.left;break;case"left":d=i.top,u=i.left-c.width;break;case"right":d=i.top,u=i.right;break;default:d=i.bottom,u=i.left}o==="bottom"||o==="top"?n==="end"&&(u=i.right-c.width):n==="end"&&(d=i.bottom-c.height),o==="bottom"&&d+c.height>s&&i.top-c.height>0?d=i.top-c.height:o==="top"&&d<0&&i.bottom+c.height<=s&&(d=i.bottom),u<4&&(u=4),u+c.width>a-4&&(u=a-c.width-4),t.style.top=`${d}px`,t.style.left=`${u}px`}function st(t){return[...t.querySelectorAll("[dropdown-item]")].filter(e=>!e.hasAttribute("disabled")&&e.getAttribute("aria-disabled")!=="true")}function it(t){let e=st(t);e.length&&e[0].focus()}function ir(t){let e=st(t);e.length&&e[e.length-1].focus()}function sr(t){t.directive("dropdown",{priority:15,init(r){Ae()}}),t.directive("dropdown-toggle",{priority:15,init(r){Ae();let o=r.closest("[dropdown]");if(!o)return;let n=o.querySelector("[dropdown-menu]");if(!n)return;r.setAttribute("aria-haspopup","menu"),r.setAttribute("aria-expanded","false"),n.classList.add("nojs-dropdown-menu"),n.setAttribute("role","menu"),n.setAttribute("popover","auto"),n.id||(n.id=`nojs-dd-menu-${Date.now()}-${Jn++}`),r.setAttribute("aria-controls",n.id);let i=!1,c=typeof n.showPopover=="function"&&typeof n.hidePopover=="function";function s(){if(n.setAttribute("data-open",""),c&&!i)try{n.showPopover(),i=!0}catch{i=!1}r.setAttribute("aria-expanded","true"),or(n,r,o),de.openMenus.set(n,{toggle:r,wrapper:o})}function a(){if(c&&i){i=!1;try{n.hidePopover()}catch{}}n.removeAttribute("data-open"),r.setAttribute("aria-expanded","false"),de.openMenus.delete(n)}function d(){return r.getAttribute("aria-expanded")==="true"}let u=p=>{p.newState==="closed"&&d()&&a()};n.addEventListener("toggle",u);let l=p=>{p.preventDefault(),p.stopPropagation(),d()?a():s()};r.addEventListener("click",l);let m=p=>{d()&&!o.contains(p.target)&&a()};document.addEventListener("click",m,!0);let f=p=>{p.key==="Escape"&&d()&&(a(),r.focus())};document.addEventListener("keydown",f);let g=p=>{switch(p.key){case"Enter":case" ":p.preventDefault(),s(),it(n);break;case"ArrowDown":p.preventDefault(),s(),it(n);break;case"ArrowUp":p.preventDefault(),s(),ir(n);break}};r.addEventListener("keydown",g);let v=p=>{if(!(!d()||st(n).find(h=>h===document.activeElement)))switch(p.key){case"ArrowDown":p.preventDefault(),it(n);break;case"ArrowUp":p.preventDefault(),ir(n);break}};n.addEventListener("keydown",v);let y=()=>{d()&&or(n,r,o)};window.addEventListener("scroll",y,!0),window.addEventListener("resize",y),eo(r,()=>{r.removeEventListener("click",l),r.removeEventListener("keydown",g),n.removeEventListener("keydown",v),n.removeEventListener("toggle",u),document.removeEventListener("click",m,!0),document.removeEventListener("keydown",f),window.removeEventListener("scroll",y,!0),window.removeEventListener("resize",y),de.openMenus.delete(n)})}}),t.directive("dropdown-menu",{priority:15,init(r){Ae(),r.hasAttribute("role")||r.setAttribute("role","menu")}});let e=r=>e.open(r);e.open=r=>{let o=document.getElementById(r);if(!o)return!1;let i=o.closest("[dropdown]")?.querySelector("[dropdown-toggle]");return!i||i.getAttribute("aria-expanded")==="true"?!1:(i.click(),!0)},e.close=r=>{let o=document.getElementById(r);if(!o)return!1;let i=o.closest("[dropdown]")?.querySelector("[dropdown-toggle]");return!i||i.getAttribute("aria-expanded")!=="true"?!1:(i.click(),!0)},t.dropdown=e}function ar(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function to(t){return[...t.querySelectorAll("[dropdown-item]")].filter(e=>!e.hasAttribute("disabled")&&e.getAttribute("aria-disabled")!=="true")}function at(t,e){if(!t)return;if(typeof t.hidePopover=="function")try{t.hidePopover()}catch{}t.removeAttribute("data-open");let r=e&&e.querySelector("[dropdown-toggle]");r&&r.setAttribute("aria-expanded","false"),de.openMenus.has(t)&&de.openMenus.delete(t)}function cr(t){t.directive("dropdown-item",{priority:15,init(e){Ae();let r=e.closest("[dropdown-menu]"),o=e.closest("[dropdown]");e.setAttribute("role","menuitem"),e.setAttribute("tabindex","-1"),e.classList.add("nojs-dropdown-item"),e.hasAttribute("disabled")&&e.setAttribute("aria-disabled","true");let n=c=>{if(!r)return;let s=to(r),a=s.indexOf(e);switch(c.key){case"ArrowDown":{c.preventDefault(),(a+1<s.length?s[a+1]:s[0]).focus();break}case"ArrowUp":{c.preventDefault(),(a-1>=0?s[a-1]:s[s.length-1]).focus();break}case"Home":{c.preventDefault(),s.length&&s[0].focus();break}case"End":{c.preventDefault(),s.length&&s[s.length-1].focus();break}case"Enter":{c.preventDefault(),e.click();break}case"Escape":{if(c.preventDefault(),at(r,o),o){let d=o.querySelector("[dropdown-toggle]");d&&d.focus()}break}case"Tab":{at(r,o);break}}};e.addEventListener("keydown",n),ar(e,()=>e.removeEventListener("keydown",n));let i=()=>{if(at(r,o),o){let c=o.querySelector("[dropdown-toggle]");c&&c.focus()}};e.addEventListener("click",i),ar(e,()=>e.removeEventListener("click",i))}})}function dr(t,e={}){sr(t),cr(t)}function lr(){nr()}var ie=new Map,_e=new Set,ur=0;function pr(){return++ur}function fr(){for(let t of _e)clearTimeout(t);_e.clear();for(let t of ie.values())t.remove();ie.clear(),ur=0}function gr(){if(typeof document>"u"||document.querySelector("style[data-nojs-toast]"))return;let t=`
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-toast",""),e.textContent=t,document.head.appendChild(e)}function ct(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}var ro=new Set(["top-right","top-left","bottom-right","bottom-left","top-center","bottom-center"]);function dt(){return ie.size>0?ie.values().next().value:no("top-right")}function no(t){if(ie.has(t))return ie.get(t);let e=document.createElement("div");return e.classList.add("nojs-toast-container"),e.setAttribute("data-position",t),e.setAttribute("role","log"),e.setAttribute("aria-live","polite"),e.setAttribute("aria-relevant","additions"),document.body.appendChild(e),ie.set(t,e),e}function oo(t){return t.startsWith("top")}function lt(t,e,r,o,n){let i=pr(),c=t.getAttribute("data-position")||"top-right",s=document.createElement("div");s.classList.add("nojs-toast"),s.setAttribute("data-toast-id",i),s.setAttribute("data-type",r),r==="error"&&s.setAttribute("aria-live","assertive");let a=document.createElement("span");if(a.textContent=e,s.appendChild(a),n){let d=document.createElement("button");d.type="button",d.classList.add("nojs-toast-dismiss"),d.setAttribute("aria-label","Dismiss"),d.textContent="\xD7",d.addEventListener("click",()=>Ge(s)),s.appendChild(d)}if(oo(c)&&t.firstChild?t.insertBefore(s,t.firstChild):t.appendChild(s),o>0){let d=setTimeout(()=>{_e.delete(d),s.isConnected&&Ge(s)},o);_e.add(d),s._toastTimerId=d}return s}function Ge(t){!t||!t.isConnected||(t._toastTimerId!=null&&(clearTimeout(t._toastTimerId),_e.delete(t._toastTimerId)),t.remove())}function mr(t){gr(),t.directive("toast-container",{priority:10,init(r,o,n){let i=n&&ro.has(n)?n:"top-right";r.classList.add("nojs-toast-container"),r.setAttribute("data-position",i),r.setAttribute("role","log"),r.setAttribute("aria-live","polite"),r.setAttribute("aria-relevant","additions"),ie.set(i,r),ct(r,()=>{ie.get(i)===r&&ie.delete(i)})}}),t.directive("toast",{priority:10,init(r,o,n){if(!n)return;let i=r.getAttribute("toast-type")||"info",c=parseInt(r.getAttribute("toast-duration"),10),s=Number.isNaN(c)?3e3:c,a=r.getAttribute("toast-dismiss")!=="false";if(r.tagName==="BUTTON"||r.tagName==="A"||r.hasAttribute("on:click")){let g=()=>{let v=dt();lt(v,n,i,s,a)};r.addEventListener("click",g),ct(r,()=>r.removeEventListener("click",g));return}let u=t.findContext(r);if(!u||typeof u.$watch!="function"){console.warn("[toast] reactive toast requires a parent [state] or [use] context \u2014 element will be inert");return}let l;function m(){let g=t.evaluate(n,u);if(g&&g!==l){let v=typeof g=="string"?g:String(g),y=dt();lt(y,v,i,s,a),l=g}else l=g}let f=u.$watch(m);ct(r,f)}});let e=(r,o="info",n=3e3)=>{if(typeof document>"u")return;let i=!0,c=dt();return lt(c,String(r),o,n,i)};e.dismiss=r=>{let o=typeof CSS<"u"&&CSS.escape?CSS.escape(String(r)):String(r).replace(/["\\\]]/g,"\\$&"),n=document.querySelector(`[data-toast-id="${o}"]`);n&&Ge(n)},e.dismissAll=()=>{document.querySelectorAll(".nojs-toast").forEach(r=>Ge(r))},t.toast=e}function br(t,e={}){mr(t)}function hr(){fr()}var me={containers:new Map};function vr(){me.containers.clear()}function yr(){if(typeof document>"u"||document.querySelector("style[data-nojs-tabs]"))return;let t=`
.nojs-tabs {
  display: flex;
  flex-direction: column;
  border: 1px solid #E2E8F0;
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-tree",""),e.textContent=t,document.head.appendChild(e)}function je(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function kr(t){let e=[],r=document.createTreeWalker(t,NodeFilter.SHOW_ELEMENT,{acceptNode(n){return n.matches&&n.matches('.nojs-subtree[aria-hidden="true"]')?NodeFilter.FILTER_REJECT:n.getAttribute("role")==="treeitem"?NodeFilter.FILTER_ACCEPT:NodeFilter.FILTER_SKIP}}),o;for(;o=r.nextNode();)e.push(o);return e}function Cr(t){return t.closest('[role="tree"]')}function ao(t){let e=t.parentElement?.closest('[role="group"], .nojs-subtree');if(e){let r=e.parentElement?.closest('[role="treeitem"]');if(r)return r;let o=e.previousElementSibling;if(o?.matches?.('[role="treeitem"]'))return o}return t.parentElement?.closest('[role="treeitem"]')||null}function co(t){let e=t.cloneNode(!0);return e.querySelectorAll('[role="group"]').forEach(o=>o.remove()),(e.textContent||"").trim().toLowerCase()}function ut(t){let e=I.selectedItem;e&&e!==t&&(e.classList.remove("nojs-branch-selected"),e.setAttribute("aria-selected","false")),t.classList.add("nojs-branch-selected"),t.setAttribute("aria-selected","true"),I.selectedItem=t}function Sr(t){let e=I.branches.get(t);!e||!e.subtreeEl||(e.expanded=!e.expanded,t.setAttribute("aria-expanded",String(e.expanded)),e.subtreeEl.setAttribute("aria-hidden",String(!e.expanded)))}function lo(t){let e=I.branches.get(t);!e||!e.subtreeEl||e.expanded||(e.expanded=!0,t.setAttribute("aria-expanded","true"),e.subtreeEl.setAttribute("aria-hidden","false"))}function uo(t){let e=I.branches.get(t);!e||!e.subtreeEl||!e.expanded||(e.expanded=!1,t.setAttribute("aria-expanded","false"),e.subtreeEl.setAttribute("aria-hidden","true"))}function Tr(t,e){let r=Cr(e);if(!r)return;let o=kr(r),n=o.indexOf(e);if(n<0)return;let i=I.branches.get(e),c=i&&i.subtreeEl;switch(t.key){case"ArrowRight":if(t.preventDefault(),c&&!i.expanded)lo(e);else if(c&&i.expanded){let s=i.subtreeEl.querySelector('[role="treeitem"]');s&&be(s,o)}break;case"ArrowLeft":if(t.preventDefault(),c&&i.expanded)uo(e);else{let s=ao(e);s&&be(s,kr(r))}break;case"ArrowDown":t.preventDefault(),n<o.length-1&&be(o[n+1],o);break;case"ArrowUp":t.preventDefault(),n>0&&be(o[n-1],o);break;case"Enter":case" ":t.preventDefault(),ut(e),c&&Sr(e);break;case"Home":t.preventDefault(),o.length>0&&be(o[0],o);break;case"End":t.preventDefault(),o.length>0&&be(o[o.length-1],o);break;default:if(t.key.length===1&&!t.ctrlKey&&!t.altKey&&!t.metaKey){t.preventDefault(),I.typeahead+=t.key.toLowerCase(),I.typeaheadTimer&&clearTimeout(I.typeaheadTimer),I.typeaheadTimer=setTimeout(()=>{I.typeahead="",I.typeaheadTimer=null},500);let s=n+1;for(let a=0;a<o.length;a++){let d=(s+a)%o.length;if(co(o[d]).startsWith(I.typeahead)){be(o[d],o);break}}}break}}function Dr(t){t.directive("tree",{priority:15,init(e){Le(),e.classList.add("nojs-tree"),e.setAttribute("role","tree"),e.getAttribute("tree-icon")==="false"&&e.setAttribute("data-tree-icon","false")}})}function Ir(t){t.directive("branch",{priority:16,init(e,r,o){Le();let n=o==="expanded";e.classList.add("nojs-branch"),e.setAttribute("role","treeitem"),e.setAttribute("aria-expanded",String(n));let i=Cr(e);if(i){let d=i.querySelector('[role="treeitem"][tabindex="0"]');e.setAttribute("tabindex",d?"-1":"0")}else e.setAttribute("tabindex","0");let c=!1;queueMicrotask(()=>{if(c)return;let d=e.querySelector(":scope > [subtree], :scope > .nojs-subtree")||(e.nextElementSibling?.matches?.("[subtree], .nojs-subtree")?e.nextElementSibling:null);d?(I.branches.set(e,{expanded:n,subtreeEl:d}),d.setAttribute("aria-hidden",String(!n))):I.branches.set(e,{expanded:n,subtreeEl:null})});let s=d=>{d.target.closest?.('[role="treeitem"]')===e&&(d.stopPropagation(),ut(e),Sr(e))};e.addEventListener("click",s),je(e,()=>e.removeEventListener("click",s));let a=d=>{Tr(d,e)};e.addEventListener("keydown",a),je(e,()=>e.removeEventListener("keydown",a)),je(e,()=>{c=!0,I.branches.delete(e),I.selectedItem===e&&(I.selectedItem=null),I.typeaheadTimer&&(clearTimeout(I.typeaheadTimer),I.typeaheadTimer=null,I.typeahead="")})}})}function be(t,e){for(let r of e)r.setAttribute("tabindex",r===t?"0":"-1");t.focus()}function Br(t){t.directive("subtree",{priority:16,init(e){Le(),e.classList.add("nojs-subtree"),e.classList.add("nojs-tree"),e.setAttribute("role","group");for(let o of e.children)if(o.tagName==="LI"&&!o.querySelector("[branch], .nojs-branch")){o.setAttribute("role","treeitem"),o.setAttribute("tabindex","-1"),o.classList.add("nojs-tree-leaf");let n=c=>{c.stopPropagation(),ut(o)};o.addEventListener("click",n),je(o,()=>o.removeEventListener("click",n));let i=c=>{Tr(c,o)};o.addEventListener("keydown",i),je(o,()=>o.removeEventListener("keydown",i)),je(o,()=>{I.selectedItem===o&&(I.selectedItem=null)})}let r=e.parentElement?.matches?.('[role="treeitem"]')?e.parentElement:e.previousElementSibling?.matches?.('[role="treeitem"]')?e.previousElementSibling:null;if(r){let o=I.branches.get(r);o?(e.setAttribute("aria-hidden",String(!o.expanded)),o.subtreeEl=e):e.setAttribute("aria-hidden","true")}else e.setAttribute("aria-hidden","true")}})}function Fr(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function pt(t){return t.closest('[role="treeitem"]')}function po(t){return t.closest('[role="tree"]')}function fo(t){let e=t.parentElement;return e?[...e.children].filter(r=>r.getAttribute("role")==="treeitem"):[]}function go(t){return fo(t).indexOf(t)}function mo(t,e,r){let o=t.getBoundingClientRect(),n=e-o.top,i=o.height;return r==="reparent"?"on":r==="reorder"?n<i/2?"before":"after":n<i*.25?"before":n>i*.75?"after":"on"}function Pr(t,e){let r=t.parentElement;for(;r;){if(r===e)return!0;r=r.parentElement}return!1}var D={dragging:null,indicator:null,currentTarget:null,currentPosition:null};function ke(){D.indicator&&(D.indicator.remove(),D.indicator=null)}function De(t){if(!t)return;let e=t.querySelectorAll(".nojs-tree-drag-over");for(let r of e)r.classList.remove("nojs-tree-drag-over")}function bo(){let t=document.createElement("div");return t.className="nojs-tree-drag-indicator",t.setAttribute("aria-hidden","true"),t}function ho(t,e){ke();let r=bo(),o=t.getBoundingClientRect(),n=po(t);if(!n)return;let i=n.getBoundingClientRect();r.style.position="absolute",r.style.left=o.left-i.left+"px",r.style.width=o.width+"px",e==="before"?r.style.top=o.top-i.top-1+"px":r.style.top=o.bottom-i.top-1+"px",getComputedStyle(n).position==="static"&&(n.style.position="relative"),n.appendChild(r),D.indicator=r}function $r(t){t.directive("tree-drag-mode",{priority:15,init(e,r,o){if(Le(),o!=="reparent"&&o!=="reorder"&&o!=="both")return;let n=0,i=m=>{let f=pt(m.target);if(f&&e.contains(f)){if(f.hasAttribute("tree-drag-disabled")){m.preventDefault();return}D.dragging={el:f,treeRoot:e},m.dataTransfer&&(m.dataTransfer.effectAllowed="move",m.dataTransfer.setData("text/plain","")),f.classList.add("nojs-dragging"),f.dispatchEvent(new CustomEvent("tree:drag-start",{bubbles:!0,detail:{node:f}}))}},c=m=>{if(!D.dragging||D.dragging.treeRoot!==e)return;let f=pt(m.target);if(!f||!e.contains(f)||f===D.dragging.el||Pr(f,D.dragging.el))return;m.preventDefault(),m.dataTransfer&&(m.dataTransfer.dropEffect="move");let g=mo(f,m.clientY,o);(D.currentTarget!==f||D.currentPosition!==g)&&(De(e),ke(),D.currentTarget=f,D.currentPosition=g,g==="on"?f.classList.add("nojs-tree-drag-over"):ho(f,g))},s=m=>{D.dragging&&D.dragging.treeRoot===e&&n++},a=m=>{D.dragging&&(n--,n<=0&&(n=0,De(e),ke(),D.currentTarget=null,D.currentPosition=null))},d=m=>{if(m.preventDefault(),m.stopPropagation(),n=0,!D.dragging||D.dragging.treeRoot!==e)return;let f=D.dragging.el,g=D.currentTarget,v=D.currentPosition;if(De(e),ke(),!g||!v){D.dragging=null,D.currentTarget=null,D.currentPosition=null;return}if(g===f||Pr(g,f)){D.dragging=null,D.currentTarget=null,D.currentPosition=null;return}if(v==="on"){let y=g.querySelector(':scope > [role="group"]');y||(y=g.nextElementSibling?.matches?.('[role="group"]')?g.nextElementSibling:null),y?y.setAttribute("aria-hidden","false"):(y=document.createElement("ul"),y.setAttribute("role","group"),y.setAttribute("subtree",""),y.classList.add("nojs-subtree","nojs-tree"),y.setAttribute("aria-hidden","false"),g.appendChild(y));let p=I.branches.get(g);p&&(p.expanded=!0,p.subtreeEl=y,g.setAttribute("aria-expanded","true")),y.appendChild(f),e.dispatchEvent(new CustomEvent("tree:reparent",{bubbles:!0,detail:{node:f,newParent:g}}))}else{let y=g.parentElement;if(!y){D.dragging=null,D.currentTarget=null,D.currentPosition=null;return}if(v==="before")y.insertBefore(f,g);else{let b=g.nextElementSibling,A=b?.matches?.('[role="group"]')?b.nextElementSibling:b;A?y.insertBefore(f,A):y.appendChild(f)}let p=go(f);e.dispatchEvent(new CustomEvent("tree:reorder",{bubbles:!0,detail:{node:f,newIndex:p}}))}D.dragging=null,D.currentTarget=null,D.currentPosition=null},u=m=>{let f=pt(m.target);f&&f.classList.remove("nojs-dragging"),De(e),ke(),n=0,D.dragging&&D.dragging.el.dispatchEvent(new CustomEvent("tree:drag-end",{bubbles:!0,detail:{node:D.dragging.el}})),D.dragging=null,D.currentTarget=null,D.currentPosition=null};e.addEventListener("dragstart",i),e.addEventListener("dragover",c),e.addEventListener("dragenter",s),e.addEventListener("dragleave",a),e.addEventListener("drop",d),e.addEventListener("dragend",u),Fr(e,()=>{e.removeEventListener("dragstart",i),e.removeEventListener("dragover",c),e.removeEventListener("dragenter",s),e.removeEventListener("dragleave",a),e.removeEventListener("drop",d),e.removeEventListener("dragend",u),De(e),ke()}),vo(e);let l=new MutationObserver(m=>{for(let f of m)for(let g of f.addedNodes){if(g.nodeType!==1)continue;g.getAttribute("role")==="treeitem"&&ft(g);let v=g.querySelectorAll?.('[role="treeitem"]');if(v)for(let y of v)ft(y)}});l.observe(e,{childList:!0,subtree:!0}),Fr(e,()=>l.disconnect())}})}function ft(t){if(t.hasAttribute("tree-drag-disabled")){t.draggable=!1;return}t.draggable=!0}function vo(t){let e=t.querySelectorAll('[role="treeitem"]');for(let r of e)ft(r)}function Rr(t,e={}){Dr(t),Ir(t),Br(t),$r(t)}function qr(){jr()}var Ue=new Map;function zr(){Ue.clear()}function Ye(){if(typeof document>"u"||document.querySelector("style[data-nojs-stepper]"))return;let t=`
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-breadcrumb",""),e.textContent=t,document.head.appendChild(e)}function wn(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function Io(t){let e=t.getAttribute("breadcrumb");if(e&&e.trim()!=="")return e.trim();let r=t.getAttribute("title");return r&&r.trim()!==""?r.trim():(t.textContent||"").trim()}function Bo(t){return t&&t.charAt(0).toUpperCase()+t.slice(1)}function An(t,e){let r=t.querySelector("ol.nojs-breadcrumb");r&&r.remove();let o=document.createElement("ol");o.classList.add("nojs-breadcrumb");for(let i=0;i<e.length;i++){let c=e[i],s=document.createElement("li");if(i===e.length-1){let d=document.createElement("span");d.setAttribute("aria-current","page"),d.textContent=c.label,s.appendChild(d)}else{let d=document.createElement("a");d.href=c.href,d.textContent=c.label,s.appendChild(d)}o.appendChild(s)}t.appendChild(o);let n=ue.containers.get(t);n&&(n.crumbs=e)}function Fo(t){let e=[],r=Array.from(t.children);for(let o of r){if(o.tagName==="OL"&&o.classList.contains("nojs-breadcrumb"))continue;let n=Io(o);if(!n)continue;let i=o.getAttribute("href")||"#";e.push({label:n,href:i})}return e}function Po(t){if(!t||t==="/")return[{label:"Home",href:"/",isLast:!0}];let r=(t.replace(/\/+$/,"")||"/").split("/").filter(Boolean),o=[{label:"Home",href:"/"}],n="";for(let i=0;i<r.length;i++){n+="/"+r[i];let c=Bo(r[i].replace(/[-_]/g," "));o.push({label:c,href:n})}return o}function _n(t){t.directive("breadcrumb",{priority:15,init(e,r,o){En(),e.tagName==="NAV"&&!e.getAttribute("aria-label")&&e.setAttribute("aria-label","Breadcrumb");let n=Array.from(e.children).some(s=>!(s.tagName==="OL"&&s.classList.contains("nojs-breadcrumb"))),i=t.router,c=!n&&i;if(ue.containers.set(e,{unsub:null,crumbs:[]}),c){let s=()=>{let a=i.current,d=a?a.path:"/",u=Po(d);An(e,u)};if(s(),typeof i.on=="function"){let a=i.on(s),d=ue.containers.get(e);d&&(d.unsub=a),wn(e,()=>{typeof a=="function"&&a();let u=ue.containers.get(e);u&&(u.unsub=null)})}}else{let s=Fo(e);for(let a of Array.from(e.children))a.tagName==="OL"&&a.classList.contains("nojs-breadcrumb")||(a.style.display="none");An(e,s)}wn(e,()=>{ue.containers.delete(e)})}})}function Ln(t,e={}){_n(t)}function jn(){xn()}var $o="[validate],[drag],[drop],[drag-list],[drag-multiple]";function kn(t){if(typeof document>"u")return;let e=document.querySelectorAll($o);for(let r of e){if(!r.__declared)continue;let o=X(t,"disposeTree");typeof o=="function"?o(r):(r.__disposers&&(r.__disposers.forEach(i=>i()),r.__disposers=null),r.__declared=!1);let n=t.findContext?t.findContext(r):null;n&&delete n.$form,t.processTree(r)}}var Ro=["tooltip","popover","popover-trigger","popover-dismiss","modal","modal-open","modal-close","dropdown","dropdown-toggle","dropdown-menu","dropdown-item","toast","toast-container","tabs","tab","tab-disabled","tab-position","tree","branch","subtree","stepper","step","skeleton","split","pane","panel","sortable","sort","fixed-header","fixed-col","breadcrumb"],qo={name:"nojs-elements",install(t,e={}){_t(t,e),Ft(t,e),Ht(t,e),Gt(t,e),tr(t,e),dr(t,e),br(t,e),_r(t,e),Rr(t,e),Gr(t,e),Zr(t,e),rn(t,e),vn(t,e),Ln(t,e),kn(t)},init(t){if(kn(t),typeof document>"u"||!document.body)return;let e=Ro.map(o=>`[${o}]`).join(","),r;try{r=document.body.querySelectorAll(e)}catch{return}for(let o of r)o.__declared&&!o.__disposers&&!o.__ctx&&(o.__declared=!1);try{t.processTree(document.body)}catch(o){t.internals?.warn?.("nojs-elements init re-process error:",o.message)}},dispose(t){Lt(),Pt(),Ot(),Ut(),rr(),lr(),hr(),Lr(),qr(),Ur(),nn(),yn(),jn()}},zo=qo;

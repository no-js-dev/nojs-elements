 ...
 * @license MIT
 */
var We=Object.defineProperty;var an=Object.getOwnPropertyDescriptor;var dn=Object.getOwnPropertyNames;var cn=Object.prototype.hasOwnProperty;var ln=(t,e)=>{for(var r in e)We(t,r,{get:e[r],enumerable:!0})},un=(t,e,r,o)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of dn(e))!cn.call(t,n)&&n!==r&&We(t,n,{get:()=>e[n],enumerable:!(o=an(e,n))||o.enumerable});return t};var pn=t=>un(We({},"__esModule",{value:!0}),t);var uo={};ln(uo,{default:()=>lo});module.exports=pn(uo);var y={dragging:null,selected:new Map,placeholder:null},Ce=new Map;function ut(){y.dragging=null,y.selected.clear(),y.placeholder&&(y.placeholder.remove(),y.placeholder=null),Ce.clear()}function Se(){if(typeof document>"u"||document.querySelector("style[data-nojs-dnd]"))return;let t=`
.nojs-dragging {
  opacity: 0.5;
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-tooltip",""),e.textContent=t,document.head.appendChild(e)}function wn(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}var Re=8;function _n(t,e,r){let o=e.getBoundingClientRect(),n=t.getBoundingClientRect(),i=window.innerWidth,a=window.innerHeight,s,d;switch(r){case"bottom":s=o.bottom+Re,d=o.left+(o.width-n.width)/2;break;case"left":s=o.top+(o.height-n.height)/2,d=o.left-n.width-Re;break;case"right":s=o.top+(o.height-n.height)/2,d=o.right+Re;break;default:s=o.top-n.height-Re,d=o.left+(o.width-n.width)/2;break}d<4&&(d=4),d+n.width>i-4&&(d=i-n.width-4),s<4&&(s=4),s+n.height>a-4&&(s=a-n.height-4),t.style.top=`${s}px`,t.style.left=`${d}px`}var jn=0;function Ln(t,e,r){document.body.appendChild(e),_n(e,t,r),e.setAttribute("aria-hidden","false")}function kn(t,e){e.setAttribute("aria-hidden","true"),e.remove()}function Dt(t){t.directive("tooltip",{priority:20,init(e,r,o){Tt();let n=o;if(!n){console.warn("[tooltip] attribute value (tooltip text) is required.");return}let i=e.getAttribute("tooltip-position")||"top",a=parseInt(e.getAttribute("tooltip-delay"),10)||300,s=e.getAttribute("tooltip-disabled"),d=s?t.findContext(e):null,p=`nojs-tooltip-${++jn}`,f=document.createElement("div");f.className="nojs-tooltip",f.setAttribute("role","tooltip"),f.setAttribute("id",p),f.setAttribute("aria-hidden","true"),f.textContent=n,e.setAttribute("aria-describedby",p),Ae.set(e,f);let u=()=>{if(s&&d&&t.evaluate(s,d))return;te.has(e)&&clearTimeout(te.get(e));let h=setTimeout(()=>{te.delete(e),!(s&&d&&t.evaluate(s,d))&&Ln(e,f,i)},a);te.set(e,h)},b=()=>{te.has(e)&&(clearTimeout(te.get(e)),te.delete(e)),kn(e,f)},l=()=>u(),c=()=>b(),g=()=>u(),m=()=>b(),v=h=>{h.key==="Escape"&&f.getAttribute("aria-hidden")==="false"&&b()};e.addEventListener("mouseenter",l),e.addEventListener("mouseleave",c),e.addEventListener("focusin",g),e.addEventListener("focusout",m),e.addEventListener("keydown",v),wn(e,()=>{e.removeEventListener("mouseenter",l),e.removeEventListener("mouseleave",c),e.removeEventListener("focusin",g),e.removeEventListener("focusout",m),e.removeEventListener("keydown",v),te.has(e)&&(clearTimeout(te.get(e)),te.delete(e)),f.remove(),Ae.delete(e)})}})}function It(t,e={}){Dt(t)}function Bt(){St()}var X=new Map;function Ft(){X.clear()}function $e(){if(typeof document>"u"||document.querySelector("style[data-nojs-popover]"))return;let t=`
.nojs-popover {
  position: fixed;
  z-index: 9998;
  margin: 0;
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-modal",""),e.textContent=t,document.head.appendChild(e)}function Sn(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}var zt='a[href], button:not([disabled]), input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])',Qe=new WeakMap;function Tn(t){let e=r=>{if(r.key!=="Tab")return;let o=[...t.querySelectorAll(zt)].filter(a=>a.offsetParent!==null);if(o.length===0){r.preventDefault();return}let n=o[0],i=o[o.length-1];r.shiftKey?document.activeElement===n&&(r.preventDefault(),i.focus()):document.activeElement===i&&(r.preventDefault(),n.focus())};t.addEventListener("keydown",e),Qe.set(t,e)}function Mt(t){let e=Qe.get(t);e&&(t.removeEventListener("keydown",e),Qe.delete(t))}var we=new WeakMap;function Ot(t){t.directive("modal",{priority:10,init(r,o,n){me();let i=n||`nojs-modal-${Date.now()}-${Math.random().toString(36).slice(2,7)}`;r.setAttribute("popover","manual"),r.classList.add("nojs-modal"),r.id=r.id||`nojs-modal-${i}`,r.setAttribute("data-modal-id",i),r.setAttribute("role","dialog"),r.setAttribute("aria-modal","true");let a=r.querySelector("h1, h2, h3, h4, h5, h6");a&&(a.id||(a.id=`nojs-modal-heading-${i}`),r.setAttribute("aria-labelledby",a.id));let s=r.getAttribute("modal-backdrop");s==="false"&&r.setAttribute("data-nojs-no-backdrop","");let d=r.getAttribute("modal-class"),p=r.getAttribute("modal-escape"),f=b=>{b.target===r&&s!=="false"&&p!=="false"&&be(r,i)};r.addEventListener("click",f),oe.set(i,r);let u=b=>{if(b.newState==="open"){if(r.style.zIndex=String(Pt()),d&&d.split(/\s+/).filter(Boolean).forEach(l=>r.classList.add(l)),requestAnimationFrame(()=>{let l=r.querySelector(zt);l?l.focus():r.focus()}),Tn(r),p!=="false"){let l=c=>{c.key==="Escape"&&(c.stopPropagation(),be(r,i))};r.addEventListener("keydown",l),we.set(r,l)}}else if(b.newState==="closed"){d&&d.split(/\s+/).filter(Boolean).forEach(g=>r.classList.remove(g)),Mt(r);let l=we.get(r);l&&(r.removeEventListener("keydown",l),we.delete(r));let c=J.findIndex(g=>g.id===i);if(c!==-1){let g=J[c];J.splice(c,1),g.triggerEl&&requestAnimationFrame(()=>{g.triggerEl.focus()})}}};r.addEventListener("toggle",u),Sn(r,()=>{r.removeEventListener("click",f),r.removeEventListener("toggle",u),Mt(r);let b=we.get(r);b&&(r.removeEventListener("keydown",b),we.delete(r)),oe.delete(i);let l=J.findIndex(c=>c.id===i);l!==-1&&J.splice(l,1)})}});let e=r=>e.open(r);e.open=r=>{let o=oe.get(r);if(!o)return!1;J.push({id:r,el:o,triggerEl:null});try{o.showPopover()}catch{return!1}return!0},e.close=r=>{let o=oe.get(r);return o?(be(o,r),!0):!1},e.closeAll=()=>{for(let r=J.length-1;r>=0;r--)be(J[r].el,J[r].id)},t.modal=e}function be(t,e){try{t.hidePopover()}catch{}}function Dn(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function Vt(t){t.directive("modal-open",{priority:10,init(e,r,o){me();let n=o;if(!n){let u=(e.closest("[use]")||e.parentElement)?.querySelector("[data-modal-id]");if(u&&(n=u.getAttribute("data-modal-id")),!n){console.warn('[modal-open] requires a target modal ID, e.g. modal-open="my-dialog"');return}}e.setAttribute("aria-haspopup","dialog"),e.setAttribute("aria-expanded","false");let i=()=>{let f=oe.get(n)||document.querySelector(`[data-modal-id="${n}"]`);if(!f){console.warn(`[modal-open] modal "${n}" not found`);return}J.push({id:n,el:f,triggerEl:e}),e.setAttribute("aria-expanded","true"),f.id&&e.setAttribute("aria-controls",f.id);try{f.showPopover()}catch{console.warn(`[modal-open] failed to open modal "${n}"`)}},a=()=>{e.setAttribute("aria-expanded","false")},s=null,d=null;requestAnimationFrame(()=>{let f=oe.get(n);f&&(d=f,s=u=>{u.newState==="closed"&&e.setAttribute("aria-expanded","false")},f.addEventListener("toggle",s))}),e.addEventListener("click",i),Dn(e,()=>{e.removeEventListener("click",i),d&&s&&d.removeEventListener("toggle",s)})}})}function In(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function Wt(t){t.directive("modal-close",{priority:10,init(e,r,o){me();let n=()=>{let i,a;if(o){if(a=o,i=oe.get(a),!i){console.warn(`[modal-close] modal "${a}" not found`);return}}else{if(i=e.closest("[modal]"),!i){console.warn("[modal-close] no parent modal found");return}a=i.getAttribute("modal")}be(i,a)};e.addEventListener("click",n),In(e,()=>{e.removeEventListener("click",n)})}})}function Gt(t,e={}){Ot(t),Vt(t),Wt(t)}function Yt(){qt()}var _e={openMenus:new Map};function Ut(){_e.openMenus.clear()}function he(){if(typeof document>"u"||document.querySelector("style[data-nojs-dropdown]"))return;let t=`
.nojs-dropdown-menu {
  position: fixed;
  z-index: 9999;
  margin: 0;
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-dropdown",""),e.textContent=t,document.head.appendChild(e)}function Bn(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function Kt(t,e,r){let o=r.getAttribute("dropdown-position")||"bottom",n=r.getAttribute("dropdown-align")||"start";t.style.top="",t.style.left="";let i=e.getBoundingClientRect(),a=t.getBoundingClientRect(),s=window.innerHeight,d=window.innerWidth,p,f;switch(o){case"top":p=i.top-a.height,f=i.left;break;case"left":p=i.top,f=i.left-a.width;break;case"right":p=i.top,f=i.right;break;default:p=i.bottom,f=i.left}o==="bottom"||o==="top"?n==="end"&&(f=i.right-a.width):n==="end"&&(p=i.bottom-a.height),o==="bottom"&&p+a.height>s&&i.top-a.height>0?p=i.top-a.height:o==="top"&&p<0&&i.bottom+a.height<=s&&(p=i.bottom),f<4&&(f=4),f+a.width>d-4&&(f=d-a.width-4),t.style.top=`${p}px`,t.style.left=`${f}px`}function Je(t){return[...t.querySelectorAll("[dropdown-item]")].filter(e=>!e.hasAttribute("disabled")&&e.getAttribute("aria-disabled")!=="true")}function Ne(t){let e=Je(t);e.length&&e[0].focus()}function Xt(t){let e=Je(t);e.length&&e[e.length-1].focus()}function Zt(t){t.directive("dropdown",{priority:15,init(r){he()}}),t.directive("dropdown-toggle",{priority:15,init(r){he();let o=r.closest("[dropdown]");if(!o)return;let n=o.querySelector("[dropdown-menu]");if(!n)return;r.setAttribute("aria-haspopup","menu"),r.setAttribute("aria-expanded","false"),n.classList.add("nojs-dropdown-menu"),n.setAttribute("role","menu"),n.setAttribute("popover","auto"),n.id||(n.id=`nojs-dd-menu-${Date.now()}-${Math.random().toString(36).slice(2,7)}`),r.setAttribute("aria-controls",n.id);function i(){n.setAttribute("data-open",""),n.showPopover&&n.showPopover(),r.setAttribute("aria-expanded","true"),Kt(n,r,o),_e.openMenus.set(n,{toggle:r,wrapper:o})}function a(){n.removeAttribute("data-open"),r.setAttribute("aria-expanded","false"),_e.openMenus.delete(n)}function s(){return r.getAttribute("aria-expanded")==="true"}let d=g=>{g.newState==="closed"&&s()&&a()};n.addEventListener("toggle",d);let p=g=>{g.preventDefault(),g.stopPropagation(),s()?a():i()};r.addEventListener("click",p);let f=g=>{s()&&!o.contains(g.target)&&a()};document.addEventListener("click",f,!0);let u=g=>{g.key==="Escape"&&s()&&(a(),r.focus())};document.addEventListener("keydown",u);let b=g=>{switch(g.key){case"Enter":case" ":g.preventDefault(),i(),Ne(n);break;case"ArrowDown":g.preventDefault(),i(),Ne(n);break;case"ArrowUp":g.preventDefault(),i(),Xt(n);break}};r.addEventListener("keydown",b);let l=g=>{if(!(!s()||Je(n).find(h=>h===document.activeElement)))switch(g.key){case"ArrowDown":g.preventDefault(),Ne(n);break;case"ArrowUp":g.preventDefault(),Xt(n);break}};n.addEventListener("keydown",l);let c=()=>{s()&&Kt(n,r,o)};window.addEventListener("scroll",c,!0),window.addEventListener("resize",c),Bn(r,()=>{r.removeEventListener("click",p),r.removeEventListener("keydown",b),n.removeEventListener("keydown",l),n.removeEventListener("toggle",d),document.removeEventListener("click",f,!0),document.removeEventListener("keydown",u),window.removeEventListener("scroll",c,!0),window.removeEventListener("resize",c),_e.openMenus.delete(n)})}}),t.directive("dropdown-menu",{priority:15,init(r){he(),r.hasAttribute("role")||r.setAttribute("role","menu")}});let e=r=>e.open(r);e.open=r=>{let o=document.getElementById(r);if(!o)return!1;let i=o.closest("[dropdown]")?.querySelector("[dropdown-toggle]");return!i||i.getAttribute("aria-expanded")==="true"?!1:(i.click(),!0)},e.close=r=>{let o=document.getElementById(r);if(!o)return!1;let i=o.closest("[dropdown]")?.querySelector("[dropdown-toggle]");return!i||i.getAttribute("aria-expanded")!=="true"?!1:(i.click(),!0)},t.dropdown=e}function Qt(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function Fn(t){return[...t.querySelectorAll("[dropdown-item]")].filter(e=>!e.hasAttribute("disabled")&&e.getAttribute("aria-disabled")!=="true")}function Nt(t){t.directive("dropdown-item",{priority:15,init(e){he();let r=e.closest("[dropdown-menu]"),o=e.closest("[dropdown]");e.setAttribute("role","menuitem"),e.setAttribute("tabindex","-1"),e.classList.add("nojs-dropdown-item"),e.hasAttribute("disabled")&&e.setAttribute("aria-disabled","true");let n=a=>{if(!r)return;let s=Fn(r),d=s.indexOf(e);switch(a.key){case"ArrowDown":{a.preventDefault(),(d+1<s.length?s[d+1]:s[0]).focus();break}case"ArrowUp":{a.preventDefault(),(d-1>=0?s[d-1]:s[s.length-1]).focus();break}case"Home":{a.preventDefault(),s.length&&s[0].focus();break}case"End":{a.preventDefault(),s.length&&s[s.length-1].focus();break}case"Enter":{a.preventDefault(),e.click();break}case"Escape":{if(a.preventDefault(),r)try{r.hidePopover()}catch{}if(o){let p=o.querySelector("[dropdown-toggle]");p&&p.focus()}break}case"Tab":{if(r)try{r.hidePopover()}catch{}break}}};e.addEventListener("keydown",n),Qt(e,()=>e.removeEventListener("keydown",n));let i=()=>{if(r)try{r.hidePopover()}catch{}if(o){let a=o.querySelector("[dropdown-toggle]");a&&a.focus()}};e.addEventListener("click",i),Qt(e,()=>e.removeEventListener("click",i))}})}function Jt(t,e={}){Zt(t),Nt(t)}function er(){Ut()}var ie=new Map,ve=new Set,tr=0;function rr(){return++tr}function nr(){for(let t of ve)clearTimeout(t);ve.clear();for(let t of ie.values())t.remove();ie.clear(),tr=0}function or(){if(typeof document>"u"||document.querySelector("style[data-nojs-toast]"))return;let t=`
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-toast",""),e.textContent=t,document.head.appendChild(e)}function et(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}var Rn=new Set(["top-right","top-left","bottom-right","bottom-left","top-center","bottom-center"]);function tt(){return ie.size>0?ie.values().next().value:$n("top-right")}function $n(t){if(ie.has(t))return ie.get(t);let e=document.createElement("div");return e.classList.add("nojs-toast-container"),e.setAttribute("data-position",t),e.setAttribute("role","log"),e.setAttribute("aria-live","polite"),e.setAttribute("aria-relevant","additions"),document.body.appendChild(e),ie.set(t,e),e}function Hn(t){return t.startsWith("top")}function rt(t,e,r,o,n){let i=rr(),a=t.getAttribute("data-position")||"top-right",s=document.createElement("div");s.classList.add("nojs-toast"),s.setAttribute("data-toast-id",i),s.setAttribute("data-type",r),r==="error"&&s.setAttribute("aria-live","assertive");let d=document.createElement("span");if(d.textContent=e,s.appendChild(d),n){let p=document.createElement("button");p.type="button",p.classList.add("nojs-toast-dismiss"),p.setAttribute("aria-label","Dismiss"),p.textContent="\xD7",p.addEventListener("click",()=>He(s)),s.appendChild(p)}if(Hn(a)&&t.firstChild?t.insertBefore(s,t.firstChild):t.appendChild(s),o>0){let p=setTimeout(()=>{ve.delete(p),He(s)},o);ve.add(p),s._toastTimerId=p}return s}function He(t){!t||!t.isConnected||(t._toastTimerId!=null&&(clearTimeout(t._toastTimerId),ve.delete(t._toastTimerId)),t.remove())}function ir(t){or(),t.directive("toast-container",{priority:10,init(r,o,n){let i=n&&Rn.has(n)?n:"top-right";r.classList.add("nojs-toast-container"),r.setAttribute("data-position",i),r.setAttribute("role","log"),r.setAttribute("aria-live","polite"),r.setAttribute("aria-relevant","additions"),ie.set(i,r),et(r,()=>{ie.get(i)===r&&ie.delete(i)})}}),t.directive("toast",{priority:10,init(r,o,n){if(!n)return;let i=r.getAttribute("toast-type")||"info",a=parseInt(r.getAttribute("toast-duration"),10)||3e3,s=r.getAttribute("toast-dismiss")!=="false";if(r.tagName==="BUTTON"||r.tagName==="A"||r.hasAttribute("on:click")){let l=()=>{let c=tt();rt(c,n,i,a,s)};r.addEventListener("click",l),et(r,()=>r.removeEventListener("click",l));return}let p=t.findContext(r),f;function u(){let l=t.evaluate(n,p);if(l&&l!==f){let c=typeof l=="string"?l:String(l),g=tt();rt(g,c,i,a,s)}f=l}let b=p.$watch(u);et(r,b)}});let e=(r,o="info",n=3e3)=>{if(typeof document>"u")return;let i=!0,a=tt();return rt(a,String(r),o,n,i)};e.dismiss=r=>{let o=document.querySelector(`[data-toast-id="${r}"]`);o&&He(o)},e.dismissAll=()=>{document.querySelectorAll(".nojs-toast").forEach(r=>He(r))},t.toast=e}function sr(t,e={}){ir(t)}function ar(){nr()}var le={containers:new Map};function dr(){le.containers.clear()}function cr(){if(typeof document>"u"||document.querySelector("style[data-nojs-tabs]"))return;let t=`
.nojs-tabs {
  display: flex;
  flex-direction: column;
  border: 1px solid #E2E8F0;
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-tree",""),e.textContent=t,document.head.appendChild(e)}function ot(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function hr(t){let e=[],r=document.createTreeWalker(t,NodeFilter.SHOW_ELEMENT,{acceptNode(n){return n.matches&&n.matches('.nojs-subtree[aria-hidden="true"]')?NodeFilter.FILTER_REJECT:n.getAttribute("role")==="treeitem"?NodeFilter.FILTER_ACCEPT:NodeFilter.FILTER_SKIP}}),o;for(;o=r.nextNode();)e.push(o);return e}function vr(t){return t.closest('[role="tree"]')}function Mn(t){let e=t.cloneNode(!0);return e.querySelectorAll('[role="group"]').forEach(o=>o.remove()),(e.textContent||"").trim().toLowerCase()}function yr(t){t.directive("tree",{priority:15,init(e){ye(),e.classList.add("nojs-tree"),e.setAttribute("role","tree"),e.getAttribute("tree-icon")==="false"&&e.setAttribute("data-tree-icon","false")}})}function xr(t){t.directive("branch",{priority:16,init(e,r,o){ye();let n=o==="expanded";e.classList.add("nojs-branch"),e.setAttribute("role","treeitem"),e.setAttribute("aria-expanded",String(n));let i=vr(e);if(i){let l=i.querySelector('[role="treeitem"]');e.setAttribute("tabindex",l===e?"0":"-1")}else e.setAttribute("tabindex","0");let a=!1;queueMicrotask(()=>{if(a)return;let l=e.querySelector(":scope > [subtree], :scope > .nojs-subtree")||(e.nextElementSibling?.matches?.("[subtree], .nojs-subtree")?e.nextElementSibling:null);l?(H.branches.set(e,{expanded:n,subtreeEl:l}),l.setAttribute("aria-hidden",String(!n))):H.branches.set(e,{expanded:n,subtreeEl:null})});function s(l){let c=H.selectedItem;c&&c!==l&&(c.classList.remove("nojs-branch-selected"),c.setAttribute("aria-selected","false")),l.classList.add("nojs-branch-selected"),l.setAttribute("aria-selected","true"),H.selectedItem=l}function d(l){let c=H.branches.get(l);!c||!c.subtreeEl||(c.expanded=!c.expanded,l.setAttribute("aria-expanded",String(c.expanded)),c.subtreeEl.setAttribute("aria-hidden",String(!c.expanded)))}function p(l){let c=H.branches.get(l);!c||!c.subtreeEl||c.expanded||(c.expanded=!0,l.setAttribute("aria-expanded","true"),c.subtreeEl.setAttribute("aria-hidden","false"))}function f(l){let c=H.branches.get(l);!c||!c.subtreeEl||!c.expanded||(c.expanded=!1,l.setAttribute("aria-expanded","false"),c.subtreeEl.setAttribute("aria-hidden","true"))}let u=l=>{l.target!==e&&!e.contains(l.target)||(l.stopPropagation(),s(e),d(e))};e.addEventListener("click",u),ot(e,()=>e.removeEventListener("click",u));let b=l=>{let c=vr(e);if(!c)return;let g=hr(c),m=g.indexOf(e),v=H.branches.get(e),h=v&&v.subtreeEl;switch(l.key){case"ArrowRight":if(l.preventDefault(),h&&!v.expanded)p(e);else if(h&&v.expanded){let _=v.subtreeEl.querySelector('[role="treeitem"]');_&&ue(_,g)}break;case"ArrowLeft":if(l.preventDefault(),h&&v.expanded)f(e);else{let _=e.parentElement?.closest('[role="treeitem"]');_&&ue(_,hr(c))}break;case"ArrowDown":l.preventDefault(),m<g.length-1&&ue(g[m+1],g);break;case"ArrowUp":l.preventDefault(),m>0&&ue(g[m-1],g);break;case"Enter":case" ":l.preventDefault(),s(e),d(e);break;case"Home":l.preventDefault(),g.length>0&&ue(g[0],g);break;case"End":l.preventDefault(),g.length>0&&ue(g[g.length-1],g);break;default:if(l.key.length===1&&!l.ctrlKey&&!l.altKey&&!l.metaKey){l.preventDefault(),H.typeahead+=l.key.toLowerCase(),H.typeaheadTimer&&clearTimeout(H.typeaheadTimer),H.typeaheadTimer=setTimeout(()=>{H.typeahead="",H.typeaheadTimer=null},500);let _=m+1;for(let x=0;x<g.length;x++){let E=(_+x)%g.length;if(Mn(g[E]).startsWith(H.typeahead)){ue(g[E],g);break}}}break}};e.addEventListener("keydown",b),ot(e,()=>e.removeEventListener("keydown",b)),ot(e,()=>{a=!0,H.branches.delete(e),H.selectedItem===e&&(H.selectedItem=null)})}})}function ue(t,e){for(let r of e)r.setAttribute("tabindex",r===t?"0":"-1");t.focus()}function Er(t){t.directive("subtree",{priority:16,init(e){ye(),e.classList.add("nojs-subtree"),e.classList.add("nojs-tree"),e.setAttribute("role","group");for(let o of e.children)o.tagName==="LI"&&!o.querySelector("[branch], .nojs-branch")&&(o.setAttribute("role","treeitem"),o.setAttribute("tabindex","-1"),o.classList.add("nojs-tree-leaf"));let r=e.parentElement?.matches?.('[role="treeitem"]')?e.parentElement:e.previousElementSibling?.matches?.('[role="treeitem"]')?e.previousElementSibling:null;if(r){let o=H.branches.get(r);o?(e.setAttribute("aria-hidden",String(!o.expanded)),o.subtreeEl=e):e.setAttribute("aria-hidden","true")}else e.setAttribute("aria-hidden","true")}})}function Ar(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function it(t){return t.closest('[role="treeitem"]')}function zn(t){return t.closest('[role="tree"]')}function On(t){let e=t.parentElement;return e?[...e.children].filter(r=>r.getAttribute("role")==="treeitem"):[]}function Vn(t){return On(t).indexOf(t)}function Wn(t,e,r){let o=t.getBoundingClientRect(),n=e-o.top,i=o.height;return r==="reparent"?"on":r==="reorder"?n<i/2?"before":"after":n<i*.25?"before":n>i*.75?"after":"on"}function wr(t,e){let r=t.parentElement;for(;r;){if(r===e)return!0;r=r.parentElement}return!1}var T={dragging:null,indicator:null,currentTarget:null,currentPosition:null};function xe(){T.indicator&&(T.indicator.remove(),T.indicator=null)}function Le(t){if(!t)return;let e=t.querySelectorAll(".nojs-tree-drag-over");for(let r of e)r.classList.remove("nojs-tree-drag-over")}function Gn(){let t=document.createElement("div");return t.className="nojs-tree-drag-indicator",t.setAttribute("aria-hidden","true"),t}function Yn(t,e){xe();let r=Gn(),o=t.getBoundingClientRect(),n=zn(t);if(!n)return;let i=n.getBoundingClientRect();r.style.position="absolute",r.style.left=o.left-i.left+"px",r.style.width=o.width+"px",e==="before"?r.style.top=o.top-i.top-1+"px":r.style.top=o.bottom-i.top-1+"px",getComputedStyle(n).position==="static"&&(n.style.position="relative"),n.appendChild(r),T.indicator=r}function _r(t){t.directive("tree-drag-mode",{priority:15,init(e,r,o){if(ye(),o!=="reparent"&&o!=="reorder"&&o!=="both")return;let n=0,i=b=>{let l=it(b.target);if(l&&e.contains(l)){if(l.hasAttribute("tree-drag-disabled")){b.preventDefault();return}T.dragging={el:l,treeRoot:e},b.dataTransfer&&(b.dataTransfer.effectAllowed="move",b.dataTransfer.setData("text/plain","")),l.classList.add("nojs-dragging"),l.dispatchEvent(new CustomEvent("tree:drag-start",{bubbles:!0,detail:{node:l}}))}},a=b=>{if(!T.dragging||T.dragging.treeRoot!==e)return;let l=it(b.target);if(!l||!e.contains(l)||l===T.dragging.el||wr(l,T.dragging.el))return;b.preventDefault(),b.dataTransfer&&(b.dataTransfer.dropEffect="move");let c=Wn(l,b.clientY,o);(T.currentTarget!==l||T.currentPosition!==c)&&(Le(e),xe(),T.currentTarget=l,T.currentPosition=c,c==="on"?l.classList.add("nojs-tree-drag-over"):Yn(l,c))},s=b=>{T.dragging&&T.dragging.treeRoot===e&&n++},d=b=>{T.dragging&&(n--,n<=0&&(n=0,Le(e),xe(),T.currentTarget=null,T.currentPosition=null))},p=b=>{if(b.preventDefault(),b.stopPropagation(),n=0,!T.dragging||T.dragging.treeRoot!==e)return;let l=T.dragging.el,c=T.currentTarget,g=T.currentPosition;if(Le(e),xe(),!c||!g){T.dragging=null,T.currentTarget=null,T.currentPosition=null;return}if(c===l||wr(c,l)){T.dragging=null,T.currentTarget=null,T.currentPosition=null;return}if(g==="on"){let m=c.querySelector(':scope > [role="group"]');m||(m=c.nextElementSibling?.matches?.('[role="group"]')?c.nextElementSibling:null),m?m.setAttribute("aria-hidden","false"):(m=document.createElement("ul"),m.setAttribute("role","group"),m.setAttribute("subtree",""),m.classList.add("nojs-subtree","nojs-tree"),m.setAttribute("aria-hidden","false"),c.appendChild(m));let v=H.branches.get(c);v&&(v.expanded=!0,v.subtreeEl=m,c.setAttribute("aria-expanded","true")),m.appendChild(l),e.dispatchEvent(new CustomEvent("tree:reparent",{bubbles:!0,detail:{node:l,newParent:c}}))}else{let m=c.parentElement;if(!m){T.dragging=null,T.currentTarget=null,T.currentPosition=null;return}if(g==="before")m.insertBefore(l,c);else{let h=c.nextElementSibling,_=h?.matches?.('[role="group"]')?h.nextElementSibling:h;_?m.insertBefore(l,_):m.appendChild(l)}let v=Vn(l);e.dispatchEvent(new CustomEvent("tree:reorder",{bubbles:!0,detail:{node:l,newIndex:v}}))}T.dragging=null,T.currentTarget=null,T.currentPosition=null},f=b=>{let l=it(b.target);l&&l.classList.remove("nojs-dragging"),Le(e),xe(),n=0,T.dragging&&T.dragging.el.dispatchEvent(new CustomEvent("tree:drag-end",{bubbles:!0,detail:{node:T.dragging.el}})),T.dragging=null,T.currentTarget=null,T.currentPosition=null};e.addEventListener("dragstart",i),e.addEventListener("dragover",a),e.addEventListener("dragenter",s),e.addEventListener("dragleave",d),e.addEventListener("drop",p),e.addEventListener("dragend",f),Ar(e,()=>{e.removeEventListener("dragstart",i),e.removeEventListener("dragover",a),e.removeEventListener("dragenter",s),e.removeEventListener("dragleave",d),e.removeEventListener("drop",p),e.removeEventListener("dragend",f),Le(e),xe()}),Un(e);let u=new MutationObserver(b=>{for(let l of b)for(let c of l.addedNodes){if(c.nodeType!==1)continue;c.getAttribute("role")==="treeitem"&&st(c);let g=c.querySelectorAll?.('[role="treeitem"]');if(g)for(let m of g)st(m)}});u.observe(e,{childList:!0,subtree:!0}),Ar(e,()=>u.disconnect())}})}function st(t){if(t.hasAttribute("tree-drag-disabled")){t.draggable=!1;return}t.draggable=!0}function Un(t){let e=t.querySelectorAll('[role="treeitem"]');for(let r of e)st(r)}function jr(t,e={}){yr(t),xr(t),Er(t),_r(t)}function Lr(){br()}var Pe=new Map;function kr(){Pe.clear()}function qe(){if(typeof document>"u"||document.querySelector("style[data-nojs-stepper]"))return;let t=`

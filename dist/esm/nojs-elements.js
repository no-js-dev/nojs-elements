 ...
 */
var E={dragging:null,selected:new Map,placeholder:null},Pe=new Map;function yt(){E.dragging=null,E.selected.clear(),E.placeholder&&(E.placeholder.remove(),E.placeholder=null),Pe.clear()}function Re(){if(typeof document>"u"||document.querySelector("style[data-nojs-dnd]"))return;let t=`
.nojs-dragging {
  opacity: 0.5;
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-tooltip",""),e.textContent=t,document.head.appendChild(e)}function Mn(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}var Oe=8;function zt(t,e,r){let o=e.getBoundingClientRect(),n=t.getBoundingClientRect(),i=window.innerWidth,c=window.innerHeight,s,a;switch(r){case"bottom":s=o.bottom+Oe,a=o.left+(o.width-n.width)/2;break;case"left":s=o.top+(o.height-n.height)/2,a=o.left-n.width-Oe;break;case"right":s=o.top+(o.height-n.height)/2,a=o.right+Oe;break;default:s=o.top-n.height-Oe,a=o.left+(o.width-n.width)/2;break}a<4&&(a=4),a+n.width>i-4&&(a=i-n.width-4),s<4&&(s=4),s+n.height>c-4&&(s=c-n.height-4),t.style.top=`${s}px`,t.style.left=`${a}px`}var qn=0;function zn(t,e,r){document.body.appendChild(e),zt(e,t,r),e.setAttribute("aria-hidden","false")}function qt(t,e){e.setAttribute("aria-hidden","true"),e.remove()}function Hn(t,e){t&&typeof t._warn=="function"?t._warn(e):console.warn(e)}function Ht(t){t.directive("tooltip",{priority:20,init(e,r,o){Mt();let n=o;if(!n){Hn(t,"[tooltip] attribute value (tooltip text) is required.");return}let i=e.getAttribute("tooltip-position")||"top",c=parseInt(e.getAttribute("tooltip-delay"),10),s=Number.isNaN(c)?300:c,a=e.getAttribute("tooltip-disabled"),d=a?t.findContext(e):null,u=()=>{if(!a||!d)return!1;try{return!!t.evaluate(a,d)}catch{return!1}},l=`nojs-tooltip-${++qn}`,m=document.createElement("div");m.className="nojs-tooltip",m.setAttribute("role","tooltip"),m.setAttribute("id",l),m.setAttribute("aria-hidden","true"),m.textContent=n,e.setAttribute("aria-describedby",l),ye.set(e,m);let p=!1,g=0,v=()=>{!p||!e.isConnected||g||(g=requestAnimationFrame(()=>{g=0,!(!p||!e.isConnected)&&zt(m,e,i)}))},y=()=>{window.addEventListener("scroll",v,!0),window.addEventListener("resize",v)},f=()=>{window.removeEventListener("scroll",v,!0),window.removeEventListener("resize",v),g&&(cancelAnimationFrame(g),g=0)},b=()=>{p||(zn(e,m,i),p=!0,y())},A=()=>{if(!p){qt(e,m);return}f(),qt(e,m),p=!1},h=()=>{if(u())return;te.has(e)&&clearTimeout(te.get(e));let B=setTimeout(()=>{te.delete(e),!u()&&e.isConnected&&b()},s);te.set(e,B)},x=()=>{te.has(e)&&(clearTimeout(te.get(e)),te.delete(e)),A()},_=()=>h(),k=()=>x(),j=()=>h(),L=()=>x(),S=B=>{B.key==="Escape"&&m.getAttribute("aria-hidden")==="false"&&x()};e.addEventListener("mouseenter",_),e.addEventListener("mouseleave",k),e.addEventListener("focusin",j),e.addEventListener("focusout",L),e.addEventListener("keydown",S);let w=null;if(a&&d&&typeof d.$watch=="function"){let B=()=>{p&&u()&&A()};w=d.$watch(B)}Mn(e,()=>{e.removeEventListener("mouseenter",_),e.removeEventListener("mouseleave",k),e.removeEventListener("focusin",j),e.removeEventListener("focusout",L),e.removeEventListener("keydown",S),w&&(w(),w=null),f(),te.has(e)&&(clearTimeout(te.get(e)),te.delete(e)),p=!1,m.remove(),ye.delete(e)})}})}function Ot(t,e={}){Ht(t)}function Vt(){$t()}var K=new Map;function Wt(){K.clear()}function Ve(){if(typeof document>"u"||document.querySelector("style[data-nojs-popover]"))return;let t=`
.nojs-popover {
  position: fixed;
  z-index: 9998;
  margin: 0;
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-modal",""),e.textContent=t,document.head.appendChild(e)}function Vn(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}var Nt='a[href], button:not([disabled]), input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])',ot=new WeakMap;function Wn(t){let e=r=>{if(r.key!=="Tab")return;let o=[...t.querySelectorAll(Nt)].filter(c=>c.offsetParent!==null);if(o.length===0){r.preventDefault();return}let n=o[0],i=o[o.length-1];r.shiftKey?document.activeElement===n&&(r.preventDefault(),i.focus()):document.activeElement===i&&(r.preventDefault(),n.focus())};t.addEventListener("keydown",e),ot.set(t,e)}function Zt(t){let e=ot.get(t);e&&(t.removeEventListener("keydown",e),ot.delete(t))}var Ce=new WeakMap;function Qt(t){t.directive("modal",{priority:10,init(r,o,n){Ee();let i=n||`nojs-modal-${Date.now()}-${Math.random().toString(36).slice(2,7)}`;r.setAttribute("popover","manual"),r.classList.add("nojs-modal"),r.id=r.id||`nojs-modal-${i}`,r.setAttribute("data-modal-id",i),r.setAttribute("role","dialog"),r.setAttribute("aria-modal","true");let c=r.querySelector("h1, h2, h3, h4, h5, h6");c&&(c.id||(c.id=`nojs-modal-heading-${i}`),r.setAttribute("aria-labelledby",c.id));let s=r.getAttribute("modal-backdrop");s==="false"&&r.setAttribute("data-nojs-no-backdrop","");let a=r.getAttribute("modal-class"),d=r.getAttribute("modal-escape"),u=m=>{m.target===r&&s!=="false"&&d!=="false"&&we(r,i)};r.addEventListener("click",u),oe.set(i,r);let l=m=>{if(m.newState==="open"){if(r.style.zIndex=String(Kt()),a&&a.split(/\s+/).filter(Boolean).forEach(p=>r.classList.add(p)),requestAnimationFrame(()=>{if(!r.isConnected||!W.some(g=>g.el===r))return;let p=r.querySelector(Nt);p?p.focus():r.focus()}),Wn(r),d!=="false"){let p=g=>{g.key==="Escape"&&(g.stopPropagation(),we(r,i))};r.addEventListener("keydown",p),Ce.set(r,p)}}else if(m.newState==="closed"){a&&a.split(/\s+/).filter(Boolean).forEach(v=>r.classList.remove(v)),Zt(r);let p=Ce.get(r);p&&(r.removeEventListener("keydown",p),Ce.delete(r));let g=W.findIndex(v=>v.el===r);if(g===-1&&(g=W.findIndex(v=>v.id===i)),g!==-1){let v=W[g];W.splice(g,1),v.triggerEl&&requestAnimationFrame(()=>{v.triggerEl.focus()})}}};r.addEventListener("toggle",l),Vn(r,()=>{r.removeEventListener("click",u),r.removeEventListener("toggle",l),Zt(r);let m=Ce.get(r);m&&(r.removeEventListener("keydown",m),Ce.delete(r)),oe.delete(i);let p=W.findIndex(g=>g.el===r);p===-1&&(p=W.findIndex(g=>g.id===i)),p!==-1&&W.splice(p,1)})}});let e=r=>e.open(r);e.open=r=>{let o=oe.get(r);if(!o)return!1;try{o.showPopover()}catch{return!1}return W.some(n=>n.id===r)||W.push({id:r,el:o,triggerEl:null}),!0},e.close=r=>{let o=oe.get(r);return o?(we(o,r),!0):!1},e.closeAll=()=>{for(let r=W.length-1;r>=0;r--)we(W[r].el,W[r].id)},t.modal=e}function we(t,e){try{t.hidePopover()}catch{}}function Jt(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function Gn(t){let e=document.querySelectorAll("[data-modal-id]");for(let r of e)if(r.getAttribute("data-modal-id")===t)return r;return null}function er(t){t.directive("modal-open",{priority:10,init(e,r,o){Ee();let n=o;if(!n){let l=(e.closest("[use]")||e.parentElement)?.querySelector("[data-modal-id]");if(l&&(n=l.getAttribute("data-modal-id")),!n){console.warn('[modal-open] requires a target modal ID, e.g. modal-open="my-dialog"');return}}e.setAttribute("aria-haspopup","dialog"),e.setAttribute("aria-expanded","false");let i=()=>{let u=oe.get(n)||Gn(n);if(!u){console.warn(`[modal-open] modal "${n}" not found`);return}let l=W.some(m=>m.id===n);u.id&&e.setAttribute("aria-controls",u.id);try{u.showPopover()}catch{console.warn(`[modal-open] failed to open modal "${n}"`);return}l||W.push({id:n,el:u,triggerEl:e}),e.setAttribute("aria-expanded","true")},c=()=>{e.setAttribute("aria-expanded","false")},s=null,a=null,d=()=>{let u=oe.get(n);return u?(a=u,s=l=>{l.newState==="closed"&&e.setAttribute("aria-expanded","false")},u.addEventListener("toggle",s),!0):!1};if(!d()){let u=requestAnimationFrame(d);Jt(e,()=>cancelAnimationFrame(u))}e.addEventListener("click",i),Jt(e,()=>{e.removeEventListener("click",i),a&&s&&a.removeEventListener("toggle",s)})}})}function Un(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function tr(t){t.directive("modal-close",{priority:10,init(e,r,o){Ee();let n=()=>{let i,c;if(o){if(c=o,i=oe.get(c),!i){console.warn(`[modal-close] modal "${c}" not found`);return}}else{if(i=e.closest("[modal]"),!i){console.warn("[modal-close] no parent modal found");return}c=i.getAttribute("modal")}we(i,c)};e.addEventListener("click",n),Un(e,()=>{e.removeEventListener("click",n)})}})}function rr(t,e={}){Qt(t),er(t),tr(t)}function nr(){Xt()}var de={openMenus:new Map};function or(){de.openMenus.clear()}function Ae(){if(typeof document>"u"||document.querySelector("style[data-nojs-dropdown]"))return;let t=`
.nojs-dropdown-menu {
  position: fixed;
  z-index: 9999;
  margin: 0;
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-dropdown",""),e.textContent=t,document.head.appendChild(e)}var Yn=0;function Kn(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function ir(t,e,r){let o=r.getAttribute("dropdown-position")||"bottom",n=r.getAttribute("dropdown-align")||"start";t.style.top="",t.style.left="";let i=e.getBoundingClientRect(),c=t.getBoundingClientRect(),s=window.innerHeight,a=window.innerWidth,d,u;switch(o){case"top":d=i.top-c.height,u=i.left;break;case"left":d=i.top,u=i.left-c.width;break;case"right":d=i.top,u=i.right;break;default:d=i.bottom,u=i.left}o==="bottom"||o==="top"?n==="end"&&(u=i.right-c.width):n==="end"&&(d=i.bottom-c.height),o==="bottom"&&d+c.height>s&&i.top-c.height>0?d=i.top-c.height:o==="top"&&d<0&&i.bottom+c.height<=s&&(d=i.bottom),u<4&&(u=4),u+c.width>a-4&&(u=a-c.width-4),t.style.top=`${d}px`,t.style.left=`${u}px`}function st(t){return[...t.querySelectorAll("[dropdown-item]")].filter(e=>!e.hasAttribute("disabled")&&e.getAttribute("aria-disabled")!=="true")}function it(t){let e=st(t);e.length&&e[0].focus()}function sr(t){let e=st(t);e.length&&e[e.length-1].focus()}function ar(t){t.directive("dropdown",{priority:15,init(r){Ae()}}),t.directive("dropdown-toggle",{priority:15,init(r){Ae();let o=r.closest("[dropdown]");if(!o)return;let n=o.querySelector("[dropdown-menu]");if(!n)return;r.setAttribute("aria-haspopup","menu"),r.setAttribute("aria-expanded","false"),n.classList.add("nojs-dropdown-menu"),n.setAttribute("role","menu"),n.setAttribute("popover","auto"),n.id||(n.id=`nojs-dd-menu-${Date.now()}-${Yn++}`),r.setAttribute("aria-controls",n.id);let i=!1,c=typeof n.showPopover=="function"&&typeof n.hidePopover=="function";function s(){if(n.setAttribute("data-open",""),c&&!i)try{n.showPopover(),i=!0}catch{i=!1}r.setAttribute("aria-expanded","true"),ir(n,r,o),de.openMenus.set(n,{toggle:r,wrapper:o})}function a(){if(c&&i){i=!1;try{n.hidePopover()}catch{}}n.removeAttribute("data-open"),r.setAttribute("aria-expanded","false"),de.openMenus.delete(n)}function d(){return r.getAttribute("aria-expanded")==="true"}let u=f=>{f.newState==="closed"&&d()&&a()};n.addEventListener("toggle",u);let l=f=>{f.preventDefault(),f.stopPropagation(),d()?a():s()};r.addEventListener("click",l);let m=f=>{d()&&!o.contains(f.target)&&a()};document.addEventListener("click",m,!0);let p=f=>{f.key==="Escape"&&d()&&(a(),r.focus())};document.addEventListener("keydown",p);let g=f=>{switch(f.key){case"Enter":case" ":f.preventDefault(),s(),it(n);break;case"ArrowDown":f.preventDefault(),s(),it(n);break;case"ArrowUp":f.preventDefault(),s(),sr(n);break}};r.addEventListener("keydown",g);let v=f=>{if(!(!d()||st(n).find(h=>h===document.activeElement)))switch(f.key){case"ArrowDown":f.preventDefault(),it(n);break;case"ArrowUp":f.preventDefault(),sr(n);break}};n.addEventListener("keydown",v);let y=()=>{d()&&ir(n,r,o)};window.addEventListener("scroll",y,!0),window.addEventListener("resize",y),Kn(r,()=>{r.removeEventListener("click",l),r.removeEventListener("keydown",g),n.removeEventListener("keydown",v),n.removeEventListener("toggle",u),document.removeEventListener("click",m,!0),document.removeEventListener("keydown",p),window.removeEventListener("scroll",y,!0),window.removeEventListener("resize",y),de.openMenus.delete(n)})}}),t.directive("dropdown-menu",{priority:15,init(r){Ae(),r.hasAttribute("role")||r.setAttribute("role","menu")}});let e=r=>e.open(r);e.open=r=>{let o=document.getElementById(r);if(!o)return!1;let i=o.closest("[dropdown]")?.querySelector("[dropdown-toggle]");return!i||i.getAttribute("aria-expanded")==="true"?!1:(i.click(),!0)},e.close=r=>{let o=document.getElementById(r);if(!o)return!1;let i=o.closest("[dropdown]")?.querySelector("[dropdown-toggle]");return!i||i.getAttribute("aria-expanded")!=="true"?!1:(i.click(),!0)},t.dropdown=e}function cr(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function Xn(t){return[...t.querySelectorAll("[dropdown-item]")].filter(e=>!e.hasAttribute("disabled")&&e.getAttribute("aria-disabled")!=="true")}function at(t,e){if(!t)return;if(typeof t.hidePopover=="function")try{t.hidePopover()}catch{}t.removeAttribute("data-open");let r=e&&e.querySelector("[dropdown-toggle]");r&&r.setAttribute("aria-expanded","false"),de.openMenus.has(t)&&de.openMenus.delete(t)}function dr(t){t.directive("dropdown-item",{priority:15,init(e){Ae();let r=e.closest("[dropdown-menu]"),o=e.closest("[dropdown]");e.setAttribute("role","menuitem"),e.setAttribute("tabindex","-1"),e.classList.add("nojs-dropdown-item"),e.hasAttribute("disabled")&&e.setAttribute("aria-disabled","true");let n=c=>{if(!r)return;let s=Xn(r),a=s.indexOf(e);switch(c.key){case"ArrowDown":{c.preventDefault(),(a+1<s.length?s[a+1]:s[0]).focus();break}case"ArrowUp":{c.preventDefault(),(a-1>=0?s[a-1]:s[s.length-1]).focus();break}case"Home":{c.preventDefault(),s.length&&s[0].focus();break}case"End":{c.preventDefault(),s.length&&s[s.length-1].focus();break}case"Enter":{c.preventDefault(),e.click();break}case"Escape":{if(c.preventDefault(),at(r,o),o){let d=o.querySelector("[dropdown-toggle]");d&&d.focus()}break}case"Tab":{at(r,o);break}}};e.addEventListener("keydown",n),cr(e,()=>e.removeEventListener("keydown",n));let i=()=>{if(at(r,o),o){let c=o.querySelector("[dropdown-toggle]");c&&c.focus()}};e.addEventListener("click",i),cr(e,()=>e.removeEventListener("click",i))}})}function lr(t,e={}){ar(t),dr(t)}function ur(){or()}var ie=new Map,_e=new Set,pr=0;function fr(){return++pr}function gr(){for(let t of _e)clearTimeout(t);_e.clear();for(let t of ie.values())t.remove();ie.clear(),pr=0}function mr(){if(typeof document>"u"||document.querySelector("style[data-nojs-toast]"))return;let t=`
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-toast",""),e.textContent=t,document.head.appendChild(e)}function ct(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}var Zn=new Set(["top-right","top-left","bottom-right","bottom-left","top-center","bottom-center"]);function dt(){return ie.size>0?ie.values().next().value:Nn("top-right")}function Nn(t){if(ie.has(t))return ie.get(t);let e=document.createElement("div");return e.classList.add("nojs-toast-container"),e.setAttribute("data-position",t),e.setAttribute("role","log"),e.setAttribute("aria-live","polite"),e.setAttribute("aria-relevant","additions"),document.body.appendChild(e),ie.set(t,e),e}function Qn(t){return t.startsWith("top")}function lt(t,e,r,o,n){let i=fr(),c=t.getAttribute("data-position")||"top-right",s=document.createElement("div");s.classList.add("nojs-toast"),s.setAttribute("data-toast-id",i),s.setAttribute("data-type",r),r==="error"&&s.setAttribute("aria-live","assertive");let a=document.createElement("span");if(a.textContent=e,s.appendChild(a),n){let d=document.createElement("button");d.type="button",d.classList.add("nojs-toast-dismiss"),d.setAttribute("aria-label","Dismiss"),d.textContent="\xD7",d.addEventListener("click",()=>Ge(s)),s.appendChild(d)}if(Qn(c)&&t.firstChild?t.insertBefore(s,t.firstChild):t.appendChild(s),o>0){let d=setTimeout(()=>{_e.delete(d),s.isConnected&&Ge(s)},o);_e.add(d),s._toastTimerId=d}return s}function Ge(t){!t||!t.isConnected||(t._toastTimerId!=null&&(clearTimeout(t._toastTimerId),_e.delete(t._toastTimerId)),t.remove())}function br(t){mr(),t.directive("toast-container",{priority:10,init(r,o,n){let i=n&&Zn.has(n)?n:"top-right";r.classList.add("nojs-toast-container"),r.setAttribute("data-position",i),r.setAttribute("role","log"),r.setAttribute("aria-live","polite"),r.setAttribute("aria-relevant","additions"),ie.set(i,r),ct(r,()=>{ie.get(i)===r&&ie.delete(i)})}}),t.directive("toast",{priority:10,init(r,o,n){if(!n)return;let i=r.getAttribute("toast-type")||"info",c=parseInt(r.getAttribute("toast-duration"),10),s=Number.isNaN(c)?3e3:c,a=r.getAttribute("toast-dismiss")!=="false";if(r.tagName==="BUTTON"||r.tagName==="A"||r.hasAttribute("on:click")){let g=()=>{let v=dt();lt(v,n,i,s,a)};r.addEventListener("click",g),ct(r,()=>r.removeEventListener("click",g));return}let u=t.findContext(r);if(!u||typeof u.$watch!="function"){console.warn("[toast] reactive toast requires a parent [state] or [use] context \u2014 element will be inert");return}let l;function m(){let g=t.evaluate(n,u);if(g&&g!==l){let v=typeof g=="string"?g:String(g),y=dt();lt(y,v,i,s,a),l=g}else l=g}let p=u.$watch(m);ct(r,p)}});let e=(r,o="info",n=3e3)=>{if(typeof document>"u")return;let i=!0,c=dt();return lt(c,String(r),o,n,i)};e.dismiss=r=>{let o=typeof CSS<"u"&&CSS.escape?CSS.escape(String(r)):String(r).replace(/["\\\]]/g,"\\$&"),n=document.querySelector(`[data-toast-id="${o}"]`);n&&Ge(n)},e.dismissAll=()=>{document.querySelectorAll(".nojs-toast").forEach(r=>Ge(r))},t.toast=e}function hr(t,e={}){br(t)}function vr(){gr()}var me={containers:new Map};function yr(){me.containers.clear()}function xr(){if(typeof document>"u"||document.querySelector("style[data-nojs-tabs]"))return;let t=`
.nojs-tabs {
  display: flex;
  flex-direction: column;
  border: 1px solid #E2E8F0;
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-tree",""),e.textContent=t,document.head.appendChild(e)}function Le(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function Cr(t){let e=[],r=document.createTreeWalker(t,NodeFilter.SHOW_ELEMENT,{acceptNode(n){return n.matches&&n.matches('.nojs-subtree[aria-hidden="true"]')?NodeFilter.FILTER_REJECT:n.getAttribute("role")==="treeitem"?NodeFilter.FILTER_ACCEPT:NodeFilter.FILTER_SKIP}}),o;for(;o=r.nextNode();)e.push(o);return e}function Sr(t){return t.closest('[role="tree"]')}function to(t){let e=t.parentElement?.closest('[role="group"], .nojs-subtree');if(e){let r=e.parentElement?.closest('[role="treeitem"]');if(r)return r;let o=e.previousElementSibling;if(o?.matches?.('[role="treeitem"]'))return o}return t.parentElement?.closest('[role="treeitem"]')||null}function ro(t){let e=t.cloneNode(!0);return e.querySelectorAll('[role="group"]').forEach(o=>o.remove()),(e.textContent||"").trim().toLowerCase()}function ut(t){let e=I.selectedItem;e&&e!==t&&(e.classList.remove("nojs-branch-selected"),e.setAttribute("aria-selected","false")),t.classList.add("nojs-branch-selected"),t.setAttribute("aria-selected","true"),I.selectedItem=t}function Tr(t){let e=I.branches.get(t);!e||!e.subtreeEl||(e.expanded=!e.expanded,t.setAttribute("aria-expanded",String(e.expanded)),e.subtreeEl.setAttribute("aria-hidden",String(!e.expanded)))}function no(t){let e=I.branches.get(t);!e||!e.subtreeEl||e.expanded||(e.expanded=!0,t.setAttribute("aria-expanded","true"),e.subtreeEl.setAttribute("aria-hidden","false"))}function oo(t){let e=I.branches.get(t);!e||!e.subtreeEl||!e.expanded||(e.expanded=!1,t.setAttribute("aria-expanded","false"),e.subtreeEl.setAttribute("aria-hidden","true"))}function Dr(t,e){let r=Sr(e);if(!r)return;let o=Cr(r),n=o.indexOf(e);if(n<0)return;let i=I.branches.get(e),c=i&&i.subtreeEl;switch(t.key){case"ArrowRight":if(t.preventDefault(),c&&!i.expanded)no(e);else if(c&&i.expanded){let s=i.subtreeEl.querySelector('[role="treeitem"]');s&&be(s,o)}break;case"ArrowLeft":if(t.preventDefault(),c&&i.expanded)oo(e);else{let s=to(e);s&&be(s,Cr(r))}break;case"ArrowDown":t.preventDefault(),n<o.length-1&&be(o[n+1],o);break;case"ArrowUp":t.preventDefault(),n>0&&be(o[n-1],o);break;case"Enter":case" ":t.preventDefault(),ut(e),c&&Tr(e);break;case"Home":t.preventDefault(),o.length>0&&be(o[0],o);break;case"End":t.preventDefault(),o.length>0&&be(o[o.length-1],o);break;default:if(t.key.length===1&&!t.ctrlKey&&!t.altKey&&!t.metaKey){t.preventDefault(),I.typeahead+=t.key.toLowerCase(),I.typeaheadTimer&&clearTimeout(I.typeaheadTimer),I.typeaheadTimer=setTimeout(()=>{I.typeahead="",I.typeaheadTimer=null},500);let s=n+1;for(let a=0;a<o.length;a++){let d=(s+a)%o.length;if(ro(o[d]).startsWith(I.typeahead)){be(o[d],o);break}}}break}}function Ir(t){t.directive("tree",{priority:15,init(e){ke(),e.classList.add("nojs-tree"),e.setAttribute("role","tree"),e.getAttribute("tree-icon")==="false"&&e.setAttribute("data-tree-icon","false")}})}function Br(t){t.directive("branch",{priority:16,init(e,r,o){ke();let n=o==="expanded";e.classList.add("nojs-branch"),e.setAttribute("role","treeitem"),e.setAttribute("aria-expanded",String(n));let i=Sr(e);if(i){let d=i.querySelector('[role="treeitem"][tabindex="0"]');e.setAttribute("tabindex",d?"-1":"0")}else e.setAttribute("tabindex","0");let c=!1;queueMicrotask(()=>{if(c)return;let d=e.querySelector(":scope > [subtree], :scope > .nojs-subtree")||(e.nextElementSibling?.matches?.("[subtree], .nojs-subtree")?e.nextElementSibling:null);d?(I.branches.set(e,{expanded:n,subtreeEl:d}),d.setAttribute("aria-hidden",String(!n))):I.branches.set(e,{expanded:n,subtreeEl:null})});let s=d=>{d.target.closest?.('[role="treeitem"]')===e&&(d.stopPropagation(),ut(e),Tr(e))};e.addEventListener("click",s),Le(e,()=>e.removeEventListener("click",s));let a=d=>{Dr(d,e)};e.addEventListener("keydown",a),Le(e,()=>e.removeEventListener("keydown",a)),Le(e,()=>{c=!0,I.branches.delete(e),I.selectedItem===e&&(I.selectedItem=null),I.typeaheadTimer&&(clearTimeout(I.typeaheadTimer),I.typeaheadTimer=null,I.typeahead="")})}})}function be(t,e){for(let r of e)r.setAttribute("tabindex",r===t?"0":"-1");t.focus()}function Fr(t){t.directive("subtree",{priority:16,init(e){ke(),e.classList.add("nojs-subtree"),e.classList.add("nojs-tree"),e.setAttribute("role","group");for(let o of e.children)if(o.tagName==="LI"&&!o.querySelector("[branch], .nojs-branch")){o.setAttribute("role","treeitem"),o.setAttribute("tabindex","-1"),o.classList.add("nojs-tree-leaf");let n=c=>{c.stopPropagation(),ut(o)};o.addEventListener("click",n),Le(o,()=>o.removeEventListener("click",n));let i=c=>{Dr(c,o)};o.addEventListener("keydown",i),Le(o,()=>o.removeEventListener("keydown",i)),Le(o,()=>{I.selectedItem===o&&(I.selectedItem=null)})}let r=e.parentElement?.matches?.('[role="treeitem"]')?e.parentElement:e.previousElementSibling?.matches?.('[role="treeitem"]')?e.previousElementSibling:null;if(r){let o=I.branches.get(r);o?(e.setAttribute("aria-hidden",String(!o.expanded)),o.subtreeEl=e):e.setAttribute("aria-hidden","true")}else e.setAttribute("aria-hidden","true")}})}function Pr(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function pt(t){return t.closest('[role="treeitem"]')}function io(t){return t.closest('[role="tree"]')}function so(t){let e=t.parentElement;return e?[...e.children].filter(r=>r.getAttribute("role")==="treeitem"):[]}function ao(t){return so(t).indexOf(t)}function co(t,e,r){let o=t.getBoundingClientRect(),n=e-o.top,i=o.height;return r==="reparent"?"on":r==="reorder"?n<i/2?"before":"after":n<i*.25?"before":n>i*.75?"after":"on"}function Rr(t,e){let r=t.parentElement;for(;r;){if(r===e)return!0;r=r.parentElement}return!1}var D={dragging:null,indicator:null,currentTarget:null,currentPosition:null};function je(){D.indicator&&(D.indicator.remove(),D.indicator=null)}function De(t){if(!t)return;let e=t.querySelectorAll(".nojs-tree-drag-over");for(let r of e)r.classList.remove("nojs-tree-drag-over")}function lo(){let t=document.createElement("div");return t.className="nojs-tree-drag-indicator",t.setAttribute("aria-hidden","true"),t}function uo(t,e){je();let r=lo(),o=t.getBoundingClientRect(),n=io(t);if(!n)return;let i=n.getBoundingClientRect();r.style.position="absolute",r.style.left=o.left-i.left+"px",r.style.width=o.width+"px",e==="before"?r.style.top=o.top-i.top-1+"px":r.style.top=o.bottom-i.top-1+"px",getComputedStyle(n).position==="static"&&(n.style.position="relative"),n.appendChild(r),D.indicator=r}function $r(t){t.directive("tree-drag-mode",{priority:15,init(e,r,o){if(ke(),o!=="reparent"&&o!=="reorder"&&o!=="both")return;let n=0,i=m=>{let p=pt(m.target);if(p&&e.contains(p)){if(p.hasAttribute("tree-drag-disabled")){m.preventDefault();return}D.dragging={el:p,treeRoot:e},m.dataTransfer&&(m.dataTransfer.effectAllowed="move",m.dataTransfer.setData("text/plain","")),p.classList.add("nojs-dragging"),p.dispatchEvent(new CustomEvent("tree:drag-start",{bubbles:!0,detail:{node:p}}))}},c=m=>{if(!D.dragging||D.dragging.treeRoot!==e)return;let p=pt(m.target);if(!p||!e.contains(p)||p===D.dragging.el||Rr(p,D.dragging.el))return;m.preventDefault(),m.dataTransfer&&(m.dataTransfer.dropEffect="move");let g=co(p,m.clientY,o);(D.currentTarget!==p||D.currentPosition!==g)&&(De(e),je(),D.currentTarget=p,D.currentPosition=g,g==="on"?p.classList.add("nojs-tree-drag-over"):uo(p,g))},s=m=>{D.dragging&&D.dragging.treeRoot===e&&n++},a=m=>{D.dragging&&(n--,n<=0&&(n=0,De(e),je(),D.currentTarget=null,D.currentPosition=null))},d=m=>{if(m.preventDefault(),m.stopPropagation(),n=0,!D.dragging||D.dragging.treeRoot!==e)return;let p=D.dragging.el,g=D.currentTarget,v=D.currentPosition;if(De(e),je(),!g||!v){D.dragging=null,D.currentTarget=null,D.currentPosition=null;return}if(g===p||Rr(g,p)){D.dragging=null,D.currentTarget=null,D.currentPosition=null;return}if(v==="on"){let y=g.querySelector(':scope > [role="group"]');y||(y=g.nextElementSibling?.matches?.('[role="group"]')?g.nextElementSibling:null),y?y.setAttribute("aria-hidden","false"):(y=document.createElement("ul"),y.setAttribute("role","group"),y.setAttribute("subtree",""),y.classList.add("nojs-subtree","nojs-tree"),y.setAttribute("aria-hidden","false"),g.appendChild(y));let f=I.branches.get(g);f&&(f.expanded=!0,f.subtreeEl=y,g.setAttribute("aria-expanded","true")),y.appendChild(p),e.dispatchEvent(new CustomEvent("tree:reparent",{bubbles:!0,detail:{node:p,newParent:g}}))}else{let y=g.parentElement;if(!y){D.dragging=null,D.currentTarget=null,D.currentPosition=null;return}if(v==="before")y.insertBefore(p,g);else{let b=g.nextElementSibling,A=b?.matches?.('[role="group"]')?b.nextElementSibling:b;A?y.insertBefore(p,A):y.appendChild(p)}let f=ao(p);e.dispatchEvent(new CustomEvent("tree:reorder",{bubbles:!0,detail:{node:p,newIndex:f}}))}D.dragging=null,D.currentTarget=null,D.currentPosition=null},u=m=>{let p=pt(m.target);p&&p.classList.remove("nojs-dragging"),De(e),je(),n=0,D.dragging&&D.dragging.el.dispatchEvent(new CustomEvent("tree:drag-end",{bubbles:!0,detail:{node:D.dragging.el}})),D.dragging=null,D.currentTarget=null,D.currentPosition=null};e.addEventListener("dragstart",i),e.addEventListener("dragover",c),e.addEventListener("dragenter",s),e.addEventListener("dragleave",a),e.addEventListener("drop",d),e.addEventListener("dragend",u),Pr(e,()=>{e.removeEventListener("dragstart",i),e.removeEventListener("dragover",c),e.removeEventListener("dragenter",s),e.removeEventListener("dragleave",a),e.removeEventListener("drop",d),e.removeEventListener("dragend",u),De(e),je()}),po(e);let l=new MutationObserver(m=>{for(let p of m)for(let g of p.addedNodes){if(g.nodeType!==1)continue;g.getAttribute("role")==="treeitem"&&ft(g);let v=g.querySelectorAll?.('[role="treeitem"]');if(v)for(let y of v)ft(y)}});l.observe(e,{childList:!0,subtree:!0}),Pr(e,()=>l.disconnect())}})}function ft(t){if(t.hasAttribute("tree-drag-disabled")){t.draggable=!1;return}t.draggable=!0}function po(t){let e=t.querySelectorAll('[role="treeitem"]');for(let r of e)ft(r)}function Mr(t,e={}){Ir(t),Br(t),Fr(t),$r(t)}function qr(){jr()}var Ue=new Map;function zr(){Ue.clear()}function Ye(){if(typeof document>"u"||document.querySelector("style[data-nojs-stepper]"))return;let t=`
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-stepper",""),e.textContent=t,document.head.appendChild(e)}function Hr(t,e){if(!t.hasAttribute("stepper-validate"))return!0;let r=t.querySelector("form[validate]");if(!r)return!0;let n=e(r)?.$form;return n?!!n.valid:!0}function Or(t){let e=t.querySelectorAll("input, textarea, select");for(let r of e)r.dispatchEvent(new Event("focusout",{bubbles:!0}))}function Vr(t,e,r){t.dispatchEvent(new CustomEvent("stepper:validation-blocked",{bubbles:!0,detail:{step:e,form:r}}))}function Ie(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function Wr(t){t.directive("stepper",{priority:14,init(e,r,o){Ye();let n=t.findContext(e),i=Array.from(e.querySelectorAll("[step]"));if(!i.length){console.warn("[stepper] No [step] children found.");return}let c=o&&parseInt(o,10)||0,s=e.getAttribute("stepper-mode")||"linear",a=e.getAttribute("stepper-indicator")!=="false",d=e.getAttribute("stepper-nav")!=="false",u=e.getAttribute("aria-label")||"Stepper",l=Math.max(0,Math.min(c,i.length-1));e.setAttribute("role","group"),e.setAttribute("aria-label",u),e.classList.add("nojs-stepper");let m=null,p=[];if(a){m=document.createElement("div"),m.className="nojs-stepper-indicator",m.setAttribute("role","tablist"),m.setAttribute("aria-label","Progress"),i.forEach((L,S)=>{if(S>0){let q=document.createElement("div");q.className="nojs-stepper-separator",q.setAttribute("aria-hidden","true"),m.appendChild(q)}let w=document.createElement("button");w.type="button",w.className="nojs-stepper-indicator-item",w.setAttribute("role","tab"),w.setAttribute("aria-selected",S===l?"true":"false");let B=L.getAttribute("step-label")||`Step ${S+1}`,H=document.createElement("span");H.textContent=B,w.appendChild(H),w.setAttribute("aria-label",B);let Z=`nojs-stepper-tab-${fo++}`;if(w.id=Z,s==="free"){w.setAttribute("data-clickable","");let q=()=>x(S);w.addEventListener("click",q),Ie(e,()=>w.removeEventListener("click",q))}else w.setAttribute("tabindex","-1");m.appendChild(w),p.push(w)});let j=L=>{if(!["ArrowLeft","ArrowRight","Home","End"].includes(L.key))return;L.preventDefault();let S=l;L.key==="ArrowRight"?S=Math.min(l+1,i.length-1):L.key==="ArrowLeft"?S=Math.max(l-1,0):L.key==="Home"?S=0:L.key==="End"&&(S=i.length-1),s==="free"?(x(S),p[S]?.focus()):p[l]?.focus()};m.addEventListener("keydown",j),Ie(e,()=>m.removeEventListener("keydown",j)),e.insertBefore(m,e.firstChild)}let g=null,v=null,y=null;if(d){g=document.createElement("div"),g.className="nojs-stepper-nav",g.setAttribute("aria-hidden","true"),v=document.createElement("button"),v.type="button",v.className="nojs-stepper-prev",v.textContent="Previous";let j=()=>h();v.addEventListener("click",j),Ie(e,()=>v.removeEventListener("click",j)),y=document.createElement("button"),y.type="button",y.className="nojs-stepper-next",y.textContent="Next";let L=()=>A();y.addEventListener("click",L),Ie(e,()=>y.removeEventListener("click",L)),g.appendChild(v),g.appendChild(y),e.appendChild(g)}function f(j){let L=i[j];if(!L)return!0;if(!Hr(L,t.findContext)){let B=L.querySelector("form[validate]");return B&&(Or(B),p[j]&&p[j].classList.add("nojs-step-invalid"),Vr(e,L,B)),!1}p[j]&&p[j].classList.remove("nojs-step-invalid");let S=L.querySelectorAll("[required]");for(let B of S)if(typeof B.checkValidity=="function"&&!B.checkValidity())return B.reportValidity(),!1;let w=L.getAttribute("step-validate");if(w)try{if(!t.evaluate(w,n))return!1}catch(B){return console.warn(`[stepper] step-validate error: ${B.message}`),!1}return!0}function b(j){i.forEach((L,S)=>{let w=S===l;L.setAttribute("aria-hidden",w?"false":"true"),w?(L.removeAttribute("inert"),L.setAttribute("aria-current","step")):(L.setAttribute("inert",""),L.removeAttribute("aria-current"))}),p.length&&p.forEach((L,S)=>{L.setAttribute("aria-selected",S===l?"true":"false"),S<l?L.setAttribute("data-completed",""):L.removeAttribute("data-completed"),L.setAttribute("tabindex",S===l?"0":"-1");let w=i[S];w.id&&(L.setAttribute("aria-controls",w.id),w.setAttribute("aria-labelledby",L.id))}),v&&(v.disabled=l===0),y&&(y.textContent=l===i.length-1?"Finish":"Next"),e.dispatchEvent(new CustomEvent("step-change",{bubbles:!j,detail:{current:l,total:i.length}}))}function A(){return l>=i.length-1?(s==="linear"&&!f(l)||e.dispatchEvent(new CustomEvent("step-complete",{bubbles:!0,detail:{current:l,total:i.length}})),!1):s==="linear"&&!f(l)?!1:(l++,b(),k(),!0)}function h(){return l<=0?!1:(l--,b(),k(),!0)}function x(j){if(j<0||j>=i.length||j===l)return!1;if(s==="linear"&&j>l){for(let L=l;L<j;L++)if(l=L,b(),!f(L))return k(),!1}return l=j,b(),k(),!0}let _={get current(){return l},get total(){return i.length},next:A,prev:h,goTo:x,get isFirst(){return l===0},get isLast(){return l===i.length-1}};function k(){n.$stepper=_}k(),Ue.set(e,{get current(){return l},steps:i,mode:s,indicatorEl:m,navEl:g}),b(!0),Ie(e,()=>{Ue.delete(e),m&&m.parentNode&&m.remove(),g&&g.parentNode&&g.remove(),delete n.$stepper})}})}var fo=0;var go=0;function Gr(t){t.directive("step",{priority:13,init(e,r,o){Ye(),e.classList.add("nojs-step"),e.setAttribute("role","tabpanel"),e.id||(e.id=`nojs-stepper-panel-${go++}`),e.setAttribute("tabindex","0")}})}function Ur(t,e={}){Gr(t),Wr(t)}function Yr(){zr()}function Kr(){if(typeof document>"u"||document.querySelector("style[data-nojs-skeleton]"))return;let t=`
.nojs-skeleton {
  position: relative;
  overflow: hidden;
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-split",""),e.textContent=t,document.head.appendChild(e)}function mo(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function Jr(t){return t==="horizontal"?"clientX":"clientY"}function N(t,e){let r=t.getBoundingClientRect?t.getBoundingClientRect():null,o=r&&(e==="horizontal"?r.width:r.height);return o||(e==="horizontal"?t.offsetWidth:t.offsetHeight)}function en(t,e){if(e!=="horizontal")return 1;try{return(t.closest&&t.closest("[dir]")?.getAttribute("dir")||(typeof getComputedStyle=="function"?getComputedStyle(t).direction:""))==="rtl"?-1:1}catch{return 1}}function bo(t,e){let o=(he.get(t)?.gutters||[]).reduce((n,i)=>n+N(i,e),0);return N(t,e)-o}function ho(t,e){if(!t)return null;let r=parseFloat(t);return Number.isNaN(r)?null:typeof t=="string"&&t.trim().endsWith("%")?r/100*e:r}function Be(t,e){let r=G.get(e);return r?r.min!=null&&t<r.min?r.min:r.max!=null&&t>r.max?r.max:t:t}function Xe(t,e,r,o){let n=N(e,o),i=N(r,o),c=G.get(e),s=G.get(r);t.setAttribute("aria-valuenow",Math.round(n)),t.setAttribute("aria-valuemin",c?.min||0),t.setAttribute("aria-valuemax",Math.round(n+i-(s?.min||0)))}function gt(t){let e=t.getAttribute("split-persist");if(!e)return;let r=he.get(t);if(!r)return;let o=r.panes.map(n=>n.style.flexBasis||"");try{localStorage.setItem(`nojs-split:${e}`,JSON.stringify(o))}catch{}}function vo(t){let e=t.getAttribute("split-persist");if(!e)return!1;try{let r=localStorage.getItem(`nojs-split:${e}`);if(!r)return!1;let o=JSON.parse(r),n=he.get(t);return!n||o.length!==n.panes.length?!1:(o.forEach((i,c)=>{i&&(n.panes[c].style.flexBasis=i,n.panes[c].style.flexGrow="0")}),!0)}catch{return!1}}function yo(t,e,r,o,n){let i=document.createElement("div");i.className="nojs-gutter",i.setAttribute("role","separator"),i.setAttribute("tabindex","0"),i.setAttribute("aria-orientation",e==="horizontal"?"vertical":"horizontal"),i.setAttribute("aria-label","Resize"),n!==6&&i.style.setProperty("--nojs-gutter-size",`${n}px`);let c=p=>{if(p.button!==0)return;p.preventDefault();let g=bo(t,e);C.active=!0,C.splitEl=t,C.gutterEl=i,C.prevPane=r,C.nextPane=o,C.direction=e,C.startPos=p[Jr(e)],C.startPrevSize=N(r,e),C.startNextSize=N(o,e),C.containerSize=g,C.sign=en(t,e),document.body.style.cursor=e==="horizontal"?"col-resize":"row-resize",document.body.style.userSelect="none",i.setPointerCapture(p.pointerId)},s=p=>{if(!C.active||C.gutterEl!==i)return;let g=(p[Jr(C.direction)]-C.startPos)*(C.sign||1),v=Be(C.startPrevSize+g,C.prevPane),y=Be(C.startNextSize-g,C.nextPane),f=C.startPrevSize+C.startNextSize;v+y!==f&&(v!==C.startPrevSize+g?y=f-v:v=f-y),C.prevPane.style.flexBasis=`${v}px`,C.prevPane.style.flexGrow="0",C.nextPane.style.flexBasis=`${y}px`,C.nextPane.style.flexGrow="0",Xe(i,C.prevPane,C.nextPane,C.direction)},a=()=>{!C.active||C.gutterEl!==i||(C.active=!1,document.body.style.cursor="",document.body.style.userSelect="",gt(t),t.dispatchEvent(new CustomEvent("split-resize",{bubbles:!0,detail:{prevPane:r,nextPane:o}})))};i.addEventListener("pointerdown",c),i.addEventListener("pointermove",s),i.addEventListener("pointerup",a),i.addEventListener("pointercancel",a);let d=10,u=p=>{let g=e==="horizontal",v=en(t,e),y=0;if(g&&p.key==="ArrowRight"||!g&&p.key==="ArrowDown")y=d*v;else if(g&&p.key==="ArrowLeft"||!g&&p.key==="ArrowUp")y=-d*v;else if(p.key==="Home")y=(G.get(r)?.min||0)-N(r,e);else if(p.key==="End"){let _=G.get(o);y=N(r,e)+N(o,e)-(_?.min||0)-N(r,e)}else return;p.preventDefault();let f=N(r,e),b=N(o,e),A=f+b,h=Be(f+y,r),x=Be(A-h,o);h=A-x,h=Be(h,r),x=A-h,r.style.flexBasis=`${h}px`,r.style.flexGrow="0",o.style.flexBasis=`${x}px`,o.style.flexGrow="0",Xe(i,r,o,e),gt(t)};i.addEventListener("keydown",u);let l=()=>{let p=G.get(r),g=G.get(o),v=p?.collapsible?r:g?.collapsible?o:null;if(!v)return;let y=G.get(v);if(!y)return;let f=v===r?o:r,b=N(r,e)+N(o,e);if(y.collapsed){y.collapsed=!1,v.removeAttribute("data-collapsed");let A=y.preCollapseSize||`${Math.round(b/2)}px`,h=ho(A,b)??b/2,x=Math.min(h,b);v.style.flexBasis=`${x}px`,v.style.flexGrow="0",f.style.flexBasis=`${b-x}px`,f.style.flexGrow="0"}else y.preCollapseSize=v.style.flexBasis||`${N(v,e)}px`,y.collapsed=!0,v.setAttribute("data-collapsed","true"),v.style.flexBasis="0px",v.style.flexGrow="0",f.style.flexBasis=`${b}px`,f.style.flexGrow="0";Xe(i,r,o,e),gt(t),t.dispatchEvent(new CustomEvent("split-collapse",{bubbles:!0,detail:{pane:v,collapsed:y.collapsed}}))};return i.addEventListener("dblclick",l),{gutter:i,cleanup:()=>{i.removeEventListener("pointerdown",c),i.removeEventListener("pointermove",s),i.removeEventListener("pointerup",a),i.removeEventListener("pointercancel",a),i.removeEventListener("keydown",u),i.removeEventListener("dblclick",l)}}}function tn(t){t.directive("split",{priority:14,init(e,r,o){Ke();let n=(o||"horizontal").trim()==="vertical"?"vertical":"horizontal",i=parseInt(e.getAttribute("split-gutter"),10)||6;e.classList.add("nojs-split"),e.setAttribute("data-direction",n);let c=Array.from(e.children).filter(u=>u.hasAttribute("pane"));if(c.length<2){console.warn(`[split] Container requires at least 2 [pane] children, found ${c.length}.`);return}c.forEach(u=>{G.get(u)||G.set(u,{size:u.getAttribute("pane")||null,min:parseInt(u.getAttribute("pane-min"),10)||0,max:parseInt(u.getAttribute("pane-max"),10)||1/0,collapsible:u.getAttribute("pane-collapsible")==="true",collapsed:!1,preCollapseSize:null})});let s=[],a=[];for(let u=0;u<c.length-1;u++){let{gutter:l,cleanup:m}=yo(e,n,c[u],c[u+1],i);c[u].after(l),s.push(l),a.push(m)}he.set(e,{direction:n,gutterSize:i,panes:c,gutters:s}),vo(e)||c.forEach(u=>{let m=G.get(u)?.size;m?(u.style.flexBasis=m,u.style.flexGrow="0"):(u.style.flexGrow="1",u.style.flexBasis="0")}),requestAnimationFrame(()=>{s.forEach((u,l)=>{Xe(u,c[l],c[l+1],n)})}),mo(e,()=>{a.forEach(u=>u()),s.forEach(u=>u.remove()),he.delete(e),c.forEach(u=>G.delete(u)),e.classList.remove("nojs-split"),e.removeAttribute("data-direction")})}})}function xo(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function rn(t){t.directive("pane",{priority:15,init(e,r,o){Ke(),e.classList.add("nojs-pane"),G.has(e)||G.set(e,{size:o||null,min:parseInt(e.getAttribute("pane-min"),10)||0,max:parseInt(e.getAttribute("pane-max"),10)||1/0,collapsible:e.getAttribute("pane-collapsible")==="true",collapsed:!1,preCollapseSize:null});let n=G.get(e),i=e.closest("[data-direction='vertical']")?"height":"width";n.min&&(e.style[`min${i==="width"?"Width":"Height"}`]=`${n.min}px`),n.max&&n.max!==1/0&&(e.style[`max${i==="width"?"Width":"Height"}`]=`${n.max}px`),xo(e,()=>{e.classList.remove("nojs-pane"),G.delete(e),e.style.removeProperty("min-width"),e.style.removeProperty("min-height"),e.style.removeProperty("max-width"),e.style.removeProperty("max-height"),e.style.removeProperty("flex-basis"),e.style.removeProperty("flex-grow")})}})}function nn(t,e={}){tn(t),rn(t)}function on(){Qr()}var le={sorts:new Map};function sn(){le.sorts.clear()}function ve(){if(typeof document>"u"||document.querySelector("style[data-nojs-table]"))return;let t=`
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-table",""),e.textContent=t,document.head.appendChild(e)}function Eo(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function wo(t,e){let r=t.querySelector("tbody");if(!r)return null;let o=null;if(r.hasAttribute("each")||r.hasAttribute("foreach")?o=r:o=r.querySelector("[each]")||r.querySelector("[foreach]"),!o)return null;let n=o.getAttribute("each")||o.getAttribute("foreach");if(!n)return null;let i=n.match(/^\s*(\w+)\s+(?:in|of)\s+(.+)\s*$/);return i?{iteratorVar:i[1],arrayPath:i[2].trim()}:null}function Ao(t,e){let r=e.split("."),o=t;for(let n of r){if(o==null)return;o=o[n]}return o}function an(t,e,r){let o=e.split("."),n=t;for(let i=0;i<o.length-1;i++){if(n[o[i]]==null)return;n=n[o[i]]}n[o[o.length-1]]=r}function cn(t,e){let r=Number.isNaN(t),o=Number.isNaN(e);return r&&o?0:r?1:o||t<e?-1:t>e?1:0}function ln(t,e,r){if(t==null&&e==null)return 0;if(t==null)return-1;if(e==null)return 1;switch(r){case"number":return cn(Number(t),Number(e));case"date":return cn(new Date(t).getTime(),new Date(e).getTime());default:return String(t).localeCompare(String(e))}}function _o(t){let e=t.querySelectorAll("th[data-sortable]");for(let r of e)r.removeAttribute("data-sort-dir"),r.setAttribute("aria-sort","none")}function un(t){t.directive("sortable",{priority:10,init(e){ve(),e.classList.add("nojs-sortable")}})}function pn(t){t.directive("sort",{priority:11,init(e,r,o){ve();let n=o;if(!n)return;let i=e.getAttribute("sort-type")||"string",c=e.getAttribute("sort-default");e.setAttribute("data-sortable",""),e.setAttribute("aria-sort","none");let s=e.closest("table");if(!s)return;le.sorts.has(s)||le.sorts.set(s,{column:null,direction:null}),(c==="asc"||c==="desc")&&(le.sorts.get(s).column||dn(e,s,n,i,c,t));let a=()=>{let d=le.sorts.get(s),u;d.column!==n?u="asc":d.direction==="asc"?u="desc":d.direction==="desc"?u=null:u="asc",dn(e,s,n,i,u,t)};e.addEventListener("click",a),Eo(e,()=>{e.removeEventListener("click",a),s&&!s.isConnected&&(le.sorts.delete(s),delete s._nojsOriginalOrder,delete s._nojsOriginalRows)})}})}function dn(t,e,r,o,n,i){let c=le.sorts.get(e);_o(e),n?(t.setAttribute("data-sort-dir",n),t.setAttribute("aria-sort",n==="asc"?"ascending":"descending"),c.column=r,c.direction=n):(c.column=null,c.direction=null);let s=wo(e,i);if(s){let a=i.findContext(e),d=a?Ao(a,s.arrayPath):null;if(Array.isArray(d)){if(!n){let l=e._nojsOriginalOrder;if(l){let m=new Set(d),p=l.filter(g=>m.has(g));for(let g of d)l.includes(g)||p.push(g);an(a,s.arrayPath,p)}return}e._nojsOriginalOrder||(e._nojsOriginalOrder=[...d]);let u=[...d].sort((l,m)=>{let p=l!=null?l[r]:null,g=m!=null?m[r]:null,v=ln(p,g,o);return n==="desc"?-v:v});an(a,s.arrayPath,u);return}}ko(e,t,r,o,n)}function ko(t,e,r,o,n){let i=t.querySelector("tbody");if(!i)return;let a=[...e.closest("tr").children].indexOf(e);if(a<0)return;let d=[...i.querySelectorAll(":scope > tr")];if(t._nojsOriginalRows||(t._nojsOriginalRows=[...d]),!n){let m=document.createDocumentFragment();for(let p of t._nojsOriginalRows)m.appendChild(p);i.appendChild(m);return}let u=m=>{let p=m.replace(/[^0-9.\-]/g,"");return p===""||p==="-"?NaN:parseFloat(p)};d.sort((m,p)=>{let g=m.children[a]?.textContent?.trim()||"",v=p.children[a]?.textContent?.trim()||"",y=ln(o==="number"?u(g):g,o==="number"?u(v):v,o);return n==="desc"?-y:y});let l=document.createDocumentFragment();for(let m of d)l.appendChild(m);i.appendChild(l)}function fn(t){t.directive("fixed-header",{priority:10,init(e){ve(),e.classList.add("nojs-fixed-header")}})}function gn(t){t.directive("fixed-col",{priority:10,init(e){ve(),e.classList.add("nojs-fixed-col")}})}function mt(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function mn(t){let e=t.querySelector("tbody");if(!e)return null;let r=null;if(e.hasAttribute("each")||e.hasAttribute("foreach")?r=e:r=e.querySelector("[each]")||e.querySelector("[foreach]"),!r)return null;let o=r.getAttribute("each")||r.getAttribute("foreach");if(!o)return null;let n=o.match(/^\s*(\w+)\s+(?:in|of)\s+(.+)\s*$/);return n?{iteratorVar:n[1],arrayPath:n[2].trim(),eachEl:r}:null}function bn(t,e){let r=e.split("."),o=t;for(let n of r){if(o==null)return;o=o[n]}return o}function hn(t,e,r){let o=e.split("."),n=t;for(let i=0;i<o.length-1;i++){if(n[o[i]]==null)return;n=n[o[i]]}n[o[o.length-1]]=r}function vn(t){t.directive("table-reorder",{priority:15,init(e){if(ve(),e.tagName!=="TABLE")return;let r=e.querySelector("tbody");if(!r)return;let o=t.findContext(e),n=e.getAttribute("table-reorder-handle"),i=e.getAttribute("table-reorder-drag-class")||"nojs-row-dragging",c=e.getAttribute("table-reorder-over-class")||"nojs-row-drag-over",s=null,a=null,d=null;function u(){let y=r.querySelectorAll(":scope > tr");for(let f=0;f<y.length;f++){let b=y[f];if(b._nojsReorderSetup)continue;b._nojsReorderSetup=!0,b.draggable=!0,b.setAttribute("aria-grabbed","false");let A=!0;if(n){let L=S=>{A=!!S.target.closest(n)};b.addEventListener("mousedown",L),mt(b,()=>b.removeEventListener("mousedown",L))}let h=L=>{if(n&&!A){L.preventDefault();return}s=[...r.querySelectorAll(":scope > tr")].indexOf(b),a=b,L.dataTransfer&&(L.dataTransfer.effectAllowed="move",L.dataTransfer.setData("text/plain","")),i.split(/\s+/).filter(Boolean).forEach(w=>b.classList.add(w)),b.setAttribute("aria-grabbed","true")},x=L=>{if(a==null)return;L.preventDefault(),L.dataTransfer&&(L.dataTransfer.dropEffect="move");let S=b.getBoundingClientRect(),w=S.top+S.height/2,H=[...r.querySelectorAll(":scope > tr")].indexOf(b);l(),H!==s&&(L.clientY<w?b.classList.add("nojs-reorder-insert-before"):b.classList.add("nojs-reorder-insert-after"),d=b)},_=()=>{b.classList.remove("nojs-reorder-insert-before"),b.classList.remove("nojs-reorder-insert-after"),d===b&&(d=null)},k=L=>{if(L.preventDefault(),L.stopPropagation(),a==null||s==null)return;let S=[...r.querySelectorAll(":scope > tr")],w=b.getBoundingClientRect(),B=w.top+w.height/2,H=S.indexOf(b);L.clientY>=B&&H++;let Z=s;if(Z===H||Z+1===H){m();return}let q=Z<H?H-1:H,se=mn(e);if(se&&o){let T=bn(o,se.arrayPath);if(Array.isArray(T)){let P=[...T],[M]=P.splice(Z,1);P.splice(q,0,M),hn(o,se.arrayPath,P),e._nojsOriginalOrder&&(e._nojsOriginalOrder=[...P]),e.dispatchEvent(new CustomEvent("table:reorder",{bubbles:!0,detail:{from:Z,to:q,item:M}}))}}else{let T=a,P=S[q];T&&P&&(Z<q?r.insertBefore(T,P.nextSibling):r.insertBefore(T,P),e.dispatchEvent(new CustomEvent("table:reorder",{bubbles:!0,detail:{from:Z,to:q,item:null}})))}m()},j=()=>{m()};b.addEventListener("dragstart",h),b.addEventListener("dragover",x),b.addEventListener("dragleave",_),b.addEventListener("drop",k),b.addEventListener("dragend",j),mt(b,()=>{b.removeEventListener("dragstart",h),b.removeEventListener("dragover",x),b.removeEventListener("dragleave",_),b.removeEventListener("drop",k),b.removeEventListener("dragend",j),b._nojsReorderSetup=!1})}}function l(){d&&(d.classList.remove("nojs-reorder-insert-before"),d.classList.remove("nojs-reorder-insert-after"),d=null)}function m(){a&&(i.split(/\s+/).filter(Boolean).forEach(f=>a.classList.remove(f)),a.setAttribute("aria-grabbed","false")),l(),s=null,a=null;let y=r.querySelectorAll(":scope > tr");for(let f of y)f.classList.remove("nojs-reorder-insert-before"),f.classList.remove("nojs-reorder-insert-after"),c.split(/\s+/).filter(Boolean).forEach(b=>f.classList.remove(b))}let p=y=>{a!=null&&(y.preventDefault(),y.dataTransfer&&(y.dataTransfer.dropEffect="move"))},g=y=>{if(a==null||y.target!==r)return;y.preventDefault(),y.stopPropagation();let f=s,A=[...r.querySelectorAll(":scope > tr")].length-1;if(f===A){m();return}let h=mn(e);if(h&&o){let x=bn(o,h.arrayPath);if(Array.isArray(x)){let _=[...x],[k]=_.splice(f,1);_.push(k),hn(o,h.arrayPath,_),e._nojsOriginalOrder&&(e._nojsOriginalOrder=[..._]),e.dispatchEvent(new CustomEvent("table:reorder",{bubbles:!0,detail:{from:f,to:_.length-1,item:k}}))}}m()};r.addEventListener("dragover",p),r.addEventListener("drop",g);let v=new MutationObserver(()=>{u()});v.observe(r,{childList:!0}),u(),mt(e,()=>{v.disconnect(),r.removeEventListener("dragover",p),r.removeEventListener("drop",g),m()})}})}function yn(t,e={}){un(t),pn(t),fn(t),gn(t),vn(t)}function xn(){sn()}var ue=new Map,Ze=new Map;function En(){for(let[t,e]of ue){if(e.observer)try{e.observer.disconnect()}catch{}for(let r of e.spyEntries){let o=r.el&&r.el.__disposers;if(o){for(let n of o)try{n()}catch{}r.el.__disposers=[]}}}ue.clear(),Ze.clear()}function wn(){if(typeof document>"u"||document.querySelector("style[data-nojs-scroll-spy]"))return;let t=`
[spy].active,
a[href^="#"].active {
  font-weight: 600;
}
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-scroll-spy",""),e.textContent=t,document.head.appendChild(e)}function Lo(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function jo(t){if(t.tagName==="A"){let r=t.getAttribute("href")||"";if(r.startsWith("#")&&r.length>1)return r.slice(1)}let e=t.getAttribute("spy")||"";return e.startsWith("#")&&e.length>1?e.slice(1):e.length>0?e:null}function Co(t){let e=t.getAttribute("spy-offset");if(e===null||e==="")return 0;let r=parseInt(e,10);return Number.isNaN(r)?0:r}function So(t){let e=t.getAttribute("spy-threshold");if(e===null||e==="")return .1;let r=parseFloat(e);return Number.isNaN(r)||r<0||r>1?.1:r}function To(){return document.documentElement}function Do(t){t.classList.add("active"),t.setAttribute("aria-current","true")}function An(t){t.classList.remove("active"),t.removeAttribute("aria-current")}function bt(t){let e=ue.get(t);if(!e)return;e.observer&&(e.observer.disconnect(),e.observer=null);let r=e.offset,o=e.threshold,n=new Set,i=`-${r}px 0px 0px 0px`,c=new IntersectionObserver(a=>{for(let l of a)l.isIntersecting?n.add(l.target.id):n.delete(l.target.id);let d=null,u=1/0;for(let l of n){let m=document.getElementById(l);if(!m)continue;let p=m.getBoundingClientRect();p.top<u&&(u=p.top,d=l)}for(let l of e.spyEntries)An(l.el);if(d){for(let l of e.spyEntries)if(l.targetId===d){Do(l.el),e.activeEl=l.el;break}}else e.activeEl=null},{rootMargin:i,threshold:o}),s=new Set;for(let a of e.spyEntries){if(s.has(a.targetId))continue;let d=document.getElementById(a.targetId);d&&(c.observe(d),s.add(a.targetId))}e.observer=c}function Io(t,e){t&&typeof t._warn=="function"?t._warn(e):console.warn(e)}function _n(t){t.directive("spy",{priority:20,init(e,r,o){wn();let n=jo(e);if(!n){e.tagName!=="A"&&Io(t,'[spy] could not resolve target ID. Use spy="#targetId" or href="#targetId" on <a>.');return}let i=Co(e),c=So(e),s=To();ue.has(s)||ue.set(s,{observer:null,spyEntries:[],activeEl:null,offset:i,threshold:c});let a=ue.get(s),d={el:e,targetId:n};a.spyEntries.push(d),Ze.set(e,s),bt(s);let u=null;typeof MutationObserver<"u"&&(u=new MutationObserver(()=>{document.getElementById(n)&&a.observer&&bt(s)}),u.observe(document.body,{childList:!0,subtree:!0})),Lo(e,()=>{let l=a.spyEntries.indexOf(d);l!==-1&&a.spyEntries.splice(l,1),Ze.delete(e),An(e),u&&(u.disconnect(),u=null),a.spyEntries.length===0?(a.observer&&(a.observer.disconnect(),a.observer=null),ue.delete(s)):bt(s)})}})}function kn(t,e={}){_n(t)}function Ln(){En()}var Bo="[validate],[drag],[drop],[drag-list],[drag-multiple]";function jn(t){if(typeof document>"u")return;let e=document.querySelectorAll(Bo);for(let r of e){if(!r.__declared)continue;let o=X(t,"disposeTree");typeof o=="function"?o(r):(r.__disposers&&(r.__disposers.forEach(i=>i()),r.__disposers=null),r.__declared=!1);let n=t.findContext?t.findContext(r):null;n&&delete n.$form,t.processTree(r)}}var Fo=["tooltip","popover","popover-trigger","popover-dismiss","modal","modal-open","modal-close","dropdown","dropdown-toggle","dropdown-menu","dropdown-item","toast","toast-container","tabs","tab","tab-disabled","tab-position","tree","branch","subtree","stepper","step","skeleton","split","pane","panel","sortable","sort","fixed-header","fixed-col","spy","spy-offset","spy-threshold"],Po={name:"nojs-elements",install(t,e={}){kt(t,e),Pt(t,e),Ot(t,e),Ut(t,e),rr(t,e),lr(t,e),hr(t,e),kr(t,e),Mr(t,e),Ur(t,e),Nr(t,e),nn(t,e),yn(t,e),kn(t,e),jn(t)},init(t){if(jn(t),typeof document>"u"||!document.body)return;let e=Fo.map(o=>`[${o}]`).join(","),r;try{r=document.body.querySelectorAll(e)}catch{return}for(let o of r)o.__declared&&!o.__disposers&&!o.__ctx&&(o.__declared=!1);try{t.processTree(document.body)}catch(o){t.internals?.warn?.("nojs-elements init re-process error:",o.message)}},dispose(t){Lt(),Rt(),Vt(),Yt(),nr(),ur(),vr(),Lr(),qr(),Yr(),on(),xn(),Ln()}},Ia=Po;export{Ia as default};

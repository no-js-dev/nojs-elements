...
`.trim(),t=document.createElement("style");t.setAttribute("data-nojs-tooltip",""),t.textContent=e,document.head.appendChild(t)}function $e(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}var Z=8;function Re(e,t,r){let i=t.getBoundingClientRect(),o=e.getBoundingClientRect(),n=window.innerWidth,d=window.innerHeight,s,l;switch(r){case"bottom":s=i.bottom+Z,l=i.left+(i.width-o.width)/2;break;case"left":s=i.top+(i.height-o.height)/2,l=i.left-o.width-Z;break;case"right":s=i.top+(i.height-o.height)/2,l=i.right+Z;break;default:s=i.top-o.height-Z,l=i.left+(i.width-o.width)/2;break}l<4&&(l=4),l+o.width>n-4&&(l=n-o.width-4),s<4&&(s=4),s+o.height>d-4&&(s=d-o.height-4),e.style.top=`${s}px`,e.style.left=`${l}px`}var Oe=0;function Ge(e,t,r){document.body.appendChild(t),Re(t,e,r),t.setAttribute("aria-hidden","false")}function We(e,t){t.setAttribute("aria-hidden","true"),t.remove()}function wt(e){e.directive("tooltip",{priority:20,init(t,r,i){xt();let o=i;if(!o){console.warn("[tooltip] attribute value (tooltip text) is required.");return}let n=t.getAttribute("tooltip-position")||"top",d=parseInt(t.getAttribute("tooltip-delay"),10)||300,s=t.getAttribute("tooltip-disabled"),l=s?e.findContext(t):null,f=`nojs-tooltip-${++Oe}`,u=document.createElement("div");u.className="nojs-tooltip",u.setAttribute("role","tooltip"),u.setAttribute("id",f),u.setAttribute("aria-hidden","true"),u.textContent=o,t.setAttribute("aria-describedby",f),U.set(t,u);let m=()=>{if(s&&l&&e.evaluate(s,l))return;C.has(t)&&clearTimeout(C.get(t));let y=setTimeout(()=>{C.delete(t),!(s&&l&&e.evaluate(s,l))&&Ge(t,u,n)},d);C.set(t,y)},g=()=>{C.has(t)&&(clearTimeout(C.get(t)),C.delete(t)),We(t,u)},p=()=>m(),a=()=>g(),c=()=>m(),b=()=>g(),h=y=>{y.key==="Escape"&&u.getAttribute("aria-hidden")==="false"&&g()};t.addEventListener("mouseenter",p),t.addEventListener("mouseleave",a),t.addEventListener("focusin",c),t.addEventListener("focusout",b),t.addEventListener("keydown",h),$e(t,()=>{t.removeEventListener("mouseenter",p),t.removeEventListener("mouseleave",a),t.removeEventListener("focusin",c),t.removeEventListener("focusout",b),t.removeEventListener("keydown",h),C.has(t)&&(clearTimeout(C.get(t)),C.delete(t)),u.remove(),U.delete(t)})}})}function At(e,t={}){wt(e)}function Et(){yt()}var _=new Map;function jt(){_.clear()}function Q(){if(typeof document>"u"||document.querySelector("style[data-nojs-popover]"))return;let e=`
.nojs-popover {
  position: fixed;
  z-index: 9998;
  margin: 0;
...
`.trim(),t=document.createElement("style");t.setAttribute("data-nojs-modal",""),t.textContent=e,document.head.appendChild(t)}function Ue(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}var Dt='a[href], button:not([disabled]), input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])',lt=new WeakMap;function Ke(e){let t=r=>{if(r.key!=="Tab")return;let i=[...e.querySelectorAll(Dt)].filter(d=>d.offsetParent!==null);if(i.length===0){r.preventDefault();return}let o=i[0],n=i[i.length-1];r.shiftKey?document.activeElement===o&&(r.preventDefault(),n.focus()):document.activeElement===n&&(r.preventDefault(),o.focus())};e.addEventListener("keydown",t),lt.set(e,t)}function Tt(e){let t=lt.get(e);t&&(e.removeEventListener("keydown",t),lt.delete(e))}var K=new WeakMap;function It(e){e.directive("modal",{priority:10,init(r,i,o){H();let n=o||`nojs-modal-${Date.now()}-${Math.random().toString(36).slice(2,7)}`;r.setAttribute("popover","manual"),r.classList.add("nojs-modal"),r.id=r.id||`nojs-modal-${n}`,r.setAttribute("data-modal-id",n),r.setAttribute("role","dialog"),r.setAttribute("aria-modal","true");let d=r.querySelector("h1, h2, h3, h4, h5, h6");d&&(d.id||(d.id=`nojs-modal-heading-${n}`),r.setAttribute("aria-labelledby",d.id));let s=r.getAttribute("modal-backdrop");s==="false"&&r.setAttribute("data-nojs-no-backdrop","");let l=r.getAttribute("modal-class"),f=r.getAttribute("modal-escape"),u=g=>{g.target===r&&s!=="false"&&f!=="false"&&$(r,n)};r.addEventListener("click",u),T.set(n,r);let m=g=>{if(g.newState==="open"){if(r.style.zIndex=String(Lt()),l&&l.split(/\s+/).filter(Boolean).forEach(p=>r.classList.add(p)),requestAnimationFrame(()=>{let p=r.querySelector(Dt);p?p.focus():r.focus()}),Ke(r),f!=="false"){let p=a=>{a.key==="Escape"&&(a.stopPropagation(),$(r,n))};r.addEventListener("keydown",p),K.set(r,p)}}else if(g.newState==="closed"){l&&l.split(/\s+/).filter(Boolean).forEach(c=>r.classList.remove(c)),Tt(r);let p=K.get(r);p&&(r.removeEventListener("keydown",p),K.delete(r));let a=L.findIndex(c=>c.id===n);if(a!==-1){let c=L[a];L.splice(a,1),c.triggerEl&&requestAnimationFrame(()=>{c.triggerEl.focus()})}}};r.addEventListener("toggle",m),Ue(r,()=>{r.removeEventListener("click",u),r.removeEventListener("toggle",m),Tt(r);let g=K.get(r);g&&(r.removeEventListener("keydown",g),K.delete(r)),T.delete(n);let p=L.findIndex(a=>a.id===n);p!==-1&&L.splice(p,1)})}});let t=r=>t.open(r);t.open=r=>{let i=T.get(r);if(!i)return!1;L.push({id:r,el:i,triggerEl:null});try{i.showPopover()}catch{return!1}return!0},t.close=r=>{let i=T.get(r);return i?($(i,r),!0):!1},t.closeAll=()=>{for(let r=L.length-1;r>=0;r--)$(L[r].el,L[r].id)},e.modal=t}function $(e,t){try{e.hidePopover()}catch{}}function Ne(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}function zt(e){e.directive("modal-open",{priority:10,init(t,r,i){H();let o=i;if(!o){let m=(t.closest("[use]")||t.parentElement)?.querySelector("[data-modal-id]");if(m&&(o=m.getAttribute("data-modal-id")),!o){console.warn('[modal-open] requires a target modal ID, e.g. modal-open="my-dialog"');return}}t.setAttribute("aria-haspopup","dialog"),t.setAttribute("aria-expanded","false");let n=()=>{let u=T.get(o)||document.querySelector(`[data-modal-id="${o}"]`);if(!u){console.warn(`[modal-open] modal "${o}" not found`);return}L.push({id:o,el:u,triggerEl:t}),t.setAttribute("aria-expanded","true"),u.id&&t.setAttribute("aria-controls",u.id);try{u.showPopover()}catch{console.warn(`[modal-open] failed to open modal "${o}"`)}},d=()=>{t.setAttribute("aria-expanded","false")},s=null,l=null;requestAnimationFrame(()=>{let u=T.get(o);u&&(l=u,s=m=>{m.newState==="closed"&&t.setAttribute("aria-expanded","false")},u.addEventListener("toggle",s))}),t.addEventListener("click",n),Ne(t,()=>{t.removeEventListener("click",n),l&&s&&l.removeEventListener("toggle",s)})}})}function Ye(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}function Ft(e){e.directive("modal-close",{priority:10,init(t,r,i){H();let o=()=>{let n,d;if(i){if(d=i,n=T.get(d),!n){console.warn(`[modal-close] modal "${d}" not found`);return}}else{if(n=t.closest("[modal]"),!n){console.warn("[modal-close] no parent modal found");return}d=n.getAttribute("modal")}$(n,d)};t.addEventListener("click",o),Ye(t,()=>{t.removeEventListener("click",o)})}})}function Pt(e,t={}){It(e),zt(e),Ft(e)}function Mt(){Ct()}var N={openMenus:new Map};function Bt(){N.openMenus.clear()}function R(){if(typeof document>"u"||document.querySelector("style[data-nojs-dropdown]"))return;let e=`
.nojs-dropdown-menu {
  position: fixed;
  z-index: 9999;
  margin: 0;
...
`.trim(),t=document.createElement("style");t.setAttribute("data-nojs-tabs",""),t.textContent=e,document.head.appendChild(t)}function er(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}var rr=0;function te(e){return`${e}-${++rr}`}function gt(e,t){let r=P.containers.get(e);if(!r)return;let{tabs:i,panels:o}=r;if(!(t<0||t>=i.length)&&i[t].getAttribute("aria-disabled")!=="true"){for(let n=0;n<i.length;n++)i[n].setAttribute("aria-selected","false"),i[n].setAttribute("tabindex","-1"),o[n].setAttribute("aria-hidden","true"),o[n].inert=!0;i[t].setAttribute("aria-selected","true"),i[t].setAttribute("tabindex","0"),o[t].setAttribute("aria-hidden","false"),o[t].inert=!1,r.activeIndex=t}}function Y(e,t,r){let i=e.length,o=t;for(let n=0;n<i;n++)if(o=(o+r+i)%i,e[o].getAttribute("aria-disabled")!=="true")return o;return t}function ee(e){e.directive("tabs",{priority:10,init(t,r,i){Jt();let o=[],n=[];for(let a of Array.from(t.children))a.hasAttribute("tab")?o.push(a):a.hasAttribute("panel")&&n.push(a);if(o.length===0){console.warn("[tabs] No child [tab] elements found.");return}o.length!==n.length&&console.warn("[tabs] Mismatch: "+o.length+" tabs but "+n.length+" panels.");let d=t.getAttribute("tab-position")||"top";t.setAttribute("data-position",d),t.classList.add("nojs-tabs");let s=document.createElement("div");s.setAttribute("role","tablist"),s.classList.add("nojs-tablist");let l=Math.min(o.length,n.length);for(let a=0;a<l;a++){let c=o[a],b=n[a],h=c.id||te("nojs-tab"),y=b.id||te("nojs-panel");c.id=h,b.id=y,c.setAttribute("role","tab"),c.setAttribute("aria-selected","false"),c.setAttribute("aria-controls",y),c.setAttribute("tabindex","-1"),c.classList.add("nojs-tab"),b.setAttribute("role","tabpanel"),b.setAttribute("aria-labelledby",h),b.setAttribute("tabindex","0"),b.setAttribute("aria-hidden","true"),b.inert=!0,b.classList.add("nojs-panel"),s.appendChild(c)}let f=n[0];f?t.insertBefore(s,f):t.appendChild(s),P.containers.set(t,{tabs:o.slice(0,l),panels:n.slice(0,l),activeIndex:-1});let u=e.findContext(t);for(let a=0;a<l;a++){let c=o[a].getAttribute("tab-disabled");c&&e.evaluate(c,u)&&o[a].setAttribute("aria-disabled","true")}let m=0;if(i&&i.trim()!==""){let a=parseInt(i,10);!isNaN(a)&&a>=0&&a<l&&(m=a)}o[m]?.getAttribute("aria-disabled")==="true"&&(m=Y(o.slice(0,l),m,1)),gt(t,m);let g=a=>{let c=P.containers.get(t);if(!c)return;let b=a.target;if(b.getAttribute("role")!=="tab")return;let{tabs:h}=c,y=h.indexOf(b);if(y===-1)return;let A=-1;switch(a.key){case"ArrowRight":case"ArrowDown":A=Y(h,y,1);break;case"ArrowLeft":case"ArrowUp":A=Y(h,y,-1);break;case"Home":A=Y(h,h.length-1,1);break;case"End":A=Y(h,0,-1);break;case"Tab":return;default:return}A!==-1&&A!==y&&(a.preventDefault(),gt(t,A),h[A].focus())};s.addEventListener("keydown",g);let p=a=>{let c=a.target.closest("[role='tab']");if(!c)return;let b=P.containers.get(t);if(!b)return;let h=b.tabs.indexOf(c);h!==-1&&(gt(t,h),c.focus())};s.addEventListener("click",p),er(t,()=>{s.removeEventListener("keydown",g),s.removeEventListener("click",p),P.containers.delete(t)})}})}function re(e){e.directive("tab",{priority:11,init(){}}),e.directive("tab-disabled",{priority:11,init(){}}),e.directive("tab-position",{priority:11,init(){}})}function oe(e){e.directive("panel",{priority:11,init(){}})}function ne(e,t={}){ee(e),re(e),oe(e)}function ie(){Qt()}var w={branches:new Map,selectedItem:null,typeahead:"",typeaheadTimer:null};function se(){w.branches.clear(),w.selectedItem=null,w.typeahead="",w.typeaheadTimer&&(clearTimeout(w.typeaheadTimer),w.typeaheadTimer=null)}function tt(){if(typeof document>"u"||document.querySelector("style[data-nojs-tree]"))return;let e=`
.nojs-tree {
  list-style: none;
  padding-left: 0;
  margin: 0;
...
`.trim(),t=document.createElement("style");t.setAttribute("data-nojs-tree",""),t.textContent=e,document.head.appendChild(t)}function ht(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}function ae(e){let t=[],r=document.createTreeWalker(e,NodeFilter.SHOW_ELEMENT,{acceptNode(o){return o.matches&&o.matches('.nojs-subtree[aria-hidden="true"]')?NodeFilter.FILTER_REJECT:o.getAttribute("role")==="treeitem"?NodeFilter.FILTER_ACCEPT:NodeFilter.FILTER_SKIP}}),i;for(;i=r.nextNode();)t.push(i);return t}function ce(e){return e.closest('[role="tree"]')}function or(e){let t=e.parentElement?.closest('[role="group"], .nojs-subtree');if(t){let r=t.parentElement?.closest('[role="treeitem"]');if(r)return r;let i=t.previousElementSibling;if(i?.matches?.('[role="treeitem"]'))return i}return e.parentElement?.closest('[role="treeitem"]')||null}function nr(e){let t=e.cloneNode(!0);return t.querySelectorAll('[role="group"]').forEach(i=>i.remove()),(t.textContent||"").trim().toLowerCase()}function de(e){e.directive("tree",{priority:15,init(t){tt(),t.classList.add("nojs-tree"),t.setAttribute("role","tree"),t.getAttribute("tree-icon")==="false"&&t.setAttribute("data-tree-icon","false")}})}function le(e){e.directive("branch",{priority:16,init(t,r,i){tt();let o=i==="expanded";t.classList.add("nojs-branch"),t.setAttribute("role","treeitem"),t.setAttribute("aria-expanded",String(o));let n=ce(t);if(n){let p=n.querySelector('[role="treeitem"][tabindex="0"]');t.setAttribute("tabindex",p?"-1":"0")}else t.setAttribute("tabindex","0");let d=!1;queueMicrotask(()=>{if(d)return;let p=t.querySelector(":scope > [subtree], :scope > .nojs-subtree")||(t.nextElementSibling?.matches?.("[subtree], .nojs-subtree")?t.nextElementSibling:null);p?(w.branches.set(t,{expanded:o,subtreeEl:p}),p.setAttribute("aria-hidden",String(!o))):w.branches.set(t,{expanded:o,subtreeEl:null})});function s(p){let a=w.selectedItem;a&&a!==p&&(a.classList.remove("nojs-branch-selected"),a.setAttribute("aria-selected","false")),p.classList.add("nojs-branch-selected"),p.setAttribute("aria-selected","true"),w.selectedItem=p}function l(p){let a=w.branches.get(p);!a||!a.subtreeEl||(a.expanded=!a.expanded,p.setAttribute("aria-expanded",String(a.expanded)),a.subtreeEl.setAttribute("aria-hidden",String(!a.expanded)))}function f(p){let a=w.branches.get(p);!a||!a.subtreeEl||a.expanded||(a.expanded=!0,p.setAttribute("aria-expanded","true"),a.subtreeEl.setAttribute("aria-hidden","false"))}function u(p){let a=w.branches.get(p);!a||!a.subtreeEl||!a.expanded||(a.expanded=!1,p.setAttribute("aria-expanded","false"),a.subtreeEl.setAttribute("aria-hidden","true"))}let m=p=>{p.target.closest?.('[role="treeitem"]')===t&&(p.stopPropagation(),s(t),l(t))};t.addEventListener("click",m),ht(t,()=>t.removeEventListener("click",m));let g=p=>{let a=ce(t);if(!a)return;let c=ae(a),b=c.indexOf(t),h=w.branches.get(t),y=h&&h.subtreeEl;switch(p.key){case"ArrowRight":if(p.preventDefault(),y&&!h.expanded)f(t);else if(y&&h.expanded){let A=h.subtreeEl.querySelector('[role="treeitem"]');A&&M(A,c)}break;case"ArrowLeft":if(p.preventDefault(),y&&h.expanded)u(t);else{let A=or(t);A&&M(A,ae(a))}break;case"ArrowDown":p.preventDefault(),b<c.length-1&&M(c[b+1],c);break;case"ArrowUp":p.preventDefault(),b>0&&M(c[b-1],c);break;case"Enter":case" ":p.preventDefault(),s(t),l(t);break;case"Home":p.preventDefault(),c.length>0&&M(c[0],c);break;case"End":p.preventDefault(),c.length>0&&M(c[c.length-1],c);break;default:if(p.key.length===1&&!p.ctrlKey&&!p.altKey&&!p.metaKey){p.preventDefault(),w.typeahead+=p.key.toLowerCase(),w.typeaheadTimer&&clearTimeout(w.typeaheadTimer),w.typeaheadTimer=setTimeout(()=>{w.typeahead="",w.typeaheadTimer=null},500);let A=b+1;for(let I=0;I<c.length;I++){let z=(A+I)%c.length;if(nr(c[z]).startsWith(w.typeahead)){M(c[z],c);break}}}break}};t.addEventListener("keydown",g),ht(t,()=>t.removeEventListener("keydown",g)),ht(t,()=>{d=!0,w.branches.delete(t),w.selectedItem===t&&(w.selectedItem=null),w.typeaheadTimer&&(clearTimeout(w.typeaheadTimer),w.typeaheadTimer=null,w.typeahead="")})}})}function M(e,t){for(let r of t)r.setAttribute("tabindex",r===e?"0":"-1");e.focus()}function pe(e){e.directive("subtree",{priority:16,init(t){tt(),t.classList.add("nojs-subtree"),t.classList.add("nojs-tree"),t.setAttribute("role","group");for(let i of t.children)i.tagName==="LI"&&!i.querySelector("[branch], .nojs-branch")&&(i.setAttribute("role","treeitem"),i.setAttribute("tabindex","-1"),i.classList.add("nojs-tree-leaf"));let r=t.parentElement?.matches?.('[role="treeitem"]')?t.parentElement:t.previousElementSibling?.matches?.('[role="treeitem"]')?t.previousElementSibling:null;if(r){let i=w.branches.get(r);i?(t.setAttribute("aria-hidden",String(!i.expanded)),i.subtreeEl=t):t.setAttribute("aria-hidden","true")}else t.setAttribute("aria-hidden","true")}})}function ue(e,t={}){de(e),le(e),pe(e)}function fe(){se()}var et=new Map;function me(){et.clear()}function rt(){if(typeof document>"u"||document.querySelector("style[data-nojs-stepper]"))return;let e=`
...
`.trim(),t=document.createElement("style");t.setAttribute("data-nojs-split",""),t.textContent=e,document.head.appendChild(t)}function cr(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}function je(e){return e==="horizontal"?"clientX":"clientY"}function S(e,t){return t==="horizontal"?e.offsetWidth:e.offsetHeight}function dr(e,t){let i=(B.get(e)?.gutters||[]).reduce((o,n)=>o+S(n,t),0);return S(e,t)-i}function nt(e,t){let r=k.get(t);return r?r.min!=null&&e<r.min?r.min:r.max!=null&&e>r.max?r.max:e:e}function it(e,t,r,i){let o=S(t,i),n=S(r,i),d=k.get(t),s=k.get(r);e.setAttribute("aria-valuenow",Math.round(o)),e.setAttribute("aria-valuemin",d?.min||0),e.setAttribute("aria-valuemax",Math.round(o+n-(s?.min||0)))}function vt(e){let t=e.getAttribute("split-persist");if(!t)return;let r=B.get(e);if(!r)return;let i=r.panes.map(o=>o.style.flexBasis||"");try{localStorage.setItem(`nojs-split:${t}`,JSON.stringify(i))}catch{}}function lr(e){let t=e.getAttribute("split-persist");if(!t)return!1;try{let r=localStorage.getItem(`nojs-split:${t}`);if(!r)return!1;let i=JSON.parse(r),o=B.get(e);return!o||i.length!==o.panes.length?!1:(i.forEach((n,d)=>{n&&(o.panes[d].style.flexBasis=n,o.panes[d].style.flexGrow="0")}),!0)}catch{return!1}}function pr(e,t,r,i,o){let n=document.createElement("div");n.className="nojs-gutter",n.setAttribute("role","separator"),n.setAttribute("tabindex","0"),n.setAttribute("aria-orientation",t==="horizontal"?"vertical":"horizontal"),n.setAttribute("aria-label","Resize"),o!==6&&n.style.setProperty("--nojs-gutter-size",`${o}px`);let d=p=>{if(p.button!==0)return;p.preventDefault();let a=dr(e,t);v.active=!0,v.splitEl=e,v.gutterEl=n,v.prevPane=r,v.nextPane=i,v.direction=t,v.startPos=p[je(t)],v.startPrevSize=S(r,t),v.startNextSize=S(i,t),v.containerSize=a,document.body.style.cursor=t==="horizontal"?"col-resize":"row-resize",document.body.style.userSelect="none",n.setPointerCapture(p.pointerId)},s=p=>{if(!v.active||v.gutterEl!==n)return;let a=p[je(v.direction)]-v.startPos,c=nt(v.startPrevSize+a,v.prevPane),b=nt(v.startNextSize-a,v.nextPane),h=v.startPrevSize+v.startNextSize;c+b!==h&&(c!==v.startPrevSize+a?b=h-c:c=h-b),v.prevPane.style.flexBasis=`${c}px`,v.prevPane.style.flexGrow="0",v.nextPane.style.flexBasis=`${b}px`,v.nextPane.style.flexGrow="0",it(n,v.prevPane,v.nextPane,v.direction)},l=()=>{!v.active||v.gutterEl!==n||(v.active=!1,document.body.style.cursor="",document.body.style.userSelect="",vt(e),e.dispatchEvent(new CustomEvent("split-resize",{bubbles:!0,detail:{prevPane:r,nextPane:i}})))};n.addEventListener("pointerdown",d),n.addEventListener("pointermove",s),n.addEventListener("pointerup",l),n.addEventListener("pointercancel",l);let f=10,u=p=>{let a=t==="horizontal",c=0;if(a&&p.key==="ArrowRight"||!a&&p.key==="ArrowDown")c=f;else if(a&&p.key==="ArrowLeft"||!a&&p.key==="ArrowUp")c=-f;else if(p.key==="Home")c=(k.get(r)?.min||0)-S(r,t);else if(p.key==="End"){let z=k.get(i);c=S(r,t)+S(i,t)-(z?.min||0)-S(r,t)}else return;p.preventDefault();let b=S(r,t),h=S(i,t),y=b+h,A=nt(b+c,r),I=nt(y-A,i);A=y-I,r.style.flexBasis=`${A}px`,r.style.flexGrow="0",i.style.flexBasis=`${I}px`,i.style.flexGrow="0",it(n,r,i,t),vt(e)};n.addEventListener("keydown",u);let m=()=>{let p=k.get(r),a=k.get(i),c=p?.collapsible?r:a?.collapsible?i:null;if(!c)return;let b=k.get(c);if(!b)return;let h=c===r?i:r,y=S(r,t)+S(i,t);if(b.collapsed){b.collapsed=!1,c.removeAttribute("data-collapsed");let A=b.preCollapseSize||`${Math.round(y/2)}px`;c.style.flexBasis=A,c.style.flexGrow="0",h.style.flexBasis=`${y-parseFloat(A)}px`,h.style.flexGrow="0"}else b.preCollapseSize=c.style.flexBasis||`${S(c,t)}px`,b.collapsed=!0,c.setAttribute("data-collapsed","true"),c.style.flexBasis="0px",c.style.flexGrow="0",h.style.flexBasis=`${y}px`,h.style.flexGrow="0";it(n,r,i,t),vt(e),e.dispatchEvent(new CustomEvent("split-collapse",{bubbles:!0,detail:{pane:c,collapsed:b.collapsed}}))};return n.addEventListener("dblclick",m),{gutter:n,cleanup:()=>{n.removeEventListener("pointerdown",d),n.removeEventListener("pointermove",s),n.removeEventListener("pointerup",l),n.removeEventListener("pointercancel",l),n.removeEventListener("keydown",u),n.removeEventListener("dblclick",m)}}}function ke(e){e.directive("split",{priority:14,init(t,r,i){ot();let o=(i||"horizontal").trim()==="vertical"?"vertical":"horizontal",n=parseInt(t.getAttribute("split-gutter"),10)||6;t.classList.add("nojs-split"),t.setAttribute("data-direction",o);let d=Array.from(t.children).filter(u=>u.hasAttribute("pane"));if(d.length<2){console.warn(`[split] Container requires at least 2 [pane] children, found ${d.length}.`);return}d.forEach(u=>{k.get(u)||k.set(u,{size:u.getAttribute("pane")||null,min:parseInt(u.getAttribute("pane-min"),10)||0,max:parseInt(u.getAttribute("pane-max"),10)||1/0,collapsible:u.getAttribute("pane-collapsible")==="true",collapsed:!1,preCollapseSize:null})});let s=[],l=[];for(let u=0;u<d.length-1;u++){let{gutter:m,cleanup:g}=pr(t,o,d[u],d[u+1],n);d[u].after(m),s.push(m),l.push(g)}B.set(t,{direction:o,gutterSize:n,panes:d,gutters:s}),lr(t)||d.forEach(u=>{let g=k.get(u)?.size;g?(u.style.flexBasis=g,u.style.flexGrow="0"):(u.style.flexGrow="1",u.style.flexBasis="0")}),requestAnimationFrame(()=>{s.forEach((u,m)=>{it(u,d[m],d[m+1],o)})}),cr(t,()=>{l.forEach(u=>u()),s.forEach(u=>u.remove()),B.delete(t),d.forEach(u=>k.delete(u)),t.classList.remove("nojs-split"),t.removeAttribute("data-direction")})}})}function ur(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}function _e(e){e.directive("pane",{priority:15,init(t,r,i){ot(),t.classList.add("nojs-pane"),k.has(t)||k.set(t,{size:i||null,min:parseInt(t.getAttribute("pane-min"),10)||0,max:parseInt(t.getAttribute("pane-max"),10)||1/0,collapsible:t.getAttribute("pane-collapsible")==="true",collapsed:!1,preCollapseSize:null});let o=k.get(t),n=t.closest("[data-direction='vertical']")?"height":"width";o.min&&(t.style[`min${n==="width"?"Width":"Height"}`]=`${o.min}px`),o.max&&o.max!==1/0&&(t.style[`max${n==="width"?"Width":"Height"}`]=`${o.max}px`),ur(t,()=>{t.classList.remove("nojs-pane"),k.delete(t),t.style.removeProperty("minWidth"),t.style.removeProperty("minHeight"),t.style.removeProperty("maxWidth"),t.style.removeProperty("maxHeight"),t.style.removeProperty("flexBasis"),t.style.removeProperty("flexGrow")})}})}function Se(e,t={}){ke(e),_e(e)}function Le(){Ee()}var G={sorts:new Map};function Ce(){G.sorts.clear()}function X(){if(typeof document>"u"||document.querySelector("style[data-nojs-table]"))return;let e=`
...
`.trim(),t=document.createElement("style");t.setAttribute("data-nojs-table",""),t.textContent=e,document.head.appendChild(t)}function fr(e,t){e.__disposers=e.__disposers||[],e.__disposers.push(t)}function mr(e,t){let r=e.querySelector("tbody");if(!r)return null;let i=null;if(r.hasAttribute("each")||r.hasAttribute("foreach")?i=r:i=r.querySelector("[each]")||r.querySelector("[foreach]"),!i)return null;let o=i.getAttribute("each")||i.getAttribute("foreach");if(!o)return null;let n=o.match(/^\s*(\w+)\s+(?:in|of)\s+(.+)\s*$/);return n?{iteratorVar:n[1],arrayPath:n[2].trim()}:null}function br(e,t){let r=t.split("."),i=e;for(let o of r){if(i==null)return;i=i[o]}return i}function Te(e,t,r){let i=t.split("."),o=e;for(let n=0;n<i.length-1;n++){if(o[i[n]]==null)return;o=o[i[n]]}o[i[i.length-1]]=r}function Ie(e,t,r){if(e==null&&t==null)return 0;if(e==null)return-1;if(t==null)return 1;switch(r){case"number":return Number(e)-Number(t);case"date":return new Date(e).getTime()-new Date(t).getTime();default:return String(e).localeCompare(String(t))}}function gr(e){let t=e.querySelectorAll("th[data-sortable]");for(let r of t)r.removeAttribute("data-sort-dir"),r.setAttribute("aria-sort","none")}function ze(e){e.directive("sortable",{priority:10,init(t){X(),t.classList.add("nojs-sortable")}})}function Fe(e){e.directive("sort",{priority:11,init(t,r,i){X();let o=i;if(!o)return;let n=t.getAttribute("sort-type")||"string",d=t.getAttribute("sort-default");t.setAttribute("data-sortable",""),t.setAttribute("aria-sort","none");let s=t.closest("table");if(!s)return;G.sorts.has(s)||G.sorts.set(s,{column:null,direction:null}),(d==="asc"||d==="desc")&&De(t,s,o,n,d,e);let l=()=>{let f=G.sorts.get(s),u;f.column!==o?u="asc":f.direction==="asc"?u="desc":f.direction==="desc"?u=null:u="asc",De(t,s,o,n,u,e)};t.addEventListener("click",l),fr(t,()=>{t.removeEventListener("click",l),s&&s._nojsOriginalOrder&&delete s._nojsOriginalOrder})}})}function De(e,t,r,i,o,n){let d=G.sorts.get(t);gr(t),o?(e.setAttribute("data-sort-dir",o),e.setAttribute("aria-sort",o==="asc"?"ascending":"descending"),d.column=r,d.direction=o):(d.column=null,d.direction=null);let s=mr(t,n);if(s){let l=n.findContext(t),f=l?br(l,s.arrayPath):null;if(Array.isArray(f)){if(!o){let m=t._nojsOriginalOrder;if(m){let g=new Set(f),p=m.filter(a=>g.has(a));for(let a of f)m.includes(a)||p.push(a);Te(l,s.arrayPath,p)}return}t._nojsOriginalOrder||(t._nojsOriginalOrder=[...f]);let u=[...f].sort((m,g)=>{let p=m!=null?m[r]:null,a=g!=null?g[r]:null,c=Ie(p,a,i);return o==="desc"?-c:c});Te(l,s.arrayPath,u);return}}hr(t,e,r,i,o)}function hr(e,t,r,i,o){let n=e.querySelector("tbody");if(!n)return;let l=[...t.closest("tr").children].indexOf(t);if(l<0)return;let f=[...n.querySelectorAll(":scope > tr")];if(e._nojsOriginalRows||(e._nojsOriginalRows=[...f]),!o){let m=document.createDocumentFragment();for(let g of e._nojsOriginalRows)m.appendChild(g);n.appendChild(m);return}f.sort((m,g)=>{let p=m.children[l]?.textContent?.trim()||"",a=g.children[l]?.textContent?.trim()||"",c=Ie(i==="number"?parseFloat(p.replace(/[^0-9.\-]/g,""))||0:p,i==="number"?parseFloat(a.replace(/[^0-9.\-]/g,""))||0:a,i);return o==="desc"?-c:c});let u=document.createDocumentFragment();for(let m of f)u.appendChild(m);n.appendChild(u)}function Pe(e){e.directive("fixed-header",{priority:10,init(t){X(),t.classList.add("nojs-fixed-header")}})}function Me(e){e.directive("fixed-col",{priority:10,init(t){X(),t.classList.add("nojs-fixed-col")}})}function Be(e,t={}){ze(e),Fe(e),Pe(e),Me(e)}function qe(){Ce()}var vr={name:"nojs-elements",install(e,t={}){At(e,t),_t(e,t),Pt(e,t),Gt(e,t),Xt(e,t),ne(e,t),ue(e,t),he(e,t),Ae(e,t),Se(e,t),Be(e,t)},dispose(e){Et(),St(),Mt(),Wt(),Zt(),ie(),fe(),ve(),Le(),qe()}},zn=vr;export{zn as default};

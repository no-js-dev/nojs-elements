 ...
 */
var x={dragging:null,selected:new Map,placeholder:null},Ne=new Map;function $t(){x.dragging=null,x.selected.clear(),x.placeholder&&(x.placeholder.remove(),x.placeholder=null),Ne.clear()}function We(){if(typeof document>"u"||document.querySelector("style[data-nojs-dnd]"))return;let t=`
.nojs-dragging {
  opacity: 0.5;
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-tooltip",""),e.textContent=t,document.head.appendChild(e)}function Lo(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}var Ze=8;function rr(t,e,r){let o=e.getBoundingClientRect(),n=t.getBoundingClientRect(),i=window.innerWidth,c=window.innerHeight,s,a;switch(r){case"bottom":s=o.bottom+Ze,a=o.left+(o.width-n.width)/2;break;case"left":s=o.top+(o.height-n.height)/2,a=o.left-n.width-Ze;break;case"right":s=o.top+(o.height-n.height)/2,a=o.right+Ze;break;default:s=o.top-n.height-Ze,a=o.left+(o.width-n.width)/2;break}a<4&&(a=4),a+n.width>i-4&&(a=i-n.width-4),s<4&&(s=4),s+n.height>c-4&&(s=c-n.height-4),t.style.top=`${s}px`,t.style.left=`${a}px`}var ko=0;function Co(t,e,r){document.body.appendChild(e),rr(e,t,r),e.setAttribute("aria-hidden","false")}function tr(t,e){e.setAttribute("aria-hidden","true"),e.remove()}function So(t,e){t&&typeof t._warn=="function"?t._warn(e):console.warn(e)}function nr(t){t.directive("tooltip",{priority:20,init(e,r,o){er();let n=o;if(!n){So(t,"[tooltip] attribute value (tooltip text) is required.");return}let i=e.getAttribute("tooltip-position")||"top",c=parseInt(e.getAttribute("tooltip-delay"),10),s=Number.isNaN(c)?300:c,a=e.getAttribute("tooltip-disabled"),d=a?t.findContext(e):null,m=()=>{if(!a||!d)return!1;try{return!!t.evaluate(a,d)}catch{return!1}},p=`nojs-tooltip-${++ko}`,f=document.createElement("div");f.className="nojs-tooltip",f.setAttribute("role","tooltip"),f.setAttribute("id",p),f.setAttribute("aria-hidden","true"),f.textContent=n,e.setAttribute("aria-describedby",p),je.set(e,f);let l=!1,u=0,v=()=>{!l||!e.isConnected||u||(u=requestAnimationFrame(()=>{u=0,!(!l||!e.isConnected)&&rr(f,e,i)}))},y=()=>{window.addEventListener("scroll",v,!0),window.addEventListener("resize",v)},g=()=>{window.removeEventListener("scroll",v,!0),window.removeEventListener("resize",v),u&&(cancelAnimationFrame(u),u=0)},b=()=>{l||(Co(e,f,i),l=!0,y())},E=()=>{if(!l){tr(e,f);return}g(),tr(e,f),l=!1},h=()=>{if(m())return;ee.has(e)&&clearTimeout(ee.get(e));let $=setTimeout(()=>{ee.delete(e),!m()&&e.isConnected&&b()},s);ee.set(e,$)},_=()=>{ee.has(e)&&(clearTimeout(ee.get(e)),ee.delete(e)),E()},A=()=>h(),j=()=>_(),k=()=>h(),L=()=>_(),S=$=>{$.key==="Escape"&&f.getAttribute("aria-hidden")==="false"&&_()};e.addEventListener("mouseenter",A),e.addEventListener("mouseleave",j),e.addEventListener("focusin",k),e.addEventListener("focusout",L),e.addEventListener("keydown",S);let w=null;if(a&&d&&typeof d.$watch=="function"){let $=()=>{l&&m()&&E()};w=d.$watch($)}Lo(e,()=>{e.removeEventListener("mouseenter",A),e.removeEventListener("mouseleave",j),e.removeEventListener("focusin",k),e.removeEventListener("focusout",L),e.removeEventListener("keydown",S),w&&(w(),w=null),g(),ee.has(e)&&(clearTimeout(ee.get(e)),ee.delete(e)),l=!1,f.remove(),je.delete(e)})}})}function or(t,e={}){nr(t)}function ir(){Jt()}var Y=new Map;function sr(){Y.clear()}function Qe(){if(typeof document>"u"||document.querySelector("style[data-nojs-popover]"))return;let t=`
.nojs-popover {
  position: fixed;
  z-index: 9998;
  margin: 0;
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-modal",""),e.textContent=t,document.head.appendChild(e)}function Do(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}var fr='a[href], button:not([disabled]), input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])',xt=new WeakMap;function Io(t){let e=r=>{if(r.key!=="Tab")return;let o=[...t.querySelectorAll(fr)].filter(c=>c.offsetParent!==null);if(o.length===0){r.preventDefault();return}let n=o[0],i=o[o.length-1];r.shiftKey?document.activeElement===n&&(r.preventDefault(),i.focus()):document.activeElement===i&&(r.preventDefault(),n.focus())};t.addEventListener("keydown",e),xt.set(t,e)}function pr(t){let e=xt.get(t);e&&(t.removeEventListener("keydown",e),xt.delete(t))}var Me=new WeakMap;function mr(t){t.directive("modal",{priority:10,init(r,o,n){ke();let i=n||`nojs-modal-${Date.now()}-${Math.random().toString(36).slice(2,7)}`;r.setAttribute("popover","manual"),r.classList.add("nojs-modal"),r.id=r.id||`nojs-modal-${i}`,r.setAttribute("data-modal-id",i),r.setAttribute("role","dialog"),r.setAttribute("aria-modal","true");let c=r.querySelector("h1, h2, h3, h4, h5, h6");c&&(c.id||(c.id=`nojs-modal-heading-${i}`),r.setAttribute("aria-labelledby",c.id));let s=r.getAttribute("modal-backdrop");s==="false"&&r.setAttribute("data-nojs-no-backdrop","");let a=r.getAttribute("modal-class"),d=r.getAttribute("modal-escape"),m=f=>{f.target===r&&s!=="false"&&d!=="false"&&Ce(r,i)};r.addEventListener("click",m),ie.set(i,r);let p=f=>{if(f.newState==="open"){if(r.style.zIndex=String(lr()),a&&a.split(/\s+/).filter(Boolean).forEach(l=>r.classList.add(l)),requestAnimationFrame(()=>{if(!r.isConnected||!G.some(u=>u.el===r))return;let l=r.querySelector(fr);l?l.focus():r.focus()}),Io(r),d!=="false"){let l=u=>{u.key==="Escape"&&(u.stopPropagation(),Ce(r,i))};r.addEventListener("keydown",l),Me.set(r,l)}}else if(f.newState==="closed"){a&&a.split(/\s+/).filter(Boolean).forEach(v=>r.classList.remove(v)),pr(r);let l=Me.get(r);l&&(r.removeEventListener("keydown",l),Me.delete(r));let u=G.findIndex(v=>v.el===r);if(u===-1&&(u=G.findIndex(v=>v.id===i)),u!==-1){let v=G[u];G.splice(u,1),v.triggerEl&&requestAnimationFrame(()=>{v.triggerEl.focus()})}}};r.addEventListener("toggle",p),Do(r,()=>{r.removeEventListener("click",m),r.removeEventListener("toggle",p),pr(r);let f=Me.get(r);f&&(r.removeEventListener("keydown",f),Me.delete(r)),ie.delete(i);let l=G.findIndex(u=>u.el===r);l===-1&&(l=G.findIndex(u=>u.id===i)),l!==-1&&G.splice(l,1)})}});let e=r=>e.open(r);e.open=r=>{let o=ie.get(r);if(!o)return!1;try{o.showPopover()}catch{return!1}return G.some(n=>n.id===r)||G.push({id:r,el:o,triggerEl:null}),!0},e.close=r=>{let o=ie.get(r);return o?(Ce(o,r),!0):!1},e.closeAll=()=>{for(let r=G.length-1;r>=0;r--)Ce(G[r].el,G[r].id)},t.modal=e}function Ce(t,e){try{t.hidePopover()}catch{}}function gr(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function Bo(t){let e=document.querySelectorAll("[data-modal-id]");for(let r of e)if(r.getAttribute("data-modal-id")===t)return r;return null}function br(t){t.directive("modal-open",{priority:10,init(e,r,o){ke();let n=o;if(!n){let p=(e.closest("[use]")||e.parentElement)?.querySelector("[data-modal-id]");if(p&&(n=p.getAttribute("data-modal-id")),!n){console.warn('[modal-open] requires a target modal ID, e.g. modal-open="my-dialog"');return}}e.setAttribute("aria-haspopup","dialog"),e.setAttribute("aria-expanded","false");let i=()=>{let m=ie.get(n)||Bo(n);if(!m){console.warn(`[modal-open] modal "${n}" not found`);return}let p=G.some(f=>f.id===n);m.id&&e.setAttribute("aria-controls",m.id);try{m.showPopover()}catch{console.warn(`[modal-open] failed to open modal "${n}"`);return}p||G.push({id:n,el:m,triggerEl:e}),e.setAttribute("aria-expanded","true")},c=()=>{e.setAttribute("aria-expanded","false")},s=null,a=null,d=()=>{let m=ie.get(n);return m?(a=m,s=p=>{p.newState==="closed"&&e.setAttribute("aria-expanded","false")},m.addEventListener("toggle",s),!0):!1};if(!d()){let m=requestAnimationFrame(d);gr(e,()=>cancelAnimationFrame(m))}e.addEventListener("click",i),gr(e,()=>{e.removeEventListener("click",i),a&&s&&a.removeEventListener("toggle",s)})}})}function Ho(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function hr(t){t.directive("modal-close",{priority:10,init(e,r,o){ke();let n=()=>{let i,c;if(o){if(c=o,i=ie.get(c),!i){console.warn(`[modal-close] modal "${c}" not found`);return}}else{if(i=e.closest("[modal]"),!i){console.warn("[modal-close] no parent modal found");return}c=i.getAttribute("modal")}Ce(i,c)};e.addEventListener("click",n),Ho(e,()=>{e.removeEventListener("click",n)})}})}function vr(t,e={}){mr(t),br(t),hr(t)}function yr(){ur()}var te={openMenus:new Map},O={installed:!1,instanceCount:0,outsideClickHandler:null,escHandler:null};function xr(){te.openMenus.clear(),O.installed=!1,O.instanceCount=0,O.outsideClickHandler=null,O.escHandler=null}function Se(){if(typeof document>"u"||document.querySelector("style[data-nojs-dropdown]"))return;let t=`
.nojs-dropdown-menu {
  position: fixed;
  z-index: 9999;
  margin: 0;
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-toast",""),e.textContent=t,document.head.appendChild(e)}function jt(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}var Ro=new Set(["top-right","top-left","bottom-right","bottom-left","top-center","bottom-center"]);function Lt(){return se.size>0?se.values().next().value:Fo("top-right")}function Fo(t){if(se.has(t))return se.get(t);let e=document.createElement("div");return e.classList.add("nojs-toast-container"),e.setAttribute("data-position",t),e.setAttribute("role","log"),e.setAttribute("aria-live","polite"),e.setAttribute("aria-relevant","additions"),document.body.appendChild(e),se.set(t,e),e}function zo(t){return t.startsWith("top")}function kt(t,e,r,o,n){let i=Sr(),c=t.getAttribute("data-position")||"top-right",s=document.createElement("div");s.classList.add("nojs-toast"),s.setAttribute("data-toast-id",i),s.setAttribute("data-type",r),r==="error"&&s.setAttribute("aria-live","assertive");let a=document.createElement("span");if(a.textContent=e,s.appendChild(a),n){let d=document.createElement("button");d.type="button",d.classList.add("nojs-toast-dismiss"),d.setAttribute("aria-label","Dismiss"),d.textContent="\xD7",d.addEventListener("click",()=>et(s)),s.appendChild(d)}if(zo(c)&&t.firstChild?t.insertBefore(s,t.firstChild):t.appendChild(s),o>0){let d=setTimeout(()=>{Te.delete(d),s.isConnected&&et(s)},o);Te.add(d),s._toastTimerId=d}return s}function et(t){!t||!t.isConnected||(t._toastTimerId!=null&&(clearTimeout(t._toastTimerId),Te.delete(t._toastTimerId)),t.remove())}function Ir(t){Dr(),t.directive("toast-container",{priority:10,init(r,o,n){let i=n&&Ro.has(n)?n:"top-right";r.classList.add("nojs-toast-container"),r.setAttribute("data-position",i),r.setAttribute("role","log"),r.setAttribute("aria-live","polite"),r.setAttribute("aria-relevant","additions"),se.set(i,r),jt(r,()=>{se.get(i)===r&&se.delete(i)})}}),t.directive("toast",{priority:10,init(r,o,n){if(!n)return;let i=r.getAttribute("toast-type")||"info",c=parseInt(r.getAttribute("toast-duration"),10),s=Number.isNaN(c)?3e3:c,a=r.getAttribute("toast-dismiss")!=="false";if(r.tagName==="BUTTON"||r.tagName==="A"||r.hasAttribute("on:click")){let u=()=>{let v=Lt();kt(v,n,i,s,a)};r.addEventListener("click",u),jt(r,()=>r.removeEventListener("click",u));return}let m=t.findContext(r);if(!m||typeof m.$watch!="function"){console.warn("[toast] reactive toast requires a parent [state] or [use] context \u2014 element will be inert");return}let p;function f(){let u=t.evaluate(n,m);if(u&&u!==p){let v=typeof u=="string"?u:String(u),y=Lt();kt(y,v,i,s,a),p=u}else p=u}let l=m.$watch(f);jt(r,l)}});let e=(r,o="info",n=3e3)=>{if(typeof document>"u")return;let i=!0,c=Lt();return kt(c,String(r),o,n,i)};e.dismiss=r=>{let o=typeof CSS<"u"&&CSS.escape?CSS.escape(String(r)):String(r).replace(/["\\\]]/g,"\\$&"),n=document.querySelector(`[data-toast-id="${o}"]`);n&&et(n)},e.dismissAll=()=>{document.querySelectorAll(".nojs-toast").forEach(r=>et(r))},t.toast=e,t.global("toast",e)}function Br(t,e={}){Ir(t)}function Hr(){Tr()}var Ee={containers:new Map};function $r(){Ee.containers.clear()}function qr(){if(typeof document>"u"||document.querySelector("style[data-nojs-tabs]"))return;let t=`
.nojs-tabs {
  display: flex;
  flex-direction: column;
  border: 1px solid #E2E8F0;
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-split",""),e.textContent=t,document.head.appendChild(e)}function ni(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function bn(t){return t==="horizontal"?"clientX":"clientY"}function Q(t,e){let r=t.getBoundingClientRect?t.getBoundingClientRect():null,o=r&&(e==="horizontal"?r.width:r.height);return o||(e==="horizontal"?t.offsetWidth:t.offsetHeight)}function hn(t,e){if(e!=="horizontal")return 1;try{return(t.closest&&t.closest("[dir]")?.getAttribute("dir")||(typeof getComputedStyle=="function"?getComputedStyle(t).direction:""))==="rtl"?-1:1}catch{return 1}}function oi(t,e){let o=(we.get(t)?.gutters||[]).reduce((n,i)=>n+Q(i,e),0);return Q(t,e)-o}function ii(t,e){if(!t)return null;let r=parseFloat(t);return Number.isNaN(r)?null:typeof t=="string"&&t.trim().endsWith("%")?r/100*e:r}function Oe(t,e){let r=U.get(e);return r?r.min!=null&&t<r.min?r.min:r.max!=null&&t>r.max?r.max:t:t}function ot(t,e,r,o){let n=Q(e,o),i=Q(r,o),c=U.get(e),s=U.get(r);t.setAttribute("aria-valuenow",Math.round(n)),t.setAttribute("aria-valuemin",c?.min||0),t.setAttribute("aria-valuemax",Math.round(n+i-(s?.min||0)))}function Dt(t){let e=t.getAttribute("split-persist");if(!e)return;let r=we.get(t);if(!r)return;let o=r.panes.map(n=>n.style.flexBasis||"");try{localStorage.setItem(`nojs-split:${e}`,JSON.stringify(o))}catch{}}function si(t){let e=t.getAttribute("split-persist");if(!e)return!1;try{let r=localStorage.getItem(`nojs-split:${e}`);if(!r)return!1;let o=JSON.parse(r),n=we.get(t);return!n||o.length!==n.panes.length?!1:(o.forEach((i,c)=>{i&&(n.panes[c].style.flexBasis=i,n.panes[c].style.flexGrow="0")}),!0)}catch{return!1}}function ai(t,e,r,o,n){let i=document.createElement("div");i.className="nojs-gutter",i.setAttribute("role","separator"),i.setAttribute("tabindex","0"),i.setAttribute("aria-orientation",e==="horizontal"?"vertical":"horizontal"),i.setAttribute("aria-label","Resize"),n!==6&&i.style.setProperty("--nojs-gutter-size",`${n}px`);let c=l=>{if(l.button!==0)return;l.preventDefault();let u=oi(t,e);C.active=!0,C.splitEl=t,C.gutterEl=i,C.prevPane=r,C.nextPane=o,C.direction=e,C.startPos=l[bn(e)],C.startPrevSize=Q(r,e),C.startNextSize=Q(o,e),C.containerSize=u,C.sign=hn(t,e),document.body.style.cursor=e==="horizontal"?"col-resize":"row-resize",document.body.style.userSelect="none",i.setPointerCapture(l.pointerId)},s=l=>{if(!C.active||C.gutterEl!==i)return;let u=(l[bn(C.direction)]-C.startPos)*(C.sign||1),v=Oe(C.startPrevSize+u,C.prevPane),y=Oe(C.startNextSize-u,C.nextPane),g=C.startPrevSize+C.startNextSize;v+y!==g&&(v!==C.startPrevSize+u?y=g-v:v=g-y),C.prevPane.style.flexBasis=`${v}px`,C.prevPane.style.flexGrow="0",C.nextPane.style.flexBasis=`${y}px`,C.nextPane.style.flexGrow="0",ot(i,C.prevPane,C.nextPane,C.direction)},a=()=>{!C.active||C.gutterEl!==i||(C.active=!1,document.body.style.cursor="",document.body.style.userSelect="",Dt(t),t.dispatchEvent(new CustomEvent("split-resize",{bubbles:!0,detail:{prevPane:r,nextPane:o}})))};i.addEventListener("pointerdown",c),i.addEventListener("pointermove",s),i.addEventListener("pointerup",a),i.addEventListener("pointercancel",a);let d=10,m=l=>{let u=e==="horizontal",v=hn(t,e),y=0;if(u&&l.key==="ArrowRight"||!u&&l.key==="ArrowDown")y=d*v;else if(u&&l.key==="ArrowLeft"||!u&&l.key==="ArrowUp")y=-d*v;else if(l.key==="Home")y=(U.get(r)?.min||0)-Q(r,e);else if(l.key==="End"){let A=U.get(o);y=Q(r,e)+Q(o,e)-(A?.min||0)-Q(r,e)}else return;l.preventDefault();let g=Q(r,e),b=Q(o,e),E=g+b,h=Oe(g+y,r),_=Oe(E-h,o);h=E-_,h=Oe(h,r),_=E-h,r.style.flexBasis=`${h}px`,r.style.flexGrow="0",o.style.flexBasis=`${_}px`,o.style.flexGrow="0",ot(i,r,o,e),Dt(t)};i.addEventListener("keydown",m);let p=()=>{let l=U.get(r),u=U.get(o),v=l?.collapsible?r:u?.collapsible?o:null;if(!v)return;let y=U.get(v);if(!y)return;let g=v===r?o:r,b=Q(r,e)+Q(o,e);if(y.collapsed){y.collapsed=!1,v.removeAttribute("data-collapsed");let E=y.preCollapseSize||`${Math.round(b/2)}px`,h=ii(E,b)??b/2,_=Math.min(h,b);v.style.flexBasis=`${_}px`,v.style.flexGrow="0",g.style.flexBasis=`${b-_}px`,g.style.flexGrow="0"}else y.preCollapseSize=v.style.flexBasis||`${Q(v,e)}px`,y.collapsed=!0,v.setAttribute("data-collapsed","true"),v.style.flexBasis="0px",v.style.flexGrow="0",g.style.flexBasis=`${b}px`,g.style.flexGrow="0";ot(i,r,o,e),Dt(t),t.dispatchEvent(new CustomEvent("split-collapse",{bubbles:!0,detail:{pane:v,collapsed:y.collapsed}}))};return i.addEventListener("dblclick",p),{gutter:i,cleanup:()=>{i.removeEventListener("pointerdown",c),i.removeEventListener("pointermove",s),i.removeEventListener("pointerup",a),i.removeEventListener("pointercancel",a),i.removeEventListener("keydown",m),i.removeEventListener("dblclick",p)}}}function vn(t){t.directive("split",{priority:14,init(e,r,o){nt();let n=(o||"horizontal").trim()==="vertical"?"vertical":"horizontal",i=parseInt(e.getAttribute("split-gutter"),10)||6;e.classList.add("nojs-split"),e.setAttribute("data-direction",n);let c=Array.from(e.children).filter(m=>m.hasAttribute("pane"));if(c.length<2){console.warn(`[split] Container requires at least 2 [pane] children, found ${c.length}.`);return}c.forEach(m=>{U.get(m)||U.set(m,{size:m.getAttribute("pane")||null,min:parseInt(m.getAttribute("pane-min"),10)||0,max:parseInt(m.getAttribute("pane-max"),10)||1/0,collapsible:m.getAttribute("pane-collapsible")==="true",collapsed:!1,preCollapseSize:null})});let s=[],a=[];for(let m=0;m<c.length-1;m++){let{gutter:p,cleanup:f}=ai(e,n,c[m],c[m+1],i);c[m].after(p),s.push(p),a.push(f)}we.set(e,{direction:n,gutterSize:i,panes:c,gutters:s}),si(e)||c.forEach(m=>{let f=U.get(m)?.size;f?(m.style.flexBasis=f,m.style.flexGrow="0"):(m.style.flexGrow="1",m.style.flexBasis="0")}),requestAnimationFrame(()=>{s.forEach((m,p)=>{ot(m,c[p],c[p+1],n)})}),ni(e,()=>{a.forEach(m=>m()),s.forEach(m=>m.remove()),we.delete(e),c.forEach(m=>U.delete(m)),e.classList.remove("nojs-split"),e.removeAttribute("data-direction")})}})}function ci(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function yn(t){t.directive("pane",{priority:15,init(e,r,o){nt(),e.classList.add("nojs-pane"),U.has(e)||U.set(e,{size:o||null,min:parseInt(e.getAttribute("pane-min"),10)||0,max:parseInt(e.getAttribute("pane-max"),10)||1/0,collapsible:e.getAttribute("pane-collapsible")==="true",collapsed:!1,preCollapseSize:null});let n=U.get(e),i=e.closest("[data-direction='vertical']")?"height":"width";n.min&&(e.style[`min${i==="width"?"Width":"Height"}`]=`${n.min}px`),n.max&&n.max!==1/0&&(e.style[`max${i==="width"?"Width":"Height"}`]=`${n.max}px`),ci(e,()=>{e.classList.remove("nojs-pane"),U.delete(e),e.style.removeProperty("min-width"),e.style.removeProperty("min-height"),e.style.removeProperty("max-width"),e.style.removeProperty("max-height"),e.style.removeProperty("flex-basis"),e.style.removeProperty("flex-grow")})}})}function xn(t,e={}){vn(t),yn(t)}function En(){gn()}var fe={sorts:new Map};function _n(){fe.sorts.clear()}function Ae(){if(typeof document>"u"||document.querySelector("style[data-nojs-table]"))return;let t=`
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-accordion",""),e.textContent=t,document.head.appendChild(e)}function vi(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}var st=null;function yi(){return st!==null||(st=typeof CSS<"u"&&typeof CSS.supports=="function"&&CSS.supports("interpolate-size","allow-keywords")),st}function Gn(t){let e=t.querySelector(":scope > summary");if(!e)return null;let r=t.querySelector(":scope > .nojs-accordion-content");if(r)return r;r=document.createElement("div"),r.classList.add("nojs-accordion-content");let o=Array.from(t.children),n=!1;for(let i of o){if(i===e){n=!0;continue}n&&r.appendChild(i)}return t.appendChild(r),r}function xi(t,e){if(!e)return;let r=e.scrollHeight;e.style.height="0px",t.open=!0,requestAnimationFrame(()=>{e.style.height=r+"px";let o=()=>{e.style.height="",e.removeEventListener("transitionend",o)};e.addEventListener("transitionend",o)})}function Yn(t,e){if(!e){t.open=!1;return}let r=e.scrollHeight;e.style.height=r+"px",requestAnimationFrame(()=>{e.style.height="0px";let o=()=>{t.open=!1,e.style.height="",e.removeEventListener("transitionend",o)};e.addEventListener("transitionend",o)})}function Un(t,e){if(t.open)if(e){let r=t.querySelector(":scope > .nojs-accordion-content");Yn(t,r)}else t.open=!1}function at(t,e,r,o){let n=new CustomEvent("nojs:accordion-change",{bubbles:!0,detail:{element:e,open:r,index:o}});t.dispatchEvent(n)}function He(t){let e=[];for(let r of t.children)r.tagName==="DETAILS"&&e.push(r);return e}function Kn(t){t.directive("accordion",{priority:10,init(e,r,o){Wn();let n=(o||"").trim().toLowerCase()==="multi"?"multi":"single",i=!yi();e.setAttribute("role","group");let c=He(e);if(c.length===0)return;if(i)for(let f of c)Gn(f);let s=[],a=new MutationObserver(f=>{for(let l of f)for(let u of l.addedNodes)u.nodeType!==1||u.tagName!=="DETAILS"||u.parentElement===e&&m(u)});a.observe(e,{childList:!0});let d=0,m=f=>{i&&Gn(f);let l=f.querySelector(":scope > summary");if(l){let y=`nojs-accordion-panel-${Date.now()}-${d++}`,g=f.querySelector(":scope > .nojs-accordion-content");g?(g.id=g.id||y,g.setAttribute("role","region"),y=g.id):(f.id||(f.id=y),y=f.id),l.setAttribute("aria-expanded",f.open?"true":"false"),l.setAttribute("aria-controls",y)}let u=y=>{let g=He(e),b=g.indexOf(f),E=f.querySelector(":scope > summary");if(E&&E.setAttribute("aria-expanded",f.open?"true":"false"),f.open){if(n==="single")for(let h of g)h!==f&&h.open&&Un(h,i);at(e,f,!0,b)}else at(e,f,!1,b)},v=null;if(i){let y=f.querySelector(":scope > summary");y&&(v=g=>{g.preventDefault();let b=f.querySelector(":scope > .nojs-accordion-content");if(f.open)Yn(f,b),y.setAttribute("aria-expanded","false"),at(e,f,!1,He(e).indexOf(f));else{if(n==="single"){let E=He(e);for(let h of E)if(h!==f&&h.open){Un(h,!0);let _=h.querySelector(":scope > summary");_&&_.setAttribute("aria-expanded","false")}}xi(f,b),y.setAttribute("aria-expanded","true"),at(e,f,!0,He(e).indexOf(f))}},y.addEventListener("click",v))}f.addEventListener("toggle",u),s.push({details:f,toggleHandler:u,clickHandler:v})};for(let f of c)m(f);let p=f=>{let l=f.target;if(l.tagName!=="SUMMARY")return;let u=l.parentElement;if(!u||u.parentElement!==e)return;let y=He(e).map(E=>E.querySelector(":scope > summary")).filter(Boolean),g=y.indexOf(l);if(g===-1)return;let b=-1;switch(f.key){case"ArrowDown":case"ArrowRight":b=(g+1)%y.length;break;case"ArrowUp":case"ArrowLeft":b=(g-1+y.length)%y.length;break;case"Home":b=0;break;case"End":b=y.length-1;break;default:return}b!==-1&&b!==g&&(f.preventDefault(),y[b].focus())};e.addEventListener("keydown",p),it.containers.set(e,{mode:n,listeners:s,observer:a}),vi(e,()=>{e.removeEventListener("keydown",p),a.disconnect();for(let f of s)if(f.details.removeEventListener("toggle",f.toggleHandler),f.clickHandler){let l=f.details.querySelector(":scope > summary");l&&l.removeEventListener("click",f.clickHandler)}s.length=0,it.containers.delete(e)})}})}function Xn(t,e={}){Kn(t)}function Zn(){Nn()}var $e=new Map;function Qn(){let t=Array.from($e.keys());for(let e of t){let r=$e.get(e);if(r){if(r.resizeObserver){try{r.resizeObserver.disconnect()}catch{}r.resizeObserver=null}if(r.scrollHandler){try{e.removeEventListener("scroll",r.scrollHandler)}catch{}r.scrollHandler=null}if(r.spacerTop&&r.spacerTop.parentNode&&r.spacerTop.remove(),r.spacerBottom&&r.spacerBottom.parentNode&&r.spacerBottom.remove(),r.renderedNodes){for(let[o,n]of r.renderedNodes){if(n.__disposers){for(let i of n.__disposers)try{i()}catch{}n.__disposers=null}n.parentNode&&n.remove()}r.renderedNodes.clear()}r.disposed=!0}}$e.clear()}function Jn(){if(typeof document>"u"||document.querySelector("style[data-nojs-virtual-list]"))return;let t=`
[data-nojs-virtual] {
  overflow-y: auto;
  position: relative;

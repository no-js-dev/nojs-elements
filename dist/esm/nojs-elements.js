 ...
 * @license MIT
 */
var E={dragging:null,selected:new Map,placeholder:null},Be=new Map;function mt(){E.dragging=null,E.selected.clear(),E.placeholder&&(E.placeholder.remove(),E.placeholder=null),Be.clear()}function Fe(){if(typeof document>"u"||document.querySelector("style[data-nojs-dnd]"))return;let t=`
.nojs-dragging {
  opacity: 0.5;
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-tooltip",""),e.textContent=t,document.head.appendChild(e)}function Ln(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}var Me=8;function $t(t,e,r){let o=e.getBoundingClientRect(),n=t.getBoundingClientRect(),i=window.innerWidth,d=window.innerHeight,s,a;switch(r){case"bottom":s=o.bottom+Me,a=o.left+(o.width-n.width)/2;break;case"left":s=o.top+(o.height-n.height)/2,a=o.left-n.width-Me;break;case"right":s=o.top+(o.height-n.height)/2,a=o.right+Me;break;default:s=o.top-n.height-Me,a=o.left+(o.width-n.width)/2;break}a<4&&(a=4),a+n.width>i-4&&(a=i-n.width-4),s<4&&(s=4),s+n.height>d-4&&(s=d-n.height-4),t.style.top=`${s}px`,t.style.left=`${a}px`}var kn=0;function jn(t,e,r){document.body.appendChild(e),$t(e,t,r),e.setAttribute("aria-hidden","false")}function Pt(t,e){e.setAttribute("aria-hidden","true"),e.remove()}function Cn(t,e){t&&typeof t._warn=="function"?t._warn(e):console.warn(e)}function Rt(t){t.directive("tooltip",{priority:20,init(e,r,o){Ft();let n=o;if(!n){Cn(t,"[tooltip] attribute value (tooltip text) is required.");return}let i=e.getAttribute("tooltip-position")||"top",d=parseInt(e.getAttribute("tooltip-delay"),10),s=Number.isNaN(d)?300:d,a=e.getAttribute("tooltip-disabled"),u=a?t.findContext(e):null,g=()=>{if(!a||!u)return!1;try{return!!t.evaluate(a,u)}catch{return!1}},p=`nojs-tooltip-${++kn}`,m=document.createElement("div");m.className="nojs-tooltip",m.setAttribute("role","tooltip"),m.setAttribute("id",p),m.setAttribute("aria-hidden","true"),m.textContent=n,e.setAttribute("aria-describedby",p),ve.set(e,m);let c=!1,l=0,v=()=>{!c||!e.isConnected||l||(l=requestAnimationFrame(()=>{l=0,!(!c||!e.isConnected)&&$t(m,e,i)}))},y=()=>{window.addEventListener("scroll",v,!0),window.addEventListener("resize",v)},f=()=>{window.removeEventListener("scroll",v,!0),window.removeEventListener("resize",v),l&&(cancelAnimationFrame(l),l=0)},b=()=>{c||(jn(e,m,i),c=!0,y())},w=()=>{if(!c){Pt(e,m);return}f(),Pt(e,m),c=!1},h=()=>{if(g())return;te.has(e)&&clearTimeout(te.get(e));let I=setTimeout(()=>{te.delete(e),!g()&&e.isConnected&&b()},s);te.set(e,I)},x=()=>{te.has(e)&&(clearTimeout(te.get(e)),te.delete(e)),w()},_=()=>h(),L=()=>x(),j=()=>h(),k=()=>x(),S=I=>{I.key==="Escape"&&m.getAttribute("aria-hidden")==="false"&&x()};e.addEventListener("mouseenter",_),e.addEventListener("mouseleave",L),e.addEventListener("focusin",j),e.addEventListener("focusout",k),e.addEventListener("keydown",S);let A=null;if(a&&u&&typeof u.$watch=="function"){let I=()=>{c&&g()&&w()};A=u.$watch(I)}Ln(e,()=>{e.removeEventListener("mouseenter",_),e.removeEventListener("mouseleave",L),e.removeEventListener("focusin",j),e.removeEventListener("focusout",k),e.removeEventListener("keydown",S),A&&(A(),A=null),f(),te.has(e)&&(clearTimeout(te.get(e)),te.delete(e)),c=!1,m.remove(),ve.delete(e)})}})}function qt(t,e={}){Rt(t)}function zt(){Bt()}var K=new Map;function Mt(){K.clear()}function He(){if(typeof document>"u"||document.querySelector("style[data-nojs-popover]"))return;let t=`
.nojs-popover {
  position: fixed;
  z-index: 9998;
  margin: 0;
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-modal",""),e.textContent=t,document.head.appendChild(e)}function Tn(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}var Yt='a[href], button:not([disabled]), input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])',tt=new WeakMap;function Dn(t){let e=r=>{if(r.key!=="Tab")return;let o=[...t.querySelectorAll(Yt)].filter(d=>d.offsetParent!==null);if(o.length===0){r.preventDefault();return}let n=o[0],i=o[o.length-1];r.shiftKey?document.activeElement===n&&(r.preventDefault(),i.focus()):document.activeElement===i&&(r.preventDefault(),n.focus())};t.addEventListener("keydown",e),tt.set(t,e)}function Ut(t){let e=tt.get(t);e&&(t.removeEventListener("keydown",e),tt.delete(t))}var ke=new WeakMap;function Kt(t){t.directive("modal",{priority:10,init(r,o,n){xe();let i=n||`nojs-modal-${Date.now()}-${Math.random().toString(36).slice(2,7)}`;r.setAttribute("popover","manual"),r.classList.add("nojs-modal"),r.id=r.id||`nojs-modal-${i}`,r.setAttribute("data-modal-id",i),r.setAttribute("role","dialog"),r.setAttribute("aria-modal","true");let d=r.querySelector("h1, h2, h3, h4, h5, h6");d&&(d.id||(d.id=`nojs-modal-heading-${i}`),r.setAttribute("aria-labelledby",d.id));let s=r.getAttribute("modal-backdrop");s==="false"&&r.setAttribute("data-nojs-no-backdrop","");let a=r.getAttribute("modal-class"),u=r.getAttribute("modal-escape"),g=m=>{m.target===r&&s!=="false"&&u!=="false"&&Ee(r,i)};r.addEventListener("click",g),oe.set(i,r);let p=m=>{if(m.newState==="open"){if(r.style.zIndex=String(Wt()),a&&a.split(/\s+/).filter(Boolean).forEach(c=>r.classList.add(c)),requestAnimationFrame(()=>{if(!r.isConnected||!W.some(l=>l.el===r))return;let c=r.querySelector(Yt);c?c.focus():r.focus()}),Dn(r),u!=="false"){let c=l=>{l.key==="Escape"&&(l.stopPropagation(),Ee(r,i))};r.addEventListener("keydown",c),ke.set(r,c)}}else if(m.newState==="closed"){a&&a.split(/\s+/).filter(Boolean).forEach(v=>r.classList.remove(v)),Ut(r);let c=ke.get(r);c&&(r.removeEventListener("keydown",c),ke.delete(r));let l=W.findIndex(v=>v.el===r);if(l===-1&&(l=W.findIndex(v=>v.id===i)),l!==-1){let v=W[l];W.splice(l,1),v.triggerEl&&requestAnimationFrame(()=>{v.triggerEl.focus()})}}};r.addEventListener("toggle",p),Tn(r,()=>{r.removeEventListener("click",g),r.removeEventListener("toggle",p),Ut(r);let m=ke.get(r);m&&(r.removeEventListener("keydown",m),ke.delete(r)),oe.delete(i);let c=W.findIndex(l=>l.el===r);c===-1&&(c=W.findIndex(l=>l.id===i)),c!==-1&&W.splice(c,1)})}});let e=r=>e.open(r);e.open=r=>{let o=oe.get(r);if(!o)return!1;try{o.showPopover()}catch{return!1}return W.some(n=>n.id===r)||W.push({id:r,el:o,triggerEl:null}),!0},e.close=r=>{let o=oe.get(r);return o?(Ee(o,r),!0):!1},e.closeAll=()=>{for(let r=W.length-1;r>=0;r--)Ee(W[r].el,W[r].id)},t.modal=e}function Ee(t,e){try{t.hidePopover()}catch{}}function In(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function Bn(t){let e=document.querySelectorAll("[data-modal-id]");for(let r of e)if(r.getAttribute("data-modal-id")===t)return r;return null}function Xt(t){t.directive("modal-open",{priority:10,init(e,r,o){xe();let n=o;if(!n){let p=(e.closest("[use]")||e.parentElement)?.querySelector("[data-modal-id]");if(p&&(n=p.getAttribute("data-modal-id")),!n){console.warn('[modal-open] requires a target modal ID, e.g. modal-open="my-dialog"');return}}e.setAttribute("aria-haspopup","dialog"),e.setAttribute("aria-expanded","false");let i=()=>{let g=oe.get(n)||Bn(n);if(!g){console.warn(`[modal-open] modal "${n}" not found`);return}let p=W.some(m=>m.id===n);g.id&&e.setAttribute("aria-controls",g.id);try{g.showPopover()}catch{console.warn(`[modal-open] failed to open modal "${n}"`);return}p||W.push({id:n,el:g,triggerEl:e}),e.setAttribute("aria-expanded","true")},d=()=>{e.setAttribute("aria-expanded","false")},s=null,a=null;requestAnimationFrame(()=>{let g=oe.get(n);g&&(a=g,s=p=>{p.newState==="closed"&&e.setAttribute("aria-expanded","false")},g.addEventListener("toggle",s))}),e.addEventListener("click",i),In(e,()=>{e.removeEventListener("click",i),a&&s&&a.removeEventListener("toggle",s)})}})}function Fn(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function Zt(t){t.directive("modal-close",{priority:10,init(e,r,o){xe();let n=()=>{let i,d;if(o){if(d=o,i=oe.get(d),!i){console.warn(`[modal-close] modal "${d}" not found`);return}}else{if(i=e.closest("[modal]"),!i){console.warn("[modal-close] no parent modal found");return}d=i.getAttribute("modal")}Ee(i,d)};e.addEventListener("click",n),Fn(e,()=>{e.removeEventListener("click",n)})}})}function Qt(t,e={}){Kt(t),Xt(t),Zt(t)}function Nt(){Gt()}var ce={openMenus:new Map};function Jt(){ce.openMenus.clear()}function we(){if(typeof document>"u"||document.querySelector("style[data-nojs-dropdown]"))return;let t=`
.nojs-dropdown-menu {
  position: fixed;
  z-index: 9999;
  margin: 0;
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-dropdown",""),e.textContent=t,document.head.appendChild(e)}var Pn=0;function $n(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function er(t,e,r){let o=r.getAttribute("dropdown-position")||"bottom",n=r.getAttribute("dropdown-align")||"start";t.style.top="",t.style.left="";let i=e.getBoundingClientRect(),d=t.getBoundingClientRect(),s=window.innerHeight,a=window.innerWidth,u,g;switch(o){case"top":u=i.top-d.height,g=i.left;break;case"left":u=i.top,g=i.left-d.width;break;case"right":u=i.top,g=i.right;break;default:u=i.bottom,g=i.left}o==="bottom"||o==="top"?n==="end"&&(g=i.right-d.width):n==="end"&&(u=i.bottom-d.height),o==="bottom"&&u+d.height>s&&i.top-d.height>0?u=i.top-d.height:o==="top"&&u<0&&i.bottom+d.height<=s&&(u=i.bottom),g<4&&(g=4),g+d.width>a-4&&(g=a-d.width-4),t.style.top=`${u}px`,t.style.left=`${g}px`}function nt(t){return[...t.querySelectorAll("[dropdown-item]")].filter(e=>!e.hasAttribute("disabled")&&e.getAttribute("aria-disabled")!=="true")}function rt(t){let e=nt(t);e.length&&e[0].focus()}function tr(t){let e=nt(t);e.length&&e[e.length-1].focus()}function rr(t){t.directive("dropdown",{priority:15,init(r){we()}}),t.directive("dropdown-toggle",{priority:15,init(r){we();let o=r.closest("[dropdown]");if(!o)return;let n=o.querySelector("[dropdown-menu]");if(!n)return;r.setAttribute("aria-haspopup","menu"),r.setAttribute("aria-expanded","false"),n.classList.add("nojs-dropdown-menu"),n.setAttribute("role","menu"),n.setAttribute("popover","auto"),n.id||(n.id=`nojs-dd-menu-${Date.now()}-${Pn++}`),r.setAttribute("aria-controls",n.id);let i=!1,d=typeof n.showPopover=="function"&&typeof n.hidePopover=="function";function s(){if(n.setAttribute("data-open",""),d&&!i)try{n.showPopover(),i=!0}catch{i=!1}r.setAttribute("aria-expanded","true"),er(n,r,o),ce.openMenus.set(n,{toggle:r,wrapper:o})}function a(){if(d&&i){i=!1;try{n.hidePopover()}catch{}}n.removeAttribute("data-open"),r.setAttribute("aria-expanded","false"),ce.openMenus.delete(n)}function u(){return r.getAttribute("aria-expanded")==="true"}let g=f=>{f.newState==="closed"&&u()&&a()};n.addEventListener("toggle",g);let p=f=>{f.preventDefault(),f.stopPropagation(),u()?a():s()};r.addEventListener("click",p);let m=f=>{u()&&!o.contains(f.target)&&a()};document.addEventListener("click",m,!0);let c=f=>{f.key==="Escape"&&u()&&(a(),r.focus())};document.addEventListener("keydown",c);let l=f=>{switch(f.key){case"Enter":case" ":f.preventDefault(),s(),rt(n);break;case"ArrowDown":f.preventDefault(),s(),rt(n);break;case"ArrowUp":f.preventDefault(),s(),tr(n);break}};r.addEventListener("keydown",l);let v=f=>{if(!(!u()||nt(n).find(h=>h===document.activeElement)))switch(f.key){case"ArrowDown":f.preventDefault(),rt(n);break;case"ArrowUp":f.preventDefault(),tr(n);break}};n.addEventListener("keydown",v);let y=()=>{u()&&er(n,r,o)};window.addEventListener("scroll",y,!0),window.addEventListener("resize",y),$n(r,()=>{r.removeEventListener("click",p),r.removeEventListener("keydown",l),n.removeEventListener("keydown",v),n.removeEventListener("toggle",g),document.removeEventListener("click",m,!0),document.removeEventListener("keydown",c),window.removeEventListener("scroll",y,!0),window.removeEventListener("resize",y),ce.openMenus.delete(n)})}}),t.directive("dropdown-menu",{priority:15,init(r){we(),r.hasAttribute("role")||r.setAttribute("role","menu")}});let e=r=>e.open(r);e.open=r=>{let o=document.getElementById(r);if(!o)return!1;let i=o.closest("[dropdown]")?.querySelector("[dropdown-toggle]");return!i||i.getAttribute("aria-expanded")==="true"?!1:(i.click(),!0)},e.close=r=>{let o=document.getElementById(r);if(!o)return!1;let i=o.closest("[dropdown]")?.querySelector("[dropdown-toggle]");return!i||i.getAttribute("aria-expanded")!=="true"?!1:(i.click(),!0)},t.dropdown=e}function nr(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function Rn(t){return[...t.querySelectorAll("[dropdown-item]")].filter(e=>!e.hasAttribute("disabled")&&e.getAttribute("aria-disabled")!=="true")}function ot(t,e){if(!t)return;if(typeof t.hidePopover=="function")try{t.hidePopover()}catch{}t.removeAttribute("data-open");let r=e&&e.querySelector("[dropdown-toggle]");r&&r.setAttribute("aria-expanded","false"),ce.openMenus.has(t)&&ce.openMenus.delete(t)}function or(t){t.directive("dropdown-item",{priority:15,init(e){we();let r=e.closest("[dropdown-menu]"),o=e.closest("[dropdown]");e.setAttribute("role","menuitem"),e.setAttribute("tabindex","-1"),e.classList.add("nojs-dropdown-item"),e.hasAttribute("disabled")&&e.setAttribute("aria-disabled","true");let n=d=>{if(!r)return;let s=Rn(r),a=s.indexOf(e);switch(d.key){case"ArrowDown":{d.preventDefault(),(a+1<s.length?s[a+1]:s[0]).focus();break}case"ArrowUp":{d.preventDefault(),(a-1>=0?s[a-1]:s[s.length-1]).focus();break}case"Home":{d.preventDefault(),s.length&&s[0].focus();break}case"End":{d.preventDefault(),s.length&&s[s.length-1].focus();break}case"Enter":{d.preventDefault(),e.click();break}case"Escape":{if(d.preventDefault(),ot(r,o),o){let u=o.querySelector("[dropdown-toggle]");u&&u.focus()}break}case"Tab":{ot(r,o);break}}};e.addEventListener("keydown",n),nr(e,()=>e.removeEventListener("keydown",n));let i=()=>{if(ot(r,o),o){let d=o.querySelector("[dropdown-toggle]");d&&d.focus()}};e.addEventListener("click",i),nr(e,()=>e.removeEventListener("click",i))}})}function ir(t,e={}){rr(t),or(t)}function sr(){Jt()}var ie=new Map,Ae=new Set,ar=0;function dr(){return++ar}function cr(){for(let t of Ae)clearTimeout(t);Ae.clear();for(let t of ie.values())t.remove();ie.clear(),ar=0}function lr(){if(typeof document>"u"||document.querySelector("style[data-nojs-toast]"))return;let t=`
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-toast",""),e.textContent=t,document.head.appendChild(e)}function it(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}var qn=new Set(["top-right","top-left","bottom-right","bottom-left","top-center","bottom-center"]);function st(){return ie.size>0?ie.values().next().value:zn("top-right")}function zn(t){if(ie.has(t))return ie.get(t);let e=document.createElement("div");return e.classList.add("nojs-toast-container"),e.setAttribute("data-position",t),e.setAttribute("role","log"),e.setAttribute("aria-live","polite"),e.setAttribute("aria-relevant","additions"),document.body.appendChild(e),ie.set(t,e),e}function Mn(t){return t.startsWith("top")}function at(t,e,r,o,n){let i=dr(),d=t.getAttribute("data-position")||"top-right",s=document.createElement("div");s.classList.add("nojs-toast"),s.setAttribute("data-toast-id",i),s.setAttribute("data-type",r),r==="error"&&s.setAttribute("aria-live","assertive");let a=document.createElement("span");if(a.textContent=e,s.appendChild(a),n){let u=document.createElement("button");u.type="button",u.classList.add("nojs-toast-dismiss"),u.setAttribute("aria-label","Dismiss"),u.textContent="\xD7",u.addEventListener("click",()=>Ve(s)),s.appendChild(u)}if(Mn(d)&&t.firstChild?t.insertBefore(s,t.firstChild):t.appendChild(s),o>0){let u=setTimeout(()=>{Ae.delete(u),s.isConnected&&Ve(s)},o);Ae.add(u),s._toastTimerId=u}return s}function Ve(t){!t||!t.isConnected||(t._toastTimerId!=null&&(clearTimeout(t._toastTimerId),Ae.delete(t._toastTimerId)),t.remove())}function ur(t){lr(),t.directive("toast-container",{priority:10,init(r,o,n){let i=n&&qn.has(n)?n:"top-right";r.classList.add("nojs-toast-container"),r.setAttribute("data-position",i),r.setAttribute("role","log"),r.setAttribute("aria-live","polite"),r.setAttribute("aria-relevant","additions"),ie.set(i,r),it(r,()=>{ie.get(i)===r&&ie.delete(i)})}}),t.directive("toast",{priority:10,init(r,o,n){if(!n)return;let i=r.getAttribute("toast-type")||"info",d=parseInt(r.getAttribute("toast-duration"),10),s=Number.isNaN(d)?3e3:d,a=r.getAttribute("toast-dismiss")!=="false";if(r.tagName==="BUTTON"||r.tagName==="A"||r.hasAttribute("on:click")){let l=()=>{let v=st();at(v,n,i,s,a)};r.addEventListener("click",l),it(r,()=>r.removeEventListener("click",l));return}let g=t.findContext(r),p;function m(){let l=t.evaluate(n,g);if(l&&l!==p){let v=typeof l=="string"?l:String(l),y=st();at(y,v,i,s,a),p=void 0}else p=l}let c=g.$watch(m);it(r,c)}});let e=(r,o="info",n=3e3)=>{if(typeof document>"u")return;let i=!0,d=st();return at(d,String(r),o,n,i)};e.dismiss=r=>{let o=typeof CSS<"u"&&CSS.escape?CSS.escape(String(r)):String(r).replace(/["\\\]]/g,"\\$&"),n=document.querySelector(`[data-toast-id="${o}"]`);n&&Ve(n)},e.dismissAll=()=>{document.querySelectorAll(".nojs-toast").forEach(r=>Ve(r))},t.toast=e}function pr(t,e={}){ur(t)}function fr(){cr()}var ge={containers:new Map};function gr(){ge.containers.clear()}function mr(){if(typeof document>"u"||document.querySelector("style[data-nojs-tabs]"))return;let t=`
.nojs-tabs {
  display: flex;
  flex-direction: column;
  border: 1px solid #E2E8F0;
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-tree",""),e.textContent=t,document.head.appendChild(e)}function dt(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function Ar(t){let e=[],r=document.createTreeWalker(t,NodeFilter.SHOW_ELEMENT,{acceptNode(n){return n.matches&&n.matches('.nojs-subtree[aria-hidden="true"]')?NodeFilter.FILTER_REJECT:n.getAttribute("role")==="treeitem"?NodeFilter.FILTER_ACCEPT:NodeFilter.FILTER_SKIP}}),o;for(;o=r.nextNode();)e.push(o);return e}function _r(t){return t.closest('[role="tree"]')}function Vn(t){let e=t.parentElement?.closest('[role="group"], .nojs-subtree');if(e){let r=e.parentElement?.closest('[role="treeitem"]');if(r)return r;let o=e.previousElementSibling;if(o?.matches?.('[role="treeitem"]'))return o}return t.parentElement?.closest('[role="treeitem"]')||null}function Wn(t){let e=t.cloneNode(!0);return e.querySelectorAll('[role="group"]').forEach(o=>o.remove()),(e.textContent||"").trim().toLowerCase()}function Lr(t){t.directive("tree",{priority:15,init(e){_e(),e.classList.add("nojs-tree"),e.setAttribute("role","tree"),e.getAttribute("tree-icon")==="false"&&e.setAttribute("data-tree-icon","false")}})}function kr(t){t.directive("branch",{priority:16,init(e,r,o){_e();let n=o==="expanded";e.classList.add("nojs-branch"),e.setAttribute("role","treeitem"),e.setAttribute("aria-expanded",String(n));let i=_r(e);if(i){let c=i.querySelector('[role="treeitem"][tabindex="0"]');e.setAttribute("tabindex",c?"-1":"0")}else e.setAttribute("tabindex","0");let d=!1;queueMicrotask(()=>{if(d)return;let c=e.querySelector(":scope > [subtree], :scope > .nojs-subtree")||(e.nextElementSibling?.matches?.("[subtree], .nojs-subtree")?e.nextElementSibling:null);c?(F.branches.set(e,{expanded:n,subtreeEl:c}),c.setAttribute("aria-hidden",String(!n))):F.branches.set(e,{expanded:n,subtreeEl:null})});function s(c){let l=F.selectedItem;l&&l!==c&&(l.classList.remove("nojs-branch-selected"),l.setAttribute("aria-selected","false")),c.classList.add("nojs-branch-selected"),c.setAttribute("aria-selected","true"),F.selectedItem=c}function a(c){let l=F.branches.get(c);!l||!l.subtreeEl||(l.expanded=!l.expanded,c.setAttribute("aria-expanded",String(l.expanded)),l.subtreeEl.setAttribute("aria-hidden",String(!l.expanded)))}function u(c){let l=F.branches.get(c);!l||!l.subtreeEl||l.expanded||(l.expanded=!0,c.setAttribute("aria-expanded","true"),l.subtreeEl.setAttribute("aria-hidden","false"))}function g(c){let l=F.branches.get(c);!l||!l.subtreeEl||!l.expanded||(l.expanded=!1,c.setAttribute("aria-expanded","false"),l.subtreeEl.setAttribute("aria-hidden","true"))}let p=c=>{c.target.closest?.('[role="treeitem"]')===e&&(c.stopPropagation(),s(e),a(e))};e.addEventListener("click",p),dt(e,()=>e.removeEventListener("click",p));let m=c=>{let l=_r(e);if(!l)return;let v=Ar(l),y=v.indexOf(e),f=F.branches.get(e),b=f&&f.subtreeEl;switch(c.key){case"ArrowRight":if(c.preventDefault(),b&&!f.expanded)u(e);else if(b&&f.expanded){let w=f.subtreeEl.querySelector('[role="treeitem"]');w&&me(w,v)}break;case"ArrowLeft":if(c.preventDefault(),b&&f.expanded)g(e);else{let w=Vn(e);w&&me(w,Ar(l))}break;case"ArrowDown":c.preventDefault(),y<v.length-1&&me(v[y+1],v);break;case"ArrowUp":c.preventDefault(),y>0&&me(v[y-1],v);break;case"Enter":case" ":c.preventDefault(),s(e),a(e);break;case"Home":c.preventDefault(),v.length>0&&me(v[0],v);break;case"End":c.preventDefault(),v.length>0&&me(v[v.length-1],v);break;default:if(c.key.length===1&&!c.ctrlKey&&!c.altKey&&!c.metaKey){c.preventDefault(),F.typeahead+=c.key.toLowerCase(),F.typeaheadTimer&&clearTimeout(F.typeaheadTimer),F.typeaheadTimer=setTimeout(()=>{F.typeahead="",F.typeaheadTimer=null},500);let w=y+1;for(let h=0;h<v.length;h++){let x=(w+h)%v.length;if(Wn(v[x]).startsWith(F.typeahead)){me(v[x],v);break}}}break}};e.addEventListener("keydown",m),dt(e,()=>e.removeEventListener("keydown",m)),dt(e,()=>{d=!0,F.branches.delete(e),F.selectedItem===e&&(F.selectedItem=null),F.typeaheadTimer&&(clearTimeout(F.typeaheadTimer),F.typeaheadTimer=null,F.typeahead="")})}})}function me(t,e){for(let r of e)r.setAttribute("tabindex",r===t?"0":"-1");t.focus()}function jr(t){t.directive("subtree",{priority:16,init(e){_e(),e.classList.add("nojs-subtree"),e.classList.add("nojs-tree"),e.setAttribute("role","group");for(let o of e.children)o.tagName==="LI"&&!o.querySelector("[branch], .nojs-branch")&&(o.setAttribute("role","treeitem"),o.setAttribute("tabindex","-1"),o.classList.add("nojs-tree-leaf"));let r=e.parentElement?.matches?.('[role="treeitem"]')?e.parentElement:e.previousElementSibling?.matches?.('[role="treeitem"]')?e.previousElementSibling:null;if(r){let o=F.branches.get(r);o?(e.setAttribute("aria-hidden",String(!o.expanded)),o.subtreeEl=e):e.setAttribute("aria-hidden","true")}else e.setAttribute("aria-hidden","true")}})}function Cr(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function ct(t){return t.closest('[role="treeitem"]')}function Gn(t){return t.closest('[role="tree"]')}function Un(t){let e=t.parentElement;return e?[...e.children].filter(r=>r.getAttribute("role")==="treeitem"):[]}function Yn(t){return Un(t).indexOf(t)}function Kn(t,e,r){let o=t.getBoundingClientRect(),n=e-o.top,i=o.height;return r==="reparent"?"on":r==="reorder"?n<i/2?"before":"after":n<i*.25?"before":n>i*.75?"after":"on"}function Sr(t,e){let r=t.parentElement;for(;r;){if(r===e)return!0;r=r.parentElement}return!1}var D={dragging:null,indicator:null,currentTarget:null,currentPosition:null};function Le(){D.indicator&&(D.indicator.remove(),D.indicator=null)}function Se(t){if(!t)return;let e=t.querySelectorAll(".nojs-tree-drag-over");for(let r of e)r.classList.remove("nojs-tree-drag-over")}function Xn(){let t=document.createElement("div");return t.className="nojs-tree-drag-indicator",t.setAttribute("aria-hidden","true"),t}function Zn(t,e){Le();let r=Xn(),o=t.getBoundingClientRect(),n=Gn(t);if(!n)return;let i=n.getBoundingClientRect();r.style.position="absolute",r.style.left=o.left-i.left+"px",r.style.width=o.width+"px",e==="before"?r.style.top=o.top-i.top-1+"px":r.style.top=o.bottom-i.top-1+"px",getComputedStyle(n).position==="static"&&(n.style.position="relative"),n.appendChild(r),D.indicator=r}function Tr(t){t.directive("tree-drag-mode",{priority:15,init(e,r,o){if(_e(),o!=="reparent"&&o!=="reorder"&&o!=="both")return;let n=0,i=m=>{let c=ct(m.target);if(c&&e.contains(c)){if(c.hasAttribute("tree-drag-disabled")){m.preventDefault();return}D.dragging={el:c,treeRoot:e},m.dataTransfer&&(m.dataTransfer.effectAllowed="move",m.dataTransfer.setData("text/plain","")),c.classList.add("nojs-dragging"),c.dispatchEvent(new CustomEvent("tree:drag-start",{bubbles:!0,detail:{node:c}}))}},d=m=>{if(!D.dragging||D.dragging.treeRoot!==e)return;let c=ct(m.target);if(!c||!e.contains(c)||c===D.dragging.el||Sr(c,D.dragging.el))return;m.preventDefault(),m.dataTransfer&&(m.dataTransfer.dropEffect="move");let l=Kn(c,m.clientY,o);(D.currentTarget!==c||D.currentPosition!==l)&&(Se(e),Le(),D.currentTarget=c,D.currentPosition=l,l==="on"?c.classList.add("nojs-tree-drag-over"):Zn(c,l))},s=m=>{D.dragging&&D.dragging.treeRoot===e&&n++},a=m=>{D.dragging&&(n--,n<=0&&(n=0,Se(e),Le(),D.currentTarget=null,D.currentPosition=null))},u=m=>{if(m.preventDefault(),m.stopPropagation(),n=0,!D.dragging||D.dragging.treeRoot!==e)return;let c=D.dragging.el,l=D.currentTarget,v=D.currentPosition;if(Se(e),Le(),!l||!v){D.dragging=null,D.currentTarget=null,D.currentPosition=null;return}if(l===c||Sr(l,c)){D.dragging=null,D.currentTarget=null,D.currentPosition=null;return}if(v==="on"){let y=l.querySelector(':scope > [role="group"]');y||(y=l.nextElementSibling?.matches?.('[role="group"]')?l.nextElementSibling:null),y?y.setAttribute("aria-hidden","false"):(y=document.createElement("ul"),y.setAttribute("role","group"),y.setAttribute("subtree",""),y.classList.add("nojs-subtree","nojs-tree"),y.setAttribute("aria-hidden","false"),l.appendChild(y));let f=F.branches.get(l);f&&(f.expanded=!0,f.subtreeEl=y,l.setAttribute("aria-expanded","true")),y.appendChild(c),e.dispatchEvent(new CustomEvent("tree:reparent",{bubbles:!0,detail:{node:c,newParent:l}}))}else{let y=l.parentElement;if(!y){D.dragging=null,D.currentTarget=null,D.currentPosition=null;return}if(v==="before")y.insertBefore(c,l);else{let b=l.nextElementSibling,w=b?.matches?.('[role="group"]')?b.nextElementSibling:b;w?y.insertBefore(c,w):y.appendChild(c)}let f=Yn(c);e.dispatchEvent(new CustomEvent("tree:reorder",{bubbles:!0,detail:{node:c,newIndex:f}}))}D.dragging=null,D.currentTarget=null,D.currentPosition=null},g=m=>{let c=ct(m.target);c&&c.classList.remove("nojs-dragging"),Se(e),Le(),n=0,D.dragging&&D.dragging.el.dispatchEvent(new CustomEvent("tree:drag-end",{bubbles:!0,detail:{node:D.dragging.el}})),D.dragging=null,D.currentTarget=null,D.currentPosition=null};e.addEventListener("dragstart",i),e.addEventListener("dragover",d),e.addEventListener("dragenter",s),e.addEventListener("dragleave",a),e.addEventListener("drop",u),e.addEventListener("dragend",g),Cr(e,()=>{e.removeEventListener("dragstart",i),e.removeEventListener("dragover",d),e.removeEventListener("dragenter",s),e.removeEventListener("dragleave",a),e.removeEventListener("drop",u),e.removeEventListener("dragend",g),Se(e),Le()}),Qn(e);let p=new MutationObserver(m=>{for(let c of m)for(let l of c.addedNodes){if(l.nodeType!==1)continue;l.getAttribute("role")==="treeitem"&&lt(l);let v=l.querySelectorAll?.('[role="treeitem"]');if(v)for(let y of v)lt(y)}});p.observe(e,{childList:!0,subtree:!0}),Cr(e,()=>p.disconnect())}})}function lt(t){if(t.hasAttribute("tree-drag-disabled")){t.draggable=!1;return}t.draggable=!0}function Qn(t){let e=t.querySelectorAll('[role="treeitem"]');for(let r of e)lt(r)}function Dr(t,e={}){Lr(t),kr(t),jr(t),Tr(t)}function Ir(){wr()}var We=new Map;function Br(){We.clear()}function Ge(){if(typeof document>"u"||document.querySelector("style[data-nojs-stepper]"))return;let t=`
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-split",""),e.textContent=t,document.head.appendChild(e)}function eo(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function Ur(t){return t==="horizontal"?"clientX":"clientY"}function Q(t,e){let r=t.getBoundingClientRect?t.getBoundingClientRect():null,o=r&&(e==="horizontal"?r.width:r.height);return o||(e==="horizontal"?t.offsetWidth:t.offsetHeight)}function Yr(t,e){if(e!=="horizontal")return 1;try{return(t.closest&&t.closest("[dir]")?.getAttribute("dir")||(typeof getComputedStyle=="function"?getComputedStyle(t).direction:""))==="rtl"?-1:1}catch{return 1}}function to(t,e){let o=(be.get(t)?.gutters||[]).reduce((n,i)=>n+Q(i,e),0);return Q(t,e)-o}function ro(t,e){if(!t)return null;let r=parseFloat(t);return Number.isNaN(r)?null:typeof t=="string"&&t.trim().endsWith("%")?r/100*e:r}function De(t,e){let r=G.get(e);return r?r.min!=null&&t<r.min?r.min:r.max!=null&&t>r.max?r.max:t:t}function Ye(t,e,r,o){let n=Q(e,o),i=Q(r,o),d=G.get(e),s=G.get(r);t.setAttribute("aria-valuenow",Math.round(n)),t.setAttribute("aria-valuemin",d?.min||0),t.setAttribute("aria-valuemax",Math.round(n+i-(s?.min||0)))}function ut(t){let e=t.getAttribute("split-persist");if(!e)return;let r=be.get(t);if(!r)return;let o=r.panes.map(n=>n.style.flexBasis||"");try{localStorage.setItem(`nojs-split:${e}`,JSON.stringify(o))}catch{}}function no(t){let e=t.getAttribute("split-persist");if(!e)return!1;try{let r=localStorage.getItem(`nojs-split:${e}`);if(!r)return!1;let o=JSON.parse(r),n=be.get(t);return!n||o.length!==n.panes.length?!1:(o.forEach((i,d)=>{i&&(n.panes[d].style.flexBasis=i,n.panes[d].style.flexGrow="0")}),!0)}catch{return!1}}function oo(t,e,r,o,n){let i=document.createElement("div");i.className="nojs-gutter",i.setAttribute("role","separator"),i.setAttribute("tabindex","0"),i.setAttribute("aria-orientation",e==="horizontal"?"vertical":"horizontal"),i.setAttribute("aria-label","Resize"),n!==6&&i.style.setProperty("--nojs-gutter-size",`${n}px`);let d=c=>{if(c.button!==0)return;c.preventDefault();let l=to(t,e);C.active=!0,C.splitEl=t,C.gutterEl=i,C.prevPane=r,C.nextPane=o,C.direction=e,C.startPos=c[Ur(e)],C.startPrevSize=Q(r,e),C.startNextSize=Q(o,e),C.containerSize=l,C.sign=Yr(t,e),document.body.style.cursor=e==="horizontal"?"col-resize":"row-resize",document.body.style.userSelect="none",i.setPointerCapture(c.pointerId)},s=c=>{if(!C.active||C.gutterEl!==i)return;let l=(c[Ur(C.direction)]-C.startPos)*(C.sign||1),v=De(C.startPrevSize+l,C.prevPane),y=De(C.startNextSize-l,C.nextPane),f=C.startPrevSize+C.startNextSize;v+y!==f&&(v!==C.startPrevSize+l?y=f-v:v=f-y),C.prevPane.style.flexBasis=`${v}px`,C.prevPane.style.flexGrow="0",C.nextPane.style.flexBasis=`${y}px`,C.nextPane.style.flexGrow="0",Ye(i,C.prevPane,C.nextPane,C.direction)},a=()=>{!C.active||C.gutterEl!==i||(C.active=!1,document.body.style.cursor="",document.body.style.userSelect="",ut(t),t.dispatchEvent(new CustomEvent("split-resize",{bubbles:!0,detail:{prevPane:r,nextPane:o}})))};i.addEventListener("pointerdown",d),i.addEventListener("pointermove",s),i.addEventListener("pointerup",a),i.addEventListener("pointercancel",a);let u=10,g=c=>{let l=e==="horizontal",v=Yr(t,e),y=0;if(l&&c.key==="ArrowRight"||!l&&c.key==="ArrowDown")y=u*v;else if(l&&c.key==="ArrowLeft"||!l&&c.key==="ArrowUp")y=-u*v;else if(c.key==="Home")y=(G.get(r)?.min||0)-Q(r,e);else if(c.key==="End"){let _=G.get(o);y=Q(r,e)+Q(o,e)-(_?.min||0)-Q(r,e)}else return;c.preventDefault();let f=Q(r,e),b=Q(o,e),w=f+b,h=De(f+y,r),x=De(w-h,o);h=w-x,h=De(h,r),x=w-h,r.style.flexBasis=`${h}px`,r.style.flexGrow="0",o.style.flexBasis=`${x}px`,o.style.flexGrow="0",Ye(i,r,o,e),ut(t)};i.addEventListener("keydown",g);let p=()=>{let c=G.get(r),l=G.get(o),v=c?.collapsible?r:l?.collapsible?o:null;if(!v)return;let y=G.get(v);if(!y)return;let f=v===r?o:r,b=Q(r,e)+Q(o,e);if(y.collapsed){y.collapsed=!1,v.removeAttribute("data-collapsed");let w=y.preCollapseSize||`${Math.round(b/2)}px`,h=ro(w,b)??b/2,x=Math.min(h,b);v.style.flexBasis=`${x}px`,v.style.flexGrow="0",f.style.flexBasis=`${b-x}px`,f.style.flexGrow="0"}else y.preCollapseSize=v.style.flexBasis||`${Q(v,e)}px`,y.collapsed=!0,v.setAttribute("data-collapsed","true"),v.style.flexBasis="0px",v.style.flexGrow="0",f.style.flexBasis=`${b}px`,f.style.flexGrow="0";Ye(i,r,o,e),ut(t),t.dispatchEvent(new CustomEvent("split-collapse",{bubbles:!0,detail:{pane:v,collapsed:y.collapsed}}))};return i.addEventListener("dblclick",p),{gutter:i,cleanup:()=>{i.removeEventListener("pointerdown",d),i.removeEventListener("pointermove",s),i.removeEventListener("pointerup",a),i.removeEventListener("pointercancel",a),i.removeEventListener("keydown",g),i.removeEventListener("dblclick",p)}}}function Kr(t){t.directive("split",{priority:14,init(e,r,o){Ue();let n=(o||"horizontal").trim()==="vertical"?"vertical":"horizontal",i=parseInt(e.getAttribute("split-gutter"),10)||6;e.classList.add("nojs-split"),e.setAttribute("data-direction",n);let d=Array.from(e.children).filter(g=>g.hasAttribute("pane"));if(d.length<2){console.warn(`[split] Container requires at least 2 [pane] children, found ${d.length}.`);return}d.forEach(g=>{G.get(g)||G.set(g,{size:g.getAttribute("pane")||null,min:parseInt(g.getAttribute("pane-min"),10)||0,max:parseInt(g.getAttribute("pane-max"),10)||1/0,collapsible:g.getAttribute("pane-collapsible")==="true",collapsed:!1,preCollapseSize:null})});let s=[],a=[];for(let g=0;g<d.length-1;g++){let{gutter:p,cleanup:m}=oo(e,n,d[g],d[g+1],i);d[g].after(p),s.push(p),a.push(m)}be.set(e,{direction:n,gutterSize:i,panes:d,gutters:s}),no(e)||d.forEach(g=>{let m=G.get(g)?.size;m?(g.style.flexBasis=m,g.style.flexGrow="0"):(g.style.flexGrow="1",g.style.flexBasis="0")}),requestAnimationFrame(()=>{s.forEach((g,p)=>{Ye(g,d[p],d[p+1],n)})}),eo(e,()=>{a.forEach(g=>g()),s.forEach(g=>g.remove()),be.delete(e),d.forEach(g=>G.delete(g)),e.classList.remove("nojs-split"),e.removeAttribute("data-direction")})}})}function io(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function Xr(t){t.directive("pane",{priority:15,init(e,r,o){Ue(),e.classList.add("nojs-pane"),G.has(e)||G.set(e,{size:o||null,min:parseInt(e.getAttribute("pane-min"),10)||0,max:parseInt(e.getAttribute("pane-max"),10)||1/0,collapsible:e.getAttribute("pane-collapsible")==="true",collapsed:!1,preCollapseSize:null});let n=G.get(e),i=e.closest("[data-direction='vertical']")?"height":"width";n.min&&(e.style[`min${i==="width"?"Width":"Height"}`]=`${n.min}px`),n.max&&n.max!==1/0&&(e.style[`max${i==="width"?"Width":"Height"}`]=`${n.max}px`),io(e,()=>{e.classList.remove("nojs-pane"),G.delete(e),e.style.removeProperty("min-width"),e.style.removeProperty("min-height"),e.style.removeProperty("max-width"),e.style.removeProperty("max-height"),e.style.removeProperty("flex-basis"),e.style.removeProperty("flex-grow")})}})}function Zr(t,e={}){Kr(t),Xr(t)}function Qr(){Gr()}var le={sorts:new Map};function Nr(){le.sorts.clear()}function he(){if(typeof document>"u"||document.querySelector("style[data-nojs-table]"))return;let t=`
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-table",""),e.textContent=t,document.head.appendChild(e)}function so(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function ao(t,e){let r=t.querySelector("tbody");if(!r)return null;let o=null;if(r.hasAttribute("each")||r.hasAttribute("foreach")?o=r:o=r.querySelector("[each]")||r.querySelector("[foreach]"),!o)return null;let n=o.getAttribute("each")||o.getAttribute("foreach");if(!n)return null;let i=n.match(/^\s*(\w+)\s+(?:in|of)\s+(.+)\s*$/);return i?{iteratorVar:i[1],arrayPath:i[2].trim()}:null}function co(t,e){let r=e.split("."),o=t;for(let n of r){if(o==null)return;o=o[n]}return o}function Jr(t,e,r){let o=e.split("."),n=t;for(let i=0;i<o.length-1;i++){if(n[o[i]]==null)return;n=n[o[i]]}n[o[o.length-1]]=r}function en(t,e){let r=Number.isNaN(t),o=Number.isNaN(e);return r&&o?0:r?1:o||t<e?-1:t>e?1:0}function rn(t,e,r){if(t==null&&e==null)return 0;if(t==null)return-1;if(e==null)return 1;switch(r){case"number":return en(Number(t),Number(e));case"date":return en(new Date(t).getTime(),new Date(e).getTime());default:return String(t).localeCompare(String(e))}}function lo(t){let e=t.querySelectorAll("th[data-sortable]");for(let r of e)r.removeAttribute("data-sort-dir"),r.setAttribute("aria-sort","none")}function nn(t){t.directive("sortable",{priority:10,init(e){he(),e.classList.add("nojs-sortable")}})}function on(t){t.directive("sort",{priority:11,init(e,r,o){he();let n=o;if(!n)return;let i=e.getAttribute("sort-type")||"string",d=e.getAttribute("sort-default");e.setAttribute("data-sortable",""),e.setAttribute("aria-sort","none");let s=e.closest("table");if(!s)return;le.sorts.has(s)||le.sorts.set(s,{column:null,direction:null}),(d==="asc"||d==="desc")&&(le.sorts.get(s).column||tn(e,s,n,i,d,t));let a=()=>{let u=le.sorts.get(s),g;u.column!==n?g="asc":u.direction==="asc"?g="desc":u.direction==="desc"?g=null:g="asc",tn(e,s,n,i,g,t)};e.addEventListener("click",a),so(e,()=>{e.removeEventListener("click",a),s&&!s.isConnected&&(le.sorts.delete(s),delete s._nojsOriginalOrder,delete s._nojsOriginalRows)})}})}function tn(t,e,r,o,n,i){let d=le.sorts.get(e);lo(e),n?(t.setAttribute("data-sort-dir",n),t.setAttribute("aria-sort",n==="asc"?"ascending":"descending"),d.column=r,d.direction=n):(d.column=null,d.direction=null);let s=ao(e,i);if(s){let a=i.findContext(e),u=a?co(a,s.arrayPath):null;if(Array.isArray(u)){if(!n){let p=e._nojsOriginalOrder;if(p){let m=new Set(u),c=p.filter(l=>m.has(l));for(let l of u)p.includes(l)||c.push(l);Jr(a,s.arrayPath,c)}return}e._nojsOriginalOrder||(e._nojsOriginalOrder=[...u]);let g=[...u].sort((p,m)=>{let c=p!=null?p[r]:null,l=m!=null?m[r]:null,v=rn(c,l,o);return n==="desc"?-v:v});Jr(a,s.arrayPath,g);return}}uo(e,t,r,o,n)}function uo(t,e,r,o,n){let i=t.querySelector("tbody");if(!i)return;let a=[...e.closest("tr").children].indexOf(e);if(a<0)return;let u=[...i.querySelectorAll(":scope > tr")];if(t._nojsOriginalRows||(t._nojsOriginalRows=[...u]),!n){let m=document.createDocumentFragment();for(let c of t._nojsOriginalRows)m.appendChild(c);i.appendChild(m);return}let g=m=>{let c=m.replace(/[^0-9.\-]/g,"");return c===""||c==="-"?NaN:parseFloat(c)};u.sort((m,c)=>{let l=m.children[a]?.textContent?.trim()||"",v=c.children[a]?.textContent?.trim()||"",y=rn(o==="number"?g(l):l,o==="number"?g(v):v,o);return n==="desc"?-y:y});let p=document.createDocumentFragment();for(let m of u)p.appendChild(m);i.appendChild(p)}function sn(t){t.directive("fixed-header",{priority:10,init(e){he(),e.classList.add("nojs-fixed-header")}})}function an(t){t.directive("fixed-col",{priority:10,init(e){he(),e.classList.add("nojs-fixed-col")}})}function pt(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function dn(t){let e=t.querySelector("tbody");if(!e)return null;let r=null;if(e.hasAttribute("each")||e.hasAttribute("foreach")?r=e:r=e.querySelector("[each]")||e.querySelector("[foreach]"),!r)return null;let o=r.getAttribute("each")||r.getAttribute("foreach");if(!o)return null;let n=o.match(/^\s*(\w+)\s+(?:in|of)\s+(.+)\s*$/);return n?{iteratorVar:n[1],arrayPath:n[2].trim(),eachEl:r}:null}function cn(t,e){let r=e.split("."),o=t;for(let n of r){if(o==null)return;o=o[n]}return o}function ln(t,e,r){let o=e.split("."),n=t;for(let i=0;i<o.length-1;i++){if(n[o[i]]==null)return;n=n[o[i]]}n[o[o.length-1]]=r}function un(t){t.directive("table-reorder",{priority:15,init(e){if(he(),e.tagName!=="TABLE")return;let r=e.querySelector("tbody");if(!r)return;let o=t.findContext(e),n=e.getAttribute("table-reorder-handle"),i=e.getAttribute("table-reorder-drag-class")||"nojs-row-dragging",d=e.getAttribute("table-reorder-over-class")||"nojs-row-drag-over",s=null,a=null,u=null;function g(){let y=r.querySelectorAll(":scope > tr");for(let f=0;f<y.length;f++){let b=y[f];if(b._nojsReorderSetup)continue;b._nojsReorderSetup=!0,b.draggable=!0,b.setAttribute("aria-grabbed","false");let w=!0;if(n){let k=S=>{w=!!S.target.closest(n)};b.addEventListener("mousedown",k),pt(b,()=>b.removeEventListener("mousedown",k))}let h=k=>{if(n&&!w){k.preventDefault();return}s=[...r.querySelectorAll(":scope > tr")].indexOf(b),a=b,k.dataTransfer&&(k.dataTransfer.effectAllowed="move",k.dataTransfer.setData("text/plain","")),i.split(/\s+/).filter(Boolean).forEach(A=>b.classList.add(A)),b.setAttribute("aria-grabbed","true")},x=k=>{if(a==null)return;k.preventDefault(),k.dataTransfer&&(k.dataTransfer.dropEffect="move");let S=b.getBoundingClientRect(),A=S.top+S.height/2,H=[...r.querySelectorAll(":scope > tr")].indexOf(b);p(),H!==s&&(k.clientY<A?b.classList.add("nojs-reorder-insert-before"):b.classList.add("nojs-reorder-insert-after"),u=b)},_=()=>{b.classList.remove("nojs-reorder-insert-before"),b.classList.remove("nojs-reorder-insert-after"),u===b&&(u=null)},L=k=>{if(k.preventDefault(),k.stopPropagation(),a==null||s==null)return;let S=[...r.querySelectorAll(":scope > tr")],A=b.getBoundingClientRect(),I=A.top+A.height/2,H=S.indexOf(b);k.clientY>=I&&H++;let Z=s;if(Z===H||Z+1===H){m();return}let z=Z<H?H-1:H,se=dn(e);if(se&&o){let T=cn(o,se.arrayPath);if(Array.isArray(T)){let P=[...T],[q]=P.splice(Z,1);P.splice(z,0,q),ln(o,se.arrayPath,P),e._nojsOriginalOrder&&(e._nojsOriginalOrder=[...P]),e.dispatchEvent(new CustomEvent("table:reorder",{bubbles:!0,detail:{from:Z,to:z,item:q}}))}}else{let T=a,P=S[z];T&&P&&(Z<z?r.insertBefore(T,P.nextSibling):r.insertBefore(T,P),e.dispatchEvent(new CustomEvent("table:reorder",{bubbles:!0,detail:{from:Z,to:z,item:null}})))}m()},j=()=>{m()};b.addEventListener("dragstart",h),b.addEventListener("dragover",x),b.addEventListener("dragleave",_),b.addEventListener("drop",L),b.addEventListener("dragend",j),pt(b,()=>{b.removeEventListener("dragstart",h),b.removeEventListener("dragover",x),b.removeEventListener("dragleave",_),b.removeEventListener("drop",L),b.removeEventListener("dragend",j),b._nojsReorderSetup=!1})}}function p(){u&&(u.classList.remove("nojs-reorder-insert-before"),u.classList.remove("nojs-reorder-insert-after"),u=null)}function m(){a&&(i.split(/\s+/).filter(Boolean).forEach(f=>a.classList.remove(f)),a.setAttribute("aria-grabbed","false")),p(),s=null,a=null;let y=r.querySelectorAll(":scope > tr");for(let f of y)f.classList.remove("nojs-reorder-insert-before"),f.classList.remove("nojs-reorder-insert-after"),d.split(/\s+/).filter(Boolean).forEach(b=>f.classList.remove(b))}let c=y=>{a!=null&&(y.preventDefault(),y.dataTransfer&&(y.dataTransfer.dropEffect="move"))},l=y=>{if(a==null||y.target!==r)return;y.preventDefault(),y.stopPropagation();let f=s,w=[...r.querySelectorAll(":scope > tr")].length-1;if(f===w){m();return}let h=dn(e);if(h&&o){let x=cn(o,h.arrayPath);if(Array.isArray(x)){let _=[...x],[L]=_.splice(f,1);_.push(L),ln(o,h.arrayPath,_),e._nojsOriginalOrder&&(e._nojsOriginalOrder=[..._]),e.dispatchEvent(new CustomEvent("table:reorder",{bubbles:!0,detail:{from:f,to:_.length-1,item:L}}))}}m()};r.addEventListener("dragover",c),r.addEventListener("drop",l);let v=new MutationObserver(()=>{g()});v.observe(r,{childList:!0}),g(),pt(e,()=>{v.disconnect(),r.removeEventListener("dragover",c),r.removeEventListener("drop",l),m()})}})}function pn(t,e={}){nn(t),on(t),sn(t),an(t),un(t)}function fn(){Nr()}var po="[validate],[drag],[drop],[drag-list],[drag-multiple]";function gn(t){if(typeof document>"u")return;let e=document.querySelectorAll(po);for(let r of e){if(!r.__declared)continue;let o=X(t,"disposeTree");typeof o=="function"?o(r):(r.__disposers&&(r.__disposers.forEach(i=>i()),r.__disposers=null),r.__declared=!1);let n=t.findContext?t.findContext(r):null;n&&delete n.$form,t.processTree(r)}}var fo=["tooltip","popover","popover-trigger","popover-dismiss","modal","modal-open","modal-close","dropdown","dropdown-toggle","dropdown-menu","dropdown-item","toast","toast-container","tabs","tab","tab-disabled","tab-position","tree","branch","subtree","stepper","step","skeleton","split","pane","panel","sortable","sort","fixed-header","fixed-col"],go={name:"nojs-elements",install(t,e={}){Et(t,e),Dt(t,e),qt(t,e),Ot(t,e),Qt(t,e),ir(t,e),pr(t,e),xr(t,e),Dr(t,e),zr(t,e),Wr(t,e),Zr(t,e),pn(t,e),gn(t)},init(t){if(gn(t),typeof document>"u"||!document.body)return;let e=fo.map(o=>`[${o}]`).join(","),r;try{r=document.body.querySelectorAll(e)}catch{return}for(let o of r)o.__declared&&!o.__disposers&&!o.__ctx&&(o.__declared=!1);try{t.processTree(document.body)}catch(o){t.internals?.warn?.("nojs-elements init re-process error:",o.message)}},dispose(t){wt(),It(),zt(),Vt(),Nt(),sr(),fr(),Er(),Ir(),Mr(),Qr(),fn()}},ra=go;export{ra as default};

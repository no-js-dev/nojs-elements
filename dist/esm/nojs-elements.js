 ...
 */
var E={dragging:null,selected:new Map,placeholder:null},Me=new Map;function Ct(){E.dragging=null,E.selected.clear(),E.placeholder&&(E.placeholder.remove(),E.placeholder=null),Me.clear()}function Pe(){if(typeof document>"u"||document.querySelector("style[data-nojs-dnd]"))return;let t=`
.nojs-dragging {
  opacity: 0.5;
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-tooltip",""),e.textContent=t,document.head.appendChild(e)}function yo(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}var We=8;function Kt(t,e,r){let o=e.getBoundingClientRect(),n=t.getBoundingClientRect(),i=window.innerWidth,c=window.innerHeight,a,s;switch(r){case"bottom":a=o.bottom+We,s=o.left+(o.width-n.width)/2;break;case"left":a=o.top+(o.height-n.height)/2,s=o.left-n.width-We;break;case"right":a=o.top+(o.height-n.height)/2,s=o.right+We;break;default:a=o.top-n.height-We,s=o.left+(o.width-n.width)/2;break}s<4&&(s=4),s+n.width>i-4&&(s=i-n.width-4),a<4&&(a=4),a+n.height>c-4&&(a=c-n.height-4),t.style.top=`${a}px`,t.style.left=`${s}px`}var xo=0;function Eo(t,e,r){document.body.appendChild(e),Kt(e,t,r),e.setAttribute("aria-hidden","false")}function Yt(t,e){e.setAttribute("aria-hidden","true"),e.remove()}function _o(t,e){t&&typeof t._warn=="function"?t._warn(e):console.warn(e)}function Xt(t){t.directive("tooltip",{priority:20,init(e,r,o){Ut();let n=o;if(!n){_o(t,"[tooltip] attribute value (tooltip text) is required.");return}let i=e.getAttribute("tooltip-position")||"top",c=parseInt(e.getAttribute("tooltip-delay"),10),a=Number.isNaN(c)?300:c,s=e.getAttribute("tooltip-disabled"),l=s?t.findContext(e):null,m=()=>{if(!s||!l)return!1;try{return!!t.evaluate(s,l)}catch{return!1}},d=`nojs-tooltip-${++xo}`,g=document.createElement("div");g.className="nojs-tooltip",g.setAttribute("role","tooltip"),g.setAttribute("id",d),g.setAttribute("aria-hidden","true"),g.textContent=n,e.setAttribute("aria-describedby",d),xe.set(e,g);let u=!1,f=0,h=()=>{!u||!e.isConnected||f||(f=requestAnimationFrame(()=>{f=0,!(!u||!e.isConnected)&&Kt(g,e,i)}))},y=()=>{window.addEventListener("scroll",h,!0),window.addEventListener("resize",h)},p=()=>{window.removeEventListener("scroll",h,!0),window.removeEventListener("resize",h),f&&(cancelAnimationFrame(f),f=0)},b=()=>{u||(Eo(e,g,i),u=!0,y())},w=()=>{if(!u){Yt(e,g);return}p(),Yt(e,g),u=!1},v=()=>{if(m())return;te.has(e)&&clearTimeout(te.get(e));let B=setTimeout(()=>{te.delete(e),!m()&&e.isConnected&&b()},a);te.set(e,B)},x=()=>{te.has(e)&&(clearTimeout(te.get(e)),te.delete(e)),w()},A=()=>v(),L=()=>x(),k=()=>v(),j=()=>x(),S=B=>{B.key==="Escape"&&g.getAttribute("aria-hidden")==="false"&&x()};e.addEventListener("mouseenter",A),e.addEventListener("mouseleave",L),e.addEventListener("focusin",k),e.addEventListener("focusout",j),e.addEventListener("keydown",S);let _=null;if(s&&l&&typeof l.$watch=="function"){let B=()=>{u&&m()&&w()};_=l.$watch(B)}yo(e,()=>{e.removeEventListener("mouseenter",A),e.removeEventListener("mouseleave",L),e.removeEventListener("focusin",k),e.removeEventListener("focusout",j),e.removeEventListener("keydown",S),_&&(_(),_=null),p(),te.has(e)&&(clearTimeout(te.get(e)),te.delete(e)),u=!1,g.remove(),xe.delete(e)})}})}function Zt(t,e={}){Xt(t)}function Qt(){Gt()}var Y=new Map;function Jt(){Y.clear()}function Ge(){if(typeof document>"u"||document.querySelector("style[data-nojs-popover]"))return;let t=`
.nojs-popover {
  position: fixed;
  z-index: 9998;
  margin: 0;
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-dropdown",""),e.textContent=t,document.head.appendChild(e)}var Co=0;function So(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function mr(t,e,r){let o=r.getAttribute("dropdown-position")||"bottom",n=r.getAttribute("dropdown-align")||"start";t.style.top="",t.style.left="";let i=e.getBoundingClientRect(),c=t.getBoundingClientRect(),a=window.innerHeight,s=window.innerWidth,l,m;switch(o){case"top":l=i.top-c.height,m=i.left;break;case"left":l=i.top,m=i.left-c.width;break;case"right":l=i.top,m=i.right;break;default:l=i.bottom,m=i.left}o==="bottom"||o==="top"?n==="end"&&(m=i.right-c.width):n==="end"&&(l=i.bottom-c.height),o==="bottom"&&l+c.height>a&&i.top-c.height>0?l=i.top-c.height:o==="top"&&l<0&&i.bottom+c.height<=a&&(l=i.bottom),m<4&&(m=4),m+c.width>s-4&&(m=s-c.width-4),t.style.top=`${l}px`,t.style.left=`${m}px`}function mt(t){return[...t.querySelectorAll("[dropdown-item]")].filter(e=>!e.hasAttribute("disabled")&&e.getAttribute("aria-disabled")!=="true")}function ft(t){let e=mt(t);e.length&&e[0].focus()}function gr(t){let e=mt(t);e.length&&e[e.length-1].focus()}function br(t){t.directive("dropdown",{priority:15,init(r){Ae()}}),t.directive("dropdown-toggle",{priority:15,init(r){Ae();let o=r.closest("[dropdown]");if(!o)return;let n=o.querySelector("[dropdown-menu]");if(!n)return;r.setAttribute("aria-haspopup","menu"),r.setAttribute("aria-expanded","false"),n.classList.add("nojs-dropdown-menu"),n.setAttribute("role","menu"),n.setAttribute("popover","auto"),n.id||(n.id=`nojs-dd-menu-${Date.now()}-${Co++}`),r.setAttribute("aria-controls",n.id);let i=!1,c=typeof n.showPopover=="function"&&typeof n.hidePopover=="function";function a(){if(n.setAttribute("data-open",""),c&&!i)try{n.showPopover(),i=!0}catch{i=!1}r.setAttribute("aria-expanded","true"),mr(n,r,o),de.openMenus.set(n,{toggle:r,wrapper:o})}function s(){if(c&&i){i=!1;try{n.hidePopover()}catch{}}n.removeAttribute("data-open"),r.setAttribute("aria-expanded","false"),de.openMenus.delete(n)}function l(){return r.getAttribute("aria-expanded")==="true"}let m=p=>{p.newState==="closed"&&l()&&s()};n.addEventListener("toggle",m);let d=p=>{p.preventDefault(),p.stopPropagation(),l()?s():a()};r.addEventListener("click",d);let g=p=>{l()&&!o.contains(p.target)&&s()};document.addEventListener("click",g,!0);let u=p=>{p.key==="Escape"&&l()&&(s(),r.focus())};document.addEventListener("keydown",u);let f=p=>{switch(p.key){case"Enter":case" ":p.preventDefault(),a(),ft(n);break;case"ArrowDown":p.preventDefault(),a(),ft(n);break;case"ArrowUp":p.preventDefault(),a(),gr(n);break}};r.addEventListener("keydown",f);let h=p=>{if(!(!l()||mt(n).find(v=>v===document.activeElement)))switch(p.key){case"ArrowDown":p.preventDefault(),ft(n);break;case"ArrowUp":p.preventDefault(),gr(n);break}};n.addEventListener("keydown",h);let y=()=>{l()&&mr(n,r,o)};window.addEventListener("scroll",y,!0),window.addEventListener("resize",y),So(r,()=>{r.removeEventListener("click",d),r.removeEventListener("keydown",f),n.removeEventListener("keydown",h),n.removeEventListener("toggle",m),document.removeEventListener("click",g,!0),document.removeEventListener("keydown",u),window.removeEventListener("scroll",y,!0),window.removeEventListener("resize",y),de.openMenus.delete(n)})}}),t.directive("dropdown-menu",{priority:15,init(r){Ae(),r.hasAttribute("role")||r.setAttribute("role","menu")}});let e=r=>e.open(r);e.open=r=>{let o=document.getElementById(r);if(!o)return!1;let i=o.closest("[dropdown]")?.querySelector("[dropdown-toggle]");return!i||i.getAttribute("aria-expanded")==="true"?!1:(i.click(),!0)},e.close=r=>{let o=document.getElementById(r);if(!o)return!1;let i=o.closest("[dropdown]")?.querySelector("[dropdown-toggle]");return!i||i.getAttribute("aria-expanded")!=="true"?!1:(i.click(),!0)},t.dropdown=e}function hr(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function To(t){return[...t.querySelectorAll("[dropdown-item]")].filter(e=>!e.hasAttribute("disabled")&&e.getAttribute("aria-disabled")!=="true")}function gt(t,e){if(!t)return;if(typeof t.hidePopover=="function")try{t.hidePopover()}catch{}t.removeAttribute("data-open");let r=e&&e.querySelector("[dropdown-toggle]");r&&r.setAttribute("aria-expanded","false"),de.openMenus.has(t)&&de.openMenus.delete(t)}function vr(t){t.directive("dropdown-item",{priority:15,init(e){Ae();let r=e.closest("[dropdown-menu]"),o=e.closest("[dropdown]");e.setAttribute("role","menuitem"),e.setAttribute("tabindex","-1"),e.classList.add("nojs-dropdown-item"),e.hasAttribute("disabled")&&e.setAttribute("aria-disabled","true");let n=c=>{if(!r)return;let a=To(r),s=a.indexOf(e);switch(c.key){case"ArrowDown":{c.preventDefault(),(s+1<a.length?a[s+1]:a[0]).focus();break}case"ArrowUp":{c.preventDefault(),(s-1>=0?a[s-1]:a[a.length-1]).focus();break}case"Home":{c.preventDefault(),a.length&&a[0].focus();break}case"End":{c.preventDefault(),a.length&&a[a.length-1].focus();break}case"Enter":{c.preventDefault(),e.click();break}case"Escape":{if(c.preventDefault(),gt(r,o),o){let l=o.querySelector("[dropdown-toggle]");l&&l.focus()}break}case"Tab":{gt(r,o);break}}};e.addEventListener("keydown",n),hr(e,()=>e.removeEventListener("keydown",n));let i=()=>{if(gt(r,o),o){let c=o.querySelector("[dropdown-toggle]");c&&c.focus()}};e.addEventListener("click",i),hr(e,()=>e.removeEventListener("click",i))}})}function yr(t,e={}){br(t),vr(t)}function xr(){fr()}var ie=new Map,Le=new Set,Er=0;function _r(){return++Er}function wr(){for(let t of Le)clearTimeout(t);Le.clear();for(let t of ie.values())t.remove();ie.clear(),Er=0}function Ar(){if(typeof document>"u"||document.querySelector("style[data-nojs-toast]"))return;let t=`
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-toast",""),e.textContent=t,document.head.appendChild(e)}function bt(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}var Do=new Set(["top-right","top-left","bottom-right","bottom-left","top-center","bottom-center"]);function ht(){return ie.size>0?ie.values().next().value:Io("top-right")}function Io(t){if(ie.has(t))return ie.get(t);let e=document.createElement("div");return e.classList.add("nojs-toast-container"),e.setAttribute("data-position",t),e.setAttribute("role","log"),e.setAttribute("aria-live","polite"),e.setAttribute("aria-relevant","additions"),document.body.appendChild(e),ie.set(t,e),e}function Bo(t){return t.startsWith("top")}function vt(t,e,r,o,n){let i=_r(),c=t.getAttribute("data-position")||"top-right",a=document.createElement("div");a.classList.add("nojs-toast"),a.setAttribute("data-toast-id",i),a.setAttribute("data-type",r),r==="error"&&a.setAttribute("aria-live","assertive");let s=document.createElement("span");if(s.textContent=e,a.appendChild(s),n){let l=document.createElement("button");l.type="button",l.classList.add("nojs-toast-dismiss"),l.setAttribute("aria-label","Dismiss"),l.textContent="\xD7",l.addEventListener("click",()=>Ye(a)),a.appendChild(l)}if(Bo(c)&&t.firstChild?t.insertBefore(a,t.firstChild):t.appendChild(a),o>0){let l=setTimeout(()=>{Le.delete(l),a.isConnected&&Ye(a)},o);Le.add(l),a._toastTimerId=l}return a}function Ye(t){!t||!t.isConnected||(t._toastTimerId!=null&&(clearTimeout(t._toastTimerId),Le.delete(t._toastTimerId)),t.remove())}function Lr(t){Ar(),t.directive("toast-container",{priority:10,init(r,o,n){let i=n&&Do.has(n)?n:"top-right";r.classList.add("nojs-toast-container"),r.setAttribute("data-position",i),r.setAttribute("role","log"),r.setAttribute("aria-live","polite"),r.setAttribute("aria-relevant","additions"),ie.set(i,r),bt(r,()=>{ie.get(i)===r&&ie.delete(i)})}}),t.directive("toast",{priority:10,init(r,o,n){if(!n)return;let i=r.getAttribute("toast-type")||"info",c=parseInt(r.getAttribute("toast-duration"),10),a=Number.isNaN(c)?3e3:c,s=r.getAttribute("toast-dismiss")!=="false";if(r.tagName==="BUTTON"||r.tagName==="A"||r.hasAttribute("on:click")){let f=()=>{let h=ht();vt(h,n,i,a,s)};r.addEventListener("click",f),bt(r,()=>r.removeEventListener("click",f));return}let m=t.findContext(r);if(!m||typeof m.$watch!="function"){console.warn("[toast] reactive toast requires a parent [state] or [use] context \u2014 element will be inert");return}let d;function g(){let f=t.evaluate(n,m);if(f&&f!==d){let h=typeof f=="string"?f:String(f),y=ht();vt(y,h,i,a,s),d=f}else d=f}let u=m.$watch(g);bt(r,u)}});let e=(r,o="info",n=3e3)=>{if(typeof document>"u")return;let i=!0,c=ht();return vt(c,String(r),o,n,i)};e.dismiss=r=>{let o=typeof CSS<"u"&&CSS.escape?CSS.escape(String(r)):String(r).replace(/["\\\]]/g,"\\$&"),n=document.querySelector(`[data-toast-id="${o}"]`);n&&Ye(n)},e.dismissAll=()=>{document.querySelectorAll(".nojs-toast").forEach(r=>Ye(r))},t.toast=e}function jr(t,e={}){Lr(t)}function kr(){wr()}var be={containers:new Map};function Cr(){be.containers.clear()}function Sr(){if(typeof document>"u"||document.querySelector("style[data-nojs-tabs]"))return;let t=`
.nojs-tabs {
  display: flex;
  flex-direction: column;
  border: 1px solid #E2E8F0;
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-tree",""),e.textContent=t,document.head.appendChild(e)}function ke(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function Fr(t){let e=[],r=document.createTreeWalker(t,NodeFilter.SHOW_ELEMENT,{acceptNode(n){return n.matches&&n.matches('.nojs-subtree[aria-hidden="true"]')?NodeFilter.FILTER_REJECT:n.getAttribute("role")==="treeitem"?NodeFilter.FILTER_ACCEPT:NodeFilter.FILTER_SKIP}}),o;for(;o=r.nextNode();)e.push(o);return e}function Mr(t){return t.closest('[role="tree"]')}function zo(t){let e=t.parentElement?.closest('[role="group"], .nojs-subtree');if(e){let r=e.parentElement?.closest('[role="treeitem"]');if(r)return r;let o=e.previousElementSibling;if(o?.matches?.('[role="treeitem"]'))return o}return t.parentElement?.closest('[role="treeitem"]')||null}function Fo(t){let e=t.cloneNode(!0);return e.querySelectorAll('[role="group"]').forEach(o=>o.remove()),(e.textContent||"").trim().toLowerCase()}function yt(t){let e=I.selectedItem;e&&e!==t&&(e.classList.remove("nojs-branch-selected"),e.setAttribute("aria-selected","false")),t.classList.add("nojs-branch-selected"),t.setAttribute("aria-selected","true"),I.selectedItem=t}function Pr(t){let e=I.branches.get(t);!e||!e.subtreeEl||(e.expanded=!e.expanded,t.setAttribute("aria-expanded",String(e.expanded)),e.subtreeEl.setAttribute("aria-hidden",String(!e.expanded)))}function Mo(t){let e=I.branches.get(t);!e||!e.subtreeEl||e.expanded||(e.expanded=!0,t.setAttribute("aria-expanded","true"),e.subtreeEl.setAttribute("aria-hidden","false"))}function Po(t){let e=I.branches.get(t);!e||!e.subtreeEl||!e.expanded||(e.expanded=!1,t.setAttribute("aria-expanded","false"),e.subtreeEl.setAttribute("aria-hidden","true"))}function qr(t,e){let r=Mr(e);if(!r)return;let o=Fr(r),n=o.indexOf(e);if(n<0)return;let i=I.branches.get(e),c=i&&i.subtreeEl;switch(t.key){case"ArrowRight":if(t.preventDefault(),c&&!i.expanded)Mo(e);else if(c&&i.expanded){let a=i.subtreeEl.querySelector('[role="treeitem"]');a&&he(a,o)}break;case"ArrowLeft":if(t.preventDefault(),c&&i.expanded)Po(e);else{let a=zo(e);a&&he(a,Fr(r))}break;case"ArrowDown":t.preventDefault(),n<o.length-1&&he(o[n+1],o);break;case"ArrowUp":t.preventDefault(),n>0&&he(o[n-1],o);break;case"Enter":case" ":t.preventDefault(),yt(e),c&&Pr(e);break;case"Home":t.preventDefault(),o.length>0&&he(o[0],o);break;case"End":t.preventDefault(),o.length>0&&he(o[o.length-1],o);break;default:if(t.key.length===1&&!t.ctrlKey&&!t.altKey&&!t.metaKey){t.preventDefault(),I.typeahead+=t.key.toLowerCase(),I.typeaheadTimer&&clearTimeout(I.typeaheadTimer),I.typeaheadTimer=setTimeout(()=>{I.typeahead="",I.typeaheadTimer=null},500);let a=n+1;for(let s=0;s<o.length;s++){let l=(a+s)%o.length;if(Fo(o[l]).startsWith(I.typeahead)){he(o[l],o);break}}}break}}function $r(t){t.directive("tree",{priority:15,init(e){je(),e.classList.add("nojs-tree"),e.setAttribute("role","tree"),e.getAttribute("tree-icon")==="false"&&e.setAttribute("data-tree-icon","false")}})}function Or(t){t.directive("branch",{priority:16,init(e,r,o){je();let n=o==="expanded";e.classList.add("nojs-branch"),e.setAttribute("role","treeitem"),e.setAttribute("aria-expanded",String(n));let i=Mr(e);if(i){let l=i.querySelector('[role="treeitem"][tabindex="0"]');e.setAttribute("tabindex",l?"-1":"0")}else e.setAttribute("tabindex","0");let c=!1;queueMicrotask(()=>{if(c)return;let l=e.querySelector(":scope > [subtree], :scope > .nojs-subtree")||(e.nextElementSibling?.matches?.("[subtree], .nojs-subtree")?e.nextElementSibling:null);l?(I.branches.set(e,{expanded:n,subtreeEl:l}),l.setAttribute("aria-hidden",String(!n))):I.branches.set(e,{expanded:n,subtreeEl:null})});let a=l=>{l.target.closest?.('[role="treeitem"]')===e&&(l.stopPropagation(),yt(e),Pr(e))};e.addEventListener("click",a),ke(e,()=>e.removeEventListener("click",a));let s=l=>{qr(l,e)};e.addEventListener("keydown",s),ke(e,()=>e.removeEventListener("keydown",s)),ke(e,()=>{c=!0,I.branches.delete(e),I.selectedItem===e&&(I.selectedItem=null),I.typeaheadTimer&&(clearTimeout(I.typeaheadTimer),I.typeaheadTimer=null,I.typeahead="")})}})}function he(t,e){for(let r of e)r.setAttribute("tabindex",r===t?"0":"-1");t.focus()}function Vr(t){t.directive("subtree",{priority:16,init(e){je(),e.classList.add("nojs-subtree"),e.classList.add("nojs-tree"),e.setAttribute("role","group");for(let o of e.children)if(o.tagName==="LI"&&!o.querySelector("[branch], .nojs-branch")){o.setAttribute("role","treeitem"),o.setAttribute("tabindex","-1"),o.classList.add("nojs-tree-leaf");let n=c=>{c.stopPropagation(),yt(o)};o.addEventListener("click",n),ke(o,()=>o.removeEventListener("click",n));let i=c=>{qr(c,o)};o.addEventListener("keydown",i),ke(o,()=>o.removeEventListener("keydown",i)),ke(o,()=>{I.selectedItem===o&&(I.selectedItem=null)})}let r=e.parentElement?.matches?.('[role="treeitem"]')?e.parentElement:e.previousElementSibling?.matches?.('[role="treeitem"]')?e.previousElementSibling:null;if(r){let o=I.branches.get(r);o?(e.setAttribute("aria-hidden",String(!o.expanded)),o.subtreeEl=e):e.setAttribute("aria-hidden","true")}else e.setAttribute("aria-hidden","true")}})}function Nr(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function xt(t){return t.closest('[role="treeitem"]')}function qo(t){return t.closest('[role="tree"]')}function $o(t){let e=t.parentElement;return e?[...e.children].filter(r=>r.getAttribute("role")==="treeitem"):[]}function Oo(t){return $o(t).indexOf(t)}function Vo(t,e,r){let o=t.getBoundingClientRect(),n=e-o.top,i=o.height;return r==="reparent"?"on":r==="reorder"?n<i/2?"before":"after":n<i*.25?"before":n>i*.75?"after":"on"}function Wr(t,e){let r=t.parentElement;for(;r;){if(r===e)return!0;r=r.parentElement}return!1}var D={dragging:null,indicator:null,currentTarget:null,currentPosition:null};function Ce(){D.indicator&&(D.indicator.remove(),D.indicator=null)}function He(t){if(!t)return;let e=t.querySelectorAll(".nojs-tree-drag-over");for(let r of e)r.classList.remove("nojs-tree-drag-over")}function No(){let t=document.createElement("div");return t.className="nojs-tree-drag-indicator",t.setAttribute("aria-hidden","true"),t}function Wo(t,e){Ce();let r=No(),o=t.getBoundingClientRect(),n=qo(t);if(!n)return;let i=n.getBoundingClientRect();r.style.position="absolute",r.style.left=o.left-i.left+"px",r.style.width=o.width+"px",e==="before"?r.style.top=o.top-i.top-1+"px":r.style.top=o.bottom-i.top-1+"px",getComputedStyle(n).position==="static"&&(n.style.position="relative"),n.appendChild(r),D.indicator=r}function Gr(t){t.directive("tree-drag-mode",{priority:15,init(e,r,o){if(je(),o!=="reparent"&&o!=="reorder"&&o!=="both")return;let n=0,i=g=>{let u=xt(g.target);if(u&&e.contains(u)){if(u.hasAttribute("tree-drag-disabled")){g.preventDefault();return}D.dragging={el:u,treeRoot:e},g.dataTransfer&&(g.dataTransfer.effectAllowed="move",g.dataTransfer.setData("text/plain","")),u.classList.add("nojs-dragging"),u.dispatchEvent(new CustomEvent("tree:drag-start",{bubbles:!0,detail:{node:u}}))}},c=g=>{if(!D.dragging||D.dragging.treeRoot!==e)return;let u=xt(g.target);if(!u||!e.contains(u)||u===D.dragging.el||Wr(u,D.dragging.el))return;g.preventDefault(),g.dataTransfer&&(g.dataTransfer.dropEffect="move");let f=Vo(u,g.clientY,o);(D.currentTarget!==u||D.currentPosition!==f)&&(He(e),Ce(),D.currentTarget=u,D.currentPosition=f,f==="on"?u.classList.add("nojs-tree-drag-over"):Wo(u,f))},a=g=>{D.dragging&&D.dragging.treeRoot===e&&n++},s=g=>{D.dragging&&(n--,n<=0&&(n=0,He(e),Ce(),D.currentTarget=null,D.currentPosition=null))},l=g=>{if(g.preventDefault(),g.stopPropagation(),n=0,!D.dragging||D.dragging.treeRoot!==e)return;let u=D.dragging.el,f=D.currentTarget,h=D.currentPosition;if(He(e),Ce(),!f||!h){D.dragging=null,D.currentTarget=null,D.currentPosition=null;return}if(f===u||Wr(f,u)){D.dragging=null,D.currentTarget=null,D.currentPosition=null;return}if(h==="on"){let y=f.querySelector(':scope > [role="group"]');y||(y=f.nextElementSibling?.matches?.('[role="group"]')?f.nextElementSibling:null),y?y.setAttribute("aria-hidden","false"):(y=document.createElement("ul"),y.setAttribute("role","group"),y.setAttribute("subtree",""),y.classList.add("nojs-subtree","nojs-tree"),y.setAttribute("aria-hidden","false"),f.appendChild(y));let p=I.branches.get(f);p&&(p.expanded=!0,p.subtreeEl=y,f.setAttribute("aria-expanded","true")),y.appendChild(u),e.dispatchEvent(new CustomEvent("tree:reparent",{bubbles:!0,detail:{node:u,newParent:f}}))}else{let y=f.parentElement;if(!y){D.dragging=null,D.currentTarget=null,D.currentPosition=null;return}if(h==="before")y.insertBefore(u,f);else{let b=f.nextElementSibling,w=b?.matches?.('[role="group"]')?b.nextElementSibling:b;w?y.insertBefore(u,w):y.appendChild(u)}let p=Oo(u);e.dispatchEvent(new CustomEvent("tree:reorder",{bubbles:!0,detail:{node:u,newIndex:p}}))}D.dragging=null,D.currentTarget=null,D.currentPosition=null},m=g=>{let u=xt(g.target);u&&u.classList.remove("nojs-dragging"),He(e),Ce(),n=0,D.dragging&&D.dragging.el.dispatchEvent(new CustomEvent("tree:drag-end",{bubbles:!0,detail:{node:D.dragging.el}})),D.dragging=null,D.currentTarget=null,D.currentPosition=null};e.addEventListener("dragstart",i),e.addEventListener("dragover",c),e.addEventListener("dragenter",a),e.addEventListener("dragleave",s),e.addEventListener("drop",l),e.addEventListener("dragend",m),Nr(e,()=>{e.removeEventListener("dragstart",i),e.removeEventListener("dragover",c),e.removeEventListener("dragenter",a),e.removeEventListener("dragleave",s),e.removeEventListener("drop",l),e.removeEventListener("dragend",m),He(e),Ce()}),Go(e);let d=new MutationObserver(g=>{for(let u of g)for(let f of u.addedNodes){if(f.nodeType!==1)continue;f.getAttribute("role")==="treeitem"&&Et(f);let h=f.querySelectorAll?.('[role="treeitem"]');if(h)for(let y of h)Et(y)}});d.observe(e,{childList:!0,subtree:!0}),Nr(e,()=>d.disconnect())}})}function Et(t){if(t.hasAttribute("tree-drag-disabled")){t.draggable=!1;return}t.draggable=!0}function Go(t){let e=t.querySelectorAll('[role="treeitem"]');for(let r of e)Et(r)}function Ur(t,e={}){$r(t),Or(t),Vr(t),Gr(t)}function Yr(){zr()}var Ke=new Map;function Kr(){Ke.clear()}function Xe(){if(typeof document>"u"||document.querySelector("style[data-nojs-stepper]"))return;let t=`
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-breadcrumb",""),e.textContent=t,document.head.appendChild(e)}function In(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function si(t){let e=t.getAttribute("breadcrumb");if(e&&e.trim()!=="")return e.trim();let r=t.getAttribute("title");return r&&r.trim()!==""?r.trim():(t.textContent||"").trim()}function ai(t){return t&&t.charAt(0).toUpperCase()+t.slice(1)}function Bn(t,e){let r=t.querySelector("ol.nojs-breadcrumb");r&&r.remove();let o=document.createElement("ol");o.classList.add("nojs-breadcrumb");for(let i=0;i<e.length;i++){let c=e[i],a=document.createElement("li");if(i===e.length-1){let l=document.createElement("span");l.setAttribute("aria-current","page"),l.textContent=c.label,a.appendChild(l)}else{let l=document.createElement("a");l.href=c.href,l.textContent=c.label,a.appendChild(l)}o.appendChild(a)}t.appendChild(o);let n=ue.containers.get(t);n&&(n.crumbs=e)}function ci(t){let e=[],r=Array.from(t.children);for(let o of r){if(o.tagName==="OL"&&o.classList.contains("nojs-breadcrumb"))continue;let n=si(o);if(!n)continue;let i=o.getAttribute("href")||"#";e.push({label:n,href:i})}return e}function di(t){if(!t||t==="/")return[{label:"Home",href:"/",isLast:!0}];let r=(t.replace(/\/+$/,"")||"/").split("/").filter(Boolean),o=[{label:"Home",href:"/"}],n="";for(let i=0;i<r.length;i++){n+="/"+r[i];let c=ai(r[i].replace(/[-_]/g," "));o.push({label:c,href:n})}return o}function Hn(t){t.directive("breadcrumb",{priority:15,init(e,r,o){Dn(),e.tagName==="NAV"&&!e.getAttribute("aria-label")&&e.setAttribute("aria-label","Breadcrumb");let n=Array.from(e.children).some(a=>!(a.tagName==="OL"&&a.classList.contains("nojs-breadcrumb"))),i=t.router,c=!n&&i;if(ue.containers.set(e,{unsub:null,crumbs:[]}),c){let a=()=>{let s=i.current,l=s?s.path:"/",m=di(l);Bn(e,m)};if(a(),typeof i.on=="function"){let s=i.on(a),l=ue.containers.get(e);l&&(l.unsub=s),In(e,()=>{typeof s=="function"&&s();let m=ue.containers.get(e);m&&(m.unsub=null)})}}else{let a=ci(e);for(let s of Array.from(e.children))s.tagName==="OL"&&s.classList.contains("nojs-breadcrumb")||(s.style.display="none");Bn(e,a)}In(e,()=>{ue.containers.delete(e)})}})}function Rn(t,e={}){Hn(t)}function zn(){Tn()}var Je={containers:new Map};function Fn(){Je.containers.clear()}function Mn(){if(typeof document>"u"||document.querySelector("style[data-nojs-accordion]"))return;let t=`
[accordion] {
  display: flex;
  flex-direction: column;
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-virtual-list",""),e.textContent=t,document.head.appendChild(e)}function fi(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function mi(t){for(let e of["each","foreach","for"])if(t.hasAttribute(e)){let r=Un(t.getAttribute(e));if(r)return{eachEl:t,...r}}for(let e of t.children)for(let r of["each","foreach","for"])if(e.hasAttribute(r)){let o=Un(e.getAttribute(r));if(o)return{eachEl:e,...o}}return null}function Un(t){if(!t)return null;let e=t.match(/^\s*(\w+)\s+(?:in|of)\s+(.+)\s*$/);return e?{iteratorVar:e[1],arrayPath:e[2].trim()}:null}function gi(t,e){let r=e.split("."),o=t;for(let n of r){if(o==null)return;o=o[n]}return o}function Yn(t){let e=t.tagName.toLowerCase(),r;if(e==="tbody"||e==="table"||e==="thead"||e==="tfoot"){r=document.createElement("tr"),r.classList.add("nojs-virtual-spacer");let o=document.createElement("td"),n=e==="table"?t:t.closest("table"),i=n?n.querySelector("tr:not(.nojs-virtual-spacer)"):null,c=i?i.children.length:1;o.setAttribute("colspan",String(c)),o.style.padding="0",o.style.border="none",r.appendChild(o)}else e==="ul"||e==="ol"?(r=document.createElement("li"),r.classList.add("nojs-virtual-spacer"),r.style.listStyle="none"):(r=document.createElement("div"),r.classList.add("nojs-virtual-spacer"));return r.setAttribute("aria-hidden","true"),r.style.height="0px",r}function rt(t,e){if(t.tagName.toLowerCase()==="tr"){let r=t.querySelector("td");r&&(r.style.height=e+"px"),t.style.height=e+"px"}else t.style.height=e+"px"}function bi(t,e){return t*e}function Xn(t){let e=t.totalItems,r=new Array(e+1),o=t.estimatedHeight||50;r[0]=0;for(let n=1;n<=e;n++)r[n]=r[n-1]+(t.heights[n-1]||o);t.prefixSums=r}function Zn(t,e){let r=0,o=t.length-2;for(;r<=o;){let n=r+o>>>1;t[n]<=e?r=n+1:o=n-1}return Math.max(0,o)}function Kn(t){if(t.prefixSums&&t.prefixSums.length===t.totalItems+1)return t.prefixSums[t.totalItems];let e=0,r=t.estimatedHeight||50;for(let o=0;o<t.totalItems;o++)e+=t.heights[o]||r;return e}function nt(t,e){if(t.itemHeight!=="auto")return e*t.itemHeight;if(t.prefixSums&&e<t.prefixSums.length)return t.prefixSums[e];let r=0,o=t.estimatedHeight||50;for(let n=0;n<e;n++)r+=t.heights[n]||o;return r}function hi(t,e){if(t.prefixSums&&t.prefixSums.length===t.totalItems+1)return Zn(t.prefixSums,e);let r=0,o=t.estimatedHeight||50;for(let n=0;n<t.totalItems;n++){let i=t.heights[n]||o;if(r+i>e)return n;r+=i}return Math.max(0,t.totalItems-1)}function vi(t,e,r){if(t.prefixSums&&t.prefixSums.length===t.totalItems+1)return Zn(t.prefixSums,e+r);let o=e+r,n=0,i=t.estimatedHeight||50;for(let c=0;c<t.totalItems;c++)if(n+=t.heights[c]||i,n>=o)return c;return t.totalItems-1}function yi(t,e,r){if(t.totalItems===0)return{start:0,end:-1};let o,n;return t.itemHeight!=="auto"?(o=Math.floor(e/t.itemHeight),n=Math.ceil((e+r)/t.itemHeight)-1):(o=hi(t,e),n=vi(t,e,r)),o=Math.max(0,o-t.buffer),n=Math.min(t.totalItems-1,n+t.buffer),{start:o,end:n}}function At(t,e){if(t.disposed)return;let r=t.container,o=r,n=o.scrollTop,i=o.clientHeight,{start:c,end:a}=yi(t,n,i);if(c===t.startIndex&&a===t.endIndex&&!t.dirty)return;t.startIndex=c,t.endIndex=a,t.dirty=!1;let s=nt(t,c),l=t.itemHeight!=="auto"?bi(t.totalItems,t.itemHeight):Kn(t),m=a>=0?nt(t,a+1):0,d=Math.max(0,l-m);rt(t.spacerTop,s),rt(t.spacerBottom,d);let g=new Set;for(let f=c;f<=a;f++)g.add(f);for(let[f,h]of t.renderedNodes)g.has(f)||(h.remove(),t.renderedNodes.delete(f));let u=[];for(let f=c;f<=a;f++){if(t.renderedNodes.has(f))continue;let h=t.dataArray[f];if(h===void 0)continue;let y=t.template.cloneNode(!0),p={};p[t.iteratorVar]=h,p.$index=f,p.$count=t.totalItems,p.$first=f===0,p.$last=f===t.totalItems-1,p.$even=f%2===0,p.$odd=f%2!==0,y.__ctx=Object.create(e.findContext?e.findContext(r)||{}:{},Object.getOwnPropertyDescriptors(p)),y.__declared=!1,u.push({index:f,node:y}),t.renderedNodes.set(f,y)}if(u.length>0){u.sort((f,h)=>f.index-h.index);for(let{index:f,node:h}of u){let y=null;for(let[p,b]of t.renderedNodes)p>f&&b.parentNode===r&&(!y||p<xi(y,t))&&(y=b);y||(y=t.spacerBottom),r.insertBefore(h,y);try{e.processTree&&e.processTree(h)}catch{}}}if(t.itemHeight==="auto"){let f=!1;for(let[h,y]of t.renderedNodes){let p=y.offsetHeight||y.getBoundingClientRect().height;p>0&&t.heights[h]!==p&&(t.heights[h]=p,f=!0)}if(f){Xn(t);let h=Kn(t),y=nt(t,c),p=a>=0?nt(t,a+1):0,b=Math.max(0,h-p);rt(t.spacerTop,y),rt(t.spacerBottom,b)}}}function xi(t,e){for(let[r,o]of e.renderedNodes)if(o===t)return r;return 1/0}function Ei(t,e,r){if(t.disposed)return;let o=t.container.scrollTop;t.dataArray=e||[],t.totalItems=t.dataArray.length,t.dirty=!0,t.itemHeight==="auto"&&t.heights.length>t.totalItems&&(t.heights.length=t.totalItems),t.itemHeight==="auto"&&Xn(t);for(let[n,i]of t.renderedNodes){if(i.__disposers){for(let c of i.__disposers)try{c()}catch{}i.__disposers=null}i.remove()}t.renderedNodes.clear(),t.container.scrollTop=o,At(t,r)}function Qn(t){t.directive("virtual",{priority:10,init(e,r,o){Gn(),e.setAttribute("data-nojs-virtual","");let n=e.getAttribute("virtual-height")||"50",i=e.getAttribute("virtual-buffer")||"5",c=n==="auto"?"auto":parseInt(n,10),a=parseInt(i,10)||5;if(c!=="auto"&&(isNaN(c)||c<=0)){console.warn("[virtual] virtual-height must be a positive number or 'auto'.");return}let s=mi(e),l=null;if(s)if(s.eachEl===e){for(let v of e.children)if(!v.classList.contains("nojs-virtual-spacer")){l=v;break}}else l=s.eachEl;else for(let v of e.children)if(!v.classList.contains("nojs-virtual-spacer")){l=v;break}if(!l){console.warn("[virtual] No child template found.");return}let m=l.cloneNode(!0);for(m.removeAttribute("each"),m.removeAttribute("foreach"),m.removeAttribute("for"),m.__declared=!1,m.__disposers=null,m.__ctx=null,s&&(s.eachEl.removeAttribute("each"),s.eachEl.removeAttribute("foreach"),s.eachEl.removeAttribute("for"));e.firstChild;)e.removeChild(e.firstChild);let d=Yn(e),g=Yn(e);e.appendChild(d),e.appendChild(g);let u={container:e,itemHeight:c,buffer:a,totalItems:0,heights:[],prefixSums:[0],estimatedHeight:c==="auto"?50:c,startIndex:-1,endIndex:-1,scrollTop:0,template:m,spacerTop:d,spacerBottom:g,resizeObserver:null,scrollHandler:null,renderedNodes:new Map,iteratorVar:s?s.iteratorVar:"item",arrayPath:s?s.arrayPath:null,dataArray:[],dirty:!0,disposed:!1};Te.set(e,u);let f=null,h=()=>{f||(f=requestAnimationFrame(()=>{f=null,At(u,t)}))};if(u.scrollHandler=h,e.addEventListener("scroll",h,{passive:!0}),typeof ResizeObserver<"u"){let v=new ResizeObserver(()=>{u.dirty=!0,At(u,t)});v.observe(e),u.resizeObserver=v}let y=null,p=-1,b=null,w=()=>{if(!u.disposed){if(u.arrayPath){let v=t.findContext?t.findContext(e):null;if(v){let x=gi(v,u.arrayPath);Array.isArray(x)&&(x!==y||x.length!==p)&&(y=x,p=x.length,Ei(u,x,t))}}b=setTimeout(w,100)}};b=setTimeout(w,100),fi(e,()=>{u.disposed=!0,f&&(cancelAnimationFrame(f),f=null),b&&(clearTimeout(b),b=null),e.removeEventListener("scroll",h),u.resizeObserver&&(u.resizeObserver.disconnect(),u.resizeObserver=null);for(let[v,x]of u.renderedNodes){if(x.__disposers){for(let A of x.__disposers)try{A()}catch{}x.__disposers=null}x.remove()}u.renderedNodes.clear(),u.spacerTop&&u.spacerTop.parentNode&&u.spacerTop.remove(),u.spacerBottom&&u.spacerBottom.parentNode&&u.spacerBottom.remove(),Te.delete(e)})}})}function Jn(t,e={}){Qn(t)}function eo(){Wn()}var pe=new Map,ot=new Map;function to(){for(let[t,e]of pe){if(e.observer)try{e.observer.disconnect()}catch{}for(let r of e.spyEntries){let o=r.el&&r.el.__disposers;if(o){for(let n of o)try{n()}catch{}r.el.__disposers=[]}}}pe.clear(),ot.clear()}function ro(){if(typeof document>"u"||document.querySelector("style[data-nojs-scroll-spy]"))return;let t=`
[spy].active,
a[href^="#"].active {
  font-weight: 600;
}
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-scroll-spy",""),e.textContent=t,document.head.appendChild(e)}function _i(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function wi(t){if(t.tagName==="A"){let r=t.getAttribute("href")||"";if(r.startsWith("#")&&r.length>1)return r.slice(1)}let e=t.getAttribute("spy")||"";return e.startsWith("#")&&e.length>1?e.slice(1):e.length>0?e:null}function Ai(t){let e=t.getAttribute("spy-offset");if(e===null||e==="")return 0;let r=parseInt(e,10);return Number.isNaN(r)?0:r}function Li(t){let e=t.getAttribute("spy-threshold");if(e===null||e==="")return .1;let r=parseFloat(e);return Number.isNaN(r)||r<0||r>1?.1:r}function ji(){return document.documentElement}function ki(t){t.classList.add("active"),t.setAttribute("aria-current","true")}function no(t){t.classList.remove("active"),t.removeAttribute("aria-current")}function Lt(t){let e=pe.get(t);if(!e)return;e.observer&&(e.observer.disconnect(),e.observer=null);let r=e.offset,o=e.threshold,n=new Set,i=`-${r}px 0px 0px 0px`,c=new IntersectionObserver(s=>{for(let d of s)d.isIntersecting?n.add(d.target.id):n.delete(d.target.id);let l=null,m=1/0;for(let d of n){let g=document.getElementById(d);if(!g)continue;let u=g.getBoundingClientRect();u.top<m&&(m=u.top,l=d)}for(let d of e.spyEntries)no(d.el);if(l){for(let d of e.spyEntries)if(d.targetId===l){ki(d.el),e.activeEl=d.el;break}}else e.activeEl=null},{rootMargin:i,threshold:o}),a=new Set;for(let s of e.spyEntries){if(a.has(s.targetId))continue;let l=document.getElementById(s.targetId);l&&(c.observe(l),a.add(s.targetId))}e.observer=c}function Ci(t,e){t&&typeof t._warn=="function"?t._warn(e):console.warn(e)}function oo(t){t.directive("spy",{priority:20,init(e,r,o){ro();let n=wi(e);if(!n){e.tagName!=="A"&&Ci(t,'[spy] could not resolve target ID. Use spy="#targetId" or href="#targetId" on <a>.');return}let i=Ai(e),c=Li(e),a=ji();pe.has(a)||pe.set(a,{observer:null,spyEntries:[],activeEl:null,offset:i,threshold:c});let s=pe.get(a),l={el:e,targetId:n};s.spyEntries.push(l),ot.set(e,a),Lt(a),!s.mutObserver&&typeof MutationObserver<"u"&&(s.mutObserver=new MutationObserver(()=>{Lt(a)}),s.mutObserver.observe(document.body,{childList:!0,subtree:!0})),_i(e,()=>{let m=s.spyEntries.indexOf(l);m!==-1&&s.spyEntries.splice(m,1),ot.delete(e),no(e),s.spyEntries.length===0?(s.observer&&(s.observer.disconnect(),s.observer=null),s.mutObserver&&(s.mutObserver.disconnect(),s.mutObserver=null),pe.delete(a)):Lt(a)})}})}function io(t,e={}){oo(t)}function so(){to()}var Si="[validate],[drag],[drop],[drag-list],[drag-multiple]";function ao(t){if(typeof document>"u")return;let e=document.querySelectorAll(Si);for(let r of e){if(!r.__declared)continue;let o=K(t,"disposeTree");typeof o=="function"?o(r):(r.__disposers&&(r.__disposers.forEach(i=>i()),r.__disposers=null),r.__declared=!1);let n=t.findContext?t.findContext(r):null;n&&delete n.$form,t.processTree(r)}}var Ti=["tooltip","popover","popover-trigger","popover-dismiss","modal","modal-open","modal-close","dropdown","dropdown-toggle","dropdown-menu","dropdown-item","toast","toast-container","tabs","tab","tab-disabled","tab-position","tree","branch","subtree","stepper","step","skeleton","split","pane","panel","sortable","sort","fixed-header","fixed-col","breadcrumb","accordion","virtual","virtual-height","virtual-buffer","spy","spy-offset","spy-threshold"],Di={name:"nojs-elements",install(t,e={}){Ht(t,e),Nt(t,e),Zt(t,e),tr(t,e),ur(t,e),yr(t,e),jr(t,e),Hr(t,e),Ur(t,e),tn(t,e),an(t,e),fn(t,e),Cn(t,e),Rn(t,e),Vn(t,e),Jn(t,e),io(t,e),ao(t)},init(t){if(ao(t),typeof document>"u"||!document.body)return;let e=Ti.map(o=>`[${o}]`).join(","),r;try{r=document.body.querySelectorAll(e)}catch{return}for(let o of r)o.__declared&&!o.__disposers&&!o.__ctx&&(o.__declared=!1);try{t.processTree(document.body)}catch(o){t.internals?.warn?.("nojs-elements init re-process error:",o.message)}},dispose(t){Rt(),Wt(),Qt(),rr(),pr(),xr(),kr(),Rr(),Yr(),rn(),mn(),Sn(),zn(),Nn(),eo(),so()}},td=Di;export{td as default};

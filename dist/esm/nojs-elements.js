 ...
 */
var E={dragging:null,selected:new Map,placeholder:null},Pe=new Map;function ht(){E.dragging=null,E.selected.clear(),E.placeholder&&(E.placeholder.remove(),E.placeholder=null),Pe.clear()}function $e(){if(typeof document>"u"||document.querySelector("style[data-nojs-dnd]"))return;let t=`
.nojs-dragging {
  opacity: 0.5;
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-tooltip",""),e.textContent=t,document.head.appendChild(e)}function Rn(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}var Oe=8;function qt(t,e,r){let o=e.getBoundingClientRect(),n=t.getBoundingClientRect(),i=window.innerWidth,c=window.innerHeight,s,a;switch(r){case"bottom":s=o.bottom+Oe,a=o.left+(o.width-n.width)/2;break;case"left":s=o.top+(o.height-n.height)/2,a=o.left-n.width-Oe;break;case"right":s=o.top+(o.height-n.height)/2,a=o.right+Oe;break;default:s=o.top-n.height-Oe,a=o.left+(o.width-n.width)/2;break}a<4&&(a=4),a+n.width>i-4&&(a=i-n.width-4),s<4&&(s=4),s+n.height>c-4&&(s=c-n.height-4),t.style.top=`${s}px`,t.style.left=`${a}px`}var qn=0;function zn(t,e,r){document.body.appendChild(e),qt(e,t,r),e.setAttribute("aria-hidden","false")}function Rt(t,e){e.setAttribute("aria-hidden","true"),e.remove()}function Mn(t,e){t&&typeof t._warn=="function"?t._warn(e):console.warn(e)}function zt(t){t.directive("tooltip",{priority:20,init(e,r,o){$t();let n=o;if(!n){Mn(t,"[tooltip] attribute value (tooltip text) is required.");return}let i=e.getAttribute("tooltip-position")||"top",c=parseInt(e.getAttribute("tooltip-delay"),10),s=Number.isNaN(c)?300:c,a=e.getAttribute("tooltip-disabled"),d=a?t.findContext(e):null,u=()=>{if(!a||!d)return!1;try{return!!t.evaluate(a,d)}catch{return!1}},l=`nojs-tooltip-${++qn}`,m=document.createElement("div");m.className="nojs-tooltip",m.setAttribute("role","tooltip"),m.setAttribute("id",l),m.setAttribute("aria-hidden","true"),m.textContent=n,e.setAttribute("aria-describedby",l),ye.set(e,m);let f=!1,g=0,v=()=>{!f||!e.isConnected||g||(g=requestAnimationFrame(()=>{g=0,!(!f||!e.isConnected)&&qt(m,e,i)}))},y=()=>{window.addEventListener("scroll",v,!0),window.addEventListener("resize",v)},p=()=>{window.removeEventListener("scroll",v,!0),window.removeEventListener("resize",v),g&&(cancelAnimationFrame(g),g=0)},b=()=>{f||(zn(e,m,i),f=!0,y())},A=()=>{if(!f){Rt(e,m);return}p(),Rt(e,m),f=!1},h=()=>{if(u())return;te.has(e)&&clearTimeout(te.get(e));let B=setTimeout(()=>{te.delete(e),!u()&&e.isConnected&&b()},s);te.set(e,B)},x=()=>{te.has(e)&&(clearTimeout(te.get(e)),te.delete(e)),A()},_=()=>h(),L=()=>x(),k=()=>h(),j=()=>x(),S=B=>{B.key==="Escape"&&m.getAttribute("aria-hidden")==="false"&&x()};e.addEventListener("mouseenter",_),e.addEventListener("mouseleave",L),e.addEventListener("focusin",k),e.addEventListener("focusout",j),e.addEventListener("keydown",S);let w=null;if(a&&d&&typeof d.$watch=="function"){let B=()=>{f&&u()&&A()};w=d.$watch(B)}Rn(e,()=>{e.removeEventListener("mouseenter",_),e.removeEventListener("mouseleave",L),e.removeEventListener("focusin",k),e.removeEventListener("focusout",j),e.removeEventListener("keydown",S),w&&(w(),w=null),p(),te.has(e)&&(clearTimeout(te.get(e)),te.delete(e)),f=!1,m.remove(),ye.delete(e)})}})}function Mt(t,e={}){zt(t)}function Ht(){Pt()}var K=new Map;function Ot(){K.clear()}function Ve(){if(typeof document>"u"||document.querySelector("style[data-nojs-popover]"))return;let t=`
.nojs-popover {
  position: fixed;
  z-index: 9998;
  margin: 0;
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-modal",""),e.textContent=t,document.head.appendChild(e)}function On(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}var Xt='a[href], button:not([disabled]), input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])',nt=new WeakMap;function Vn(t){let e=r=>{if(r.key!=="Tab")return;let o=[...t.querySelectorAll(Xt)].filter(c=>c.offsetParent!==null);if(o.length===0){r.preventDefault();return}let n=o[0],i=o[o.length-1];r.shiftKey?document.activeElement===n&&(r.preventDefault(),i.focus()):document.activeElement===i&&(r.preventDefault(),n.focus())};t.addEventListener("keydown",e),nt.set(t,e)}function Kt(t){let e=nt.get(t);e&&(t.removeEventListener("keydown",e),nt.delete(t))}var Ce=new WeakMap;function Zt(t){t.directive("modal",{priority:10,init(r,o,n){Ee();let i=n||`nojs-modal-${Date.now()}-${Math.random().toString(36).slice(2,7)}`;r.setAttribute("popover","manual"),r.classList.add("nojs-modal"),r.id=r.id||`nojs-modal-${i}`,r.setAttribute("data-modal-id",i),r.setAttribute("role","dialog"),r.setAttribute("aria-modal","true");let c=r.querySelector("h1, h2, h3, h4, h5, h6");c&&(c.id||(c.id=`nojs-modal-heading-${i}`),r.setAttribute("aria-labelledby",c.id));let s=r.getAttribute("modal-backdrop");s==="false"&&r.setAttribute("data-nojs-no-backdrop","");let a=r.getAttribute("modal-class"),d=r.getAttribute("modal-escape"),u=m=>{m.target===r&&s!=="false"&&d!=="false"&&we(r,i)};r.addEventListener("click",u),oe.set(i,r);let l=m=>{if(m.newState==="open"){if(r.style.zIndex=String(Ut()),a&&a.split(/\s+/).filter(Boolean).forEach(f=>r.classList.add(f)),requestAnimationFrame(()=>{if(!r.isConnected||!W.some(g=>g.el===r))return;let f=r.querySelector(Xt);f?f.focus():r.focus()}),Vn(r),d!=="false"){let f=g=>{g.key==="Escape"&&(g.stopPropagation(),we(r,i))};r.addEventListener("keydown",f),Ce.set(r,f)}}else if(m.newState==="closed"){a&&a.split(/\s+/).filter(Boolean).forEach(v=>r.classList.remove(v)),Kt(r);let f=Ce.get(r);f&&(r.removeEventListener("keydown",f),Ce.delete(r));let g=W.findIndex(v=>v.el===r);if(g===-1&&(g=W.findIndex(v=>v.id===i)),g!==-1){let v=W[g];W.splice(g,1),v.triggerEl&&requestAnimationFrame(()=>{v.triggerEl.focus()})}}};r.addEventListener("toggle",l),On(r,()=>{r.removeEventListener("click",u),r.removeEventListener("toggle",l),Kt(r);let m=Ce.get(r);m&&(r.removeEventListener("keydown",m),Ce.delete(r)),oe.delete(i);let f=W.findIndex(g=>g.el===r);f===-1&&(f=W.findIndex(g=>g.id===i)),f!==-1&&W.splice(f,1)})}});let e=r=>e.open(r);e.open=r=>{let o=oe.get(r);if(!o)return!1;try{o.showPopover()}catch{return!1}return W.some(n=>n.id===r)||W.push({id:r,el:o,triggerEl:null}),!0},e.close=r=>{let o=oe.get(r);return o?(we(o,r),!0):!1},e.closeAll=()=>{for(let r=W.length-1;r>=0;r--)we(W[r].el,W[r].id)},t.modal=e}function we(t,e){try{t.hidePopover()}catch{}}function Nt(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function Wn(t){let e=document.querySelectorAll("[data-modal-id]");for(let r of e)if(r.getAttribute("data-modal-id")===t)return r;return null}function Qt(t){t.directive("modal-open",{priority:10,init(e,r,o){Ee();let n=o;if(!n){let l=(e.closest("[use]")||e.parentElement)?.querySelector("[data-modal-id]");if(l&&(n=l.getAttribute("data-modal-id")),!n){console.warn('[modal-open] requires a target modal ID, e.g. modal-open="my-dialog"');return}}e.setAttribute("aria-haspopup","dialog"),e.setAttribute("aria-expanded","false");let i=()=>{let u=oe.get(n)||Wn(n);if(!u){console.warn(`[modal-open] modal "${n}" not found`);return}let l=W.some(m=>m.id===n);u.id&&e.setAttribute("aria-controls",u.id);try{u.showPopover()}catch{console.warn(`[modal-open] failed to open modal "${n}"`);return}l||W.push({id:n,el:u,triggerEl:e}),e.setAttribute("aria-expanded","true")},c=()=>{e.setAttribute("aria-expanded","false")},s=null,a=null,d=()=>{let u=oe.get(n);return u?(a=u,s=l=>{l.newState==="closed"&&e.setAttribute("aria-expanded","false")},u.addEventListener("toggle",s),!0):!1};if(!d()){let u=requestAnimationFrame(d);Nt(e,()=>cancelAnimationFrame(u))}e.addEventListener("click",i),Nt(e,()=>{e.removeEventListener("click",i),a&&s&&a.removeEventListener("toggle",s)})}})}function Gn(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function Jt(t){t.directive("modal-close",{priority:10,init(e,r,o){Ee();let n=()=>{let i,c;if(o){if(c=o,i=oe.get(c),!i){console.warn(`[modal-close] modal "${c}" not found`);return}}else{if(i=e.closest("[modal]"),!i){console.warn("[modal-close] no parent modal found");return}c=i.getAttribute("modal")}we(i,c)};e.addEventListener("click",n),Gn(e,()=>{e.removeEventListener("click",n)})}})}function er(t,e={}){Zt(t),Qt(t),Jt(t)}function tr(){Yt()}var de={openMenus:new Map};function rr(){de.openMenus.clear()}function Ae(){if(typeof document>"u"||document.querySelector("style[data-nojs-dropdown]"))return;let t=`
.nojs-dropdown-menu {
  position: fixed;
  z-index: 9999;
  margin: 0;
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-dropdown",""),e.textContent=t,document.head.appendChild(e)}var Un=0;function Yn(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function nr(t,e,r){let o=r.getAttribute("dropdown-position")||"bottom",n=r.getAttribute("dropdown-align")||"start";t.style.top="",t.style.left="";let i=e.getBoundingClientRect(),c=t.getBoundingClientRect(),s=window.innerHeight,a=window.innerWidth,d,u;switch(o){case"top":d=i.top-c.height,u=i.left;break;case"left":d=i.top,u=i.left-c.width;break;case"right":d=i.top,u=i.right;break;default:d=i.bottom,u=i.left}o==="bottom"||o==="top"?n==="end"&&(u=i.right-c.width):n==="end"&&(d=i.bottom-c.height),o==="bottom"&&d+c.height>s&&i.top-c.height>0?d=i.top-c.height:o==="top"&&d<0&&i.bottom+c.height<=s&&(d=i.bottom),u<4&&(u=4),u+c.width>a-4&&(u=a-c.width-4),t.style.top=`${d}px`,t.style.left=`${u}px`}function it(t){return[...t.querySelectorAll("[dropdown-item]")].filter(e=>!e.hasAttribute("disabled")&&e.getAttribute("aria-disabled")!=="true")}function ot(t){let e=it(t);e.length&&e[0].focus()}function or(t){let e=it(t);e.length&&e[e.length-1].focus()}function ir(t){t.directive("dropdown",{priority:15,init(r){Ae()}}),t.directive("dropdown-toggle",{priority:15,init(r){Ae();let o=r.closest("[dropdown]");if(!o)return;let n=o.querySelector("[dropdown-menu]");if(!n)return;r.setAttribute("aria-haspopup","menu"),r.setAttribute("aria-expanded","false"),n.classList.add("nojs-dropdown-menu"),n.setAttribute("role","menu"),n.setAttribute("popover","auto"),n.id||(n.id=`nojs-dd-menu-${Date.now()}-${Un++}`),r.setAttribute("aria-controls",n.id);let i=!1,c=typeof n.showPopover=="function"&&typeof n.hidePopover=="function";function s(){if(n.setAttribute("data-open",""),c&&!i)try{n.showPopover(),i=!0}catch{i=!1}r.setAttribute("aria-expanded","true"),nr(n,r,o),de.openMenus.set(n,{toggle:r,wrapper:o})}function a(){if(c&&i){i=!1;try{n.hidePopover()}catch{}}n.removeAttribute("data-open"),r.setAttribute("aria-expanded","false"),de.openMenus.delete(n)}function d(){return r.getAttribute("aria-expanded")==="true"}let u=p=>{p.newState==="closed"&&d()&&a()};n.addEventListener("toggle",u);let l=p=>{p.preventDefault(),p.stopPropagation(),d()?a():s()};r.addEventListener("click",l);let m=p=>{d()&&!o.contains(p.target)&&a()};document.addEventListener("click",m,!0);let f=p=>{p.key==="Escape"&&d()&&(a(),r.focus())};document.addEventListener("keydown",f);let g=p=>{switch(p.key){case"Enter":case" ":p.preventDefault(),s(),ot(n);break;case"ArrowDown":p.preventDefault(),s(),ot(n);break;case"ArrowUp":p.preventDefault(),s(),or(n);break}};r.addEventListener("keydown",g);let v=p=>{if(!(!d()||it(n).find(h=>h===document.activeElement)))switch(p.key){case"ArrowDown":p.preventDefault(),ot(n);break;case"ArrowUp":p.preventDefault(),or(n);break}};n.addEventListener("keydown",v);let y=()=>{d()&&nr(n,r,o)};window.addEventListener("scroll",y,!0),window.addEventListener("resize",y),Yn(r,()=>{r.removeEventListener("click",l),r.removeEventListener("keydown",g),n.removeEventListener("keydown",v),n.removeEventListener("toggle",u),document.removeEventListener("click",m,!0),document.removeEventListener("keydown",f),window.removeEventListener("scroll",y,!0),window.removeEventListener("resize",y),de.openMenus.delete(n)})}}),t.directive("dropdown-menu",{priority:15,init(r){Ae(),r.hasAttribute("role")||r.setAttribute("role","menu")}});let e=r=>e.open(r);e.open=r=>{let o=document.getElementById(r);if(!o)return!1;let i=o.closest("[dropdown]")?.querySelector("[dropdown-toggle]");return!i||i.getAttribute("aria-expanded")==="true"?!1:(i.click(),!0)},e.close=r=>{let o=document.getElementById(r);if(!o)return!1;let i=o.closest("[dropdown]")?.querySelector("[dropdown-toggle]");return!i||i.getAttribute("aria-expanded")!=="true"?!1:(i.click(),!0)},t.dropdown=e}function sr(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function Kn(t){return[...t.querySelectorAll("[dropdown-item]")].filter(e=>!e.hasAttribute("disabled")&&e.getAttribute("aria-disabled")!=="true")}function st(t,e){if(!t)return;if(typeof t.hidePopover=="function")try{t.hidePopover()}catch{}t.removeAttribute("data-open");let r=e&&e.querySelector("[dropdown-toggle]");r&&r.setAttribute("aria-expanded","false"),de.openMenus.has(t)&&de.openMenus.delete(t)}function ar(t){t.directive("dropdown-item",{priority:15,init(e){Ae();let r=e.closest("[dropdown-menu]"),o=e.closest("[dropdown]");e.setAttribute("role","menuitem"),e.setAttribute("tabindex","-1"),e.classList.add("nojs-dropdown-item"),e.hasAttribute("disabled")&&e.setAttribute("aria-disabled","true");let n=c=>{if(!r)return;let s=Kn(r),a=s.indexOf(e);switch(c.key){case"ArrowDown":{c.preventDefault(),(a+1<s.length?s[a+1]:s[0]).focus();break}case"ArrowUp":{c.preventDefault(),(a-1>=0?s[a-1]:s[s.length-1]).focus();break}case"Home":{c.preventDefault(),s.length&&s[0].focus();break}case"End":{c.preventDefault(),s.length&&s[s.length-1].focus();break}case"Enter":{c.preventDefault(),e.click();break}case"Escape":{if(c.preventDefault(),st(r,o),o){let d=o.querySelector("[dropdown-toggle]");d&&d.focus()}break}case"Tab":{st(r,o);break}}};e.addEventListener("keydown",n),sr(e,()=>e.removeEventListener("keydown",n));let i=()=>{if(st(r,o),o){let c=o.querySelector("[dropdown-toggle]");c&&c.focus()}};e.addEventListener("click",i),sr(e,()=>e.removeEventListener("click",i))}})}function cr(t,e={}){ir(t),ar(t)}function dr(){rr()}var ie=new Map,_e=new Set,lr=0;function ur(){return++lr}function pr(){for(let t of _e)clearTimeout(t);_e.clear();for(let t of ie.values())t.remove();ie.clear(),lr=0}function fr(){if(typeof document>"u"||document.querySelector("style[data-nojs-toast]"))return;let t=`
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-toast",""),e.textContent=t,document.head.appendChild(e)}function at(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}var Xn=new Set(["top-right","top-left","bottom-right","bottom-left","top-center","bottom-center"]);function ct(){return ie.size>0?ie.values().next().value:Zn("top-right")}function Zn(t){if(ie.has(t))return ie.get(t);let e=document.createElement("div");return e.classList.add("nojs-toast-container"),e.setAttribute("data-position",t),e.setAttribute("role","log"),e.setAttribute("aria-live","polite"),e.setAttribute("aria-relevant","additions"),document.body.appendChild(e),ie.set(t,e),e}function Nn(t){return t.startsWith("top")}function dt(t,e,r,o,n){let i=ur(),c=t.getAttribute("data-position")||"top-right",s=document.createElement("div");s.classList.add("nojs-toast"),s.setAttribute("data-toast-id",i),s.setAttribute("data-type",r),r==="error"&&s.setAttribute("aria-live","assertive");let a=document.createElement("span");if(a.textContent=e,s.appendChild(a),n){let d=document.createElement("button");d.type="button",d.classList.add("nojs-toast-dismiss"),d.setAttribute("aria-label","Dismiss"),d.textContent="\xD7",d.addEventListener("click",()=>Ge(s)),s.appendChild(d)}if(Nn(c)&&t.firstChild?t.insertBefore(s,t.firstChild):t.appendChild(s),o>0){let d=setTimeout(()=>{_e.delete(d),s.isConnected&&Ge(s)},o);_e.add(d),s._toastTimerId=d}return s}function Ge(t){!t||!t.isConnected||(t._toastTimerId!=null&&(clearTimeout(t._toastTimerId),_e.delete(t._toastTimerId)),t.remove())}function gr(t){fr(),t.directive("toast-container",{priority:10,init(r,o,n){let i=n&&Xn.has(n)?n:"top-right";r.classList.add("nojs-toast-container"),r.setAttribute("data-position",i),r.setAttribute("role","log"),r.setAttribute("aria-live","polite"),r.setAttribute("aria-relevant","additions"),ie.set(i,r),at(r,()=>{ie.get(i)===r&&ie.delete(i)})}}),t.directive("toast",{priority:10,init(r,o,n){if(!n)return;let i=r.getAttribute("toast-type")||"info",c=parseInt(r.getAttribute("toast-duration"),10),s=Number.isNaN(c)?3e3:c,a=r.getAttribute("toast-dismiss")!=="false";if(r.tagName==="BUTTON"||r.tagName==="A"||r.hasAttribute("on:click")){let g=()=>{let v=ct();dt(v,n,i,s,a)};r.addEventListener("click",g),at(r,()=>r.removeEventListener("click",g));return}let u=t.findContext(r);if(!u||typeof u.$watch!="function"){console.warn("[toast] reactive toast requires a parent [state] or [use] context \u2014 element will be inert");return}let l;function m(){let g=t.evaluate(n,u);if(g&&g!==l){let v=typeof g=="string"?g:String(g),y=ct();dt(y,v,i,s,a),l=g}else l=g}let f=u.$watch(m);at(r,f)}});let e=(r,o="info",n=3e3)=>{if(typeof document>"u")return;let i=!0,c=ct();return dt(c,String(r),o,n,i)};e.dismiss=r=>{let o=typeof CSS<"u"&&CSS.escape?CSS.escape(String(r)):String(r).replace(/["\\\]]/g,"\\$&"),n=document.querySelector(`[data-toast-id="${o}"]`);n&&Ge(n)},e.dismissAll=()=>{document.querySelectorAll(".nojs-toast").forEach(r=>Ge(r))},t.toast=e}function mr(t,e={}){gr(t)}function br(){pr()}var me={containers:new Map};function hr(){me.containers.clear()}function vr(){if(typeof document>"u"||document.querySelector("style[data-nojs-tabs]"))return;let t=`
.nojs-tabs {
  display: flex;
  flex-direction: column;
  border: 1px solid #E2E8F0;
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-tree",""),e.textContent=t,document.head.appendChild(e)}function je(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function jr(t){let e=[],r=document.createTreeWalker(t,NodeFilter.SHOW_ELEMENT,{acceptNode(n){return n.matches&&n.matches('.nojs-subtree[aria-hidden="true"]')?NodeFilter.FILTER_REJECT:n.getAttribute("role")==="treeitem"?NodeFilter.FILTER_ACCEPT:NodeFilter.FILTER_SKIP}}),o;for(;o=r.nextNode();)e.push(o);return e}function kr(t){return t.closest('[role="tree"]')}function eo(t){let e=t.parentElement?.closest('[role="group"], .nojs-subtree');if(e){let r=e.parentElement?.closest('[role="treeitem"]');if(r)return r;let o=e.previousElementSibling;if(o?.matches?.('[role="treeitem"]'))return o}return t.parentElement?.closest('[role="treeitem"]')||null}function to(t){let e=t.cloneNode(!0);return e.querySelectorAll('[role="group"]').forEach(o=>o.remove()),(e.textContent||"").trim().toLowerCase()}function lt(t){let e=I.selectedItem;e&&e!==t&&(e.classList.remove("nojs-branch-selected"),e.setAttribute("aria-selected","false")),t.classList.add("nojs-branch-selected"),t.setAttribute("aria-selected","true"),I.selectedItem=t}function Cr(t){let e=I.branches.get(t);!e||!e.subtreeEl||(e.expanded=!e.expanded,t.setAttribute("aria-expanded",String(e.expanded)),e.subtreeEl.setAttribute("aria-hidden",String(!e.expanded)))}function ro(t){let e=I.branches.get(t);!e||!e.subtreeEl||e.expanded||(e.expanded=!0,t.setAttribute("aria-expanded","true"),e.subtreeEl.setAttribute("aria-hidden","false"))}function no(t){let e=I.branches.get(t);!e||!e.subtreeEl||!e.expanded||(e.expanded=!1,t.setAttribute("aria-expanded","false"),e.subtreeEl.setAttribute("aria-hidden","true"))}function Sr(t,e){let r=kr(e);if(!r)return;let o=jr(r),n=o.indexOf(e);if(n<0)return;let i=I.branches.get(e),c=i&&i.subtreeEl;switch(t.key){case"ArrowRight":if(t.preventDefault(),c&&!i.expanded)ro(e);else if(c&&i.expanded){let s=i.subtreeEl.querySelector('[role="treeitem"]');s&&be(s,o)}break;case"ArrowLeft":if(t.preventDefault(),c&&i.expanded)no(e);else{let s=eo(e);s&&be(s,jr(r))}break;case"ArrowDown":t.preventDefault(),n<o.length-1&&be(o[n+1],o);break;case"ArrowUp":t.preventDefault(),n>0&&be(o[n-1],o);break;case"Enter":case" ":t.preventDefault(),lt(e),c&&Cr(e);break;case"Home":t.preventDefault(),o.length>0&&be(o[0],o);break;case"End":t.preventDefault(),o.length>0&&be(o[o.length-1],o);break;default:if(t.key.length===1&&!t.ctrlKey&&!t.altKey&&!t.metaKey){t.preventDefault(),I.typeahead+=t.key.toLowerCase(),I.typeaheadTimer&&clearTimeout(I.typeaheadTimer),I.typeaheadTimer=setTimeout(()=>{I.typeahead="",I.typeaheadTimer=null},500);let s=n+1;for(let a=0;a<o.length;a++){let d=(s+a)%o.length;if(to(o[d]).startsWith(I.typeahead)){be(o[d],o);break}}}break}}function Tr(t){t.directive("tree",{priority:15,init(e){Le(),e.classList.add("nojs-tree"),e.setAttribute("role","tree"),e.getAttribute("tree-icon")==="false"&&e.setAttribute("data-tree-icon","false")}})}function Dr(t){t.directive("branch",{priority:16,init(e,r,o){Le();let n=o==="expanded";e.classList.add("nojs-branch"),e.setAttribute("role","treeitem"),e.setAttribute("aria-expanded",String(n));let i=kr(e);if(i){let d=i.querySelector('[role="treeitem"][tabindex="0"]');e.setAttribute("tabindex",d?"-1":"0")}else e.setAttribute("tabindex","0");let c=!1;queueMicrotask(()=>{if(c)return;let d=e.querySelector(":scope > [subtree], :scope > .nojs-subtree")||(e.nextElementSibling?.matches?.("[subtree], .nojs-subtree")?e.nextElementSibling:null);d?(I.branches.set(e,{expanded:n,subtreeEl:d}),d.setAttribute("aria-hidden",String(!n))):I.branches.set(e,{expanded:n,subtreeEl:null})});let s=d=>{d.target.closest?.('[role="treeitem"]')===e&&(d.stopPropagation(),lt(e),Cr(e))};e.addEventListener("click",s),je(e,()=>e.removeEventListener("click",s));let a=d=>{Sr(d,e)};e.addEventListener("keydown",a),je(e,()=>e.removeEventListener("keydown",a)),je(e,()=>{c=!0,I.branches.delete(e),I.selectedItem===e&&(I.selectedItem=null),I.typeaheadTimer&&(clearTimeout(I.typeaheadTimer),I.typeaheadTimer=null,I.typeahead="")})}})}function be(t,e){for(let r of e)r.setAttribute("tabindex",r===t?"0":"-1");t.focus()}function Ir(t){t.directive("subtree",{priority:16,init(e){Le(),e.classList.add("nojs-subtree"),e.classList.add("nojs-tree"),e.setAttribute("role","group");for(let o of e.children)if(o.tagName==="LI"&&!o.querySelector("[branch], .nojs-branch")){o.setAttribute("role","treeitem"),o.setAttribute("tabindex","-1"),o.classList.add("nojs-tree-leaf");let n=c=>{c.stopPropagation(),lt(o)};o.addEventListener("click",n),je(o,()=>o.removeEventListener("click",n));let i=c=>{Sr(c,o)};o.addEventListener("keydown",i),je(o,()=>o.removeEventListener("keydown",i)),je(o,()=>{I.selectedItem===o&&(I.selectedItem=null)})}let r=e.parentElement?.matches?.('[role="treeitem"]')?e.parentElement:e.previousElementSibling?.matches?.('[role="treeitem"]')?e.previousElementSibling:null;if(r){let o=I.branches.get(r);o?(e.setAttribute("aria-hidden",String(!o.expanded)),o.subtreeEl=e):e.setAttribute("aria-hidden","true")}else e.setAttribute("aria-hidden","true")}})}function Br(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function ut(t){return t.closest('[role="treeitem"]')}function oo(t){return t.closest('[role="tree"]')}function io(t){let e=t.parentElement;return e?[...e.children].filter(r=>r.getAttribute("role")==="treeitem"):[]}function so(t){return io(t).indexOf(t)}function ao(t,e,r){let o=t.getBoundingClientRect(),n=e-o.top,i=o.height;return r==="reparent"?"on":r==="reorder"?n<i/2?"before":"after":n<i*.25?"before":n>i*.75?"after":"on"}function Fr(t,e){let r=t.parentElement;for(;r;){if(r===e)return!0;r=r.parentElement}return!1}var D={dragging:null,indicator:null,currentTarget:null,currentPosition:null};function ke(){D.indicator&&(D.indicator.remove(),D.indicator=null)}function De(t){if(!t)return;let e=t.querySelectorAll(".nojs-tree-drag-over");for(let r of e)r.classList.remove("nojs-tree-drag-over")}function co(){let t=document.createElement("div");return t.className="nojs-tree-drag-indicator",t.setAttribute("aria-hidden","true"),t}function lo(t,e){ke();let r=co(),o=t.getBoundingClientRect(),n=oo(t);if(!n)return;let i=n.getBoundingClientRect();r.style.position="absolute",r.style.left=o.left-i.left+"px",r.style.width=o.width+"px",e==="before"?r.style.top=o.top-i.top-1+"px":r.style.top=o.bottom-i.top-1+"px",getComputedStyle(n).position==="static"&&(n.style.position="relative"),n.appendChild(r),D.indicator=r}function Pr(t){t.directive("tree-drag-mode",{priority:15,init(e,r,o){if(Le(),o!=="reparent"&&o!=="reorder"&&o!=="both")return;let n=0,i=m=>{let f=ut(m.target);if(f&&e.contains(f)){if(f.hasAttribute("tree-drag-disabled")){m.preventDefault();return}D.dragging={el:f,treeRoot:e},m.dataTransfer&&(m.dataTransfer.effectAllowed="move",m.dataTransfer.setData("text/plain","")),f.classList.add("nojs-dragging"),f.dispatchEvent(new CustomEvent("tree:drag-start",{bubbles:!0,detail:{node:f}}))}},c=m=>{if(!D.dragging||D.dragging.treeRoot!==e)return;let f=ut(m.target);if(!f||!e.contains(f)||f===D.dragging.el||Fr(f,D.dragging.el))return;m.preventDefault(),m.dataTransfer&&(m.dataTransfer.dropEffect="move");let g=ao(f,m.clientY,o);(D.currentTarget!==f||D.currentPosition!==g)&&(De(e),ke(),D.currentTarget=f,D.currentPosition=g,g==="on"?f.classList.add("nojs-tree-drag-over"):lo(f,g))},s=m=>{D.dragging&&D.dragging.treeRoot===e&&n++},a=m=>{D.dragging&&(n--,n<=0&&(n=0,De(e),ke(),D.currentTarget=null,D.currentPosition=null))},d=m=>{if(m.preventDefault(),m.stopPropagation(),n=0,!D.dragging||D.dragging.treeRoot!==e)return;let f=D.dragging.el,g=D.currentTarget,v=D.currentPosition;if(De(e),ke(),!g||!v){D.dragging=null,D.currentTarget=null,D.currentPosition=null;return}if(g===f||Fr(g,f)){D.dragging=null,D.currentTarget=null,D.currentPosition=null;return}if(v==="on"){let y=g.querySelector(':scope > [role="group"]');y||(y=g.nextElementSibling?.matches?.('[role="group"]')?g.nextElementSibling:null),y?y.setAttribute("aria-hidden","false"):(y=document.createElement("ul"),y.setAttribute("role","group"),y.setAttribute("subtree",""),y.classList.add("nojs-subtree","nojs-tree"),y.setAttribute("aria-hidden","false"),g.appendChild(y));let p=I.branches.get(g);p&&(p.expanded=!0,p.subtreeEl=y,g.setAttribute("aria-expanded","true")),y.appendChild(f),e.dispatchEvent(new CustomEvent("tree:reparent",{bubbles:!0,detail:{node:f,newParent:g}}))}else{let y=g.parentElement;if(!y){D.dragging=null,D.currentTarget=null,D.currentPosition=null;return}if(v==="before")y.insertBefore(f,g);else{let b=g.nextElementSibling,A=b?.matches?.('[role="group"]')?b.nextElementSibling:b;A?y.insertBefore(f,A):y.appendChild(f)}let p=so(f);e.dispatchEvent(new CustomEvent("tree:reorder",{bubbles:!0,detail:{node:f,newIndex:p}}))}D.dragging=null,D.currentTarget=null,D.currentPosition=null},u=m=>{let f=ut(m.target);f&&f.classList.remove("nojs-dragging"),De(e),ke(),n=0,D.dragging&&D.dragging.el.dispatchEvent(new CustomEvent("tree:drag-end",{bubbles:!0,detail:{node:D.dragging.el}})),D.dragging=null,D.currentTarget=null,D.currentPosition=null};e.addEventListener("dragstart",i),e.addEventListener("dragover",c),e.addEventListener("dragenter",s),e.addEventListener("dragleave",a),e.addEventListener("drop",d),e.addEventListener("dragend",u),Br(e,()=>{e.removeEventListener("dragstart",i),e.removeEventListener("dragover",c),e.removeEventListener("dragenter",s),e.removeEventListener("dragleave",a),e.removeEventListener("drop",d),e.removeEventListener("dragend",u),De(e),ke()}),uo(e);let l=new MutationObserver(m=>{for(let f of m)for(let g of f.addedNodes){if(g.nodeType!==1)continue;g.getAttribute("role")==="treeitem"&&pt(g);let v=g.querySelectorAll?.('[role="treeitem"]');if(v)for(let y of v)pt(y)}});l.observe(e,{childList:!0,subtree:!0}),Br(e,()=>l.disconnect())}})}function pt(t){if(t.hasAttribute("tree-drag-disabled")){t.draggable=!1;return}t.draggable=!0}function uo(t){let e=t.querySelectorAll('[role="treeitem"]');for(let r of e)pt(r)}function $r(t,e={}){Tr(t),Dr(t),Ir(t),Pr(t)}function Rr(){Lr()}var Ue=new Map;function qr(){Ue.clear()}function Ye(){if(typeof document>"u"||document.querySelector("style[data-nojs-stepper]"))return;let t=`
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-split",""),e.textContent=t,document.head.appendChild(e)}function go(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function Nr(t){return t==="horizontal"?"clientX":"clientY"}function N(t,e){let r=t.getBoundingClientRect?t.getBoundingClientRect():null,o=r&&(e==="horizontal"?r.width:r.height);return o||(e==="horizontal"?t.offsetWidth:t.offsetHeight)}function Qr(t,e){if(e!=="horizontal")return 1;try{return(t.closest&&t.closest("[dir]")?.getAttribute("dir")||(typeof getComputedStyle=="function"?getComputedStyle(t).direction:""))==="rtl"?-1:1}catch{return 1}}function mo(t,e){let o=(he.get(t)?.gutters||[]).reduce((n,i)=>n+N(i,e),0);return N(t,e)-o}function bo(t,e){if(!t)return null;let r=parseFloat(t);return Number.isNaN(r)?null:typeof t=="string"&&t.trim().endsWith("%")?r/100*e:r}function Be(t,e){let r=G.get(e);return r?r.min!=null&&t<r.min?r.min:r.max!=null&&t>r.max?r.max:t:t}function Xe(t,e,r,o){let n=N(e,o),i=N(r,o),c=G.get(e),s=G.get(r);t.setAttribute("aria-valuenow",Math.round(n)),t.setAttribute("aria-valuemin",c?.min||0),t.setAttribute("aria-valuemax",Math.round(n+i-(s?.min||0)))}function ft(t){let e=t.getAttribute("split-persist");if(!e)return;let r=he.get(t);if(!r)return;let o=r.panes.map(n=>n.style.flexBasis||"");try{localStorage.setItem(`nojs-split:${e}`,JSON.stringify(o))}catch{}}function ho(t){let e=t.getAttribute("split-persist");if(!e)return!1;try{let r=localStorage.getItem(`nojs-split:${e}`);if(!r)return!1;let o=JSON.parse(r),n=he.get(t);return!n||o.length!==n.panes.length?!1:(o.forEach((i,c)=>{i&&(n.panes[c].style.flexBasis=i,n.panes[c].style.flexGrow="0")}),!0)}catch{return!1}}function vo(t,e,r,o,n){let i=document.createElement("div");i.className="nojs-gutter",i.setAttribute("role","separator"),i.setAttribute("tabindex","0"),i.setAttribute("aria-orientation",e==="horizontal"?"vertical":"horizontal"),i.setAttribute("aria-label","Resize"),n!==6&&i.style.setProperty("--nojs-gutter-size",`${n}px`);let c=f=>{if(f.button!==0)return;f.preventDefault();let g=mo(t,e);C.active=!0,C.splitEl=t,C.gutterEl=i,C.prevPane=r,C.nextPane=o,C.direction=e,C.startPos=f[Nr(e)],C.startPrevSize=N(r,e),C.startNextSize=N(o,e),C.containerSize=g,C.sign=Qr(t,e),document.body.style.cursor=e==="horizontal"?"col-resize":"row-resize",document.body.style.userSelect="none",i.setPointerCapture(f.pointerId)},s=f=>{if(!C.active||C.gutterEl!==i)return;let g=(f[Nr(C.direction)]-C.startPos)*(C.sign||1),v=Be(C.startPrevSize+g,C.prevPane),y=Be(C.startNextSize-g,C.nextPane),p=C.startPrevSize+C.startNextSize;v+y!==p&&(v!==C.startPrevSize+g?y=p-v:v=p-y),C.prevPane.style.flexBasis=`${v}px`,C.prevPane.style.flexGrow="0",C.nextPane.style.flexBasis=`${y}px`,C.nextPane.style.flexGrow="0",Xe(i,C.prevPane,C.nextPane,C.direction)},a=()=>{!C.active||C.gutterEl!==i||(C.active=!1,document.body.style.cursor="",document.body.style.userSelect="",ft(t),t.dispatchEvent(new CustomEvent("split-resize",{bubbles:!0,detail:{prevPane:r,nextPane:o}})))};i.addEventListener("pointerdown",c),i.addEventListener("pointermove",s),i.addEventListener("pointerup",a),i.addEventListener("pointercancel",a);let d=10,u=f=>{let g=e==="horizontal",v=Qr(t,e),y=0;if(g&&f.key==="ArrowRight"||!g&&f.key==="ArrowDown")y=d*v;else if(g&&f.key==="ArrowLeft"||!g&&f.key==="ArrowUp")y=-d*v;else if(f.key==="Home")y=(G.get(r)?.min||0)-N(r,e);else if(f.key==="End"){let _=G.get(o);y=N(r,e)+N(o,e)-(_?.min||0)-N(r,e)}else return;f.preventDefault();let p=N(r,e),b=N(o,e),A=p+b,h=Be(p+y,r),x=Be(A-h,o);h=A-x,h=Be(h,r),x=A-h,r.style.flexBasis=`${h}px`,r.style.flexGrow="0",o.style.flexBasis=`${x}px`,o.style.flexGrow="0",Xe(i,r,o,e),ft(t)};i.addEventListener("keydown",u);let l=()=>{let f=G.get(r),g=G.get(o),v=f?.collapsible?r:g?.collapsible?o:null;if(!v)return;let y=G.get(v);if(!y)return;let p=v===r?o:r,b=N(r,e)+N(o,e);if(y.collapsed){y.collapsed=!1,v.removeAttribute("data-collapsed");let A=y.preCollapseSize||`${Math.round(b/2)}px`,h=bo(A,b)??b/2,x=Math.min(h,b);v.style.flexBasis=`${x}px`,v.style.flexGrow="0",p.style.flexBasis=`${b-x}px`,p.style.flexGrow="0"}else y.preCollapseSize=v.style.flexBasis||`${N(v,e)}px`,y.collapsed=!0,v.setAttribute("data-collapsed","true"),v.style.flexBasis="0px",v.style.flexGrow="0",p.style.flexBasis=`${b}px`,p.style.flexGrow="0";Xe(i,r,o,e),ft(t),t.dispatchEvent(new CustomEvent("split-collapse",{bubbles:!0,detail:{pane:v,collapsed:y.collapsed}}))};return i.addEventListener("dblclick",l),{gutter:i,cleanup:()=>{i.removeEventListener("pointerdown",c),i.removeEventListener("pointermove",s),i.removeEventListener("pointerup",a),i.removeEventListener("pointercancel",a),i.removeEventListener("keydown",u),i.removeEventListener("dblclick",l)}}}function Jr(t){t.directive("split",{priority:14,init(e,r,o){Ke();let n=(o||"horizontal").trim()==="vertical"?"vertical":"horizontal",i=parseInt(e.getAttribute("split-gutter"),10)||6;e.classList.add("nojs-split"),e.setAttribute("data-direction",n);let c=Array.from(e.children).filter(u=>u.hasAttribute("pane"));if(c.length<2){console.warn(`[split] Container requires at least 2 [pane] children, found ${c.length}.`);return}c.forEach(u=>{G.get(u)||G.set(u,{size:u.getAttribute("pane")||null,min:parseInt(u.getAttribute("pane-min"),10)||0,max:parseInt(u.getAttribute("pane-max"),10)||1/0,collapsible:u.getAttribute("pane-collapsible")==="true",collapsed:!1,preCollapseSize:null})});let s=[],a=[];for(let u=0;u<c.length-1;u++){let{gutter:l,cleanup:m}=vo(e,n,c[u],c[u+1],i);c[u].after(l),s.push(l),a.push(m)}he.set(e,{direction:n,gutterSize:i,panes:c,gutters:s}),ho(e)||c.forEach(u=>{let m=G.get(u)?.size;m?(u.style.flexBasis=m,u.style.flexGrow="0"):(u.style.flexGrow="1",u.style.flexBasis="0")}),requestAnimationFrame(()=>{s.forEach((u,l)=>{Xe(u,c[l],c[l+1],n)})}),go(e,()=>{a.forEach(u=>u()),s.forEach(u=>u.remove()),he.delete(e),c.forEach(u=>G.delete(u)),e.classList.remove("nojs-split"),e.removeAttribute("data-direction")})}})}function yo(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function en(t){t.directive("pane",{priority:15,init(e,r,o){Ke(),e.classList.add("nojs-pane"),G.has(e)||G.set(e,{size:o||null,min:parseInt(e.getAttribute("pane-min"),10)||0,max:parseInt(e.getAttribute("pane-max"),10)||1/0,collapsible:e.getAttribute("pane-collapsible")==="true",collapsed:!1,preCollapseSize:null});let n=G.get(e),i=e.closest("[data-direction='vertical']")?"height":"width";n.min&&(e.style[`min${i==="width"?"Width":"Height"}`]=`${n.min}px`),n.max&&n.max!==1/0&&(e.style[`max${i==="width"?"Width":"Height"}`]=`${n.max}px`),yo(e,()=>{e.classList.remove("nojs-pane"),G.delete(e),e.style.removeProperty("min-width"),e.style.removeProperty("min-height"),e.style.removeProperty("max-width"),e.style.removeProperty("max-height"),e.style.removeProperty("flex-basis"),e.style.removeProperty("flex-grow")})}})}function tn(t,e={}){Jr(t),en(t)}function rn(){Zr()}var le={sorts:new Map};function nn(){le.sorts.clear()}function ve(){if(typeof document>"u"||document.querySelector("style[data-nojs-table]"))return;let t=`
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-table",""),e.textContent=t,document.head.appendChild(e)}function xo(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function Eo(t,e){let r=t.querySelector("tbody");if(!r)return null;let o=null;if(r.hasAttribute("each")||r.hasAttribute("foreach")?o=r:o=r.querySelector("[each]")||r.querySelector("[foreach]"),!o)return null;let n=o.getAttribute("each")||o.getAttribute("foreach");if(!n)return null;let i=n.match(/^\s*(\w+)\s+(?:in|of)\s+(.+)\s*$/);return i?{iteratorVar:i[1],arrayPath:i[2].trim()}:null}function wo(t,e){let r=e.split("."),o=t;for(let n of r){if(o==null)return;o=o[n]}return o}function on(t,e,r){let o=e.split("."),n=t;for(let i=0;i<o.length-1;i++){if(n[o[i]]==null)return;n=n[o[i]]}n[o[o.length-1]]=r}function sn(t,e){let r=Number.isNaN(t),o=Number.isNaN(e);return r&&o?0:r?1:o||t<e?-1:t>e?1:0}function cn(t,e,r){if(t==null&&e==null)return 0;if(t==null)return-1;if(e==null)return 1;switch(r){case"number":return sn(Number(t),Number(e));case"date":return sn(new Date(t).getTime(),new Date(e).getTime());default:return String(t).localeCompare(String(e))}}function Ao(t){let e=t.querySelectorAll("th[data-sortable]");for(let r of e)r.removeAttribute("data-sort-dir"),r.setAttribute("aria-sort","none")}function dn(t){t.directive("sortable",{priority:10,init(e){ve(),e.classList.add("nojs-sortable")}})}function ln(t){t.directive("sort",{priority:11,init(e,r,o){ve();let n=o;if(!n)return;let i=e.getAttribute("sort-type")||"string",c=e.getAttribute("sort-default");e.setAttribute("data-sortable",""),e.setAttribute("aria-sort","none");let s=e.closest("table");if(!s)return;le.sorts.has(s)||le.sorts.set(s,{column:null,direction:null}),(c==="asc"||c==="desc")&&(le.sorts.get(s).column||an(e,s,n,i,c,t));let a=()=>{let d=le.sorts.get(s),u;d.column!==n?u="asc":d.direction==="asc"?u="desc":d.direction==="desc"?u=null:u="asc",an(e,s,n,i,u,t)};e.addEventListener("click",a),xo(e,()=>{e.removeEventListener("click",a),s&&!s.isConnected&&(le.sorts.delete(s),delete s._nojsOriginalOrder,delete s._nojsOriginalRows)})}})}function an(t,e,r,o,n,i){let c=le.sorts.get(e);Ao(e),n?(t.setAttribute("data-sort-dir",n),t.setAttribute("aria-sort",n==="asc"?"ascending":"descending"),c.column=r,c.direction=n):(c.column=null,c.direction=null);let s=Eo(e,i);if(s){let a=i.findContext(e),d=a?wo(a,s.arrayPath):null;if(Array.isArray(d)){if(!n){let l=e._nojsOriginalOrder;if(l){let m=new Set(d),f=l.filter(g=>m.has(g));for(let g of d)l.includes(g)||f.push(g);on(a,s.arrayPath,f)}return}e._nojsOriginalOrder||(e._nojsOriginalOrder=[...d]);let u=[...d].sort((l,m)=>{let f=l!=null?l[r]:null,g=m!=null?m[r]:null,v=cn(f,g,o);return n==="desc"?-v:v});on(a,s.arrayPath,u);return}}_o(e,t,r,o,n)}function _o(t,e,r,o,n){let i=t.querySelector("tbody");if(!i)return;let a=[...e.closest("tr").children].indexOf(e);if(a<0)return;let d=[...i.querySelectorAll(":scope > tr")];if(t._nojsOriginalRows||(t._nojsOriginalRows=[...d]),!n){let m=document.createDocumentFragment();for(let f of t._nojsOriginalRows)m.appendChild(f);i.appendChild(m);return}let u=m=>{let f=m.replace(/[^0-9.\-]/g,"");return f===""||f==="-"?NaN:parseFloat(f)};d.sort((m,f)=>{let g=m.children[a]?.textContent?.trim()||"",v=f.children[a]?.textContent?.trim()||"",y=cn(o==="number"?u(g):g,o==="number"?u(v):v,o);return n==="desc"?-y:y});let l=document.createDocumentFragment();for(let m of d)l.appendChild(m);i.appendChild(l)}function un(t){t.directive("fixed-header",{priority:10,init(e){ve(),e.classList.add("nojs-fixed-header")}})}function pn(t){t.directive("fixed-col",{priority:10,init(e){ve(),e.classList.add("nojs-fixed-col")}})}function gt(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function fn(t){let e=t.querySelector("tbody");if(!e)return null;let r=null;if(e.hasAttribute("each")||e.hasAttribute("foreach")?r=e:r=e.querySelector("[each]")||e.querySelector("[foreach]"),!r)return null;let o=r.getAttribute("each")||r.getAttribute("foreach");if(!o)return null;let n=o.match(/^\s*(\w+)\s+(?:in|of)\s+(.+)\s*$/);return n?{iteratorVar:n[1],arrayPath:n[2].trim(),eachEl:r}:null}function gn(t,e){let r=e.split("."),o=t;for(let n of r){if(o==null)return;o=o[n]}return o}function mn(t,e,r){let o=e.split("."),n=t;for(let i=0;i<o.length-1;i++){if(n[o[i]]==null)return;n=n[o[i]]}n[o[o.length-1]]=r}function bn(t){t.directive("table-reorder",{priority:15,init(e){if(ve(),e.tagName!=="TABLE")return;let r=e.querySelector("tbody");if(!r)return;let o=t.findContext(e),n=e.getAttribute("table-reorder-handle"),i=e.getAttribute("table-reorder-drag-class")||"nojs-row-dragging",c=e.getAttribute("table-reorder-over-class")||"nojs-row-drag-over",s=null,a=null,d=null;function u(){let y=r.querySelectorAll(":scope > tr");for(let p=0;p<y.length;p++){let b=y[p];if(b._nojsReorderSetup)continue;b._nojsReorderSetup=!0,b.draggable=!0,b.setAttribute("aria-grabbed","false");let A=!0;if(n){let j=S=>{A=!!S.target.closest(n)};b.addEventListener("mousedown",j),gt(b,()=>b.removeEventListener("mousedown",j))}let h=j=>{if(n&&!A){j.preventDefault();return}s=[...r.querySelectorAll(":scope > tr")].indexOf(b),a=b,j.dataTransfer&&(j.dataTransfer.effectAllowed="move",j.dataTransfer.setData("text/plain","")),i.split(/\s+/).filter(Boolean).forEach(w=>b.classList.add(w)),b.setAttribute("aria-grabbed","true")},x=j=>{if(a==null)return;j.preventDefault(),j.dataTransfer&&(j.dataTransfer.dropEffect="move");let S=b.getBoundingClientRect(),w=S.top+S.height/2,H=[...r.querySelectorAll(":scope > tr")].indexOf(b);l(),H!==s&&(j.clientY<w?b.classList.add("nojs-reorder-insert-before"):b.classList.add("nojs-reorder-insert-after"),d=b)},_=()=>{b.classList.remove("nojs-reorder-insert-before"),b.classList.remove("nojs-reorder-insert-after"),d===b&&(d=null)},L=j=>{if(j.preventDefault(),j.stopPropagation(),a==null||s==null)return;let S=[...r.querySelectorAll(":scope > tr")],w=b.getBoundingClientRect(),B=w.top+w.height/2,H=S.indexOf(b);j.clientY>=B&&H++;let Z=s;if(Z===H||Z+1===H){m();return}let z=Z<H?H-1:H,se=fn(e);if(se&&o){let T=gn(o,se.arrayPath);if(Array.isArray(T)){let P=[...T],[q]=P.splice(Z,1);P.splice(z,0,q),mn(o,se.arrayPath,P),e._nojsOriginalOrder&&(e._nojsOriginalOrder=[...P]),e.dispatchEvent(new CustomEvent("table:reorder",{bubbles:!0,detail:{from:Z,to:z,item:q}}))}}else{let T=a,P=S[z];T&&P&&(Z<z?r.insertBefore(T,P.nextSibling):r.insertBefore(T,P),e.dispatchEvent(new CustomEvent("table:reorder",{bubbles:!0,detail:{from:Z,to:z,item:null}})))}m()},k=()=>{m()};b.addEventListener("dragstart",h),b.addEventListener("dragover",x),b.addEventListener("dragleave",_),b.addEventListener("drop",L),b.addEventListener("dragend",k),gt(b,()=>{b.removeEventListener("dragstart",h),b.removeEventListener("dragover",x),b.removeEventListener("dragleave",_),b.removeEventListener("drop",L),b.removeEventListener("dragend",k),b._nojsReorderSetup=!1})}}function l(){d&&(d.classList.remove("nojs-reorder-insert-before"),d.classList.remove("nojs-reorder-insert-after"),d=null)}function m(){a&&(i.split(/\s+/).filter(Boolean).forEach(p=>a.classList.remove(p)),a.setAttribute("aria-grabbed","false")),l(),s=null,a=null;let y=r.querySelectorAll(":scope > tr");for(let p of y)p.classList.remove("nojs-reorder-insert-before"),p.classList.remove("nojs-reorder-insert-after"),c.split(/\s+/).filter(Boolean).forEach(b=>p.classList.remove(b))}let f=y=>{a!=null&&(y.preventDefault(),y.dataTransfer&&(y.dataTransfer.dropEffect="move"))},g=y=>{if(a==null||y.target!==r)return;y.preventDefault(),y.stopPropagation();let p=s,A=[...r.querySelectorAll(":scope > tr")].length-1;if(p===A){m();return}let h=fn(e);if(h&&o){let x=gn(o,h.arrayPath);if(Array.isArray(x)){let _=[...x],[L]=_.splice(p,1);_.push(L),mn(o,h.arrayPath,_),e._nojsOriginalOrder&&(e._nojsOriginalOrder=[..._]),e.dispatchEvent(new CustomEvent("table:reorder",{bubbles:!0,detail:{from:p,to:_.length-1,item:L}}))}}m()};r.addEventListener("dragover",f),r.addEventListener("drop",g);let v=new MutationObserver(()=>{u()});v.observe(r,{childList:!0}),u(),gt(e,()=>{v.disconnect(),r.removeEventListener("dragover",f),r.removeEventListener("drop",g),m()})}})}function hn(t,e={}){dn(t),ln(t),un(t),pn(t),bn(t)}function vn(){nn()}var ue={containers:new Map};function yn(){for(let[,t]of ue.containers)typeof t.unsub=="function"&&t.unsub();ue.containers.clear()}function xn(){if(typeof document>"u"||document.querySelector("style[data-nojs-breadcrumb]"))return;let t=`
.nojs-breadcrumb {
  display: flex;
  align-items: center;
  flex-wrap: wrap;
...
`.trim(),e=document.createElement("style");e.setAttribute("data-nojs-breadcrumb",""),e.textContent=t,document.head.appendChild(e)}function En(t,e){t.__disposers=t.__disposers||[],t.__disposers.push(e)}function Lo(t){let e=t.getAttribute("breadcrumb");if(e&&e.trim()!=="")return e.trim();let r=t.getAttribute("title");return r&&r.trim()!==""?r.trim():(t.textContent||"").trim()}function jo(t){return t&&t.charAt(0).toUpperCase()+t.slice(1)}function wn(t,e){let r=t.querySelector("ol.nojs-breadcrumb");r&&r.remove();let o=document.createElement("ol");o.classList.add("nojs-breadcrumb");for(let i=0;i<e.length;i++){let c=e[i],s=document.createElement("li");if(i===e.length-1){let d=document.createElement("span");d.setAttribute("aria-current","page"),d.textContent=c.label,s.appendChild(d)}else{let d=document.createElement("a");d.href=c.href,d.textContent=c.label,s.appendChild(d)}o.appendChild(s)}t.appendChild(o);let n=ue.containers.get(t);n&&(n.crumbs=e)}function ko(t){let e=[],r=Array.from(t.children);for(let o of r){if(o.tagName==="OL"&&o.classList.contains("nojs-breadcrumb"))continue;let n=Lo(o);if(!n)continue;let i=o.getAttribute("href")||"#";e.push({label:n,href:i})}return e}function Co(t){if(!t||t==="/")return[{label:"Home",href:"/",isLast:!0}];let r=(t.replace(/\/+$/,"")||"/").split("/").filter(Boolean),o=[{label:"Home",href:"/"}],n="";for(let i=0;i<r.length;i++){n+="/"+r[i];let c=jo(r[i].replace(/[-_]/g," "));o.push({label:c,href:n})}return o}function An(t){t.directive("breadcrumb",{priority:15,init(e,r,o){xn(),e.tagName==="NAV"&&!e.getAttribute("aria-label")&&e.setAttribute("aria-label","Breadcrumb");let n=Array.from(e.children).some(s=>!(s.tagName==="OL"&&s.classList.contains("nojs-breadcrumb"))),i=t.router,c=!n&&i;if(ue.containers.set(e,{unsub:null,crumbs:[]}),c){let s=()=>{let a=i.current,d=a?a.path:"/",u=Co(d);wn(e,u)};if(s(),typeof i.on=="function"){let a=i.on(s),d=ue.containers.get(e);d&&(d.unsub=a),En(e,()=>{typeof a=="function"&&a();let u=ue.containers.get(e);u&&(u.unsub=null)})}}else{let s=ko(e);for(let a of Array.from(e.children))a.tagName==="OL"&&a.classList.contains("nojs-breadcrumb")||(a.style.display="none");wn(e,s)}En(e,()=>{ue.containers.delete(e)})}})}function _n(t,e={}){An(t)}function Ln(){yn()}var So="[validate],[drag],[drop],[drag-list],[drag-multiple]";function jn(t){if(typeof document>"u")return;let e=document.querySelectorAll(So);for(let r of e){if(!r.__declared)continue;let o=X(t,"disposeTree");typeof o=="function"?o(r):(r.__disposers&&(r.__disposers.forEach(i=>i()),r.__disposers=null),r.__declared=!1);let n=t.findContext?t.findContext(r):null;n&&delete n.$form,t.processTree(r)}}var To=["tooltip","popover","popover-trigger","popover-dismiss","modal","modal-open","modal-close","dropdown","dropdown-toggle","dropdown-menu","dropdown-item","toast","toast-container","tabs","tab","tab-disabled","tab-position","tree","branch","subtree","stepper","step","skeleton","split","pane","panel","sortable","sort","fixed-header","fixed-col","breadcrumb"],Do={name:"nojs-elements",install(t,e={}){At(t,e),Bt(t,e),Mt(t,e),Wt(t,e),er(t,e),cr(t,e),mr(t,e),Ar(t,e),$r(t,e),Wr(t,e),Xr(t,e),tn(t,e),hn(t,e),_n(t,e),jn(t)},init(t){if(jn(t),typeof document>"u"||!document.body)return;let e=To.map(o=>`[${o}]`).join(","),r;try{r=document.body.querySelectorAll(e)}catch{return}for(let o of r)o.__declared&&!o.__disposers&&!o.__ctx&&(o.__declared=!1);try{t.processTree(document.body)}catch(o){t.internals?.warn?.("nojs-elements init re-process error:",o.message)}},dispose(t){_t(),Ft(),Ht(),Gt(),tr(),dr(),br(),_r(),Rr(),Gr(),rn(),vn(),Ln()}},Ca=Do;export{Ca as default};
